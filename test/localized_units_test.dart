...
void main() {
  test('units', () {
    ...
    expect(
      CommonLocaleDataEn().units.lengthMeter.long(3).toString(),
      '3 meters',
    );
    expect(CommonLocaleDataEn().units.lengthMeter.long(1), '1 meter');
    expect(
      CommonLocaleDataEn().units.areaSquareMeter.long(3),
      '3 square meters',
    );
    ...
    expect(
      CommonLocaleDataEn().units.areaSquareMeter.long(
        2,
        numberFormat: NumberFormat.decimalPattern()..minimumFractionDigits = 1,
      ),
      '2.0 square meters',
    );
  });
  ...
  test('unit patterns', () {
    ...
    expect(
      CommonLocaleDataEn().units.pattern10pMinus3.narrow.unit(
        CommonLocaleDataEn().units.electricVolt.narrow,
      ),
      'mV',
    );
  });
  ...
  test('countries', () {
    ...
    expect(
      CommonLocaleDataEn().territories.territories['US']!.name,
      'United States',
    );
