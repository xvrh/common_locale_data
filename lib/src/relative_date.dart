...
enum RelativeDateTimeDirection { past, future }
...
class RelativeDateTimeFormatter {
  ...
  RelativeDateTimeFormatter({this.data, this.style});

  String format(Duration duration,
      {RelativeDateTimeDirection? direction,
      LocaleDataStyle? style,
      CommonLocaleData? data}) {
    data ??= this.data ?? cld;
    style ??= this.style ?? LocaleDataStyle.long;
    direction ??= duration.isNegative
        ? RelativeDateTimeDirection.future
        : RelativeDateTimeDirection.past;
    ...
    switch (direction) {
      case RelativeDateTimeDirection.future:
        withLength = field.future;
        break;
      case RelativeDateTimeDirection.past:
