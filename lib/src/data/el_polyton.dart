...
class CommonLocaleDataElPolyton implements CommonLocaleData {
  ...
  static final _listPatterns = ListPatternsElPolyton._();
  @override
  ListPatterns get listPatterns => _listPatterns;

  static final _calendar = CalendarElPolyton._();
  @override
  Calendar get calendar => _calendar;

  static final _currencies = CurrenciesElPolyton._();
  @override
...
class ListPatternsElPolyton extends ListPatterns {
  ListPatternsElPolyton._();
...
class CalendarElPolyton extends Calendar {
  CalendarElPolyton._();
...
class CurrenciesElPolyton extends Currencies {
  ...
  Currency get aed => Currency(
        _locale,
        'AED',
        'Ντιρὰμ Ἡνωμένων Ἀραβικῶν Ἐμιράτων',
  ...
  Currency get ecv => Currency(
        _locale,
        'ECV',
        'Unidad de Valor Constante (UVC) Ἰσημερινοῦ',
      );
  ...
  Currency get mxp => Currency(
        _locale,
        'MXP',
        'Ἀσημένιο Πέσο Μεξικοῦ (1861–1992)',
  ...
  Currency get xbc => Currency(
        _locale,
        'XBC',
        'Εὐρωπαϊκὴ Μονάδα Λογαριασμοῦ (XBC)',
  ...
  Currency get xbd => Currency(
        _locale,
        'XBD',
        'Εὐρωπαϊκὴ Μονάδα Λογαριασμοῦ (XBD)',
  ...
  Currency get xeu => Currency(
        _locale,
        'XEU',
        'Εὐρωπαϊκὴ Συναλλαγματικὴ Μονάδα',
