...
class CommonLocaleDataSwKE implements CommonLocaleData {
  ...
  static final _scripts = ScriptsSwKE._();
  @override
  Scripts get scripts => _scripts;

  static final _variants = VariantsSwKE._();
  @override
  ...
  static final _timeZones = TimeZonesSwKE._(_territories);
  @override
  TimeZones get timeZones => _timeZones;

  static final _listPatterns = ListPatternsSwKE._();
  @override
  ListPatterns get listPatterns => _listPatterns;

  static final _calendar = CalendarSwKE._();
  @override
  Calendar get calendar => _calendar;

  static final _currencies = CurrenciesSwKE._();
  @override
...
class TimeZonesSwKE extends TimeZones {
  TimeZonesSwKE._(Territories territories)
  ...
  final timeZoneNames = CanonicalizedMap<String, String, TimeZoneNames>.from({
    ...
    'America/Curacao': TimeZoneNames(
      exemplarCity: 'kurakao',
    ),
    'America/Dominica': TimeZoneNames(
      exemplarCity: 'Dominika',
    ),
    'America/El_Salvador': TimeZoneNames(
      exemplarCity: 'Elsalvado',
    ),
    ...
    'Asia/Saigon': TimeZoneNames(
      exemplarCity: 'Jiji la Ho Chi Minh',
    ),
    'Asia/Singapore': TimeZoneNames(
      exemplarCity: 'Singapoo',
    ),
    'Indian/Christmas': TimeZoneNames(
      exemplarCity: 'Krismasi',
    ),
  ...
  final metaZoneNames = CanonicalizedMap<String, String, MetaZone>.from({
    ...
    'Gulf': MetaZone(
      code: 'Gulf',
      long: TimeZoneName(
        standard: 'Saa za Wastani za Ghuba',
      ),
    ),
    'Guyana': MetaZone(
      code: 'Guyana',
    ...
    'Kazakhstan_Eastern': MetaZone(
      ...
      long: TimeZoneName(
        standard: 'Saa za Kazakistani Mashariki',
      ),
    ),
    'Kazakhstan_Western': MetaZone(
      code: 'Kazakhstan_Western',
      long: TimeZoneName(
        standard: 'Saa za Kazakistani Magharibi',
      ),
    ),
    'Korea': MetaZone(
      code: 'Korea',
    ...
    'Malaysia': MetaZone(
      code: 'Malaysia',
      long: TimeZoneName(
        standard: 'Saa za Malesia',
      ),
    ),
    'Maldives': MetaZone(
      code: 'Maldives',
      long: TimeZoneName(
        standard: 'Saa za Maldivi',
      ),
    ),
    'Marquesas': MetaZone(
      code: 'Marquesas',
    ...
    'Phoenix_Islands': MetaZone(
      ...
      long: TimeZoneName(
        standard: 'Saa za Visiwa vya Finiksi',
      ),
    ),
    ...
    'Singapore': MetaZone(
      code: 'Singapore',
      long: TimeZoneName(
        standard: 'Saa za Wastani za Singapoo',
      ),
    ),
    'Solomon': MetaZone(
      code: 'Solomon',
...
class ListPatternsSwKE extends ListPatterns {
  ListPatternsSwKE._();
...
class CalendarSwKE extends Calendar {
  CalendarSwKE._();
