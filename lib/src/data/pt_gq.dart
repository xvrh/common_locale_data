...
const _locale = 'pt-GQ';
const _cld = CommonLocaleDataPtGQ.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataPtGQ extends CommonLocaleDataPt {
  @override
  String get locale => _locale;

  const CommonLocaleDataPtGQ.constant() : super.constant();

  factory CommonLocaleDataPtGQ() => _cld;
  ...
  static final _units = UnitsPtGQ(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsPtGQ(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesPtGQ(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsPtGQ(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesPtGQ(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsPtGQ(_cld);
  @override
  Variants get variants => _variants;

  static final _currencies = CurrenciesPtGQ(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesPtGQ(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNamePtGQ(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsPtGQ extends UnitsPt {
  const UnitsPtGQ(super.cld);
  ...
  Unit get lengthFoot => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'pés', one: '{0}′', other: '{0}′'),
  );
  ...
  Unit get pressurePoundForcePerSquareInch => const Unit(
    long: UnitCountPattern(_locale, 'psi', one: '{0} psi', other: '{0} psi'),
  ...
  Unit get speedKnot => const Unit(
    ...
    short: UnitCountPattern(_locale, 'nós', one: '{0} nó', other: '{0} nós'),
  ...
  Unit get volumeTeaspoon => const Unit(
    ...
    short: UnitCountPattern(_locale, 'cc', one: '{0} cc', other: '{0} cc'),
    narrow: UnitCountPattern(_locale, 'cc', one: '{0} cc', other: '{0} cc'),
  );
...
class DateFieldsPtGQ extends DateFieldsPt {
  const DateFieldsPtGQ(super.cld);
  ...
  DateFieldFullData get year => const DateFieldFullData(
    ...
    past: MultiLengthRelativeTime(
      ...
      narrow: RelativeTime(_locale, one: '-{0} ano', other: '-{0} anos'),
    ),
  ...
  DateFieldFullData get month => const DateFieldFullData(
    ...
    past: MultiLengthRelativeTime(
      ...
      narrow: RelativeTime(_locale, one: '-{0} mês', other: '-{0} meses'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
  ...
  DateFieldFullData get day => const DateFieldFullData(
    ...
    past: MultiLengthRelativeTime(
      ...
      narrow: RelativeTime(_locale, one: '-{0} dia', other: '-{0} dias'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
  ...
  DateFieldDataWithRelative get tuesday => const DateFieldDataWithRelative(
    ...
    past: MultiLengthRelativeTime(
      ...
      short: RelativeTime(_locale, one: 'há {0} terça', other: 'há {0} terças'),
  ...
  DateFieldDataWithRelative get friday => const DateFieldDataWithRelative(
    ...
    past: MultiLengthRelativeTime(
      ...
      short: RelativeTime(_locale, one: 'há {0} sexta', other: 'há {0} sextas'),
  ...
  DateFieldDataTime get second => const DateFieldDataTime(
    ...
    past: MultiLengthRelativeTime(
      ...
      short: RelativeTime(_locale, one: 'há {0} s', other: 'há {0} s'),
...
class LanguagesPtGQ extends LanguagesPt {
  const LanguagesPtGQ(super.cld);
...
class ScriptsPtGQ extends ScriptsPt {
  const ScriptsPtGQ(super.cld);
...
class TerritoriesPtGQ extends TerritoriesPt {
  const TerritoriesPtGQ(super.cld);
...
class VariantsPtGQ extends VariantsPt {
  const VariantsPtGQ(super.cld);
...
class CurrenciesPtGQ extends CurrenciesPt {
  const CurrenciesPtGQ(super.cld);
...
class TimeZonesPtGQ extends TimeZonesPt {
  const TimeZonesPtGQ(super.cld);
  ...
  Map<String, MetaZone> get metaZoneNames => Map.unmodifiable({
    ...
    ...const {
      ...
      'Bhutan': MetaZone(
        'Bhutan',
        long: TimeZoneName(standard: 'Hora do Butão'),
      ),
      'Bolivia': MetaZone(
        'Bolivia',
      ...
      'Tahiti': MetaZone(
        'Tahiti',
        long: TimeZoneName(standard: 'Hora do Taiti'),
      ),
      'Taipei': MetaZone(
        'Taipei',
        long: TimeZoneName(
...
class LocaleDisplayNamePtGQ extends LocaleDisplayNamePt {
  const LocaleDisplayNamePtGQ(super.cld);
  ...
  Map<String, Map<String, String>> get valueNames => Map.unmodifiable({
    ...
    ...const {
      ...
      'm0': {'bgn': 'Transliteração BGN', 'ungegn': 'Transliteração UNGEGN'},
      'ms': {
