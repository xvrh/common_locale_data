...
const _locale = 'nb-SJ';
const _cld = CommonLocaleDataNbSJ._();
...
class CommonLocaleDataNbSJ implements CommonLocaleData {
  ...
  static final _units = UnitsNbSJ._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsNbSJ._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesNbSJ._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsNbSJ._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesNbSJ._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsNbSJ._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsNbSJ._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesNbSJ._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesNbSJ._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameNbSJ._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsNbSJ extends Units {
  UnitsNbSJ._(super.cld);
...
class DateFieldsNbSJ extends DateFields {
  DateFieldsNbSJ._(super.cld);
...
class LanguagesNbSJ extends Languages {
  const LanguagesNbSJ._(super.cld);
...
class TerritoriesNbSJ extends Territories {
  const TerritoriesNbSJ._(super.cld);
...
class VariantsNbSJ extends Variants {
  const VariantsNbSJ._(super.cld);
...
class SubdivisionsNbSJ extends Subdivisions {
  const SubdivisionsNbSJ._(super.cld);

  @override
  final subdivisions = const {};
}

class CurrenciesNbSJ extends Currencies {
  const CurrenciesNbSJ._(super.cld);
...
class TimeZonesNbSJ extends TimeZones {
  const TimeZonesNbSJ._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
...
class LocaleDisplayNameNbSJ extends LocaleDisplayName {
  const LocaleDisplayNameNbSJ._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
