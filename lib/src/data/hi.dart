...
class CommonLocaleDataHi implements CommonLocaleData {
  ...
  static final _listPatterns = ListPatternsHi._();
  @override
  ListPatterns get listPatterns => _listPatterns;

  static final _calendar = CalendarHi._();
  @override
  Calendar get calendar => _calendar;

  static final _currencies = CurrenciesHi._();
  @override
...
class TimeZonesHi extends TimeZones {
  ...
  final timeZoneNames = CanonicalizedMap<String, String, TimeZoneNames>.from({
    ...
    'America/Fort_Nelson': TimeZoneNames(
      exemplarCity: 'फ़ोर्ट नेल्सन',
    ),
    'America/Fortaleza': TimeZoneNames(
      exemplarCity: 'फ़ोर्टालेज़ा',
    ),
    'America/Glace_Bay': TimeZoneNames(
      exemplarCity: 'ग्लेस खाड़ी',
    ),
    'America/Godthab': TimeZoneNames(
      exemplarCity: 'नुक',
    ),
    'America/Goose_Bay': TimeZoneNames(
      exemplarCity: 'गूस खाड़ी',
    ),
...
class CalendarHi extends Calendar {
  CalendarHi._();
