...
const _locale = 'pt-ST';
const _cld = CommonLocaleDataPtST.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataPtST extends CommonLocaleDataPt {
  @override
  String get locale => _locale;

  const CommonLocaleDataPtST.constant() : super.constant();
  ...
  static final _units = UnitsPtST(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsPtST(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesPtST(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsPtST(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesPtST(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsPtST(_cld);
  @override
  Variants get variants => _variants;

  static final _currencies = CurrenciesPtST(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesPtST(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNamePtST(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsPtST extends UnitsPt {
  const UnitsPtST(super.cld);
...
class DateFieldsPtST extends DateFieldsPt {
  const DateFieldsPtST(super.cld);
...
class LanguagesPtST extends LanguagesPt {
  const LanguagesPtST(super.cld);
...
class ScriptsPtST extends ScriptsPt {
  const ScriptsPtST(super.cld);
...
class TerritoriesPtST extends TerritoriesPt {
  const TerritoriesPtST(super.cld);
...
class VariantsPtST extends VariantsPt {
  const VariantsPtST(super.cld);
...
class CurrenciesPtST extends CurrenciesPt {
  const CurrenciesPtST(super.cld);
...
class TimeZonesPtST extends TimeZonesPt {
  const TimeZonesPtST(super.cld);
...
class LocaleDisplayNamePtST extends LocaleDisplayNamePt {
  const LocaleDisplayNamePtST(super.cld);
