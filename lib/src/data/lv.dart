...
const _locale = 'lv';
const _cld = CommonLocaleDataLv.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataLv extends CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataLv.constant() : super.constant();
  ...
  static final _units = UnitsLv(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsLv(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesLv(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsLv(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesLv(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsLv(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsLv(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesLv(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesLv(_cld);
  @override
...
class DateFieldsLv extends DateFields {
  const DateFieldsLv(super.cld);

  @override
  MultiLength get era =>
      const MultiLength(long: 'ēra', short: 'ēra', narrow: 'ēra');

  @override
  DateFieldFullData get year => const DateFieldFullData(
    displayName: MultiLength(long: 'gads', short: 'g.', narrow: 'g.'),
    previous: MultiLength(
      long: 'pagājušajā gadā',
      short: 'pag. gadā',
      narrow: 'pag. gadā',
    ),
    now: MultiLength(long: 'šajā gadā', short: 'šajā g.', narrow: 'šajā g.'),
    next: MultiLength(
      long: 'nākamajā gadā',
      short: 'nāk. gadā',
      narrow: 'nāk. gadā',
  ...
  DateFieldFullData get quarter => const DateFieldFullData(
    displayName: MultiLength(long: 'ceturksnis', short: 'cet.', narrow: 'cet.'),
    previous: MultiLength(
  ...
  DateFieldFullData get month => const DateFieldFullData(
    displayName: MultiLength(long: 'mēnesis', short: 'mēn.', narrow: 'mēn.'),
    previous: MultiLength(
  ...
  DateFieldFullData get week => const DateFieldFullData(
    displayName: MultiLength(long: 'nedēļa', short: 'ned.', narrow: 'ned.'),
    previous: MultiLength(
  ...
  DateFieldFullData get day => const DateFieldFullData(
    ...
    now: MultiLength(long: 'šodien', short: 'šodien', narrow: 'šodien'),
    next: MultiLength(long: 'rīt', short: 'rīt', narrow: 'rīt'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
        zero: 'pirms {0} dienām',
  ...
  DateFieldDataTime get hour => const DateFieldDataTime(
    displayName: MultiLength(long: 'stundas', short: 'st.', narrow: 'h'),
    now: MultiLength(
      long: 'šajā stundā',
      short: 'šajā stundā',
      narrow: 'šajā stundā',
  ...
  DateFieldDataTime get minute => const DateFieldDataTime(
    displayName: MultiLength(long: 'minūtes', short: 'min', narrow: 'min'),
    now: MultiLength(
      long: 'šajā minūtē',
      short: 'šajā minūtē',
      narrow: 'šajā minūtē',
  ...
  DateFieldDataTime get second => const DateFieldDataTime(
    displayName: MultiLength(long: 'sekundes', short: 'sek.', narrow: 's'),
    now: MultiLength(long: 'tagad', short: 'tagad', narrow: 'tagad'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
...
class SubdivisionsLv extends Subdivisions {
  const SubdivisionsLv(super.cld);
...
class TimeZonesLv extends TimeZones {
  ...
  @override
  String get regionFormat => 'Laika josla: {0}';
  @override
  String get regionFormatDaylight => '{0}: vasaras laiks';
  @override
  String get regionFormatStandard => '{0}: standarta laiks';
  @override
  String get fallbackFormat => '{0} ({1})';
  @override
  ...
  static const staticMetaZoneNames = <String, MetaZone>{
    ...
    'Bolivia': MetaZone(
      'Bolivia',
      long: TimeZoneName(standard: 'Bolīvijas laiks'),
    ),
    'Brasilia': MetaZone(
      'Brasilia',
      long: TimeZoneName(
    ...
    'Ecuador': MetaZone(
      'Ecuador',
      long: TimeZoneName(standard: 'Ekvadoras laiks'),
    ),
    ...
    'Galapagos': MetaZone(
      'Galapagos',
      long: TimeZoneName(standard: 'Galapagu laiks'),
    ),
    'Gambier': MetaZone(
      'Gambier',
      long: TimeZoneName(standard: 'Gambjē salu laiks'),
    ),
    'Georgia': MetaZone(
      'Georgia',
      long: TimeZoneName(
    ...
    'Gulf': MetaZone(
      'Gulf',
      long: TimeZoneName(standard: 'Persijas līča laiks'),
    ),
    ...
    'India': MetaZone(
      'India',
      long: TimeZoneName(standard: 'Indijas ziemas laiks'),
    ),
    ...
    'Indochina': MetaZone(
      'Indochina',
      long: TimeZoneName(standard: 'Indoķīnas laiks'),
    ),
    ...
    'Malaysia': MetaZone(
      'Malaysia',
      long: TimeZoneName(standard: 'Malaizijas laiks'),
    ),
    'Maldives': MetaZone(
      'Maldives',
      long: TimeZoneName(standard: 'Maldīvijas laiks'),
    ),
    'Marquesas': MetaZone(
      'Marquesas',
    ...
    'Myanmar': MetaZone(
      'Myanmar',
      long: TimeZoneName(standard: 'Mjanmas laiks'),
    ),
    ...
    'Pitcairn': MetaZone(
      'Pitcairn',
      long: TimeZoneName(standard: 'Pitkērnas laiks'),
    ),
    'Ponape': MetaZone('Ponape', long: TimeZoneName(standard: 'Ponapē laiks')),
    'Pyongyang': MetaZone(
      'Pyongyang',
      long: TimeZoneName(standard: 'Phenjanas laiks'),
    ),
    'Reunion': MetaZone(
      'Reunion',
      long: TimeZoneName(standard: 'Reinjonas laiks'),
    ),
    'Rothera': MetaZone(
      'Rothera',
      long: TimeZoneName(standard: 'Roteras laiks'),
    ),
    'Sakhalin': MetaZone(
      'Sakhalin',
      long: TimeZoneName(
    ...
    'Singapore': MetaZone(
      'Singapore',
      long: TimeZoneName(standard: 'Singapūras laiks'),
    ),
    'Solomon': MetaZone(
      'Solomon',
    ...
    'Suriname': MetaZone(
      'Suriname',
      long: TimeZoneName(standard: 'Surinamas laiks'),
    ),
    ...
    'Tokelau': MetaZone(
      'Tokelau',
      long: TimeZoneName(standard: 'Tokelau laiks'),
    ),
    'Tonga': MetaZone(
      'Tonga',
      long: TimeZoneName(
    ...
    'Venezuela': MetaZone(
      'Venezuela',
      long: TimeZoneName(standard: 'Venecuēlas laiks'),
    ),
    ...
    'Vostok': MetaZone(
      'Vostok',
      long: TimeZoneName(standard: 'Vostokas laiks'),
    ),
...
class LocaleDisplayNameLv extends LocaleDisplayName {
  const LocaleDisplayNameLv(super.cld);
  ...
  @override
  String get codePatternLanguage => 'Valoda: {0}';
  @override
  String get codePatternScript => 'Rakstība: {0}';
  @override
  String get codePatternTerritory => 'Reģions: {0}';
