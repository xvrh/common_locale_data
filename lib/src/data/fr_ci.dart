...
const _locale = 'fr-CI';
const _cld = CommonLocaleDataFrCI._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataFrCI implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataFrCI._();
  ...
  static final _units = UnitsFrCI._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsFrCI._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesFrCI._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsFrCI._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesFrCI._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsFrCI._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsFrCI._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesFrCI._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesFrCI._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameFrCI._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsFrCI extends Units {
  UnitsFrCI._(super.cld);
...
class DateFieldsFrCI extends DateFields {
  DateFieldsFrCI._(super.cld);
...
class LanguagesFrCI extends Languages {
  const LanguagesFrCI._(super.cld);
...
class ScriptsFrCI extends Scripts {
  const ScriptsFrCI._(super.cld);
...
class TerritoriesFrCI extends Territories {
  const TerritoriesFrCI._(super.cld);
...
class VariantsFrCI extends Variants {
  const VariantsFrCI._(super.cld);
...
class SubdivisionsFrCI extends Subdivisions {
  const SubdivisionsFrCI._(super.cld);
...
class CurrenciesFrCI extends Currencies {
  const CurrenciesFrCI._(super.cld);
...
class TimeZonesFrCI extends TimeZones {
  const TimeZonesFrCI._(super.cld)
      : super(
            gmtFormat: 'UTC{0}',
            gmtZeroFormat: 'UTC',
...
class LocaleDisplayNameFrCI extends LocaleDisplayName {
  const LocaleDisplayNameFrCI._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
