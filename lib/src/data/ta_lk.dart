...
class CommonLocaleDataTaLK implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataTaLK();

  static final _dateFields = DateFieldsTaLK._();
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesTaLK._();
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsTaLK._();
  @override
  Scripts get scripts => _scripts;

  static final _variants = VariantsTaLK._();
  @override
  Variants get variants => _variants;

  static final _units = UnitsTaLK._();
  @override
  Units get units => _units;

  static final _territories = TerritoriesTaLK._();
  @override
  Territories get territories => _territories;

  static final _timeZones = TimeZonesTaLK._(_territories);
  @override
  TimeZones get timeZones => _timeZones;
}

class LanguagesTaLK extends Languages {
  LanguagesTaLK._();
...
class ScriptsTaLK extends Scripts {
  ScriptsTaLK._();
...
class VariantsTaLK extends Variants {
  VariantsTaLK._();
...
class UnitsTaLK implements Units {
  UnitsTaLK._();
...
class DateFieldsTaLK implements DateFields {
  DateFieldsTaLK._();
...
class TerritoriesTaLK implements Territories {
  TerritoriesTaLK._();
...
class TimeZonesTaLK extends TimeZones {
  TimeZonesTaLK._(Territories territories)
  ...
  final timeZoneNames = CanonicalizedMap<String, String, TimeZoneNames>.from({
    ...
    'America/Cambridge_Bay': TimeZoneNames(
      city: 'கேம்பிரிட்ஜ் வளைகுடா',
    ),
    'America/Campo_Grande': TimeZoneNames(
      city: 'கேம்போ கிராண்டே',
    ),
    ...
    'America/Indiana/Vincennes': TimeZoneNames(
      city: 'வின்செனேஸ், இண்டியானா',
    ),
    'America/Indiana/Petersburg': TimeZoneNames(
      city: 'பீட்டர்ஸ்பெர்க், இண்டியானா',
    ),
    'America/Indiana/Tell_City': TimeZoneNames(
      city: 'டெல் சிட்டி, இண்டியானா',
    ),
    'America/Indiana/Knox': TimeZoneNames(
      city: 'நாக்ஸ், இண்டியானா',
    ),
    'America/Indiana/Winamac': TimeZoneNames(
      city: 'வினாமேக், இண்டியானா',
    ),
    'America/Indiana/Marengo': TimeZoneNames(
      city: 'மரென்கோ, இண்டியானா',
    ),
    'America/Indiana/Vevay': TimeZoneNames(
      city: 'வேவே, இண்டியானா',
    ),
    'America/Indianapolis': TimeZoneNames(
      city: 'இண்டியானாபொலிஸ்',
    ),
    ...
    'America/Lower_Princes': TimeZoneNames(
      city: 'லோயர் பிரின்ஸஸ் குவார்ட்டர்',
    ),
    ...
    'America/North_Dakota/Beulah': TimeZoneNames(
      city: 'பெவுலா, வடக்கு டகோட்டா',
    ),
    'America/North_Dakota/New_Salem': TimeZoneNames(
      city: 'நியூ சலேம், வடக்கு டகோடா',
    ),
    'America/North_Dakota/Center': TimeZoneNames(
      city: 'சென்டர், வடக்கு டகோடா',
    ),
    ...
    'America/Port-au-Prince': TimeZoneNames(
      city: 'போர்ட்-அவ்-பிரின்ஸ்',
    ),
    'America/Port_of_Spain': TimeZoneNames(
      city: 'போர்ட் ஆஃப் ஸ்பெயின்',
    ),
    'America/Porto_Velho': TimeZoneNames(
      city: 'போர்ட்டோ வெல்ஹோ',
    ),
    ...
    'America/Santo_Domingo': TimeZoneNames(
      city: 'சாண்டோ டோமிங்கோ',
    ),
    'America/Sao_Paulo': TimeZoneNames(
      city: 'சாவோ பவுலோ',
    ),
    'America/Scoresbysund': TimeZoneNames(
      city: 'இடோகோர்டோர்மிட்',
    ),
    'America/Sitka': TimeZoneNames(
      city: 'சிட்கா',
    ),
    'America/St_Barthelemy': TimeZoneNames(
      city: 'செயின்ட் பார்தேலெமி',
    ),
    'America/St_Johns': TimeZoneNames(
      city: 'செயின்ட் ஜான்ஸ்',
    ),
    'America/St_Kitts': TimeZoneNames(
      city: 'செயின்ட் கீட்ஸ்',
    ),
    'America/St_Lucia': TimeZoneNames(
      city: 'செயின்ட் லூசியா',
    ),
    'America/St_Thomas': TimeZoneNames(
      city: 'செயின்ட் தாமஸ்',
    ),
    'America/St_Vincent': TimeZoneNames(
      city: 'செயின்ட் வின்சென்ட்',
    ),
    'America/Swift_Current': TimeZoneNames(
      city: 'ஸ்விஃப்ட் கரண்ட்',
    ),
    ...
    'Atlantic/South_Georgia': TimeZoneNames(
      city: 'தெற்கு ஜார்ஜியா',
    ),
    'Atlantic/St_Helena': TimeZoneNames(
      city: 'செயின்ட் ஹெலெனா',
    ),
