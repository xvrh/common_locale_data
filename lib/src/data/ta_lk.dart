...
const _locale = 'ta-LK';
const _cld = CommonLocaleDataTaLK._();
...
class CommonLocaleDataTaLK implements CommonLocaleData {
  ...
  static final _units = UnitsTaLK._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsTaLK._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesTaLK._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsTaLK._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesTaLK._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsTaLK._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsTaLK._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesTaLK._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesTaLK._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameTaLK._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsTaLK extends Units {
  UnitsTaLK._(super.cld);
...
class DateFieldsTaLK extends DateFields {
  DateFieldsTaLK._(super.cld);
...
class LanguagesTaLK extends Languages {
  const LanguagesTaLK._(super.cld);
...
class TerritoriesTaLK extends Territories {
  const TerritoriesTaLK._(super.cld);
...
class VariantsTaLK extends Variants {
  const VariantsTaLK._(super.cld);
...
class SubdivisionsTaLK extends Subdivisions {
  const SubdivisionsTaLK._(super.cld);
...
class CurrenciesTaLK extends Currencies {
  const CurrenciesTaLK._(super.cld);
...
class TimeZonesTaLK extends TimeZones {
  const TimeZonesTaLK._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
...
class LocaleDisplayNameTaLK extends LocaleDisplayName {
  const LocaleDisplayNameTaLK._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
