...
const _locale = 'fr-SN';
const _cld = CommonLocaleDataFrSN._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataFrSN implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataFrSN._();
  ...
  static final _units = UnitsFrSN._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsFrSN._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesFrSN._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsFrSN._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesFrSN._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsFrSN._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsFrSN._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesFrSN._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesFrSN._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameFrSN._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsFrSN extends Units {
  UnitsFrSN._(super.cld);
...
class DateFieldsFrSN extends DateFields {
  DateFieldsFrSN._(super.cld);
...
class LanguagesFrSN extends Languages {
  const LanguagesFrSN._(super.cld);
...
class ScriptsFrSN extends Scripts {
  const ScriptsFrSN._(super.cld);
...
class TerritoriesFrSN extends Territories {
  const TerritoriesFrSN._(super.cld);
...
class VariantsFrSN extends Variants {
  const VariantsFrSN._(super.cld);
...
class SubdivisionsFrSN extends Subdivisions {
  const SubdivisionsFrSN._(super.cld);
...
class CurrenciesFrSN extends Currencies {
  const CurrenciesFrSN._(super.cld);
...
class TimeZonesFrSN extends TimeZones {
  const TimeZonesFrSN._(super.cld)
      : super(
            gmtFormat: 'UTC{0}',
            gmtZeroFormat: 'UTC',
...
class LocaleDisplayNameFrSN extends LocaleDisplayName {
  const LocaleDisplayNameFrSN._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
