...
const _cld = CommonLocaleDataZhHantHK._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataZhHantHK implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataZhHantHK._();
  ...
  static final _units = UnitsZhHantHK._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsZhHantHK._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesZhHantHK._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsZhHantHK._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesZhHantHK._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsZhHantHK._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsZhHantHK._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesZhHantHK._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesZhHantHK._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameZhHantHK._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsZhHantHK extends Units {
  UnitsZhHantHK._(super.cld);
...
class DateFieldsZhHantHK extends DateFields {
  DateFieldsZhHantHK._(super.cld);
...
class LanguagesZhHantHK extends Languages {
  const LanguagesZhHantHK._(super.cld);
...
class ScriptsZhHantHK extends Scripts {
  const ScriptsZhHantHK._(super.cld);
...
class TerritoriesZhHantHK extends Territories {
  const TerritoriesZhHantHK._(super.cld);
...
class VariantsZhHantHK extends Variants {
  const VariantsZhHantHK._(super.cld);
...
class SubdivisionsZhHantHK extends Subdivisions {
  const SubdivisionsZhHantHK._(super.cld);
...
class CurrenciesZhHantHK extends Currencies {
  const CurrenciesZhHantHK._(super.cld);
...
class TimeZonesZhHantHK extends TimeZones {
  const TimeZonesZhHantHK._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
            regionFormat: '{0}時間',
  ...
  final timeZoneNames = const {
    ...
    'America/North_Dakota/New_Salem': TimeZoneNames(exemplarCity: '北達科他州新薩勒姆'),
  ...
  final metaZoneNames = const {
    ...
    'America_Central': MetaZone('America_Central',
        long: TimeZoneName(
            generic: '北美中部時間', standard: '北美中部標準時間', daylight: '北美中部夏令時間'),
        short: TimeZoneName(generic: 'CT', standard: 'CST', daylight: 'CDT')),
    'America_Eastern': MetaZone('America_Eastern',
        long: TimeZoneName(
            generic: '北美東部時間', standard: '北美東部標準時間', daylight: '北美東部夏令時間'),
        short: TimeZoneName(generic: 'ET', standard: 'EST', daylight: 'EDT')),
    'America_Mountain': MetaZone('America_Mountain',
        long: TimeZoneName(
            generic: '北美山區時間', standard: '北美山區標準時間', daylight: '北美山區夏令時間'),
        short: TimeZoneName(generic: 'MT', standard: 'MST', daylight: 'MDT')),
    'America_Pacific': MetaZone('America_Pacific',
        long: TimeZoneName(
            generic: '北美太平洋時間', standard: '北美太平洋標準時間', daylight: '北美太平洋夏令時間'),
    ...
    'Azerbaijan': MetaZone('Azerbaijan',
        long: TimeZoneName(
            generic: '亞塞拜疆時間', standard: '亞塞拜疆標準時間', daylight: '亞塞拜疆夏令時間')),
    ...
    'DumontDUrville':
        MetaZone('DumontDUrville', long: TimeZoneName(standard: '迪蒙迪維爾時間')),
    ...
    'Georgia': MetaZone('Georgia',
        long: TimeZoneName(
            generic: '格魯吉亞時間', standard: '格魯吉亞標準時間', daylight: '格魯吉亞夏令時間')),
    'Gilbert_Islands':
    ...
    'Irkutsk': MetaZone('Irkutsk',
        long: TimeZoneName(
            generic: '伊爾庫茨克時間', standard: '伊爾庫茨克標準時間', daylight: '伊爾庫茨克夏令時間')),
    ...
    'Marquesas': MetaZone('Marquesas', long: TimeZoneName(standard: '馬克薩斯時間')),
    'Marshall_Islands':
        MetaZone('Marshall_Islands', long: TimeZoneName(standard: '馬紹爾群島時間')),
    'Mauritius': MetaZone('Mauritius',
        long: TimeZoneName(
            generic: '毛里裘斯時間', standard: '毛里裘斯標準時間', daylight: '毛里裘斯夏令時間')),
    ...
    'Papua_New_Guinea':
        MetaZone('Papua_New_Guinea', long: TimeZoneName(standard: '巴布亞新畿內亞時間')),
    ...
    'Seychelles': MetaZone('Seychelles', long: TimeZoneName(standard: '塞舌爾時間')),
    ...
    'Vanuatu': MetaZone('Vanuatu',
        long: TimeZoneName(
            generic: '瓦努阿圖時間', standard: '瓦努阿圖標準時間', daylight: '瓦努阿圖夏令時間')),
    ...
    'Yakutsk': MetaZone('Yakutsk',
        long: TimeZoneName(
            generic: '雅庫茨克時間', standard: '雅庫茨克標準時間', daylight: '雅庫茨克夏令時間')),
...
class LocaleDisplayNameZhHantHK extends LocaleDisplayName {
  const LocaleDisplayNameZhHantHK._(super.cld)
      : super(
            localePattern: '{0}（{1}）',
            localeSeparator: '{0}，{1}',
