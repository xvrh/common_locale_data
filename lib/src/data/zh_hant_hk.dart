...
const _locale = 'zh-Hant-HK';
const _cld = CommonLocaleDataZhHantHK.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataZhHantHK extends CommonLocaleDataZhHant {
  @override
  String get locale => _locale;

  const CommonLocaleDataZhHantHK.constant() : super.constant();

  factory CommonLocaleDataZhHantHK() => _cld;
  ...
  static final _units = UnitsZhHantHK(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsZhHantHK(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesZhHantHK(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsZhHantHK(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesZhHantHK(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsZhHantHK(_cld);
  @override
  Variants get variants => _variants;

  static final _currencies = CurrenciesZhHantHK(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesZhHantHK(_cld);
  @override
...
class UnitsZhHantHK extends UnitsZhHant {
  ...
  Unit get accelerationGForce => const Unit(
    long: UnitCountPattern(_locale, 'G 力', one: '{0} g-force', other: '{0} G'),
    short: UnitCountPattern(_locale, 'G 力', one: '{0} G', other: '{0} G'),
  ...
  Unit get angleRevolution => const Unit(
    long: UnitCountPattern(_locale, '周', one: '{0} revolution', other: '{0} 周'),
    short: UnitCountPattern(_locale, '周', one: '{0} rev', other: '{0} 周'),
    narrow: UnitCountPattern(_locale, '周', one: '{0}rev', other: '{0} 周'),
  );
  ...
  Unit get areaSquareCentimeter => const Unit(
    ...
    narrow: UnitCountPattern(_locale, '平方厘米', one: '{0}cm²', other: '{0}cm²'),
  );
  ...
  Unit get areaSquareMile => const Unit(
    ...
    narrow: UnitCountPattern(_locale, '平方英里', one: '{0}mi²', other: '{0}mi²'),
  );
  ...
  Unit get areaSquareFoot => const Unit(
    ...
    short: UnitCountPattern(_locale, '平方呎', one: '{0} sq ft', other: '{0} 平方呎'),
    narrow: UnitCountPattern(_locale, '平方呎', one: '{0}ft²', other: '{0}ft²'),
  );
  ...
  Unit get areaSquareInch => const Unit(
    ...
    short: UnitCountPattern(_locale, '平方吋', one: '{0} in²', other: '{0} 平方吋'),
    narrow: UnitCountPattern(_locale, '平方吋', one: '{0}in²', other: '{0}平方英寸'),
  );
  ...
  Unit get concentrPermillion => const Unit(
    ...
    narrow: UnitCountPattern(_locale, '百萬分率', one: '{0}ppm', other: '{0} ppm'),
  );
  ...
  Unit get digitalByte => const Unit(
    long: UnitCountPattern(_locale, '位元組', one: '{0} byte', other: '{0} 位元組'),
    short: UnitCountPattern(
      _locale,
      'byte',
      one: '{0} byte',
  ...
  Unit get digitalBit => const Unit(
    long: UnitCountPattern(_locale, '位元', one: '{0} bit', other: '{0} 個位元'),
  ...
  Unit get durationDecade => const Unit(
    ...
    narrow: UnitCountPattern(_locale, '10年', one: '{0}dec', other: '{0}0年'),
  );
  ...
  Unit get durationMonth => const Unit(
    long: UnitCountPattern(_locale, '個月', one: '{0} month', other: '{0} 個月'),
    short: UnitCountPattern(_locale, '個月', one: '{0} mth', other: '{0} 個月'),
    narrow: UnitCountPattern(_locale, '個月', one: '{0}m', other: '{0}個月'),
  );

  @override
  Unit get durationWeek => const Unit(
    long: UnitCountPattern(_locale, '星期', one: '{0} week', other: '{0} 星期'),
    short: UnitCountPattern(_locale, '星期', one: '{0} wk', other: '{0} 星期'),
    narrow: UnitCountPattern(_locale, '星期', one: '{0}w', other: '{0}週'),
  );
  ...
  Unit get durationDay => const Unit(
    ...
    narrow: UnitCountPattern(_locale, '日', one: '{0}d', other: '{0}日'),
  );
  ...
  Unit get durationMinute => const Unit(
    ...
    narrow: UnitCountPattern(_locale, '分', one: '{0}m', other: '{0}分'),
  );
  ...
  Unit get durationNanosecond => const Unit(
    ...
    short: UnitCountPattern(_locale, '納秒', one: '{0} ns', other: '{0} 納秒'),
    narrow: UnitCountPattern(_locale, '納秒', one: '{0}ns', other: '{0}ns'),
  );
  ...
  Unit get energyFoodcalorie => const Unit(
    ...
    short: UnitCountPattern(_locale, '千卡', one: '{0} Cal', other: '{0} 千卡'),
    narrow: UnitCountPattern(_locale, '千卡', one: '{0}Cal', other: '{0}千卡'),
  );
  ...
  Unit get energyKilojoule => const Unit(
    ...
    narrow: UnitCountPattern(_locale, '千焦', one: '{0}kJ', other: '{0}千焦'),
  );
  ...
  Unit get lengthDecimeter => const Unit(
    ...
    narrow: UnitCountPattern(_locale, '分米', one: '{0}dm', other: '{0}公寸'),
  );
  ...
  Unit get lengthNanometer => const Unit(
    ...
    short: UnitCountPattern(_locale, '納米', one: '{0} nm', other: '{0} 納米'),
    narrow: UnitCountPattern(_locale, '納米', one: '{0}nm', other: '{0}奈米'),
  );

  @override
  Unit get lengthMile => const Unit(
    long: UnitCountPattern(_locale, '哩', one: '{0} mile', other: '{0} 哩'),
    short: UnitCountPattern(_locale, '哩', one: '{0} mi', other: '{0} 哩'),
    narrow: UnitCountPattern(_locale, '哩', one: '{0}mi', other: '{0}哩'),
  );

  @override
  Unit get lengthFoot => const Unit(
    long: UnitCountPattern(_locale, '呎', one: '{0} foot', other: '{0} 呎'),
    short: UnitCountPattern(_locale, '呎', one: '{0} ft', other: '{0} 呎'),
    narrow: UnitCountPattern(_locale, '呎', one: '{0}′', other: '{0}呎'),
  );

  @override
  Unit get lengthInch => const Unit(
    long: UnitCountPattern(_locale, '吋', one: '{0} inch', other: '{0} 吋'),
    short: UnitCountPattern(_locale, '吋', one: '{0} in', other: '{0} 吋'),
    narrow: UnitCountPattern(_locale, '吋', one: '{0}″', other: '{0}吋'),
  );
  ...
  Unit get lengthNauticalMile => const Unit(
    ...
    short: UnitCountPattern(_locale, '浬', one: '{0} nmi', other: '{0} 浬'),
    narrow: UnitCountPattern(_locale, '浬', one: '{0}nmi', other: '{0}nmi'),
  );

  @override
  Unit get lengthPoint => const Unit(
    long: UnitCountPattern(_locale, '點', one: '{0} point', other: '{0} pt'),
    short: UnitCountPattern(_locale, '點', one: '{0} pt', other: '{0} pt'),
    narrow: UnitCountPattern(_locale, '點', one: '{0}pt', other: '{0} pt'),
  );
  ...
  Unit get massOunceTroy => const Unit(
    ...
    narrow: UnitCountPattern(_locale, '金衡安士', one: '{0}oz t', other: '{0}金衡盎司'),
  );
  ...
  Unit get massGrain => const Unit(
    ...
    short: UnitCountPattern(_locale, '格令', one: '{0} gr', other: '{0} 格令'),
    narrow: UnitCountPattern(_locale, '格令', one: '{0}gr', other: '{0}格令'),
  );
  ...
  Unit get powerMegawatt => const Unit(
    ...
    narrow: UnitCountPattern(_locale, '兆瓦', one: '{0}MW', other: '{0}百萬瓦'),
  );
  ...
  Unit get powerWatt => const Unit(
    long: UnitCountPattern(_locale, '瓦', one: '{0} watt', other: '{0} 瓦特'),
    short: UnitCountPattern(_locale, '瓦', one: '{0} W', other: '{0} 瓦'),
    narrow: UnitCountPattern(_locale, '瓦', one: '{0}W', other: '{0}瓦特'),
  );
  ...
  Unit get pressurePoundForcePerSquareInch => const Unit(
    ...
    narrow: UnitCountPattern(_locale, '磅每平方吋', one: '{0}psi', other: '{0}psi'),
  );
  ...
  Unit get pressureInchOfhg => const Unit(
    ...
    short: UnitCountPattern(_locale, '吋汞柱', one: '{0} inHg', other: '{0} 吋汞柱'),
    narrow: UnitCountPattern(_locale, '吋汞柱', one: '{0}″ Hg', other: '{0}″ Hg'),
  );
  ...
  Unit get speedKilometerPerHour => const Unit(
    ...
    narrow: UnitCountPattern(_locale, '公里每小時', one: '{0}km/h', other: '{0}kph'),
  );
  ...
  Unit get speedMeterPerSecond => const Unit(
    ...
    short: UnitCountPattern(_locale, '米每秒', one: '{0} m/s', other: '{0} 米/秒'),
    narrow: UnitCountPattern(_locale, '米每秒', one: '{0}m/s', other: '{0}m/s'),
  );
  ...
  Unit get speedMilePerHour => const Unit(
    ...
    narrow: UnitCountPattern(_locale, '英里每小時', one: '{0}mph', other: '{0}mph'),
  );
  ...
  Unit get temperatureKelvin => const Unit(
    long: UnitCountPattern(_locale, '開爾文', one: '{0} kelvin', other: '{0} 開爾文'),
  ...
  Unit get volumeCubicMeter => const Unit(
    ...
    narrow: UnitCountPattern(_locale, '立方米', one: '{0}m³', other: '{0}立方公尺'),
  );
  ...
  Unit get volumeCubicCentimeter => const Unit(
    ...
    narrow: UnitCountPattern(_locale, '立方厘米', one: '{0}cm³', other: '{0}立方公分'),
  );
  ...
  Unit get volumeCubicMile => const Unit(
    ...
    narrow: UnitCountPattern(_locale, '立方英里', one: '{0}mi³', other: '{0}mi³'),
  );
  ...
  Unit get volumeCubicFoot => const Unit(
    ...
    short: UnitCountPattern(_locale, '立方呎', one: '{0} ft³', other: '{0} 立方呎'),
    narrow: UnitCountPattern(_locale, '立方呎', one: '{0}ft³', other: '{0}立方英尺'),
  );
  ...
  Unit get volumeCubicInch => const Unit(
    ...
    short: UnitCountPattern(_locale, '立方吋', one: '{0} in³', other: '{0} 立方吋'),
    narrow: UnitCountPattern(_locale, '立方吋', one: '{0}in³', other: '{0}立方英寸'),
  );

  @override
  Unit get volumeLiter => const Unit(
    long: UnitCountPattern(_locale, '升', one: '{0} liter', other: '{0} 公升'),
  ...
  Unit get volumeCentiliter => const Unit(
    ...
    narrow: UnitCountPattern(_locale, '厘升', one: '{0}cL', other: '{0}釐升'),
  );
  ...
  Unit get volumeCupMetric => const Unit(
    ...
    short: UnitCountPattern(_locale, '公制量杯', one: '{0} mc', other: '{0} 公制量杯'),
    narrow: UnitCountPattern(_locale, '公制量杯', one: '{0}mc', other: '{0} 量杯'),
  );
  ...
  Unit get volumeAcreFoot => const Unit(
    ...
    short: UnitCountPattern(_locale, '英畝呎', one: '{0} ac ft', other: '{0} 英畝呎'),
    narrow: UnitCountPattern(_locale, '英畝呎', one: '{0}ac ft', other: '{0}英畝英尺'),
  );

  @override
  Unit get volumeCup => const Unit(
    long: UnitCountPattern(_locale, '量杯', one: '{0} cup', other: '{0} 量杯'),
    short: UnitCountPattern(_locale, '量杯', one: '{0} c', other: '{0} 量杯'),
  ...
  Unit get volumeFluidOunce => const Unit(
    ...
    short: UnitCountPattern(_locale, '液安士', one: '{0} fl oz', other: '{0} 液安士'),
    narrow: UnitCountPattern(_locale, '液安士', one: '{0}fl oz', other: '{0}液盎司'),
  );
  ...
  Unit get speedLightSpeed => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'light', one: '{0}light', other: '{0}夜'),
  );
}

class DateFieldsZhHantHK extends DateFieldsZhHant {
  const DateFieldsZhHantHK(super.cld);

  @override
  DateFieldFullData get year => const DateFieldFullData(
    displayName: MultiLength(long: '年', short: '年', narrow: '年'),
    previous: MultiLength(long: '上年', short: '上年', narrow: '上年'),
  ...
  DateFieldFullData get quarter => const DateFieldFullData(
    ...
    past: MultiLengthRelativeTime(
      ...
      narrow: RelativeTime(_locale, other: '-{0}Q'),
    ),
    future: MultiLengthRelativeTime(
  ...
  DateFieldFullData get week => const DateFieldFullData(
    displayName: MultiLength(long: '星期', short: '星期', narrow: '星期'),
    previous: MultiLength(long: '上星期', short: '上星期', narrow: '上星期'),
    now: MultiLength(long: '本星期', short: '本星期', narrow: '本星期'),
    next: MultiLength(long: '下星期', short: '下星期', narrow: '下星期'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(_locale, other: '{0} 星期前'),
      short: RelativeTime(_locale, other: '{0} 星期前'),
      narrow: RelativeTime(_locale, other: '{0}星期前'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(_locale, other: '{0} 星期後'),
      short: RelativeTime(_locale, other: '{0} 星期後'),
      narrow: RelativeTime(_locale, other: '{0}星期後'),
    ),
  );
  ...
  MultiLength get weekday =>
      const MultiLength(long: '星期幾', short: '星期', narrow: '星期');

  @override
  DateFieldDataWithRelative get sunday => const DateFieldDataWithRelative(
    previous: MultiLength(long: '上星期日', short: '上星期日', narrow: '上星期日'),
    now: MultiLength(long: '本星期日', short: '本星期日', narrow: '本星期日'),
  ...
  DateFieldDataWithRelative get monday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: '本星期一', short: '本星期一', narrow: '本星期一'),
  ...
  DateFieldDataWithRelative get tuesday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: '本星期二', short: '本星期二', narrow: '本星期二'),
  ...
  DateFieldDataWithRelative get wednesday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: '本星期三', short: '本星期三', narrow: '本星期三'),
  ...
  DateFieldDataWithRelative get thursday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: '本星期四', short: '本星期四', narrow: '本星期四'),
  ...
  DateFieldDataWithRelative get friday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: '本星期五', short: '本星期五', narrow: '本星期五'),
  ...
  DateFieldDataWithRelative get saturday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: '本星期六', short: '本星期六', narrow: '本星期六'),
  ...
  DateFieldDataTime get hour => const DateFieldDataTime(
    ...
    now: MultiLength(long: '這個小時', short: '這個小時', narrow: '這個小時'),
    past: MultiLengthRelativeTime(
  ...
  DateFieldDataTime get minute => const DateFieldDataTime(
    ...
    now: MultiLength(long: '這分鐘', short: '這分鐘', narrow: '這分鐘'),
    past: MultiLengthRelativeTime(
...
class LanguagesZhHantHK extends LanguagesZhHant {
  const LanguagesZhHantHK(super.cld);
  ...
  static const _yue = Language('yue', '廣東話', menu: '廣東話');
...
class ScriptsZhHantHK extends ScriptsZhHant {
  const ScriptsZhHantHK(super.cld);
...
class TerritoriesZhHantHK extends TerritoriesZhHant {
  const TerritoriesZhHantHK(super.cld);
...
class VariantsZhHantHK extends VariantsZhHant {
  const VariantsZhHantHK(super.cld);
...
class CurrenciesZhHantHK extends CurrenciesZhHant {
  const CurrenciesZhHantHK(super.cld);
...
class TimeZonesZhHantHK extends TimeZonesZhHant {
  const TimeZonesZhHantHK(super.cld);
  ...
  Map<String, TimeZoneNames> get timeZoneNames => Map.unmodifiable({
    ...
    ...const {
      ...
      'America/North_Dakota/Beulah': TimeZoneNames(exemplarCity: '北達科他州比尤拉'),
      'America/North_Dakota/New_Salem': TimeZoneNames(
        exemplarCity: '北達科他州新薩勒姆',
      ),
      'America/North_Dakota/Center': TimeZoneNames(exemplarCity: '北達科他州中心市'),
  ...
  Map<String, MetaZone> get metaZoneNames => Map.unmodifiable({
    ...
    ...const {
      'Africa_Southern': MetaZone(
        'Africa_Southern',
        long: TimeZoneName(standard: '南非時間'),
      ),
      ...
      'Ecuador': MetaZone('Ecuador', long: TimeZoneName(standard: '厄瓜多爾時間')),
      'Galapagos': MetaZone(
        'Galapagos',
        long: TimeZoneName(standard: '加拉帕戈群島時間'),
      ),
      'Georgia': MetaZone(
        'Georgia',
        long: TimeZoneName(
      ...
      'Maldives': MetaZone('Maldives', long: TimeZoneName(standard: '馬爾代夫時間')),
      'Marquesas': MetaZone(
        'Marquesas',
        long: TimeZoneName(standard: '馬克薩斯時間'),
      ),
      'Mauritius': MetaZone(
        'Mauritius',
        long: TimeZoneName(
      ...
      'Pitcairn': MetaZone('Pitcairn', long: TimeZoneName(standard: '皮特康時間')),
      'Seychelles': MetaZone(
        'Seychelles',
        long: TimeZoneName(standard: '塞舌爾時間'),
      ),
      'Singapore': MetaZone('Singapore', long: TimeZoneName(standard: '新加坡時間')),
      'Solomon': MetaZone('Solomon', long: TimeZoneName(standard: '所羅門群島時間')),
      'Suriname': MetaZone('Suriname', long: TimeZoneName(standard: '蘇里南時間')),
      'Tonga': MetaZone(
        'Tonga',
        long: TimeZoneName(
          generic: '湯加時間',
...
class LocaleDisplayNameZhHantHK extends LocaleDisplayNameZhHant {
  const LocaleDisplayNameZhHantHK(super.cld);

  @override
  Map<String, String> get keyNames => Map.unmodifiable({
    ...LocaleDisplayNameZhHant.staticKeyNames,
    ...const {'ms': '度量衡系統', 'x': '專用區'},
  });
