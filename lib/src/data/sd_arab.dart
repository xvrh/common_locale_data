...
const _cld = CommonLocaleDataSdArab._();
...
class CommonLocaleDataSdArab implements CommonLocaleData {
  ...
  const CommonLocaleDataSdArab._();
  ...
  static final _units = UnitsSdArab._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsSdArab._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesSdArab._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsSdArab._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesSdArab._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsSdArab._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsSdArab._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesSdArab._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesSdArab._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameSdArab._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsSdArab extends Units {
  UnitsSdArab._(super.cld);
...
class LanguagesSdArab extends Languages {
  const LanguagesSdArab._(super.cld);
...
class ScriptsSdArab extends Scripts {
  const ScriptsSdArab._(super.cld);
...
class TerritoriesSdArab extends Territories {
  const TerritoriesSdArab._(super.cld);
...
class VariantsSdArab extends Variants {
  const VariantsSdArab._(super.cld);
...
class SubdivisionsSdArab extends Subdivisions {
  const SubdivisionsSdArab._(super.cld);
...
class CurrenciesSdArab extends Currencies {
  const CurrenciesSdArab._(super.cld);
...
class TimeZonesSdArab extends TimeZones {
  const TimeZonesSdArab._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
            regionFormat: '{0} وقت',
...
class LocaleDisplayNameSdArab extends LocaleDisplayName {
  const LocaleDisplayNameSdArab._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
