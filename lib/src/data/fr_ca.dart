...
class UnitsFrCA extends UnitsFr {
  ...
  Unit get areaSquareYard => const Unit(
    ...
    short: UnitCountPattern(_locale, 'vg²', one: '{0} vg²', other: '{0} vg²'),
    narrow: UnitCountPattern(_locale, 'vg²', one: '{0}vg²', other: '{0}vg²'),
  );
  ...
  Unit get concentrKarat => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'carats', one: '{0}ct', other: '{0}ct'),
  );
  ...
  Unit get pressureInchOfhg => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'poHg', one: '{0}poHg', other: '{0}poHg'),
  );
  ...
  Unit get speedBeaufort => const Unit(
    ...
    short: UnitCountPattern(_locale, 'Bft', one: '{0} Bf', other: '{0} Bf'),
  ...
  Unit get volumePint => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'chop', one: '{0}chop', other: '{0}chop'),
  );
...
class DateFieldsFrCA extends DateFieldsFr {
  ...
  DateFieldFullData get year => const DateFieldFullData(
    displayName: MultiLength(long: 'année', short: 'a', narrow: 'a'),
  ...
  DateFieldDataWithRelative get sunday => const DateFieldDataWithRelative(
    ...
    future: MultiLengthRelativeTime(
      ...
      narrow: RelativeTime(_locale, one: 'dans {0} dim', other: 'dans {0} dim'),
    ),
  );
  ...
  DateFieldDataWithRelative get monday => const DateFieldDataWithRelative(
    ...
    future: MultiLengthRelativeTime(
      ...
      narrow: RelativeTime(_locale, one: 'dans {0} lun', other: 'dans {0} lun'),
    ),
  );
  ...
  DateFieldDataWithRelative get tuesday => const DateFieldDataWithRelative(
    ...
    future: MultiLengthRelativeTime(
      ...
      narrow: RelativeTime(_locale, one: 'dans {0} mar', other: 'dans {0} mar'),
    ),
  );
  ...
  DateFieldDataWithRelative get wednesday => const DateFieldDataWithRelative(
    ...
    future: MultiLengthRelativeTime(
      ...
      narrow: RelativeTime(_locale, one: 'dans {0} mer', other: 'dans {0} mer'),
    ),
  );
  ...
  DateFieldDataWithRelative get thursday => const DateFieldDataWithRelative(
    ...
    future: MultiLengthRelativeTime(
      ...
      narrow: RelativeTime(_locale, one: 'dans {0} jeu', other: 'dans {0} jeu'),
    ),
  );
  ...
  DateFieldDataWithRelative get friday => const DateFieldDataWithRelative(
    ...
    future: MultiLengthRelativeTime(
      ...
      narrow: RelativeTime(_locale, one: 'dans {0} ven', other: 'dans {0} ven'),
    ),
  );
  ...
  DateFieldDataWithRelative get saturday => const DateFieldDataWithRelative(
    ...
    future: MultiLengthRelativeTime(
      ...
      narrow: RelativeTime(_locale, one: 'dans {0} sam', other: 'dans {0} sam'),
    ),
  );
...
class TerritoriesFrCA extends TerritoriesFr {
  ...
  static const _fk = Territory(
    'FK',
    'îles Malouines',
    variant: 'îles Falkland (Malouines)',
  );
  ...
  Map<String, TimeZoneNames> get timeZoneNames => Map.unmodifiable({
    ...
    ...const {
      ...
      'America/St_Kitts': TimeZoneNames(
        exemplarCity: 'Saint-Christophe-et-Niévès',
      ),
  ...
  Map<String, MetaZone> get metaZoneNames => Map.unmodifiable({
    ...
    ...const {
      ...
      'America_Central': MetaZone(
        ...
        short: TimeZoneName(generic: 'HC', standard: 'HNC', daylight: 'HAC'),
      ),
      'America_Eastern': MetaZone(
        ...
        short: TimeZoneName(generic: 'HE', standard: 'HNE', daylight: 'HAE'),
      ),
      'America_Mountain': MetaZone(
        ...
        short: TimeZoneName(generic: 'HR', standard: 'HNR', daylight: 'HAR'),
      ),
      'America_Pacific': MetaZone(
        ...
        short: TimeZoneName(generic: 'HP', standard: 'HNP', daylight: 'HAP'),
      ),
      'Anadyr': MetaZone(
        'Anadyr',
        long: TimeZoneName(
      ...
      'Newfoundland': MetaZone(
        ...
        short: TimeZoneName(generic: 'HT', standard: 'HNT', daylight: 'HAT'),
      ),
      'Niue': MetaZone('Niue', long: TimeZoneName(standard: 'heure de Nioué')),
      'Norfolk': MetaZone(
        'Norfolk',
        long: TimeZoneName(
