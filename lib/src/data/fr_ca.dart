...
const _locale = 'fr-CA';
const _cld = CommonLocaleDataFrCA._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataFrCA implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataFrCA._();
  ...
  static final _units = UnitsFrCA._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsFrCA._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesFrCA._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsFrCA._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesFrCA._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsFrCA._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsFrCA._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesFrCA._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesFrCA._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameFrCA._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsFrCA extends Units {
  UnitsFrCA._(super.cld);
...
class DateFieldsFrCA extends DateFields {
  DateFieldsFrCA._(super.cld);
...
class LanguagesFrCA extends Languages {
  const LanguagesFrCA._(super.cld);
...
class ScriptsFrCA extends Scripts {
  const ScriptsFrCA._(super.cld);
...
class TerritoriesFrCA extends Territories {
  const TerritoriesFrCA._(super.cld);
...
class VariantsFrCA extends Variants {
  const VariantsFrCA._(super.cld);
...
class SubdivisionsFrCA extends Subdivisions {
  const SubdivisionsFrCA._(super.cld);
...
class CurrenciesFrCA extends Currencies {
  const CurrenciesFrCA._(super.cld);
  ...
  static const _rwf = Currency(_cld, 'RWF', 'franc rwandais',
      one: 'franc rwandais', other: 'francs rwandais', symbolNarrow: 'FR');
...
class TimeZonesFrCA extends TimeZones {
  const TimeZonesFrCA._(super.cld)
      : super(
            gmtFormat: 'UTC{0}',
            gmtZeroFormat: 'UTC',
            regionFormat: 'heure : {0}',
            regionFormatDaylight: '{0} (heure avancée)',
            regionFormatStandard: '{0} (heure normale)',
            fallbackFormat: '{1} ({0})',
            positiveH: '+HH',
            positiveHM: '+HH:mm',
  ...
  final timeZoneNames = const {
    ...
    'Europe/Dublin':
        TimeZoneNames(long: TimeZoneName(daylight: 'heure avancée irlandaise')),
  ...
  final metaZoneNames = const {
    ...
    'Brunei':
        MetaZone('Brunei', long: TimeZoneName(standard: 'heure du Brunéi')),
...
class LocaleDisplayNameFrCA extends LocaleDisplayName {
  const LocaleDisplayNameFrCA._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
