...
const _locale = 'fr-TN';
const _cld = CommonLocaleDataFrTN._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataFrTN implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataFrTN._();
  ...
  static final _units = UnitsFrTN._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsFrTN._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesFrTN._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsFrTN._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesFrTN._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsFrTN._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsFrTN._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesFrTN._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesFrTN._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameFrTN._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsFrTN extends Units {
  UnitsFrTN._(super.cld);
...
class DateFieldsFrTN extends DateFields {
  DateFieldsFrTN._(super.cld);
...
class LanguagesFrTN extends Languages {
  const LanguagesFrTN._(super.cld);
...
class ScriptsFrTN extends Scripts {
  const ScriptsFrTN._(super.cld);
...
class TerritoriesFrTN extends Territories {
  const TerritoriesFrTN._(super.cld);
...
class VariantsFrTN extends Variants {
  const VariantsFrTN._(super.cld);
...
class SubdivisionsFrTN extends Subdivisions {
  const SubdivisionsFrTN._(super.cld);
...
class CurrenciesFrTN extends Currencies {
  const CurrenciesFrTN._(super.cld);
...
class TimeZonesFrTN extends TimeZones {
  const TimeZonesFrTN._(super.cld)
      : super(
            gmtFormat: 'UTC{0}',
            gmtZeroFormat: 'UTC',
...
class LocaleDisplayNameFrTN extends LocaleDisplayName {
  const LocaleDisplayNameFrTN._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
