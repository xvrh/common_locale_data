...
const _locale = 'en-VC';
const _cld = CommonLocaleDataEnVC.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEnVC extends CommonLocaleDataEn {
  @override
  String get locale => _locale;

  const CommonLocaleDataEnVC.constant() : super.constant();

  factory CommonLocaleDataEnVC() => _cld;
  ...
  static final _units = UnitsEnVC(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEnVC(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEnVC(_cld);
  @override
  Languages get languages => _languages;

  static final _territories = TerritoriesEnVC(_cld);
  @override
  Territories get territories => _territories;

  static final _currencies = CurrenciesEnVC(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEnVC(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEnVC(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEnVC extends UnitsEn {
  const UnitsEnVC(super.cld);
...
class DateFieldsEnVC extends DateFieldsEn {
  const DateFieldsEnVC(super.cld);
...
class LanguagesEnVC extends LanguagesEn {
  const LanguagesEnVC(super.cld);
...
class TerritoriesEnVC extends TerritoriesEn {
  const TerritoriesEnVC(super.cld);
...
class CurrenciesEnVC extends CurrenciesEn {
  const CurrenciesEnVC(super.cld);
...
class TimeZonesEnVC extends TimeZonesEn {
  const TimeZonesEnVC(super.cld);
...
class LocaleDisplayNameEnVC extends LocaleDisplayNameEn {
  const LocaleDisplayNameEnVC(super.cld);
