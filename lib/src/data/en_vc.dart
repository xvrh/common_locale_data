...
const _locale = 'en-VC';
const _cld = CommonLocaleDataEnVC._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEnVC implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataEnVC._();
  ...
  static final _units = UnitsEnVC._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEnVC._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEnVC._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsEnVC._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesEnVC._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsEnVC._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsEnVC._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesEnVC._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEnVC._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEnVC._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEnVC extends Units {
  UnitsEnVC._(super.cld);
...
class DateFieldsEnVC extends DateFields {
  DateFieldsEnVC._(super.cld);
...
class LanguagesEnVC extends Languages {
  const LanguagesEnVC._(super.cld);
...
class ScriptsEnVC extends Scripts {
  const ScriptsEnVC._(super.cld);
...
class TerritoriesEnVC extends Territories {
  const TerritoriesEnVC._(super.cld);
...
class VariantsEnVC extends Variants {
  const VariantsEnVC._(super.cld);
...
class SubdivisionsEnVC extends Subdivisions {
  const SubdivisionsEnVC._(super.cld);
...
class CurrenciesEnVC extends Currencies {
  const CurrenciesEnVC._(super.cld);
...
class TimeZonesEnVC extends TimeZones {
  const TimeZonesEnVC._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
            regionFormat: '{0} Time',
...
class LocaleDisplayNameEnVC extends LocaleDisplayName {
  const LocaleDisplayNameEnVC._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
