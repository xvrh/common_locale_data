...
const _locale = 'en-BI';
const _cld = CommonLocaleDataEnBI._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEnBI implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataEnBI._();
  ...
  static final _units = UnitsEnBI._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEnBI._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEnBI._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsEnBI._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesEnBI._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsEnBI._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsEnBI._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesEnBI._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEnBI._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEnBI._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEnBI extends Units {
  UnitsEnBI._(super.cld);
...
class DateFieldsEnBI extends DateFields {
  DateFieldsEnBI._(super.cld);
...
class LanguagesEnBI extends Languages {
  const LanguagesEnBI._(super.cld);
...
class ScriptsEnBI extends Scripts {
  const ScriptsEnBI._(super.cld);
...
class TerritoriesEnBI extends Territories {
  const TerritoriesEnBI._(super.cld);
...
class VariantsEnBI extends Variants {
  const VariantsEnBI._(super.cld);
...
class SubdivisionsEnBI extends Subdivisions {
  const SubdivisionsEnBI._(super.cld);
...
class CurrenciesEnBI extends Currencies {
  const CurrenciesEnBI._(super.cld);
...
class TimeZonesEnBI extends TimeZones {
  const TimeZonesEnBI._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
            regionFormat: '{0} Time',
...
class LocaleDisplayNameEnBI extends LocaleDisplayName {
  const LocaleDisplayNameEnBI._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
