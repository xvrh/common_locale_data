...
const _locale = 'en-BZ';
const _cld = CommonLocaleDataEnBZ._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEnBZ implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataEnBZ._();
  ...
  static final _units = UnitsEnBZ._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEnBZ._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEnBZ._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsEnBZ._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesEnBZ._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsEnBZ._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsEnBZ._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesEnBZ._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEnBZ._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEnBZ._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEnBZ extends Units {
  UnitsEnBZ._(super.cld);
...
class DateFieldsEnBZ extends DateFields {
  DateFieldsEnBZ._(super.cld);
...
class LanguagesEnBZ extends Languages {
  const LanguagesEnBZ._(super.cld);
...
class ScriptsEnBZ extends Scripts {
  const ScriptsEnBZ._(super.cld);
...
class TerritoriesEnBZ extends Territories {
  const TerritoriesEnBZ._(super.cld);
...
class VariantsEnBZ extends Variants {
  const VariantsEnBZ._(super.cld);
...
class SubdivisionsEnBZ extends Subdivisions {
  const SubdivisionsEnBZ._(super.cld);
...
class CurrenciesEnBZ extends Currencies {
  const CurrenciesEnBZ._(super.cld);
...
class TimeZonesEnBZ extends TimeZones {
  const TimeZonesEnBZ._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
            regionFormat: '{0} Time',
...
class LocaleDisplayNameEnBZ extends LocaleDisplayName {
  const LocaleDisplayNameEnBZ._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
