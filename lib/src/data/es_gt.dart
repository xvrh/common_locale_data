...
const _locale = 'es-GT';
const _cld = CommonLocaleDataEsGT.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEsGT extends CommonLocaleDataEs {
  @override
  String get locale => _locale;

  const CommonLocaleDataEsGT.constant() : super.constant();

  factory CommonLocaleDataEsGT() => _cld;
  ...
  static final _units = UnitsEsGT(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEsGT(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEsGT(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsEsGT(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesEsGT(_cld);
  @override
  Territories get territories => _territories;

  static final _currencies = CurrenciesEsGT(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEsGT(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEsGT(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEsGT extends UnitsEs {
  const UnitsEsGT(super.cld);
  ...
  Unit get durationHour => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'hora', one: '{0}h', other: '{0}h'),
  );
  ...
  Unit get lengthFoot => const Unit(
    ...
    short: UnitCountPattern(_locale, 'pie', one: '{0} pie', other: '{0} ft'),
    narrow: UnitCountPattern(_locale, 'pie', one: '{0}ft', other: '{0}ft'),
  );
...
class DateFieldsEsGT extends DateFieldsEs {
  const DateFieldsEsGT(super.cld);
...
class LanguagesEsGT extends LanguagesEs {
  const LanguagesEsGT(super.cld);
...
class ScriptsEsGT extends ScriptsEs {
  const ScriptsEsGT(super.cld);
...
class TerritoriesEsGT extends TerritoriesEs {
  const TerritoriesEsGT(super.cld);
...
class CurrenciesEsGT extends CurrenciesEs {
  const CurrenciesEsGT(super.cld);
...
class TimeZonesEsGT extends TimeZonesEs {
  const TimeZonesEsGT(super.cld);
...
class LocaleDisplayNameEsGT extends LocaleDisplayNameEs {
  const LocaleDisplayNameEsGT(super.cld);
