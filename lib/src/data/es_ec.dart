...
const _locale = 'es-EC';
const _cld = CommonLocaleDataEsEC.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEsEC extends CommonLocaleDataEs {
  @override
  String get locale => _locale;

  const CommonLocaleDataEsEC.constant() : super.constant();

  factory CommonLocaleDataEsEC() => _cld;
  ...
  static final _units = UnitsEsEC(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEsEC(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEsEC(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsEsEC(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesEsEC(_cld);
  @override
  Territories get territories => _territories;

  static final _currencies = CurrenciesEsEC(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEsEC(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEsEC(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEsEC extends UnitsEs {
  const UnitsEsEC(super.cld);
...
class DateFieldsEsEC extends DateFieldsEs {
  const DateFieldsEsEC(super.cld);
...
class LanguagesEsEC extends LanguagesEs {
  const LanguagesEsEC(super.cld);
...
class ScriptsEsEC extends ScriptsEs {
  const ScriptsEsEC(super.cld);
...
class TerritoriesEsEC extends TerritoriesEs {
  const TerritoriesEsEC(super.cld);
...
class CurrenciesEsEC extends CurrenciesEs {
  const CurrenciesEsEC(super.cld);
...
class TimeZonesEsEC extends TimeZonesEs {
  const TimeZonesEsEC(super.cld);
...
class LocaleDisplayNameEsEC extends LocaleDisplayNameEs {
  const LocaleDisplayNameEsEC(super.cld);
