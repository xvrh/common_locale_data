...
const _cld = CommonLocaleDataBsLatn._();
...
class CommonLocaleDataBsLatn implements CommonLocaleData {
  ...
  const CommonLocaleDataBsLatn._();
  ...
  static final _units = UnitsBsLatn._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsBsLatn._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesBsLatn._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsBsLatn._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesBsLatn._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsBsLatn._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsBsLatn._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesBsLatn._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesBsLatn._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameBsLatn._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsBsLatn extends Units {
  UnitsBsLatn._(super.cld);
...
class LanguagesBsLatn extends Languages {
  const LanguagesBsLatn._(super.cld);
...
class ScriptsBsLatn extends Scripts {
  const ScriptsBsLatn._(super.cld);
...
class TerritoriesBsLatn extends Territories {
  const TerritoriesBsLatn._(super.cld);
...
class VariantsBsLatn extends Variants {
  const VariantsBsLatn._(super.cld);
...
class SubdivisionsBsLatn extends Subdivisions {
  const SubdivisionsBsLatn._(super.cld);
...
class CurrenciesBsLatn extends Currencies {
  const CurrenciesBsLatn._(super.cld);
...
class TimeZonesBsLatn extends TimeZones {
  const TimeZonesBsLatn._(super.cld)
      : super(
            gmtFormat: 'GMT {0}',
            gmtZeroFormat: 'GMT',
            regionFormat: '{0}',
...
class LocaleDisplayNameBsLatn extends LocaleDisplayName {
  const LocaleDisplayNameBsLatn._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
