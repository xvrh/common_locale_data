...
const _locale = 'uk';
const _cld = CommonLocaleDataUk.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataUk extends CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataUk.constant() : super.constant();
  ...
  static final _units = UnitsUk(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsUk(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesUk(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsUk(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesUk(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsUk(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsUk(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesUk(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesUk(_cld);
  @override
...
class DateFieldsUk extends DateFields {
  const DateFieldsUk(super.cld);

  @override
  MultiLength get era =>
      const MultiLength(long: 'ера', short: 'е.', narrow: 'е');

  @override
  DateFieldFullData get year => const DateFieldFullData(
    displayName: MultiLength(long: 'рік', short: 'р.', narrow: 'р'),
  ...
  DateFieldFullData get month => const DateFieldFullData(
    displayName: MultiLength(long: 'місяць', short: 'міс.', narrow: 'м'),
    previous: MultiLength(
  ...
  DateFieldFullData get week => const DateFieldFullData(
    displayName: MultiLength(long: 'тиждень', short: 'тиж.', narrow: 'т'),
    previous: MultiLength(
      long: 'минулого тижня',
      short: 'мин. тижня',
  ...
  DateFieldFullData get day => const DateFieldFullData(
    displayName: MultiLength(long: 'день', short: 'д.', narrow: 'д'),
    previous: MultiLength(long: 'учора', short: 'учора', narrow: 'учора'),
    now: MultiLength(long: 'сьогодні', short: 'сьогодні', narrow: 'сьогодні'),
  ...
  MultiLength get dayOfYear =>
      const MultiLength(long: 'день року', short: 'д. року', narrow: 'д. р.');
  ...
  DateFieldDataWithRelative get sunday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: 'цієї неділі', short: 'цієї нд', narrow: 'цієї нд'),
    next: MultiLength(
  ...
  DateFieldDataWithRelative get wednesday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: 'цієї середи', short: 'цієї ср', narrow: 'цієї ср'),
    next: MultiLength(
  ...
  DateFieldDataWithRelative get saturday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: 'цієї суботи', short: 'цієї сб', narrow: 'цієї сб'),
    next: MultiLength(
  ...
  MultiLength get dayperiod =>
      const MultiLength(long: 'дп/пп', short: 'дп/пп', narrow: 'дп/пп');
  ...
  DateFieldDataTime get minute => const DateFieldDataTime(
    displayName: MultiLength(long: 'хвилина', short: 'хв.', narrow: 'хв'),
    now: MultiLength(
      long: 'цієї хвилини',
      short: 'цієї хвилини',
      narrow: 'цієї хвилини',
  ...
  DateFieldDataTime get second => const DateFieldDataTime(
    ...
    now: MultiLength(long: 'зараз', short: 'зараз', narrow: 'зараз'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
        one: '{0} секунду тому',
...
class SubdivisionsUk extends Subdivisions {
  const SubdivisionsUk(super.cld);
...
class TimeZonesUk extends TimeZones {
  ...
  @override
  String get regionFormat => 'час: {0}';
  @override
  String get regionFormatDaylight => 'час: {0}, літній';
  @override
  String get regionFormatStandard => 'час: {0}, стандартний';
  @override
  ...
  static const staticMetaZoneNames = <String, MetaZone>{
    ...
    'Bhutan': MetaZone(
      'Bhutan',
      long: TimeZoneName(standard: 'за часом у Бутані'),
    ),
    'Bolivia': MetaZone(
      'Bolivia',
    ...
    'Brunei': MetaZone(
      'Brunei',
      long: TimeZoneName(standard: 'за часом у Брунеї'),
    ),
    'Cape_Verde': MetaZone(
      'Cape_Verde',
      long: TimeZoneName(
    ...
    'Guyana': MetaZone(
      'Guyana',
      long: TimeZoneName(standard: 'за часом у Ґаяні'),
    ),
    ...
    'Myanmar': MetaZone(
      'Myanmar',
      long: TimeZoneName(standard: 'за часом у Мʼянмі'),
    ),
    'Nauru': MetaZone(
      'Nauru',
    ...
    'Nepal': MetaZone(
      'Nepal',
      long: TimeZoneName(standard: 'за часом у Непалі'),
    ),
...
class LocaleDisplayNameUk extends LocaleDisplayName {
  const LocaleDisplayNameUk(super.cld);
  ...
  @override
  String get codePatternLanguage => 'Мова: {0}';
  @override
  String get codePatternScript => 'Система письма: {0}';
  @override
  String get codePatternTerritory => 'Територія: {0}';
