...
const _locale = 'nb';
const _cld = CommonLocaleDataNb._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataNb implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataNb._();
  ...
  static final _units = UnitsNb._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsNb._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesNb._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsNb._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesNb._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsNb._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsNb._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesNb._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesNb._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameNb._(_cld);
  @override
...
class TerritoriesNb extends Territories {
  const TerritoriesNb._(super.cld);
...
class SubdivisionsNb extends Subdivisions {
  const SubdivisionsNb._(super.cld);
...
class CurrenciesNb extends Currencies {
  const CurrenciesNb._(super.cld);
...
class LocaleDisplayNameNb extends LocaleDisplayName {
  const LocaleDisplayNameNb._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
