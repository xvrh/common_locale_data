...
const _locale = 'sq-XK';
const _cld = CommonLocaleDataSqXK._();
...
class CommonLocaleDataSqXK implements CommonLocaleData {
  ...
  static final _units = UnitsSqXK._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsSqXK._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesSqXK._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsSqXK._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesSqXK._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsSqXK._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsSqXK._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesSqXK._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesSqXK._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameSqXK._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsSqXK extends Units {
  UnitsSqXK._(super.cld);
...
class DateFieldsSqXK extends DateFields {
  DateFieldsSqXK._(super.cld);
...
class LanguagesSqXK extends Languages {
  const LanguagesSqXK._(super.cld);
...
class ScriptsSqXK extends Scripts {
  const ScriptsSqXK._(super.cld);
...
class TerritoriesSqXK extends Territories {
  const TerritoriesSqXK._(super.cld);
...
class VariantsSqXK extends Variants {
  const VariantsSqXK._(super.cld);

  @override
  final variants = const {};
}

class SubdivisionsSqXK extends Subdivisions {
  const SubdivisionsSqXK._(super.cld);
...
class CurrenciesSqXK extends Currencies {
  const CurrenciesSqXK._(super.cld);
...
class TimeZonesSqXK extends TimeZones {
  const TimeZonesSqXK._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
            regionFormat: 'Ora: {0}',
...
class LocaleDisplayNameSqXK extends LocaleDisplayName {
  const LocaleDisplayNameSqXK._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
