...
const _locale = 'nl-CW';
const _cld = CommonLocaleDataNlCW._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataNlCW implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataNlCW._();
  ...
  static final _units = UnitsNlCW._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsNlCW._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesNlCW._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsNlCW._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesNlCW._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsNlCW._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsNlCW._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesNlCW._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesNlCW._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameNlCW._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsNlCW extends Units {
  UnitsNlCW._(super.cld);
...
class DateFieldsNlCW extends DateFields {
  DateFieldsNlCW._(super.cld);
...
class LanguagesNlCW extends Languages {
  const LanguagesNlCW._(super.cld);
...
class ScriptsNlCW extends Scripts {
  const ScriptsNlCW._(super.cld);
...
class TerritoriesNlCW extends Territories {
  const TerritoriesNlCW._(super.cld);
...
class VariantsNlCW extends Variants {
  const VariantsNlCW._(super.cld);
...
class SubdivisionsNlCW extends Subdivisions {
  const SubdivisionsNlCW._(super.cld);
...
class CurrenciesNlCW extends Currencies {
  const CurrenciesNlCW._(super.cld);
...
class TimeZonesNlCW extends TimeZones {
  const TimeZonesNlCW._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
...
class LocaleDisplayNameNlCW extends LocaleDisplayName {
  const LocaleDisplayNameNlCW._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
