...
const _locale = 'en-MO';
const _cld = CommonLocaleDataEnMO._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEnMO implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataEnMO._();
  ...
  static final _units = UnitsEnMO._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEnMO._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEnMO._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsEnMO._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesEnMO._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsEnMO._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsEnMO._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesEnMO._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEnMO._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEnMO._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEnMO extends Units {
  UnitsEnMO._(super.cld);
...
class DateFieldsEnMO extends DateFields {
  DateFieldsEnMO._(super.cld);
...
class LanguagesEnMO extends Languages {
  const LanguagesEnMO._(super.cld);
...
class ScriptsEnMO extends Scripts {
  const ScriptsEnMO._(super.cld);
...
class TerritoriesEnMO extends Territories {
  const TerritoriesEnMO._(super.cld);
...
class VariantsEnMO extends Variants {
  const VariantsEnMO._(super.cld);
...
class SubdivisionsEnMO extends Subdivisions {
  const SubdivisionsEnMO._(super.cld);
...
class CurrenciesEnMO extends Currencies {
  const CurrenciesEnMO._(super.cld);
  ...
  static const _mop = Currency(_cld, 'MOP', 'Macanese Pataca',
      one: 'Macanese pataca', other: 'Macanese patacas', symbol: r'MOP$');
...
class TimeZonesEnMO extends TimeZones {
  const TimeZonesEnMO._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
            regionFormat: '{0} Time',
...
class LocaleDisplayNameEnMO extends LocaleDisplayName {
  const LocaleDisplayNameEnMO._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
