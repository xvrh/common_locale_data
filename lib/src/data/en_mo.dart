...
const _locale = 'en-MO';
const _cld = CommonLocaleDataEnMO.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEnMO extends CommonLocaleDataEn {
  @override
  String get locale => _locale;

  const CommonLocaleDataEnMO.constant() : super.constant();

  factory CommonLocaleDataEnMO() => _cld;
  ...
  static final _units = UnitsEnMO(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEnMO(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEnMO(_cld);
  @override
  Languages get languages => _languages;

  static final _territories = TerritoriesEnMO(_cld);
  @override
  Territories get territories => _territories;

  static final _currencies = CurrenciesEnMO(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEnMO(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEnMO(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEnMO extends UnitsEn {
  const UnitsEnMO(super.cld);
...
class DateFieldsEnMO extends DateFieldsEn {
  const DateFieldsEnMO(super.cld);
...
class LanguagesEnMO extends LanguagesEn {
  const LanguagesEnMO(super.cld);
...
class TerritoriesEnMO extends TerritoriesEn {
  const TerritoriesEnMO(super.cld);
...
class CurrenciesEnMO extends CurrenciesEn {
  const CurrenciesEnMO(super.cld);
...
class TimeZonesEnMO extends TimeZonesEn {
  const TimeZonesEnMO(super.cld);
  ...
  Map<String, MetaZone> get metaZoneNames => Map.unmodifiable({
    ...
    ...const {
      ...
      'Hong_Kong': MetaZone(
        ...
        short: TimeZoneName(generic: 'HKT', standard: 'HKT', daylight: 'HKST'),
      ),
      'Macau': MetaZone(
        'Macau',
        long: TimeZoneName(
        ...
        short: TimeZoneName(generic: 'MST', standard: 'MST', daylight: 'MDT'),
      ),
...
class LocaleDisplayNameEnMO extends LocaleDisplayNameEn {
  const LocaleDisplayNameEnMO(super.cld);
