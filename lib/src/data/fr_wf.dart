...
const _locale = 'fr-WF';
const _cld = CommonLocaleDataFrWF._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataFrWF implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataFrWF._();
  ...
  static final _units = UnitsFrWF._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsFrWF._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesFrWF._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsFrWF._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesFrWF._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsFrWF._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsFrWF._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesFrWF._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesFrWF._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameFrWF._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsFrWF extends Units {
  UnitsFrWF._(super.cld);
...
class DateFieldsFrWF extends DateFields {
  DateFieldsFrWF._(super.cld);
...
class LanguagesFrWF extends Languages {
  const LanguagesFrWF._(super.cld);
...
class ScriptsFrWF extends Scripts {
  const ScriptsFrWF._(super.cld);
...
class TerritoriesFrWF extends Territories {
  const TerritoriesFrWF._(super.cld);
...
class VariantsFrWF extends Variants {
  const VariantsFrWF._(super.cld);
...
class SubdivisionsFrWF extends Subdivisions {
  const SubdivisionsFrWF._(super.cld);
...
class CurrenciesFrWF extends Currencies {
  const CurrenciesFrWF._(super.cld);
...
class TimeZonesFrWF extends TimeZones {
  const TimeZonesFrWF._(super.cld)
      : super(
            gmtFormat: 'UTC{0}',
            gmtZeroFormat: 'UTC',
...
class LocaleDisplayNameFrWF extends LocaleDisplayName {
  const LocaleDisplayNameFrWF._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
