...
class UnitsYoBJ extends UnitsYo {
  ...
  Unit get durationYear => const Unit(
    ...
    short: UnitCountPattern(_locale, 'ɔd', one: '{0} yr', other: '{0} ɔd'),
  ...
  Unit get durationMonth => const Unit(
    ...
    short: UnitCountPattern(_locale, 'oshù', one: '{0} mth', other: '{0} oshù'),
    narrow: UnitCountPattern(_locale, 'oshù', one: '{0}m', other: '{0} oshù'),
  );

  @override
  Unit get durationWeek => const Unit(
    long: UnitCountPattern(_locale, 'ɔsh', one: '{0} week', other: '{0} ɔsh'),
    short: UnitCountPattern(_locale, 'ɔsh', one: '{0} wk', other: '{0} ɔsh'),
    narrow: UnitCountPattern(_locale, 'ɔshɛ́', one: '{0}w', other: '{0} ɔsh'),
  );

  @override
  Unit get durationDay => const Unit(
    long: UnitCountPattern(_locale, 'ɔjɔ́', one: '{0} day', other: 'ɔj {0}'),
    short: UnitCountPattern(_locale, 'ɔjɔ́', one: '{0} day', other: '{0} ɔj'),
    narrow: UnitCountPattern(_locale, 'ɔjɔ́', one: '{0}d', other: 'ɔj {0}'),
  );

  @override
  Unit get durationMinute => const Unit(
    long: UnitCountPattern(_locale, 'ìsh', one: '{0} minute', other: '{0} ìsh'),
    short: UnitCountPattern(_locale, 'ìsh', one: '{0} min', other: '{0} ìsh'),
    narrow: UnitCountPattern(_locale, 'ìsh', one: '{0}m', other: '{0}/ìsh'),
  );
  ...
  Unit get lengthFathom => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'fatɔ́', one: '{0}fth', other: '{0}fth'),
  );
  ...
  Unit get lightLux => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'lɔ́s', one: '{0}lx', other: '{0}lx'),
  );
  ...
  Unit get lightLumen => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'lm', one: '{0}lm', other: '{0} Lúmɛ́nì'),
  );
  ...
  Unit get volumeCup => const Unit(
    long: UnitCountPattern(_locale, 'àwɔn ife', one: '{0} cup', other: '{0} c'),
  ...
  Unit get volumeDrop => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'dírɔ́pù', one: '{0}dr', other: '{0}dr'),
  );
...
class DateFieldsYoBJ extends DateFieldsYo {
  ...
  DateFieldFullData get year => const DateFieldFullData(
    displayName: MultiLength(long: 'Ɔdún', short: 'Ɔdún', narrow: 'Ɔdún'),
    previous: MultiLength(
      long: 'Èshí',
      short: 'Ɔdún tó kɔjá',
      narrow: 'Ɔdún tó kɔjá',
    ),
    now: MultiLength(long: 'Ɔdún yìí', short: 'Ɔdún yìí', narrow: 'Ɔdún yìí'),
    next: MultiLength(
      long: 'Àmɔ́dún',
      short: 'Ɔdún tó ńbɔ̀',
      narrow: 'Ɔdún tó ńbɔ̀',
    ...
    past: MultiLengthRelativeTime(
      long: RelativeTime(_locale, other: '{0} Ɔdún sɛ́yìn'),
      short: RelativeTime(_locale, other: 'Ɔdún {0} sɛ́yìn'),
      narrow: RelativeTime(_locale, other: 'Ɔdún {0} sɛ́yìn'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(_locale, other: 'ní {0} Ɔdún'),
      short: RelativeTime(_locale, other: 'ní {0} Ɔdún'),
      narrow: RelativeTime(_locale, other: 'ní {0} Ɔdún'),
    ),
  );
  ...
  DateFieldFullData get month => const DateFieldFullData(
    displayName: MultiLength(long: 'Osù', short: 'Osù', narrow: 'Oshù'),
    previous: MultiLength(
      long: 'óshù tó kɔjá',
      short: 'óshù tó kɔjá',
      narrow: 'óshù tó kɔjá',
    ),
    now: MultiLength(long: 'oshù yìí', short: 'oshù yìí', narrow: 'oshù yìí'),
    next: MultiLength(
      long: 'óshù tó ń bɔ̀,',
      short: 'óshù tó ń bɔ̀,',
  ...
  DateFieldFullData get week => const DateFieldFullData(
    displayName: MultiLength(long: 'Ɔ̀sɛ̀', short: 'Ɔ̀sɛ̀', narrow: 'Ɔ̀sɛ̀'),
    previous: MultiLength(
      long: 'ɔ̀sɛ̀ tó kɔjá',
      short: 'ɔ̀sɛ̀ tó kɔjá',
  ...
  DateFieldFullData get day => const DateFieldFullData(
    displayName: MultiLength(long: 'Ɔjɔ́', short: 'Ɔjɔ́', narrow: 'Ɔjɔ́'),
    previous: MultiLength(long: 'Àná', short: 'Àná', narrow: 'Àná'),
    now: MultiLength(long: 'Òní', short: 'Òní', narrow: 'Òní'),
    next: MultiLength(long: 'Ɔ̀la', short: 'Ɔ̀la', narrow: 'Ɔ̀la'),
    past: MultiLengthRelativeTime(
  ...
  DateFieldDataWithRelative get sunday => const DateFieldDataWithRelative(
    ...
    future: MultiLengthRelativeTime(
      long: RelativeTime(_locale, other: '+{0} Sundays'),
      short: RelativeTime(_locale, other: '+{0} Sundays'),
      narrow: RelativeTime(_locale, other: 'Ɔjɔ́ Àíkú +{0}'),
    ),
  );
  ...
  DateFieldDataWithRelative get tuesday => const DateFieldDataWithRelative(
    ...
    past: MultiLengthRelativeTime(
      long: RelativeTime(_locale, other: '{0} àwɔn Ìshɛ́gun tɛ́lɛ̀'),
      short: RelativeTime(_locale, other: '{0} Ishɛ́. tɛ́lɛ̀'),
      narrow: RelativeTime(_locale, other: '{0} Ìs tɛ́lɛ̀'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(_locale, other: '+{0} àwɔn ìsɛ́gun'),
      short: RelativeTime(_locale, other: '{0} Ìshɛ́'),
  ...
  DateFieldDataWithRelative get wednesday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: 'Ojɔ́rú yì', short: 'Ojɔ́rú yì', narrow: 'O yì'),
    next: MultiLength(
      long: 'Ojɔ́rú tónbɔ̀',
      short: 'Ojɔ́rú tóńbɔ̀',
      narrow: 'O tóńbɔ̀',
    ...
    past: MultiLengthRelativeTime(
      long: RelativeTime(_locale, other: '-{0} Àwɔn Ojɔ́rú tɛ́lɛ̀'),
      short: RelativeTime(_locale, other: '{0} Ojɔ́ tɛ́lɛ̀'),
      narrow: RelativeTime(_locale, other: '{0} W tɛ́lɛ̀'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(_locale, other: '{0} Àwɔn Ojɔ́rú'),
      short: RelativeTime(_locale, other: 'ní {0} Ojɔ́'),
  ...
  DateFieldDataWithRelative get thursday => const DateFieldDataWithRelative(
    ...
    past: MultiLengthRelativeTime(
      long: RelativeTime(_locale, other: '-{0} Àwɔn Ojɔ́bɔ̀'),
      short: RelativeTime(_locale, other: '{0} Ojɔ́ èyìn'),
      narrow: RelativeTime(_locale, other: '{0} Ojɔ́ sɛ́yìn'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(_locale, other: '+{0} Ojɔ́bɔ̀'),
      short: RelativeTime(_locale, other: '+ {0} Ojɔ́'),
      narrow: RelativeTime(_locale, other: '{0} Ojɔ́'),
    ),
  );
  ...
  DateFieldDataWithRelative get friday => const DateFieldDataWithRelative(
    ...
    past: MultiLengthRelativeTime(
      ...
      short: RelativeTime(_locale, other: '{0} Et sɛ́yìn'),
      narrow: RelativeTime(_locale, other: '{0} F tɛ́lɛ̀'),
    ),
    future: MultiLengthRelativeTime(
  ...
  DateFieldDataWithRelative get saturday => const DateFieldDataWithRelative(
    ...
    past: MultiLengthRelativeTime(
      ...
      short: RelativeTime(_locale, other: '{0} Aba. sɛ́yìn'),
      narrow: RelativeTime(_locale, other: '{0} Ab ɛ̀yí'),
    ),
    future: MultiLengthRelativeTime(
  ...
  DateFieldDataTime get minute => const DateFieldDataTime(
    displayName: MultiLength(long: 'Ìsɛ́jú', short: 'Ìsɛ́jú', narrow: 'Ìsɛ́jú'),
    now: MultiLength(
      long: 'ìshɛ́jú yìí',
      short: 'ìshɛ́jú yìí',
      narrow: 'ìshɛ́jú yìí',
  ...
  Map<String, TimeZoneNames> get timeZoneNames => Map.unmodifiable({
    ...
    ...const {
      ...
      'Europe/London': TimeZoneNames(
        long: TimeZoneName(daylight: 'Àkókò Sɔmà Gɛɛsi'),
      ),
