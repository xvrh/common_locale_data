...
class CommonLocaleDataYoBJ implements CommonLocaleData {
  ...
  static final _listPatterns = ListPatternsYoBJ._();
  @override
  ListPatterns get listPatterns => _listPatterns;

  static final _calendar = CalendarYoBJ._();
  @override
  Calendar get calendar => _calendar;

  static final _currencies = CurrenciesYoBJ._();
  @override
...
class ListPatternsYoBJ extends ListPatterns {
  ListPatternsYoBJ._();
...
class CalendarYoBJ extends Calendar {
  CalendarYoBJ._();

  @override
  Months get months => Months(
        wide: MonthNames(
          january: 'Oshù Shɛ́rɛ́',
          february: 'Oshù Èrèlè',
          march: 'Oshù Ɛrɛ̀nà',
          april: 'Oshù Ìgbé',
          may: 'Oshù Ɛ̀bibi',
  ...
  Weekdays get weekdays => Weekdays(
        wide: WeekdayNames(
          monday: 'Ɔjɔ́ Ajé',
          tuesday: 'Ɔjɔ́ Ìsɛ́gun',
          wednesday: 'Ɔjɔ́rú',
          thursday: 'Ɔjɔ́bɔ',
          friday: 'Ɔjɔ́ Ɛtì',
          saturday: 'Ɔjɔ́ Àbámɛ́ta',
          sunday: 'Ɔjɔ́ Àìkú',
        ),
