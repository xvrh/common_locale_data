...
const _locale = 'en-BM';
const _cld = CommonLocaleDataEnBM._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEnBM implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataEnBM._();
  ...
  static final _units = UnitsEnBM._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEnBM._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEnBM._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsEnBM._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesEnBM._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsEnBM._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsEnBM._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesEnBM._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEnBM._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEnBM._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEnBM extends Units {
  UnitsEnBM._(super.cld);
...
class DateFieldsEnBM extends DateFields {
  DateFieldsEnBM._(super.cld);
...
class LanguagesEnBM extends Languages {
  const LanguagesEnBM._(super.cld);
...
class ScriptsEnBM extends Scripts {
  const ScriptsEnBM._(super.cld);
...
class TerritoriesEnBM extends Territories {
  const TerritoriesEnBM._(super.cld);
...
class VariantsEnBM extends Variants {
  const VariantsEnBM._(super.cld);
...
class SubdivisionsEnBM extends Subdivisions {
  const SubdivisionsEnBM._(super.cld);
...
class CurrenciesEnBM extends Currencies {
  const CurrenciesEnBM._(super.cld);
...
class TimeZonesEnBM extends TimeZones {
  const TimeZonesEnBM._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
            regionFormat: '{0} Time',
...
class LocaleDisplayNameEnBM extends LocaleDisplayName {
  const LocaleDisplayNameEnBM._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
