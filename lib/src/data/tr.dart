...
const _locale = 'tr';
const _cld = CommonLocaleDataTr.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataTr extends CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataTr.constant() : super.constant();

  factory CommonLocaleDataTr() => _cld;
  ...
  static final _units = UnitsTr(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsTr(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesTr(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsTr(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesTr(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsTr(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsTr(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesTr(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesTr(_cld);
  @override
...
class UnitsTr extends Units {
  ...
  Unit get accelerationGForce => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'g kuvveti', one: '{0}G', other: '{0}G'),
  );
  ...
  Unit get angleRevolution => const Unit(
    ...
    short: UnitCountPattern(_locale, 'dev', one: '{0} dev', other: '{0} dev'),
    narrow: UnitCountPattern(_locale, 'dev', one: '{0} dev', other: '{0} dev'),
  );
  ...
  Unit get areaAcre => const Unit(
    long: UnitCountPattern(_locale, 'akre', one: '{0} akre', other: '{0} akre'),
    short: UnitCountPattern(_locale, 'akre', one: '{0} akre', other: '{0} ac'),
    narrow: UnitCountPattern(_locale, 'akre', one: '{0} akre', other: '{0} ac'),
  );
  ...
  Unit get concentrKarat => const Unit(
    long: UnitCountPattern(_locale, 'ayar', one: '{0} ayar', other: '{0} ayar'),
    short: UnitCountPattern(
      _locale,
      'ayar',
      one: '{0} ayar',
  ...
  Unit get concentrItem => const Unit(
    long: UnitCountPattern(_locale, 'öğe', one: '{0} öğe', other: '{0} öğe'),
    short: UnitCountPattern(_locale, 'öğe', one: '{0} öğe', other: '{0} öğe'),
    narrow: UnitCountPattern(_locale, 'öğe', one: '{0} öğe', other: '{0} öğe'),
  );
  ...
  Unit get concentrPermyriad => const Unit(
    ...
    short: UnitCountPattern(_locale, 'onbinde', one: '‱{0}', other: '‱{0}'),
    narrow: UnitCountPattern(_locale, 'onbinde', one: '‱{0}', other: '‱{0}'),
  );
  ...
  Unit get durationCentury => const Unit(
    ...
    short: UnitCountPattern(_locale, 'yy', one: '{0} yy', other: '{0} yy'),
    narrow: UnitCountPattern(_locale, 'yy', one: '{0} yy', other: '{0} yy'),
  );
  ...
  Unit get durationYear => const Unit(
    long: UnitCountPattern(_locale, 'yıl', one: '{0} yıl', other: '{0} yıl'),
    short: UnitCountPattern(_locale, 'yıl', one: '{0} yıl', other: '{0} yıl'),
    narrow: UnitCountPattern(_locale, 'yıl', one: '{0}y', other: '{0}y'),
  );
  ...
  Unit get durationMonth => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'ay', one: '{0}a', other: '{0}a'),
  );
  ...
  Unit get durationWeek => const Unit(
    ...
    short: UnitCountPattern(_locale, 'hafta', one: '{0} hf.', other: '{0} hf.'),
    narrow: UnitCountPattern(_locale, 'hafta', one: '{0}h', other: '{0}h'),
  );
  ...
  Unit get durationDay => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'gün', one: '{0}g', other: '{0}g'),
  );

  @override
  Unit get durationHour => const Unit(
    long: UnitCountPattern(_locale, 'saat', one: '{0} saat', other: '{0} saat'),
    short: UnitCountPattern(_locale, 'saat', one: '{0} sa.', other: '{0} sa.'),
    narrow: UnitCountPattern(_locale, 'sa', one: '{0} sa', other: '{0}s'),
  );
  ...
  Unit get durationMinute => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'dk', one: '{0}d', other: '{0}d'),
  );
  ...
  Unit get durationSecond => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'sn', one: '{0}sn', other: '{0}sn'),
  );
  ...
  Unit get durationMillisecond => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'msn', one: '{0}msn', other: '{0}msn'),
  );
  ...
  Unit get durationMicrosecond => const Unit(
    ...
    short: UnitCountPattern(_locale, 'μsn', one: '{0} μsn', other: '{0} μsn'),
    narrow: UnitCountPattern(_locale, 'μsn', one: '{0} μsn', other: '{0} μsn'),
  );
  ...
  Unit get durationNanosecond => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'nsn', one: '{0} nsn', other: '{0} nsn'),
  );
  ...
  Unit get electricAmpere => const Unit(
    ...
    short: UnitCountPattern(_locale, 'amper', one: '{0} amper', other: '{0} A'),
    narrow: UnitCountPattern(
      _locale,
      'amper',
      one: '{0} amper',
  ...
  Unit get energyKilojoule => const Unit(
    ...
    short: UnitCountPattern(_locale, 'kJ', one: '{0} kilojul', other: '{0} kJ'),
    narrow: UnitCountPattern(
      _locale,
      'kJ',
      one: '{0} kilojul',
  ...
  Unit get energyJoule => const Unit(
    long: UnitCountPattern(_locale, 'jul', one: '{0} jul', other: '{0} jul'),
    short: UnitCountPattern(_locale, 'jul', one: '{0} jul', other: '{0} J'),
    narrow: UnitCountPattern(_locale, 'jul', one: '{0} jul', other: '{0} J'),
  );
  ...
  Unit get lengthMeter => const Unit(
    ...
    short: UnitCountPattern(_locale, 'metre', one: '{0} metre', other: '{0} m'),
    narrow: UnitCountPattern(_locale, 'm', one: '{0} metre', other: '{0} m'),
  );
  ...
  Unit get lengthYard => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'yd', one: '{0} yarda', other: '{0} yd'),
  );

  @override
  Unit get lengthFoot => const Unit(
    long: UnitCountPattern(_locale, 'fit', one: '{0} fit', other: '{0} fit'),
    short: UnitCountPattern(_locale, 'fit', one: '{0} fit', other: '{0} fit'),
    narrow: UnitCountPattern(_locale, 'fit', one: '{0}′', other: '{0}′'),
  );

  @override
  Unit get lengthInch => const Unit(
    long: UnitCountPattern(_locale, 'inç', one: '{0} inç', other: '{0} inç'),
    short: UnitCountPattern(_locale, 'inç', one: '{0} inç', other: '{0} inç'),
    narrow: UnitCountPattern(_locale, 'inç', one: '{0}″', other: '{0}″'),
  );
  ...
  Unit get lengthLightYear => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'Iy', one: '{0} IY', other: '{0} IY'),
  );
  ...
  Unit get lengthPoint => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'pt', one: '{0} punto', other: '{0} pt'),
  );
  ...
  Unit get lightCandela => const Unit(
    ...
    short: UnitCountPattern(_locale, 'cd', one: '{0} kandela', other: '{0} cd'),
    narrow: UnitCountPattern(
      _locale,
      'cd',
      one: '{0} kandela',
  ...
  Unit get massGram => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'gram', one: '{0} gram', other: '{0} g'),
  );
  ...
  Unit get massPound => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'lb', one: '{0} libre', other: '{0} lb'),
  );

  @override
  Unit get massOunce => const Unit(
    long: UnitCountPattern(_locale, 'ons', one: '{0} ons', other: '{0} ons'),
    short: UnitCountPattern(_locale, 'oz', one: '{0} ons', other: '{0} oz'),
    narrow: UnitCountPattern(_locale, 'oz', one: '{0} ons', other: '{0} oz'),
  );
  ...
  Unit get massGrain => const Unit(
    long: UnitCountPattern(_locale, 'tane', one: '{0} tane', other: '{0} tane'),
    short: UnitCountPattern(
      _locale,
      'tane',
      one: '{0} tane',
  ...
  Unit get powerGigawatt => const Unit(
    ...
    short: UnitCountPattern(_locale, 'GW', one: '{0} gigavat', other: '{0} GW'),
    narrow: UnitCountPattern(
      _locale,
      'GW',
      one: '{0} gigavat',
  ...
  Unit get powerMegawatt => const Unit(
    ...
    short: UnitCountPattern(_locale, 'MW', one: '{0} megavat', other: '{0} MW'),
    narrow: UnitCountPattern(
      _locale,
      'MW',
      one: '{0} megavat',
  ...
  Unit get powerKilowatt => const Unit(
    ...
    short: UnitCountPattern(_locale, 'kW', one: '{0} kilovat', other: '{0} kW'),
    narrow: UnitCountPattern(
      _locale,
      'kW',
      one: '{0} kilovat',
  ...
  Unit get powerWatt => const Unit(
    long: UnitCountPattern(_locale, 'vat', one: '{0} vat', other: '{0} vat'),
    short: UnitCountPattern(_locale, 'vat', one: '{0} vat', other: '{0} W'),
    narrow: UnitCountPattern(_locale, 'vat', one: '{0} vat', other: '{0} W'),
  );
  ...
  Unit get powerMilliwatt => const Unit(
    ...
    short: UnitCountPattern(_locale, 'mW', one: '{0} milivat', other: '{0} mW'),
    narrow: UnitCountPattern(
      _locale,
      'mW',
      one: '{0} milivat',
  ...
  Unit get powerHorsepower => const Unit(
    ...
    short: UnitCountPattern(_locale, 'bg', one: '{0} bg', other: '{0} bg'),
    narrow: UnitCountPattern(_locale, 'bg', one: '{0} bg', other: '{0} bg'),
  );
  ...
  Unit get speedKnot => const Unit(
    ...
    short: UnitCountPattern(_locale, 'kn', one: '{0} knot', other: '{0} kn'),
    narrow: UnitCountPattern(_locale, 'kn', one: '{0} knot', other: '{0} kn'),
  );
  ...
  Unit get temperatureGeneric => const Unit(
    ...
    short: UnitCountPattern(_locale, '°', one: '{0} derece', other: '{0}°'),
    narrow: UnitCountPattern(_locale, '°', one: '{0} derece', other: '{0}°'),
  );
  ...
  Unit get volumeLiter => const Unit(
    ...
    short: UnitCountPattern(_locale, 'litre', one: '{0} litre', other: '{0} l'),
    narrow: UnitCountPattern(
      _locale,
      'litre',
      one: '{0} litre',
  ...
  Unit get volumeCupMetric => const Unit(
    ...
    short: UnitCountPattern(_locale, 'msub', one: '{0} msb', other: '{0} msb'),
    narrow: UnitCountPattern(_locale, 'msub', one: '{0} msb', other: '{0} msb'),
  );
  ...
  Unit get volumeCup => const Unit(
    ...
    short: UnitCountPattern(_locale, 'su b.', one: '{0} sb', other: '{0} sb'),
    narrow: UnitCountPattern(_locale, 'su b.', one: '{0} sb', other: '{0} sb'),
  );
  ...
  Unit get volumeTablespoon => const Unit(
    ...
    short: UnitCountPattern(_locale, 'yk', one: '{0} yk', other: '{0} yk'),
    narrow: UnitCountPattern(_locale, 'yk', one: '{0} yk', other: '{0} yk'),
  );
  ...
  Unit get volumeTeaspoon => const Unit(
    ...
    short: UnitCountPattern(_locale, 'çk', one: '{0} çk', other: '{0} çk'),
    narrow: UnitCountPattern(_locale, 'çk', one: '{0} çk', other: '{0} çk'),
  );
  ...
  Unit get volumeDessertSpoon => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'tk', one: '{0} tk', other: '{0} tk'),
  );
  ...
  Unit get speedLightSpeed => const Unit(
    long: UnitCountPattern(_locale, 'ışık', one: '{0} ışık', other: '{0} ışık'),
    short: UnitCountPattern(
      _locale,
      'ışık',
      one: '{0} ışık',
  ...
  Unit get durationNight => const Unit(
    long: UnitCountPattern(_locale, 'gece', one: '{0} gece', other: '{0} gece'),
    short: UnitCountPattern(
      _locale,
      'gece',
      one: '{0} gece',
...
class DateFieldsTr extends DateFields {
  const DateFieldsTr(super.cld);

  @override
  MultiLength get era =>
      const MultiLength(long: 'çağ', short: 'çağ', narrow: 'çağ');

  @override
  DateFieldFullData get year => const DateFieldFullData(
    displayName: MultiLength(long: 'yıl', short: 'yıl', narrow: 'yıl'),
    previous: MultiLength(
      long: 'geçen yıl',
      short: 'geçen yıl',
      narrow: 'geçen yıl',
    ),
    now: MultiLength(long: 'bu yıl', short: 'bu yıl', narrow: 'bu yıl'),
    next: MultiLength(
      long: 'gelecek yıl',
      short: 'gelecek yıl',
      narrow: 'gelecek yıl',
    ...
    past: MultiLengthRelativeTime(
      long: RelativeTime(_locale, one: '{0} yıl önce', other: '{0} yıl önce'),
      short: RelativeTime(_locale, one: '{0} yıl önce', other: '{0} yıl önce'),
      narrow: RelativeTime(_locale, one: '{0} yıl önce', other: '{0} yıl önce'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(_locale, one: '{0} yıl sonra', other: '{0} yıl sonra'),
      short: RelativeTime(
        _locale,
        one: '{0} yıl sonra',
        other: '{0} yıl sonra',
  ...
  DateFieldFullData get quarter => const DateFieldFullData(
    displayName: MultiLength(long: 'çeyrek', short: 'çyr.', narrow: 'çyr.'),
    previous: MultiLength(
      long: 'geçen çeyrek',
      short: 'geçen çyr.',
      narrow: 'geçen çyr.',
    ),
    now: MultiLength(long: 'bu çeyrek', short: 'bu çyr.', narrow: 'bu çyr.'),
    next: MultiLength(
      long: 'gelecek çeyrek',
      short: 'gelecek çyr.',
      narrow: 'gelecek çyr.',
  ...
  DateFieldFullData get month => const DateFieldFullData(
    ...
    past: MultiLengthRelativeTime(
      long: RelativeTime(_locale, one: '{0} ay önce', other: '{0} ay önce'),
      short: RelativeTime(_locale, one: '{0} ay önce', other: '{0} ay önce'),
      narrow: RelativeTime(_locale, one: '{0} ay önce', other: '{0} ay önce'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(_locale, one: '{0} ay sonra', other: '{0} ay sonra'),
      short: RelativeTime(_locale, one: '{0} ay sonra', other: '{0} ay sonra'),
      narrow: RelativeTime(_locale, one: '{0} ay sonra', other: '{0} ay sonra'),
    ),
  );

  @override
  DateFieldFullData get week => const DateFieldFullData(
    displayName: MultiLength(long: 'hafta', short: 'hf.', narrow: 'hf.'),
    previous: MultiLength(
      long: 'geçen hafta',
      short: 'geçen hf.',
      narrow: 'geçen hf.',
    ),
    now: MultiLength(long: 'bu hafta', short: 'bu hf.', narrow: 'bu hf.'),
    next: MultiLength(
      long: 'gelecek hafta',
      short: 'gelecek hf.',
      narrow: 'gelecek hf.',
    ...
    past: MultiLengthRelativeTime(
      ...
      short: RelativeTime(_locale, one: '{0} hf. önce', other: '{0} hf. önce'),
      narrow: RelativeTime(_locale, one: '{0} hf. önce', other: '{0} hf. önce'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
  ...
  DateFieldFullData get day => const DateFieldFullData(
    ...
    previous: MultiLength(long: 'dün', short: 'dün', narrow: 'dün'),
    now: MultiLength(long: 'bugün', short: 'bugün', narrow: 'bugün'),
    next: MultiLength(long: 'yarın', short: 'yarın', narrow: 'yarın'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(_locale, one: '{0} gün önce', other: '{0} gün önce'),
      short: RelativeTime(_locale, one: '{0} gün önce', other: '{0} gün önce'),
      narrow: RelativeTime(_locale, one: '{0} gün önce', other: '{0} gün önce'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(_locale, one: '{0} gün sonra', other: '{0} gün sonra'),
      short: RelativeTime(
        _locale,
        one: '{0} gün sonra',
        other: '{0} gün sonra',
  ...
  DateFieldDataWithRelative get sunday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: 'bu pazar', short: 'bu paz.', narrow: 'bu paz.'),
    next: MultiLength(
      long: 'gelecek pazar',
      short: 'gelecek paz.',
      narrow: 'gelecek paz.',
  ...
  DateFieldDataWithRelative get monday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: 'bu pazartesi', short: 'bu pzt.', narrow: 'bu pzt.'),
    next: MultiLength(
  ...
  DateFieldDataWithRelative get tuesday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: 'bu salı', short: 'bu salı', narrow: 'bu salı'),
    next: MultiLength(
      long: 'gelecek salı',
      short: 'gelecek salı',
      narrow: 'gelecek salı',
    ...
    past: MultiLengthRelativeTime(
      long: RelativeTime(_locale, one: '{0} salı önce', other: '{0} salı önce'),
      short: RelativeTime(
        _locale,
        one: '{0} salı önce',
        other: '{0} salı önce',
  ...
  DateFieldDataWithRelative get wednesday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: 'bu çarşamba', short: 'bu çar.', narrow: 'bu çar.'),
    next: MultiLength(
  ...
  DateFieldDataWithRelative get thursday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: 'bu perşembe', short: 'bu per.', narrow: 'bu per.'),
    next: MultiLength(
  ...
  DateFieldDataWithRelative get friday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: 'bu cuma', short: 'bu cuma', narrow: 'bu cuma'),
    next: MultiLength(
      long: 'gelecek cuma',
      short: 'gelecek cuma',
      narrow: 'gelecek cuma',
    ...
    past: MultiLengthRelativeTime(
      long: RelativeTime(_locale, one: '{0} cuma önce', other: '{0} cuma önce'),
      short: RelativeTime(
        _locale,
        one: '{0} cuma önce',
        other: '{0} cuma önce',
  ...
  DateFieldDataWithRelative get saturday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: 'bu cumartesi', short: 'bu cmt.', narrow: 'bu cmt.'),
    next: MultiLength(
  ...
  MultiLength get dayperiod =>
      const MultiLength(long: 'ÖÖ/ÖS', short: 'ÖÖ/ÖS', narrow: 'ÖÖ/ÖS');

  @override
  DateFieldDataTime get hour => const DateFieldDataTime(
    displayName: MultiLength(long: 'saat', short: 'sa.', narrow: 'sa.'),
    now: MultiLength(long: 'bu saat', short: 'bu saat', narrow: 'bu saat'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(_locale, one: '{0} saat önce', other: '{0} saat önce'),
      short: RelativeTime(_locale, one: '{0} sa. önce', other: '{0} sa. önce'),
      narrow: RelativeTime(_locale, one: '{0} sa. önce', other: '{0} sa. önce'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
  ...
  DateFieldDataTime get minute => const DateFieldDataTime(
    displayName: MultiLength(long: 'dakika', short: 'dk.', narrow: 'dk.'),
    now: MultiLength(
      long: 'bu dakika',
      short: 'bu dakika',
      narrow: 'bu dakika',
    ...
    past: MultiLengthRelativeTime(
      ...
      short: RelativeTime(_locale, one: '{0} dk. önce', other: '{0} dk. önce'),
      narrow: RelativeTime(_locale, one: '{0} dk. önce', other: '{0} dk. önce'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
  ...
  DateFieldDataTime get second => const DateFieldDataTime(
    displayName: MultiLength(long: 'saniye', short: 'sn.', narrow: 'sn.'),
    now: MultiLength(long: 'şimdi', short: 'şimdi', narrow: 'şimdi'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
        one: '{0} saniye önce',
      ...
      short: RelativeTime(_locale, one: '{0} sn. önce', other: '{0} sn. önce'),
      narrow: RelativeTime(_locale, one: '{0} sn. önce', other: '{0} sn. önce'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
  ...
  MultiLength get zone =>
      const MultiLength(long: 'saat dilimi', short: 'dilim', narrow: 'dilim');
}

class LanguagesTr extends Languages {
  const LanguagesTr(super.cld);
...
class ScriptsTr extends Scripts {
  const ScriptsTr(super.cld);
...
class TerritoriesTr extends Territories {
  const TerritoriesTr(super.cld);
...
class VariantsTr extends Variants {
  const VariantsTr(super.cld);
  ...
  static const _wadegile = Variant(
    'WADEGILE',
...
class SubdivisionsTr extends Subdivisions {
  const SubdivisionsTr(super.cld);
...
class CurrenciesTr extends Currencies {
  const CurrenciesTr(super.cld);
...
class TimeZonesTr extends TimeZones {
  const TimeZonesTr(super.cld);
  ...
  @override
  String get regionFormat => '{0} Saati';
  @override
  String get regionFormatDaylight => '{0} Yaz Saati';
  @override
  String get regionFormatStandard => '{0} Standart Saati';
  @override
  ...
  static const staticTimeZoneNames = <String, TimeZoneNames>{
    ...
    'Europe/Dublin': TimeZoneNames(
      long: TimeZoneName(daylight: 'İrlanda Standart Saati'),
    ),
  ...
  static const staticMetaZoneNames = <String, MetaZone>{
    ...
    'Bolivia': MetaZone(
      'Bolivia',
      long: TimeZoneName(standard: 'Bolivya Saati'),
    ),
    'Brasilia': MetaZone(
      'Brasilia',
      long: TimeZoneName(
    ...
    'Chamorro': MetaZone(
      'Chamorro',
      long: TimeZoneName(standard: 'Chamorro Saati'),
    ),
    'Chatham': MetaZone(
      'Chatham',
      long: TimeZoneName(
    ...
    'Cocos': MetaZone(
      'Cocos',
      long: TimeZoneName(standard: 'Cocos Adaları Saati'),
    ),
    'Colombia': MetaZone(
      'Colombia',
      long: TimeZoneName(
    ...
    'Ecuador': MetaZone(
      'Ecuador',
      long: TimeZoneName(standard: 'Ekvador Saati'),
    ),
    ...
    'Galapagos': MetaZone(
      'Galapagos',
      long: TimeZoneName(standard: 'Galapagos Saati'),
    ),
    'Gambier': MetaZone(
      'Gambier',
      long: TimeZoneName(standard: 'Gambier Saati'),
    ),
    'Georgia': MetaZone(
      'Georgia',
      long: TimeZoneName(
    ...
    'Guam': MetaZone(
      'Guam',
      long: TimeZoneName(standard: 'Guam Standart Saati'),
    ),
    ...
    'Indochina': MetaZone(
      'Indochina',
      long: TimeZoneName(standard: 'Hindiçin Saati'),
    ),
    ...
    'Malaysia': MetaZone(
      'Malaysia',
      long: TimeZoneName(standard: 'Malezya Saati'),
    ),
    'Maldives': MetaZone(
      'Maldives',
      long: TimeZoneName(standard: 'Maldivler Saati'),
    ),
    'Marquesas': MetaZone(
      'Marquesas',
    ...
    'Myanmar': MetaZone(
      'Myanmar',
      long: TimeZoneName(standard: 'Myanmar Saati'),
    ),
    ...
    'Pitcairn': MetaZone(
      'Pitcairn',
      long: TimeZoneName(standard: 'Pitcairn Saati'),
    ),
    'Ponape': MetaZone('Ponape', long: TimeZoneName(standard: 'Ponape Saati')),
    'Pyongyang': MetaZone(
      'Pyongyang',
      long: TimeZoneName(standard: 'Pyongyang Saati'),
    ),
    'Qyzylorda': MetaZone(
      'Qyzylorda',
      long: TimeZoneName(
    ...
    'Reunion': MetaZone(
      'Reunion',
      long: TimeZoneName(standard: 'Reunion Saati'),
    ),
    'Rothera': MetaZone(
      'Rothera',
      long: TimeZoneName(standard: 'Rothera Saati'),
    ),
    'Sakhalin': MetaZone(
      'Sakhalin',
      long: TimeZoneName(
    ...
    'Seychelles': MetaZone(
      'Seychelles',
      long: TimeZoneName(standard: 'Seyşeller Saati'),
    ),
    'Singapore': MetaZone(
      'Singapore',
    ...
    'Suriname': MetaZone(
      'Suriname',
      long: TimeZoneName(standard: 'Surinam Saati'),
    ),
    ...
    'Tokelau': MetaZone(
      'Tokelau',
      long: TimeZoneName(standard: 'Tokelau Saati'),
    ),
    'Tonga': MetaZone(
      'Tonga',
      long: TimeZoneName(
    ...
    'Venezuela': MetaZone(
      'Venezuela',
      long: TimeZoneName(standard: 'Venezuela Saati'),
    ),
...
class LocaleDisplayNameTr extends LocaleDisplayName {
  const LocaleDisplayNameTr(super.cld);
  ...
  @override
  String get codePatternScript => 'Alfabe: {0}';
  @override
  String get codePatternTerritory => 'Bölge: {0}';
