...
const _locale = 'ro';
const _cld = CommonLocaleDataRo.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataRo extends CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataRo.constant() : super.constant();

  factory CommonLocaleDataRo() => _cld;
  ...
  static final _units = UnitsRo(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsRo(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesRo(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsRo(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesRo(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsRo(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsRo(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesRo(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesRo(_cld);
  @override
...
class DateFieldsRo extends DateFields {
  const DateFieldsRo(super.cld);

  @override
  MultiLength get era =>
      const MultiLength(long: 'eră', short: 'eră', narrow: 'eră');

  @override
  DateFieldFullData get year => const DateFieldFullData(
    displayName: MultiLength(long: 'an', short: 'an', narrow: 'an'),
  ...
  DateFieldFullData get month => const DateFieldFullData(
    displayName: MultiLength(long: 'lună', short: 'lună', narrow: 'lună'),
    previous: MultiLength(
      long: 'luna trecută',
      short: 'luna trecută',
      narrow: 'luna trecută',
  ...
  DateFieldFullData get day => const DateFieldFullData(
    displayName: MultiLength(long: 'zi', short: 'zi', narrow: 'zi'),
    previous: MultiLength(long: 'ieri', short: 'ieri', narrow: 'ieri'),
    now: MultiLength(long: 'azi', short: 'azi', narrow: 'azi'),
    next: MultiLength(long: 'mâine', short: 'mâine', narrow: 'mâine'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
        one: 'acum {0} zi',
  ...
  DateFieldDataTime get hour => const DateFieldDataTime(
    displayName: MultiLength(long: 'oră', short: 'h', narrow: 'h'),
    now: MultiLength(
      long: 'ora aceasta',
      short: 'ora aceasta',
      narrow: 'ora aceasta',
  ...
  DateFieldDataTime get second => const DateFieldDataTime(
    displayName: MultiLength(long: 'secundă', short: 'sec.', narrow: 's'),
    now: MultiLength(long: 'acum', short: 'acum', narrow: 'acum'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
        one: 'acum {0} secundă',
  ...
  MultiLength get zone =>
      const MultiLength(long: 'fus orar', short: 'fus', narrow: 'fus');
}

class LanguagesRo extends Languages {
  const LanguagesRo(super.cld);
...
class TerritoriesRo extends Territories {
  const TerritoriesRo(super.cld);
...
class SubdivisionsRo extends Subdivisions {
  const SubdivisionsRo(super.cld);
...
class CurrenciesRo extends Currencies {
  const CurrenciesRo(super.cld);
...
class TimeZonesRo extends TimeZones {
  ...
  @override
  String get regionFormat => 'Ora din {0}';
  @override
  String get regionFormatDaylight => 'Ora de vară din {0}';
  @override
  String get regionFormatStandard => 'Ora standard din {0}';
  @override
  ...
  static const staticTimeZoneNames = <String, TimeZoneNames>{
    ...
    'Europe/Dublin': TimeZoneNames(
      long: TimeZoneName(daylight: 'Ora de vară a Irlandei'),
    ),
  ...
  static const staticMetaZoneNames = <String, MetaZone>{
    ...
    'Bhutan': MetaZone(
      'Bhutan',
      long: TimeZoneName(standard: 'Ora Bhutanului'),
    ),
    'Bolivia': MetaZone(
      'Bolivia',
      long: TimeZoneName(standard: 'Ora Boliviei'),
    ),
    'Brasilia': MetaZone(
      'Brasilia',
      long: TimeZoneName(
    ...
    'Chamorro': MetaZone(
      'Chamorro',
      long: TimeZoneName(standard: 'Ora din Chamorro'),
    ),
    'Chatham': MetaZone(
      'Chatham',
      long: TimeZoneName(
    ...
    'Cocos': MetaZone(
      'Cocos',
      long: TimeZoneName(standard: 'Ora Insulelor Cocos'),
    ),
    'Colombia': MetaZone(
      'Colombia',
      long: TimeZoneName(
    ...
    'Ecuador': MetaZone(
      'Ecuador',
      long: TimeZoneName(standard: 'Ora Ecuadorului'),
    ),
    ...
    'Gambier': MetaZone(
      'Gambier',
      long: TimeZoneName(standard: 'Ora din Gambier'),
    ),
    'Georgia': MetaZone(
      'Georgia',
      long: TimeZoneName(
    ...
    'Guyana': MetaZone(
      'Guyana',
      long: TimeZoneName(standard: 'Ora din Guyana'),
    ),
    ...
    'Indochina': MetaZone(
      'Indochina',
      long: TimeZoneName(standard: 'Ora Indochinei'),
    ),
    ...
    'Kosrae': MetaZone(
      'Kosrae',
      long: TimeZoneName(standard: 'Ora din Kosrae'),
    ),
    ...
    'Malaysia': MetaZone(
      'Malaysia',
      long: TimeZoneName(standard: 'Ora din Malaysia'),
    ),
    'Maldives': MetaZone(
      'Maldives',
      long: TimeZoneName(standard: 'Ora din Maldive'),
    ),
    'Marquesas': MetaZone(
      'Marquesas',
    ...
    'Mawson': MetaZone(
      'Mawson',
      long: TimeZoneName(standard: 'Ora din Mawson'),
    ),
    ...
    'Myanmar': MetaZone(
      'Myanmar',
      long: TimeZoneName(standard: 'Ora Myanmarului'),
    ),
    ...
    'Pitcairn': MetaZone(
      'Pitcairn',
      long: TimeZoneName(standard: 'Ora din Pitcairn'),
    ),
    'Ponape': MetaZone(
      'Ponape',
      long: TimeZoneName(standard: 'Ora din Ponape'),
    ),
    'Pyongyang': MetaZone(
      'Pyongyang',
    ...
    'Reunion': MetaZone(
      'Reunion',
      long: TimeZoneName(standard: 'Ora din Reunion'),
    ),
    'Rothera': MetaZone(
      'Rothera',
      long: TimeZoneName(standard: 'Ora din Rothera'),
    ),
    'Sakhalin': MetaZone(
      'Sakhalin',
      long: TimeZoneName(
    ...
    'Suriname': MetaZone(
      'Suriname',
      long: TimeZoneName(standard: 'Ora Surinamului'),
    ),
    'Syowa': MetaZone('Syowa', long: TimeZoneName(standard: 'Ora din Syowa')),
    'Tahiti': MetaZone(
      'Tahiti',
      long: TimeZoneName(standard: 'Ora din Tahiti'),
    ),
    'Taipei': MetaZone(
      'Taipei',
      long: TimeZoneName(
    ...
    'Tokelau': MetaZone(
      'Tokelau',
      long: TimeZoneName(standard: 'Ora din Tokelau'),
    ),
    'Tonga': MetaZone(
      'Tonga',
      long: TimeZoneName(
    ...
    'Tuvalu': MetaZone(
      'Tuvalu',
      long: TimeZoneName(standard: 'Ora din Tuvalu'),
    ),
    'Uruguay': MetaZone(
      'Uruguay',
      long: TimeZoneName(
    ...
    'Venezuela': MetaZone(
      'Venezuela',
      long: TimeZoneName(standard: 'Ora Venezuelei'),
    ),
    ...
    'Vostok': MetaZone(
      'Vostok',
      long: TimeZoneName(standard: 'Ora din Vostok'),
    ),
...
class LocaleDisplayNameRo extends LocaleDisplayName {
  const LocaleDisplayNameRo(super.cld);
  ...
  @override
  String get codePatternLanguage => 'Limbă: {0}';
  @override
  String get codePatternScript => 'Scriere: {0}';
  @override
  String get codePatternTerritory => 'Regiune: {0}';
  ...
  static const staticValueNames = <String, Map<String, String>>{
    ...
    'm0': {'bgn': 'transliterare BGN SUA', 'ungegn': 'transliterare GEGN ONU'},
    'ms': {
