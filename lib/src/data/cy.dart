...
const _locale = 'cy';
const _cld = CommonLocaleDataCy.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataCy extends CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataCy.constant() : super.constant();
  ...
  static final _units = UnitsCy(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsCy(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesCy(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsCy(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesCy(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsCy(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsCy(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesCy(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesCy(_cld);
  @override
...
class UnitsCy extends Units {
  ...
  Unit get lightLumen => const Unit(
    long: UnitCountPattern(_locale, 'lwmen', one: '{0} lumen', other: '{0} lm'),
...
class DateFieldsCy extends DateFields {
  const DateFieldsCy(super.cld);

  @override
  MultiLength get era =>
      const MultiLength(long: 'oes', short: 'oes', narrow: 'oes');

  @override
  DateFieldFullData get year => const DateFieldFullData(
    displayName: MultiLength(long: 'blwyddyn', short: 'bl.', narrow: 'bl.'),
    previous: MultiLength(long: 'llynedd', short: 'llynedd', narrow: 'llynedd'),
    now: MultiLength(long: 'eleni', short: 'eleni', narrow: 'eleni'),
    next: MultiLength(
      long: 'blwyddyn nesaf',
  ...
  DateFieldFullData get quarter => const DateFieldFullData(
    displayName: MultiLength(long: 'chwarter', short: 'chw.', narrow: 'chw.'),
  ...
  DateFieldFullData get month => const DateFieldFullData(
    displayName: MultiLength(long: 'mis', short: 'mis', narrow: 'mis'),
    previous: MultiLength(
      long: 'mis diwethaf',
      short: 'mis diwethaf',
      narrow: 'mis diwethaf',
  ...
  DateFieldFullData get day => const DateFieldFullData(
    ...
    previous: MultiLength(long: 'ddoe', short: 'ddoe', narrow: 'ddoe'),
    now: MultiLength(long: 'heddiw', short: 'heddiw', narrow: 'heddiw'),
    next: MultiLength(long: 'yfory', short: 'yfory', narrow: 'yfory'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
  ...
  DateFieldDataWithRelative get sunday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: 'dydd Sul yma', short: 'Sul yma', narrow: 'Sul yma'),
    next: MultiLength(
      long: 'dydd Sul nesaf',
      short: 'Sul nesaf',
      narrow: 'Sul nesaf',
  ...
  DateFieldDataWithRelative get thursday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: 'dydd Iau yma', short: 'Iau yma', narrow: 'I yma'),
    next: MultiLength(
      long: 'dydd Iau nesaf',
      short: 'Iau nesaf',
      narrow: 'I nesaf',
  ...
  DateFieldDataTime get hour => const DateFieldDataTime(
    displayName: MultiLength(long: 'awr', short: 'awr', narrow: 'awr'),
    now: MultiLength(
      long: 'yr awr hon',
      short: 'yr awr hon',
      narrow: 'yr awr hon',
  ...
  DateFieldDataTime get minute => const DateFieldDataTime(
    displayName: MultiLength(long: 'munud', short: 'mun.', narrow: 'mun.'),
    now: MultiLength(
      long: 'y funud hon',
      short: 'y funud hon',
      narrow: 'y funud hon',
  ...
  DateFieldDataTime get second => const DateFieldDataTime(
    displayName: MultiLength(long: 'eiliad', short: 'eiliad', narrow: 'eiliad'),
    now: MultiLength(long: 'nawr', short: 'nawr', narrow: 'nawr'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
        zero: '{0} eiliad yn ôl',
...
class SubdivisionsCy extends Subdivisions {
  const SubdivisionsCy(super.cld);
...
class TimeZonesCy extends TimeZones {
  ...
  @override
  String get regionFormat => 'Amser {0}';
  @override
  String get regionFormatDaylight => 'Amser Haf {0}';
  @override
  String get regionFormatStandard => 'Amser Safonol {0}';
  @override
  ...
  static const staticMetaZoneNames = <String, MetaZone>{
    ...
    'Bolivia': MetaZone(
      'Bolivia',
      long: TimeZoneName(standard: 'Amser Bolifia'),
    ),
    'Brasilia': MetaZone(
      'Brasilia',
      long: TimeZoneName(
    ...
    'Chamorro': MetaZone(
      'Chamorro',
      long: TimeZoneName(standard: 'Amser Chamorro'),
    ),
    'Chatham': MetaZone(
      'Chatham',
      long: TimeZoneName(
    ...
    'Cocos': MetaZone(
      'Cocos',
      long: TimeZoneName(standard: 'Amser Ynysoedd Cocos'),
    ),
    'Colombia': MetaZone(
      'Colombia',
      long: TimeZoneName(
    ...
    'Ecuador': MetaZone(
      'Ecuador',
      long: TimeZoneName(standard: 'Amser Ecuador'),
    ),
    ...
    'Galapagos': MetaZone(
      'Galapagos',
      long: TimeZoneName(standard: 'Amser Galapagos'),
    ),
    'Gambier': MetaZone(
      'Gambier',
      long: TimeZoneName(standard: 'Amser Gambier'),
    ),
    'Georgia': MetaZone(
      'Georgia',
      long: TimeZoneName(
    ...
    'Gulf': MetaZone(
      'Gulf',
      long: TimeZoneName(standard: 'Amser Safonol y Gwlff'),
    ),
    ...
    'Kyrgystan': MetaZone(
      'Kyrgystan',
      long: TimeZoneName(standard: 'Amser Kyrgyzstan'),
    ),
    ...
    'Malaysia': MetaZone(
      'Malaysia',
      long: TimeZoneName(standard: 'Amser Malaysia'),
    ),
    'Maldives': MetaZone(
      'Maldives',
      long: TimeZoneName(standard: 'Amser Y Maldives'),
    ),
    'Marquesas': MetaZone(
      'Marquesas',
      long: TimeZoneName(standard: 'Amser Marquises'),
    ),
    ...
    'Myanmar': MetaZone(
      'Myanmar',
      long: TimeZoneName(standard: 'Amser Myanmar'),
    ),
    ...
    'Pitcairn': MetaZone(
      'Pitcairn',
      long: TimeZoneName(standard: 'Amser Pitcairn'),
    ),
    'Ponape': MetaZone('Ponape', long: TimeZoneName(standard: 'Amser Pohnpei')),
    'Pyongyang': MetaZone(
      'Pyongyang',
      long: TimeZoneName(standard: 'Amser Pyongyang'),
    ),
    'Reunion': MetaZone(
      'Reunion',
      long: TimeZoneName(standard: 'Amser Réunion'),
    ),
    'Rothera': MetaZone(
      'Rothera',
      long: TimeZoneName(standard: 'Amser Rothera'),
    ),
    'Sakhalin': MetaZone(
      'Sakhalin',
      long: TimeZoneName(
    ...
    'Singapore': MetaZone(
      'Singapore',
      long: TimeZoneName(standard: 'Amser Singapore'),
    ),
    'Solomon': MetaZone(
      'Solomon',
    ...
    'Suriname': MetaZone(
      'Suriname',
      long: TimeZoneName(standard: 'Amser Suriname'),
    ),
    ...
    'Tokelau': MetaZone(
      'Tokelau',
      long: TimeZoneName(standard: 'Amser Tokelau'),
    ),
    'Tonga': MetaZone(
      'Tonga',
      long: TimeZoneName(
    ...
    'Venezuela': MetaZone(
      'Venezuela',
      long: TimeZoneName(standard: 'Amser Venezuela'),
    ),
...
class LocaleDisplayNameCy extends LocaleDisplayName {
  const LocaleDisplayNameCy(super.cld);
  ...
  @override
  String get codePatternLanguage => 'Iaith: {0}';
  @override
  String get codePatternScript => 'Sgript: {0}';
  @override
  String get codePatternTerritory => 'Rhanbarth: {0}';
