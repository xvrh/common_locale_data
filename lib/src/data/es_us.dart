...
class UnitsEsUS extends UnitsEs {
  ...
  Unit get digitalBit => const Unit(
    ...
    short: UnitCountPattern(_locale, 'bit', one: '{0} b', other: '{0} b'),
    narrow: UnitCountPattern(_locale, 'bit', one: '{0}b', other: '{0}b'),
  );
  ...
  Unit get lengthFathom => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'braza', one: '{0}ftm', other: '{0}ftm'),
  );
  ...
  Unit get speedKnot => const Unit(
    ...
    short: UnitCountPattern(_locale, 'kn', one: '{0} nudo', other: '{0} nudos'),
  ...
  Unit get volumeBushel => const Unit(
    ...
    short: UnitCountPattern(_locale, 'bsh', one: '{0} bsh', other: '{0} bsh'),
    narrow: UnitCountPattern(_locale, 'bsh', one: '{0}bsh', other: '{0}bsh'),
  );
  ...
  Unit get speedLightSpeed => const Unit(
    long: UnitCountPattern(_locale, 'luz', one: '{0} luz', other: '{0} luces'),
    short: UnitCountPattern(
      _locale,
      'luz',
      one: '{0} luz',
    ...
    narrow: UnitCountPattern(_locale, 'luz', one: '{0}luz', other: '{0}luces'),
  );
