...
const _locale = 'en-TT';
const _cld = CommonLocaleDataEnTT._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEnTT implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataEnTT._();
  ...
  static final _units = UnitsEnTT._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEnTT._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEnTT._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsEnTT._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesEnTT._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsEnTT._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsEnTT._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesEnTT._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEnTT._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEnTT._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEnTT extends Units {
  UnitsEnTT._(super.cld);
...
class DateFieldsEnTT extends DateFields {
  DateFieldsEnTT._(super.cld);
...
class LanguagesEnTT extends Languages {
  const LanguagesEnTT._(super.cld);
...
class ScriptsEnTT extends Scripts {
  const ScriptsEnTT._(super.cld);
...
class TerritoriesEnTT extends Territories {
  const TerritoriesEnTT._(super.cld);
...
class VariantsEnTT extends Variants {
  const VariantsEnTT._(super.cld);
...
class SubdivisionsEnTT extends Subdivisions {
  const SubdivisionsEnTT._(super.cld);
...
class CurrenciesEnTT extends Currencies {
  const CurrenciesEnTT._(super.cld);
...
class TimeZonesEnTT extends TimeZones {
  const TimeZonesEnTT._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
            regionFormat: '{0} Time',
...
class LocaleDisplayNameEnTT extends LocaleDisplayName {
  const LocaleDisplayNameEnTT._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
