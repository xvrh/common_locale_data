...
const _locale = 'fr-GA';
const _cld = CommonLocaleDataFrGA._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataFrGA implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataFrGA._();
  ...
  static final _units = UnitsFrGA._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsFrGA._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesFrGA._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsFrGA._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesFrGA._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsFrGA._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsFrGA._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesFrGA._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesFrGA._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameFrGA._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsFrGA extends Units {
  UnitsFrGA._(super.cld);
...
class DateFieldsFrGA extends DateFields {
  DateFieldsFrGA._(super.cld);
...
class LanguagesFrGA extends Languages {
  const LanguagesFrGA._(super.cld);
...
class ScriptsFrGA extends Scripts {
  const ScriptsFrGA._(super.cld);
...
class TerritoriesFrGA extends Territories {
  const TerritoriesFrGA._(super.cld);
...
class VariantsFrGA extends Variants {
  const VariantsFrGA._(super.cld);
...
class SubdivisionsFrGA extends Subdivisions {
  const SubdivisionsFrGA._(super.cld);
...
class CurrenciesFrGA extends Currencies {
  const CurrenciesFrGA._(super.cld);
...
class TimeZonesFrGA extends TimeZones {
  const TimeZonesFrGA._(super.cld)
      : super(
            gmtFormat: 'UTC{0}',
            gmtZeroFormat: 'UTC',
...
class LocaleDisplayNameFrGA extends LocaleDisplayName {
  const LocaleDisplayNameFrGA._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
