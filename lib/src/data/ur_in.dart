...
class DateFieldsUrIN extends DateFieldsUr {
  ...
  DateFieldFullData get year => const DateFieldFullData(
    ...
    future: MultiLengthRelativeTime(
      long: RelativeTime(_locale, one: '{0} سال میں', other: '{0} سالوں میں'),
      short: RelativeTime(_locale, one: '{0} سال میں', other: '{0} سالوں میں'),
      narrow: RelativeTime(_locale, one: '{0} سال میں', other: '{0} سالوں میں'),
    ),
  );

  @override
  DateFieldFullData get month => const DateFieldFullData(
    displayName: MultiLength(long: 'مہینہ', short: 'مہینہ', narrow: 'مہینہ'),
    previous: MultiLength(
      long: 'گزشتہ ماہ',
      short: 'پچھلے مہینہ',
      narrow: 'گزشتہ ماہ',
    ...
    past: MultiLengthRelativeTime(
      long: RelativeTime(_locale, one: '{0} ماہ قبل', other: '{0} ماہ قبل'),
      short: RelativeTime(_locale, one: '{0} ماہ قبل', other: '{0} ماہ قبل'),
      narrow: RelativeTime(_locale, one: '{0} ماہ قبل', other: '{0} ماہ قبل'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(_locale, one: '{0} ماہ میں', other: '{0} ماہ میں'),
  ...
  DateFieldFullData get week => const DateFieldFullData(
    ...
    past: MultiLengthRelativeTime(
      long: RelativeTime(_locale, one: '{0} ہفتہ قبل', other: '{0} ہفتے قبل'),
      short: RelativeTime(_locale, one: '{0} ہفتے قبل', other: '{0} ہفتے قبل'),
      narrow: RelativeTime(_locale, one: '{0} ہفتہ قبل', other: '{0} ہفتے قبل'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(_locale, one: '{0} ہفتہ میں', other: '{0} ہفتوں میں'),
  ...
  DateFieldFullData get day => const DateFieldFullData(
    ...
    past: MultiLengthRelativeTime(
      ...
      narrow: RelativeTime(_locale, one: '{0} دن قبل', other: '{0} دن قبل'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(_locale, one: '{0} دن میں', other: '{0} دنوں میں'),
      short: RelativeTime(_locale, one: '{0} دنوں میں', other: '{0} دنوں میں'),
      narrow: RelativeTime(_locale, one: '{0} دنوں میں', other: '{0} دنوں میں'),
    ),
  );
  ...
  DateFieldDataTime get minute => const DateFieldDataTime(
    ...
    past: MultiLengthRelativeTime(
      long: RelativeTime(_locale, one: '{0} منٹ قبل', other: '{0} منٹ قبل'),
      short: RelativeTime(_locale, one: '{0} منٹ قبل', other: '{0} منٹ قبل'),
      narrow: RelativeTime(_locale, one: '{0} منٹ قبل', other: '{0} منٹ قبل'),
    ),
    future: MultiLengthRelativeTime(
  ...
  DateFieldDataTime get second => const DateFieldDataTime(
    ...
    past: MultiLengthRelativeTime(
      long: RelativeTime(_locale, one: '{0} سیکنڈ قبل', other: '{0} سیکنڈ قبل'),
      short: RelativeTime(
        _locale,
        one: '{0} سیکنڈ قبل',
        other: '{0} سیکنڈ قبل',
...
class TimeZonesUrIN extends TimeZonesUr {
  ...
  Map<String, MetaZone> get metaZoneNames => Map.unmodifiable({
    ...
    ...const {
      ...
      'Bolivia': MetaZone(
        'Bolivia',
        long: TimeZoneName(standard: 'بولیویا ٹائم'),
      ),
      'Brasilia': MetaZone(
        'Brasilia',
        long: TimeZoneName(
      ...
      'Maldives': MetaZone(
        'Maldives',
        long: TimeZoneName(standard: 'مالدیپ ٹائم'),
      ),
      ...
      'Rothera': MetaZone(
        'Rothera',
        long: TimeZoneName(standard: 'روتھیرا ٹائم'),
      ),
      'Suriname': MetaZone(
        'Suriname',
