...
const _locale = 'pt-LU';
const _cld = CommonLocaleDataPtLU.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataPtLU extends CommonLocaleDataPt {
  @override
  String get locale => _locale;

  const CommonLocaleDataPtLU.constant() : super.constant();

  factory CommonLocaleDataPtLU() => _cld;
  ...
  static final _units = UnitsPtLU(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsPtLU(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesPtLU(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsPtLU(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesPtLU(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsPtLU(_cld);
  @override
  Variants get variants => _variants;

  static final _currencies = CurrenciesPtLU(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesPtLU(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNamePtLU(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsPtLU extends UnitsPt {
  const UnitsPtLU(super.cld);
...
class DateFieldsPtLU extends DateFieldsPt {
  const DateFieldsPtLU(super.cld);
...
class LanguagesPtLU extends LanguagesPt {
  const LanguagesPtLU(super.cld);
...
class ScriptsPtLU extends ScriptsPt {
  const ScriptsPtLU(super.cld);
...
class TerritoriesPtLU extends TerritoriesPt {
  const TerritoriesPtLU(super.cld);
...
class VariantsPtLU extends VariantsPt {
  const VariantsPtLU(super.cld);
...
class CurrenciesPtLU extends CurrenciesPt {
  const CurrenciesPtLU(super.cld);
...
class TimeZonesPtLU extends TimeZonesPt {
  const TimeZonesPtLU(super.cld);
...
class LocaleDisplayNamePtLU extends LocaleDisplayNamePt {
  const LocaleDisplayNamePtLU(super.cld);
