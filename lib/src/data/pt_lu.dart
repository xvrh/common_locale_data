...
const _locale = 'pt-LU';
const _cld = CommonLocaleDataPtLU._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataPtLU implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataPtLU._();
  ...
  static final _units = UnitsPtLU._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsPtLU._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesPtLU._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsPtLU._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesPtLU._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsPtLU._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsPtLU._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesPtLU._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesPtLU._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNamePtLU._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsPtLU extends Units {
  UnitsPtLU._(super.cld);
...
class DateFieldsPtLU extends DateFields {
  DateFieldsPtLU._(super.cld);
...
class LanguagesPtLU extends Languages {
  const LanguagesPtLU._(super.cld);
...
class ScriptsPtLU extends Scripts {
  const ScriptsPtLU._(super.cld);
...
class TerritoriesPtLU extends Territories {
  const TerritoriesPtLU._(super.cld);
...
class VariantsPtLU extends Variants {
  const VariantsPtLU._(super.cld);
...
class SubdivisionsPtLU extends Subdivisions {
  const SubdivisionsPtLU._(super.cld);
...
class CurrenciesPtLU extends Currencies {
  const CurrenciesPtLU._(super.cld);
  ...
  static const _luf = Currency(_cld, 'LUF', 'Franco luxemburguês',
      one: 'Franco de Luxemburgo', other: 'Francos de Luxemburgo', symbol: 'F');
...
class TimeZonesPtLU extends TimeZones {
  const TimeZonesPtLU._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
  ...
  final metaZoneNames = const {
    ...
    'Azores': MetaZone('Azores',
        ...
        short:
            TimeZoneName(generic: 'AZOT', standard: 'AZOT', daylight: 'AZOST')),
...
class LocaleDisplayNamePtLU extends LocaleDisplayName {
  const LocaleDisplayNamePtLU._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
