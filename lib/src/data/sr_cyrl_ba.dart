...
class DateFieldsSrCyrlBA extends DateFieldsSrCyrl {
  ...
  DateFieldFullData get month => const DateFieldFullData(
    displayName: MultiLength(long: 'мјесец', short: 'мјес.', narrow: 'мјес.'),
    previous: MultiLength(
  ...
  DateFieldFullData get week => const DateFieldFullData(
    ...
    now: MultiLength(long: 'ове седмице', short: 'ове седм.', narrow: 'ове с.'),
    next: MultiLength(
  ...
  DateFieldDataWithRelative get sunday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: 'у недјељу', short: 'у нед', narrow: 'у нед'),
    next: MultiLength(
  ...
  DateFieldDataWithRelative get monday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: 'у понедјељак', short: 'у пон', narrow: 'у пон'),
    next: MultiLength(
  ...
  DateFieldDataWithRelative get wednesday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: 'у сриједу', short: 'у сри', narrow: 'у сри'),
    next: MultiLength(
...
class TimeZonesSrCyrlBA extends TimeZonesSrCyrl {
  ...
  Map<String, MetaZone> get metaZoneNames => Map.unmodifiable({
    ...
    ...const {
      ...
      'Bhutan': MetaZone(
        'Bhutan',
        long: TimeZoneName(standard: 'Бутан вријеме'),
      ),
      'Bolivia': MetaZone(
        'Bolivia',
      ...
      'Davis': MetaZone(
        'Davis',
        long: TimeZoneName(standard: 'Дејвис вријеме'),
      ),
      ...
      'Kosrae': MetaZone(
        'Kosrae',
        long: TimeZoneName(standard: 'Кошре вријеме'),
      ),
      ...
      'Mawson': MetaZone(
        'Mawson',
        long: TimeZoneName(standard: 'Мосон вријеме'),
      ),
...
class LocaleDisplayNameSrCyrlBA extends LocaleDisplayNameSrCyrl {
  ...
  Map<String, String> get keyNames => Map.unmodifiable({
    ...
    ...const {'co': 'редослијед сортирања', 'ms': 'систем мјерних јединица'},
  });
