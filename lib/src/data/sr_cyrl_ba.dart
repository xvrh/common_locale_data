...
const _cld = CommonLocaleDataSrCyrlBA._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataSrCyrlBA implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataSrCyrlBA._();
  ...
  static final _units = UnitsSrCyrlBA._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsSrCyrlBA._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesSrCyrlBA._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsSrCyrlBA._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesSrCyrlBA._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsSrCyrlBA._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsSrCyrlBA._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesSrCyrlBA._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesSrCyrlBA._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameSrCyrlBA._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsSrCyrlBA extends Units {
  UnitsSrCyrlBA._(super.cld);
...
class DateFieldsSrCyrlBA extends DateFields {
  DateFieldsSrCyrlBA._(super.cld);
...
class LanguagesSrCyrlBA extends Languages {
  const LanguagesSrCyrlBA._(super.cld);
...
class ScriptsSrCyrlBA extends Scripts {
  const ScriptsSrCyrlBA._(super.cld);
...
class TerritoriesSrCyrlBA extends Territories {
  const TerritoriesSrCyrlBA._(super.cld);
...
class VariantsSrCyrlBA extends Variants {
  const VariantsSrCyrlBA._(super.cld);
...
class SubdivisionsSrCyrlBA extends Subdivisions {
  const SubdivisionsSrCyrlBA._(super.cld);
...
class CurrenciesSrCyrlBA extends Currencies {
  const CurrenciesSrCyrlBA._(super.cld);
...
class TimeZonesSrCyrlBA extends TimeZones {
  const TimeZonesSrCyrlBA._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
            regionFormat: '{0}',
  ...
  final timeZoneNames = const {
    ...
    'America/Indiana/Vevay': TimeZoneNames(exemplarCity: 'Виви, Индијана'),
    ...
    'Antarctica/DumontDUrville': TimeZoneNames(exemplarCity: 'Димон д’Ирвил'),
  ...
  final metaZoneNames = const {
    ...
    'Bhutan': MetaZone('Bhutan', long: TimeZoneName(standard: 'Бутан вријеме')),
    'Bolivia':
        MetaZone('Bolivia', long: TimeZoneName(standard: 'Боливија вријеме')),
    ...
    'Chamorro':
        MetaZone('Chamorro', long: TimeZoneName(standard: 'Чаморо вријеме')),
    ...
    'Davis': MetaZone('Davis', long: TimeZoneName(standard: 'Дејвис вријеме')),
    ...
    'Ecuador':
        MetaZone('Ecuador', long: TimeZoneName(standard: 'Еквадор вријеме')),
    ...
    'French_Southern': MetaZone('French_Southern',
        long: TimeZoneName(standard: 'Француско јужно и антарктичко вријеме')),
    'Galapagos': MetaZone('Galapagos',
        long: TimeZoneName(standard: 'Галапагос вријеме')),
    'Gambier':
        MetaZone('Gambier', long: TimeZoneName(standard: 'Гамбије вријеме')),
    ...
    'Gulf': MetaZone('Gulf', long: TimeZoneName(standard: 'Заливско вријеме')),
    'Guyana':
        MetaZone('Guyana', long: TimeZoneName(standard: 'Гвајана вријеме')),
    ...
    'Indochina':
        MetaZone('Indochina', long: TimeZoneName(standard: 'Индокина вријеме')),
    ...
    'Kosrae': MetaZone('Kosrae', long: TimeZoneName(standard: 'Кошре вријеме')),
    ...
    'Malaysia':
        MetaZone('Malaysia', long: TimeZoneName(standard: 'Малезија вријеме')),
    'Maldives':
        MetaZone('Maldives', long: TimeZoneName(standard: 'Малдиви вријеме')),
    'Marquesas':
        MetaZone('Marquesas', long: TimeZoneName(standard: 'Маркиз вријеме')),
    ...
    'Mawson': MetaZone('Mawson', long: TimeZoneName(standard: 'Мосон вријеме')),
    ...
    'Myanmar':
        MetaZone('Myanmar', long: TimeZoneName(standard: 'Мјанмар вријеме')),
    'Nauru': MetaZone('Nauru', long: TimeZoneName(standard: 'Науру вријеме')),
    'Nepal': MetaZone('Nepal', long: TimeZoneName(standard: 'Непал вријеме')),
    ...
    'Niue': MetaZone('Niue', long: TimeZoneName(standard: 'Нијуе вријеме')),
    ...
    'Palau': MetaZone('Palau', long: TimeZoneName(standard: 'Палау вријеме')),
    ...
    'Pitcairn':
        MetaZone('Pitcairn', long: TimeZoneName(standard: 'Питкерн вријеме')),
    'Ponape':
        MetaZone('Ponape', long: TimeZoneName(standard: 'Понпеј вријеме')),
    ...
    'Reunion':
        MetaZone('Reunion', long: TimeZoneName(standard: 'Реунион вријеме')),
    'Rothera':
        MetaZone('Rothera', long: TimeZoneName(standard: 'Ротера вријеме')),
    ...
    'Seychelles':
        MetaZone('Seychelles', long: TimeZoneName(standard: 'Сејшели вријеме')),
    ...
    'Suriname':
        MetaZone('Suriname', long: TimeZoneName(standard: 'Суринам вријеме')),
    'Syowa': MetaZone('Syowa', long: TimeZoneName(standard: 'Шова вријеме')),
    'Tahiti':
        MetaZone('Tahiti', long: TimeZoneName(standard: 'Тахити вријеме')),
    ...
    'Tokelau':
        MetaZone('Tokelau', long: TimeZoneName(standard: 'Токелау вријеме')),
    ...
    'Tuvalu':
        MetaZone('Tuvalu', long: TimeZoneName(standard: 'Тувалу вријеме')),
    ...
    'Vostok':
        MetaZone('Vostok', long: TimeZoneName(standard: 'Восток вријеме')),
    'Wake':
        MetaZone('Wake', long: TimeZoneName(standard: 'острво Вејк вријеме')),
...
class LocaleDisplayNameSrCyrlBA extends LocaleDisplayName {
  const LocaleDisplayNameSrCyrlBA._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
