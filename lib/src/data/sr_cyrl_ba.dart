...
class CommonLocaleDataSrCyrlBA implements CommonLocaleData {
  ...
  const CommonLocaleDataSrCyrlBA();

  static final _dateFields = DateFieldsSrCyrlBA._();
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesSrCyrlBA._();
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsSrCyrlBA._();
  @override
  Scripts get scripts => _scripts;

  static final _variants = VariantsSrCyrlBA._();
  @override
  Variants get variants => _variants;

  static final _units = UnitsSrCyrlBA._();
  @override
  Units get units => _units;

  static final _territories = TerritoriesSrCyrlBA._();
  @override
  Territories get territories => _territories;

  static final _timeZones = TimeZonesSrCyrlBA._(_territories);
  @override
  TimeZones get timeZones => _timeZones;

  static final _listPatterns = ListPatternsSrCyrlBA._();
  @override
  ListPatterns get listPatterns => _listPatterns;

  static final _calendar = CalendarSrCyrlBA._();
  @override
  Calendar get calendar => _calendar;

  static final _currencies = CurrenciesSrCyrlBA._();
  @override
...
class UnitsSrCyrlBA implements Units {
  UnitsSrCyrlBA._();
...
class DateFieldsSrCyrlBA implements DateFields {
  DateFieldsSrCyrlBA._();
...
class TerritoriesSrCyrlBA implements Territories {
  TerritoriesSrCyrlBA._();
...
class TimeZonesSrCyrlBA extends TimeZones {
  TimeZonesSrCyrlBA._(Territories territories)
  ...
  final timeZoneNames = CanonicalizedMap<String, String, TimeZoneNames>.from({
    ...
    'America/North_Dakota/Beulah': TimeZoneNames(
      exemplarCity: 'Бјула, Сјеверна Дакота',
    ),
    'America/North_Dakota/New_Salem': TimeZoneNames(
      exemplarCity: 'Нови Салем, Сјеверна Дакота',
    ),
    'America/North_Dakota/Center': TimeZoneNames(
      exemplarCity: 'Центар, Сјеверна Дакота',
    ),
    ...
    'Europe/Dublin': TimeZoneNames(
      long: TimeZoneName(
        daylight: 'Ирска, стандардно вријеме',
      ),
      exemplarCity: 'Даблин',
    ),
    ...
    'Europe/London': TimeZoneNames(
      long: TimeZoneName(
        daylight: 'Британија, љетње вријеме',
      ),
      exemplarCity: 'Лондон',
    ),
    ...
    'Etc/UTC': TimeZoneNames(
      long: TimeZoneName(
        standard: 'Координисано универзално вријеме',
      ),
      short: TimeZoneName(
        standard: 'UTC',
      ),
  ...
  final metaZoneNames = CanonicalizedMap<String, String, MetaZone>.from({
    ...
    'Afghanistan': MetaZone(
      code: 'Afghanistan',
      long: TimeZoneName(
        standard: 'Авганистан вријеме',
      ),
    ),
    'Africa_Central': MetaZone(
      code: 'Africa_Central',
      long: TimeZoneName(
        standard: 'Централно-афричко вријеме',
      ),
    ),
    'Africa_Eastern': MetaZone(
      code: 'Africa_Eastern',
      long: TimeZoneName(
        standard: 'Источно-афричко вријеме',
      ),
    ),
    'Africa_Southern': MetaZone(
      code: 'Africa_Southern',
      long: TimeZoneName(
        standard: 'Јужно-афричко вријеме',
      ),
    ),
    ...
    'Bhutan': MetaZone(
      code: 'Bhutan',
      long: TimeZoneName(
        standard: 'Бутан вријеме',
      ),
    ),
    'Bolivia': MetaZone(
      code: 'Bolivia',
      long: TimeZoneName(
        standard: 'Боливија вријеме',
      ),
    ),
    'Brasilia': MetaZone(
      code: 'Brasilia',
    ...
    'Brunei': MetaZone(
      code: 'Brunei',
      long: TimeZoneName(
        standard: 'Брунеј Дарусалум вријеме',
      ),
    ),
    'Cape_Verde': MetaZone(
      code: 'Cape_Verde',
    ...
    'Christmas': MetaZone(
      code: 'Christmas',
      long: TimeZoneName(
        standard: 'Божићно острво вријеме',
      ),
    ),
    'Cocos': MetaZone(
      code: 'Cocos',
      long: TimeZoneName(
        standard: 'Кокосова (Килинг) острва вријеме',
      ),
    ),
    'Colombia': MetaZone(
      code: 'Colombia',
    ...
    'Davis': MetaZone(
      code: 'Davis',
      long: TimeZoneName(
        standard: 'Дејвис вријеме',
      ),
    ),
    'DumontDUrville': MetaZone(
      code: 'DumontDUrville',
      long: TimeZoneName(
        standard: 'Димон д’Ирвил вријеме',
      ),
    ),
    'East_Timor': MetaZone(
      code: 'East_Timor',
      long: TimeZoneName(
        standard: 'Источни Тимор вријеме',
      ),
    ),
    'Easter': MetaZone(
      code: 'Easter',
    ...
    'French_Guiana': MetaZone(
      code: 'French_Guiana',
      long: TimeZoneName(
        standard: 'Француска Гвајана вријеме',
      ),
    ),
    ...
    'Galapagos': MetaZone(
      code: 'Galapagos',
      long: TimeZoneName(
        standard: 'Галапагос вријеме',
      ),
    ),
    'Gambier': MetaZone(
      code: 'Gambier',
      long: TimeZoneName(
        standard: 'Гамбије вријеме',
      ),
    ),
    'Georgia': MetaZone(
      code: 'Georgia',
    ...
    'Gilbert_Islands': MetaZone(
      ...
      long: TimeZoneName(
        standard: 'Гилбертова острва вријеме',
      ),
    ),
    'GMT': MetaZone(
      code: 'GMT',
      long: TimeZoneName(
        standard: 'Средње вријеме по Гриничу',
      ),
      short: TimeZoneName(
        standard: 'GMT',
      ),
    ...
    'Gulf': MetaZone(
      code: 'Gulf',
      long: TimeZoneName(
        standard: 'Заливско вријеме',
      ),
    ),
    'Guyana': MetaZone(
      code: 'Guyana',
      long: TimeZoneName(
        standard: 'Гвајана вријеме',
      ),
    ),
    ...
    'India': MetaZone(
      code: 'India',
      long: TimeZoneName(
        standard: 'Индијско стандардно вријеме',
      ),
    ),
    'Indian_Ocean': MetaZone(
      code: 'Indian_Ocean',
      long: TimeZoneName(
        standard: 'Индијско океанско вријеме',
      ),
    ),
    'Indochina': MetaZone(
      code: 'Indochina',
      long: TimeZoneName(
        standard: 'Индокина вријеме',
      ),
    ),
    'Indonesia_Central': MetaZone(
      code: 'Indonesia_Central',
      long: TimeZoneName(
        standard: 'Централно-индонезијско вријеме',
      ),
    ),
    'Indonesia_Eastern': MetaZone(
      code: 'Indonesia_Eastern',
      long: TimeZoneName(
        standard: 'Источно-индонезијско вријеме',
      ),
    ),
    'Indonesia_Western': MetaZone(
      code: 'Indonesia_Western',
      long: TimeZoneName(
        standard: 'Западно-индонезијско вријеме',
      ),
    ),
    'Iran': MetaZone(
      code: 'Iran',
    ...
    'Kazakhstan': MetaZone(
      code: 'Kazakhstan',
      long: TimeZoneName(
        standard: 'Казахстанско вријеме',
      ),
    ),
    'Kazakhstan_Eastern': MetaZone(
      code: 'Kazakhstan_Eastern',
      long: TimeZoneName(
        standard: 'Источно-казахстанско вријеме',
      ),
    ),
    'Kazakhstan_Western': MetaZone(
      code: 'Kazakhstan_Western',
      long: TimeZoneName(
        standard: 'Западно-казахстанско вријеме',
      ),
    ),
    'Korea': MetaZone(
      code: 'Korea',
    ...
    'Line_Islands': MetaZone(
      code: 'Line_Islands',
      long: TimeZoneName(
        standard: 'Линијска острва вријеме',
      ),
    ),
    'Lord_Howe': MetaZone(
      code: 'Lord_Howe',
    ...
    'Malaysia': MetaZone(
      code: 'Malaysia',
      long: TimeZoneName(
        standard: 'Малезија вријеме',
      ),
    ),
    'Maldives': MetaZone(
      code: 'Maldives',
      long: TimeZoneName(
        standard: 'Малдиви вријеме',
      ),
    ),
    'Marquesas': MetaZone(
      code: 'Marquesas',
      long: TimeZoneName(
        standard: 'Маркиз вријеме',
      ),
    ),
    'Marshall_Islands': MetaZone(
      code: 'Marshall_Islands',
      long: TimeZoneName(
        standard: 'Маршалска Острва вријеме',
      ),
    ),
    'Mauritius': MetaZone(
      code: 'Mauritius',
    ...
    'Myanmar': MetaZone(
      code: 'Myanmar',
      long: TimeZoneName(
        standard: 'Мјанмар вријеме',
      ),
    ),
    'Nauru': MetaZone(
      code: 'Nauru',
      long: TimeZoneName(
        standard: 'Науру вријеме',
      ),
    ),
    'Nepal': MetaZone(
      code: 'Nepal',
      long: TimeZoneName(
        standard: 'Непал вријеме',
      ),
    ),
    ...
    'Palau': MetaZone(
      code: 'Palau',
      long: TimeZoneName(
        standard: 'Палау вријеме',
      ),
    ),
    'Papua_New_Guinea': MetaZone(
      code: 'Papua_New_Guinea',
      long: TimeZoneName(
        standard: 'Папуа Нова Гвинеја вријеме',
      ),
    ),
    'Paraguay': MetaZone(
      code: 'Paraguay',
    ...
    'Phoenix_Islands': MetaZone(
      ...
      long: TimeZoneName(
        standard: 'Феникс острва вријеме',
      ),
    ),
    ...
    'Pitcairn': MetaZone(
      code: 'Pitcairn',
      long: TimeZoneName(
        standard: 'Питкерн вријеме',
      ),
    ),
    'Ponape': MetaZone(
      code: 'Ponape',
      long: TimeZoneName(
        standard: 'Понпеј вријеме',
      ),
    ),
    'Pyongyang': MetaZone(
      code: 'Pyongyang',
      long: TimeZoneName(
        standard: 'Пјонгјаншко вријеме',
      ),
    ),
    'Qyzylorda': MetaZone(
      code: 'Qyzylorda',
    ...
    'Reunion': MetaZone(
      code: 'Reunion',
      long: TimeZoneName(
        standard: 'Реунион вријеме',
      ),
    ),
    'Rothera': MetaZone(
      code: 'Rothera',
      long: TimeZoneName(
        standard: 'Ротера вријеме',
      ),
    ),
    'Sakhalin': MetaZone(
      code: 'Sakhalin',
    ...
    'Seychelles': MetaZone(
      code: 'Seychelles',
      long: TimeZoneName(
        standard: 'Сејшели вријеме',
      ),
    ),
    'Singapore': MetaZone(
      code: 'Singapore',
      long: TimeZoneName(
        standard: 'Сингапур, стандардно вријеме',
      ),
    ),
    'Solomon': MetaZone(
      code: 'Solomon',
      long: TimeZoneName(
        standard: 'Соломонска Острва вријеме',
      ),
    ),
    'South_Georgia': MetaZone(
      code: 'South_Georgia',
      long: TimeZoneName(
        standard: 'Јужна Џорџија вријеме',
      ),
    ),
    'Suriname': MetaZone(
      code: 'Suriname',
      long: TimeZoneName(
        standard: 'Суринам вријеме',
      ),
    ),
    'Syowa': MetaZone(
      code: 'Syowa',
      long: TimeZoneName(
        standard: 'Шова вријеме',
      ),
    ),
    'Tahiti': MetaZone(
      code: 'Tahiti',
      long: TimeZoneName(
        standard: 'Тахити вријеме',
      ),
    ),
    'Taipei': MetaZone(
      code: 'Taipei',
    ...
    'Tajikistan': MetaZone(
      code: 'Tajikistan',
      long: TimeZoneName(
        standard: 'Таџикистан вријеме',
      ),
    ),
    'Tokelau': MetaZone(
      code: 'Tokelau',
      long: TimeZoneName(
        standard: 'Токелау вријеме',
      ),
    ),
    'Tonga': MetaZone(
      code: 'Tonga',
    ...
    'Vostok': MetaZone(
      code: 'Vostok',
      long: TimeZoneName(
        standard: 'Восток вријеме',
      ),
    ),
    'Wake': MetaZone(
      code: 'Wake',
      long: TimeZoneName(
        standard: 'острво Вејк вријеме',
      ),
    ),
    'Wallis': MetaZone(
      code: 'Wallis',
      long: TimeZoneName(
        standard: 'острва Валис и Футуна вријеме',
      ),
    ),
    'Yakutsk': MetaZone(
      code: 'Yakutsk',
...
class ListPatternsSrCyrlBA extends ListPatterns {
  ListPatternsSrCyrlBA._();
...
class CalendarSrCyrlBA extends Calendar {
  CalendarSrCyrlBA._();
