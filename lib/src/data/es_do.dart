...
const _locale = 'es-DO';
const _cld = CommonLocaleDataEsDO.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEsDO extends CommonLocaleDataEs {
  @override
  String get locale => _locale;

  const CommonLocaleDataEsDO.constant() : super.constant();

  factory CommonLocaleDataEsDO() => _cld;
  ...
  static final _units = UnitsEsDO(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEsDO(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEsDO(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsEsDO(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesEsDO(_cld);
  @override
  Territories get territories => _territories;

  static final _currencies = CurrenciesEsDO(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEsDO(_cld);
  @override
...
class UnitsEsDO extends UnitsEs {
  ...
  Unit get accelerationGForce => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'G', one: '{0}Fg', other: '{0}Fg'),
  );
  ...
  Unit get angleDegree => const Unit(
    ...
    short: UnitCountPattern(_locale, 'grados', one: '{0} grado', other: '{0}°'),
  ...
  Unit get digitalByte => const Unit(
    ...
    short: UnitCountPattern(_locale, 'B', one: '{0} byte', other: '{0} byte'),
  ...
  Unit get durationYear => const Unit(
    ...
    short: UnitCountPattern(_locale, 'aa.', one: '{0} a.', other: '{0} aa.'),
    narrow: UnitCountPattern(_locale, 'a.', one: '{0}a.', other: '{0}aa.'),
  );
  ...
  Unit get durationMonth => const Unit(
    ...
    short: UnitCountPattern(_locale, 'mm.', one: '{0} m.', other: '{0} mm.'),
  ...
  Unit get durationDay => const Unit(
    ...
    short: UnitCountPattern(_locale, 'd.', one: '{0} d.', other: '{0} dd.'),
  ...
  Unit get electricVolt => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'voltios', one: '{0}V', other: '{0}V'),
  );
  ...
  Unit get lengthYard => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'yardas', one: '{0}yd', other: '{0}yd'),
  );
  ...
  Unit get powerWatt => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'vatios', one: '{0}W', other: '{0}W'),
  );
  ...
  Unit get volumePint => const Unit(
    ...
    short: UnitCountPattern(_locale, 'pintas', one: '{0} pt', other: '{0} pt'),
...
class DateFieldsEsDO extends DateFieldsEs {
  const DateFieldsEsDO(super.cld);
...
class LanguagesEsDO extends LanguagesEs {
  const LanguagesEsDO(super.cld);
...
class ScriptsEsDO extends ScriptsEs {
  const ScriptsEsDO(super.cld);
...
class TerritoriesEsDO extends TerritoriesEs {
  const TerritoriesEsDO(super.cld);
...
class CurrenciesEsDO extends CurrenciesEs {
  const CurrenciesEsDO(super.cld);
...
class TimeZonesEsDO extends TimeZonesEs {
  const TimeZonesEsDO(super.cld);
...
class LocaleDisplayNameEsDO extends LocaleDisplayNameEs {
  const LocaleDisplayNameEsDO(super.cld);
