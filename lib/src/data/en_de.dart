...
const _locale = 'en-DE';
const _cld = CommonLocaleDataEnDE.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEnDE extends CommonLocaleDataEn {
  @override
  String get locale => _locale;

  const CommonLocaleDataEnDE.constant() : super.constant();

  factory CommonLocaleDataEnDE() => _cld;
  ...
  static final _units = UnitsEnDE(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEnDE(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEnDE(_cld);
  @override
  Languages get languages => _languages;

  static final _territories = TerritoriesEnDE(_cld);
  @override
  Territories get territories => _territories;

  static final _currencies = CurrenciesEnDE(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEnDE(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEnDE(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEnDE extends UnitsEn {
  const UnitsEnDE(super.cld);
...
class DateFieldsEnDE extends DateFieldsEn {
  const DateFieldsEnDE(super.cld);
...
class LanguagesEnDE extends LanguagesEn {
  const LanguagesEnDE(super.cld);
...
class TerritoriesEnDE extends TerritoriesEn {
  const TerritoriesEnDE(super.cld);
...
class CurrenciesEnDE extends CurrenciesEn {
  const CurrenciesEnDE(super.cld);
...
class TimeZonesEnDE extends TimeZonesEn {
  const TimeZonesEnDE(super.cld);
...
class LocaleDisplayNameEnDE extends LocaleDisplayNameEn {
  const LocaleDisplayNameEnDE(super.cld);
