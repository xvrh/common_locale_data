...
const _cld = CommonLocaleDataSrCyrlME._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataSrCyrlME implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataSrCyrlME._();
  ...
  static final _units = UnitsSrCyrlME._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsSrCyrlME._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesSrCyrlME._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsSrCyrlME._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesSrCyrlME._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsSrCyrlME._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsSrCyrlME._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesSrCyrlME._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesSrCyrlME._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameSrCyrlME._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsSrCyrlME extends Units {
  UnitsSrCyrlME._(super.cld);
...
class DateFieldsSrCyrlME extends DateFields {
  DateFieldsSrCyrlME._(super.cld);
...
class LanguagesSrCyrlME extends Languages {
  const LanguagesSrCyrlME._(super.cld);
...
class ScriptsSrCyrlME extends Scripts {
  const ScriptsSrCyrlME._(super.cld);
...
class TerritoriesSrCyrlME extends Territories {
  const TerritoriesSrCyrlME._(super.cld);
...
class VariantsSrCyrlME extends Variants {
  const VariantsSrCyrlME._(super.cld);
...
class SubdivisionsSrCyrlME extends Subdivisions {
  const SubdivisionsSrCyrlME._(super.cld);
...
class CurrenciesSrCyrlME extends Currencies {
  const CurrenciesSrCyrlME._(super.cld);
...
class TimeZonesSrCyrlME extends TimeZones {
  const TimeZonesSrCyrlME._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
            regionFormat: '{0}',
...
class LocaleDisplayNameSrCyrlME extends LocaleDisplayName {
  const LocaleDisplayNameSrCyrlME._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
