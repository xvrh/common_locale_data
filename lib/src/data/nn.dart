...
class CommonLocaleDataNn implements CommonLocaleData {
  ...
  static final _scripts = ScriptsNn._();
  @override
  Scripts get scripts => _scripts;

  static final _variants = VariantsNn._();
  @override
  ...
  static final _timeZones = TimeZonesNn._(_territories);
  @override
  TimeZones get timeZones => _timeZones;

  static final _listPatterns = ListPatternsNn._();
  @override
  ListPatterns get listPatterns => _listPatterns;

  static final _calendar = CalendarNn._();
  @override
  Calendar get calendar => _calendar;

  static final _currencies = CurrenciesNn._();
  @override
...
class TimeZonesNn extends TimeZones {
  TimeZonesNn._(Territories territories)
  ...
  final timeZoneNames = CanonicalizedMap<String, String, TimeZoneNames>.from({
    ...
    'Atlantic/Azores': TimeZoneNames(
      exemplarCity: 'Asorane',
    ),
    'Atlantic/Canary': TimeZoneNames(
      exemplarCity: 'Kanariøyane',
    ),
    'Atlantic/Cape_Verde': TimeZoneNames(
      exemplarCity: 'Kapp Verde',
    ),
    'Atlantic/Faeroe': TimeZoneNames(
      exemplarCity: 'Færøyane',
    ),
    ...
    'Indian/Cocos': TimeZoneNames(
      exemplarCity: 'Kokosøyane',
    ),
    'Indian/Comoro': TimeZoneNames(
      exemplarCity: 'Komorane',
    ),
    'Indian/Mahe': TimeZoneNames(
      exemplarCity: 'Mahé',
    ),
    'Indian/Maldives': TimeZoneNames(
      exemplarCity: 'Maldivane',
    ),
    ...
    'Pacific/Kanton': TimeZoneNames(
      exemplarCity: 'Kantonøya',
    ),
    'Pacific/Norfolk': TimeZoneNames(
      exemplarCity: 'Norfolkøya',
    ),
  ...
  final metaZoneNames = CanonicalizedMap<String, String, MetaZone>.from({
    ...
    'Cocos': MetaZone(
      code: 'Cocos',
      long: TimeZoneName(
        standard: 'tidssone for Kokosøyane',
      ),
    ),
    'Colombia': MetaZone(
      code: 'Colombia',
    ...
    'Europe_Further_Eastern': MetaZone(
      ...
      long: TimeZoneName(
        standard: 'fjern-austeuropeisk tid',
      ),
    ),
    ...
    'French_Southern': MetaZone(
      ...
      long: TimeZoneName(
        standard: 'tidssone for Dei franske sørterritoria',
      ),
    ),
    'Galapagos': MetaZone(
      code: 'Galapagos',
      long: TimeZoneName(
        standard: 'tidssone for Galápagosøyane',
      ),
    ),
    'Gambier': MetaZone(
      code: 'Gambier',
    ...
    'Gilbert_Islands': MetaZone(
      ...
      long: TimeZoneName(
        standard: 'tidssone for Gilbertøyane',
      ),
    ),
    'GMT': MetaZone(
      code: 'GMT',
    ...
    'Line_Islands': MetaZone(
      code: 'Line_Islands',
      long: TimeZoneName(
        standard: 'tidssone for Lineøyane',
      ),
    ),
    'Lord_Howe': MetaZone(
      code: 'Lord_Howe',
    ...
    'Marquesas': MetaZone(
      code: 'Marquesas',
      long: TimeZoneName(
        standard: 'tidssone for Marquesasøyane',
      ),
    ),
    ...
    'Phoenix_Islands': MetaZone(
      ...
      long: TimeZoneName(
        standard: 'tidssone for Phoenixøyane',
      ),
    ),
    ...
    'Truk': MetaZone(
      code: 'Truk',
      long: TimeZoneName(
        standard: 'tidssone for Chuukøyane',
      ),
    ),
    ...
    'Wallis': MetaZone(
      code: 'Wallis',
      long: TimeZoneName(
        standard: 'tidssone for Wallis- og Futunaøyane',
      ),
    ),
    'Yakutsk': MetaZone(
      code: 'Yakutsk',
...
class CalendarNn extends Calendar {
  CalendarNn._();
