...
const _locale = 'de-CH';
const _cld = CommonLocaleDataDeCH._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataDeCH implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataDeCH._();
  ...
  static final _units = UnitsDeCH._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsDeCH._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesDeCH._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsDeCH._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesDeCH._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsDeCH._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsDeCH._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesDeCH._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesDeCH._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameDeCH._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsDeCH extends Units {
  UnitsDeCH._(super.cld);
...
class DateFieldsDeCH extends DateFields {
  DateFieldsDeCH._(super.cld);
...
class LanguagesDeCH extends Languages {
  const LanguagesDeCH._(super.cld);
...
class ScriptsDeCH extends Scripts {
  const ScriptsDeCH._(super.cld);
...
class TerritoriesDeCH extends Territories {
  const TerritoriesDeCH._(super.cld);
...
class VariantsDeCH extends Variants {
  const VariantsDeCH._(super.cld);
...
class SubdivisionsDeCH extends Subdivisions {
  const SubdivisionsDeCH._(super.cld);
...
class CurrenciesDeCH extends Currencies {
  const CurrenciesDeCH._(super.cld);
...
class TimeZonesDeCH extends TimeZones {
  const TimeZonesDeCH._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
  ...
  final metaZoneNames = const {
    ...
    'Solomon':
        MetaZone('Solomon', long: TimeZoneName(standard: 'Salomoninseln-Zeit')),
...
class LocaleDisplayNameDeCH extends LocaleDisplayName {
  const LocaleDisplayNameDeCH._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
