...
const _locale = 'es-VE';
const _cld = CommonLocaleDataEsVE.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEsVE extends CommonLocaleDataEs {
  @override
  String get locale => _locale;

  const CommonLocaleDataEsVE.constant() : super.constant();

  factory CommonLocaleDataEsVE() => _cld;
  ...
  static final _units = UnitsEsVE(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEsVE(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEsVE(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsEsVE(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesEsVE(_cld);
  @override
  Territories get territories => _territories;

  static final _currencies = CurrenciesEsVE(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEsVE(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEsVE(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEsVE extends UnitsEs {
  const UnitsEsVE(super.cld);
  ...
  Unit get durationMonth => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'm.', one: '{0}m.', other: '{0}mm.'),
  );
  ...
  Unit get durationDay => const Unit(
    ...
    short: UnitCountPattern(_locale, 'dd.', one: '{0} d.', other: '{0} dd.'),
    narrow: UnitCountPattern(_locale, 'd.', one: '{0}d.', other: '{0}dd.'),
  );
...
class DateFieldsEsVE extends DateFieldsEs {
  const DateFieldsEsVE(super.cld);
...
class LanguagesEsVE extends LanguagesEs {
  const LanguagesEsVE(super.cld);
...
class ScriptsEsVE extends ScriptsEs {
  const ScriptsEsVE(super.cld);
...
class TerritoriesEsVE extends TerritoriesEs {
  const TerritoriesEsVE(super.cld);
...
class CurrenciesEsVE extends CurrenciesEs {
  const CurrenciesEsVE(super.cld);
...
class TimeZonesEsVE extends TimeZonesEs {
  const TimeZonesEsVE(super.cld);
...
class LocaleDisplayNameEsVE extends LocaleDisplayNameEs {
  const LocaleDisplayNameEsVE(super.cld);
