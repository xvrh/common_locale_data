...
const _locale = 'fr-SC';
const _cld = CommonLocaleDataFrSC._();
...
class CommonLocaleDataFrSC implements CommonLocaleData {
  ...
  static final _units = UnitsFrSC._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsFrSC._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesFrSC._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsFrSC._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesFrSC._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsFrSC._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsFrSC._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesFrSC._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesFrSC._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameFrSC._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsFrSC extends Units {
  UnitsFrSC._(super.cld);
...
class DateFieldsFrSC extends DateFields {
  DateFieldsFrSC._(super.cld);
...
class LanguagesFrSC extends Languages {
  const LanguagesFrSC._(super.cld);
...
class ScriptsFrSC extends Scripts {
  const ScriptsFrSC._(super.cld);
...
class TerritoriesFrSC extends Territories {
  const TerritoriesFrSC._(super.cld);
...
class VariantsFrSC extends Variants {
  const VariantsFrSC._(super.cld);
...
class SubdivisionsFrSC extends Subdivisions {
  const SubdivisionsFrSC._(super.cld);
...
class CurrenciesFrSC extends Currencies {
  const CurrenciesFrSC._(super.cld);
...
class TimeZonesFrSC extends TimeZones {
  const TimeZonesFrSC._(super.cld)
      : super(
            gmtFormat: 'UTC{0}',
            gmtZeroFormat: 'UTC',
...
class LocaleDisplayNameFrSC extends LocaleDisplayName {
  const LocaleDisplayNameFrSC._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
