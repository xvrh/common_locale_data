...
const _cld = CommonLocaleDataPaGuru._();
...
class CommonLocaleDataPaGuru implements CommonLocaleData {
  ...
  const CommonLocaleDataPaGuru._();
  ...
  static final _units = UnitsPaGuru._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsPaGuru._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesPaGuru._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsPaGuru._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesPaGuru._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsPaGuru._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsPaGuru._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesPaGuru._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesPaGuru._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNamePaGuru._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsPaGuru extends Units {
  UnitsPaGuru._(super.cld);
...
class LanguagesPaGuru extends Languages {
  const LanguagesPaGuru._(super.cld);
...
class ScriptsPaGuru extends Scripts {
  const ScriptsPaGuru._(super.cld);
...
class TerritoriesPaGuru extends Territories {
  const TerritoriesPaGuru._(super.cld);
...
class VariantsPaGuru extends Variants {
  const VariantsPaGuru._(super.cld);
...
class SubdivisionsPaGuru extends Subdivisions {
  const SubdivisionsPaGuru._(super.cld);
...
class CurrenciesPaGuru extends Currencies {
  const CurrenciesPaGuru._(super.cld);
...
class TimeZonesPaGuru extends TimeZones {
  const TimeZonesPaGuru._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
            regionFormat: '{0} ਵੇਲਾ',
...
class LocaleDisplayNamePaGuru extends LocaleDisplayName {
  const LocaleDisplayNamePaGuru._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
            localeKeyTypePattern: '{0}: {1}',
            codePatternLanguage: 'ਬੋਲੀ: {0}',
            codePatternScript: 'ਲਿਪੀ: {0}',
            codePatternTerritory: 'ਇਲਾਕਾ: {0}');
