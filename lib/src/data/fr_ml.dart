...
const _locale = 'fr-ML';
const _cld = CommonLocaleDataFrML._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataFrML implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataFrML._();
  ...
  static final _units = UnitsFrML._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsFrML._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesFrML._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsFrML._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesFrML._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsFrML._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsFrML._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesFrML._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesFrML._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameFrML._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsFrML extends Units {
  UnitsFrML._(super.cld);
...
class DateFieldsFrML extends DateFields {
  DateFieldsFrML._(super.cld);
...
class LanguagesFrML extends Languages {
  const LanguagesFrML._(super.cld);
...
class ScriptsFrML extends Scripts {
  const ScriptsFrML._(super.cld);
...
class TerritoriesFrML extends Territories {
  const TerritoriesFrML._(super.cld);
...
class VariantsFrML extends Variants {
  const VariantsFrML._(super.cld);
...
class SubdivisionsFrML extends Subdivisions {
  const SubdivisionsFrML._(super.cld);
...
class CurrenciesFrML extends Currencies {
  const CurrenciesFrML._(super.cld);
...
class TimeZonesFrML extends TimeZones {
  const TimeZonesFrML._(super.cld)
      : super(
            gmtFormat: 'UTC{0}',
            gmtZeroFormat: 'UTC',
...
class LocaleDisplayNameFrML extends LocaleDisplayName {
  const LocaleDisplayNameFrML._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
