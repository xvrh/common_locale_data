...
const _locale = 'pt-CV';
const _cld = CommonLocaleDataPtCV.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataPtCV extends CommonLocaleDataPt {
  @override
  String get locale => _locale;

  const CommonLocaleDataPtCV.constant() : super.constant();

  factory CommonLocaleDataPtCV() => _cld;
  ...
  static final _units = UnitsPtCV(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsPtCV(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesPtCV(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsPtCV(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesPtCV(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsPtCV(_cld);
  @override
  Variants get variants => _variants;

  static final _currencies = CurrenciesPtCV(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesPtCV(_cld);
  @override
...
class DateFieldsPtCV extends DateFieldsPt {
  const DateFieldsPtCV(super.cld);
...
class LanguagesPtCV extends LanguagesPt {
  const LanguagesPtCV(super.cld);
...
class ScriptsPtCV extends ScriptsPt {
  const ScriptsPtCV(super.cld);
...
class TerritoriesPtCV extends TerritoriesPt {
  const TerritoriesPtCV(super.cld);
...
class VariantsPtCV extends VariantsPt {
  const VariantsPtCV(super.cld);
...
class CurrenciesPtCV extends CurrenciesPt {
  const CurrenciesPtCV(super.cld);
...
class TimeZonesPtCV extends TimeZonesPt {
  const TimeZonesPtCV(super.cld);
  ...
  Map<String, MetaZone> get metaZoneNames => Map.unmodifiable({
    ...
    ...const {
      ...
      'Azores': MetaZone(
        ...
        short: TimeZoneName(generic: 'AZOT'),
      ),
      'Bangladesh': MetaZone(
        'Bangladesh',
        long: TimeZoneName(
...
class LocaleDisplayNamePtCV extends LocaleDisplayNamePt {
  const LocaleDisplayNamePtCV(super.cld);
