...
const _locale = 'en-MG';
const _cld = CommonLocaleDataEnMG.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEnMG extends CommonLocaleDataEn {
  @override
  String get locale => _locale;

  const CommonLocaleDataEnMG.constant() : super.constant();

  factory CommonLocaleDataEnMG() => _cld;
  ...
  static final _units = UnitsEnMG(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEnMG(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEnMG(_cld);
  @override
  Languages get languages => _languages;

  static final _territories = TerritoriesEnMG(_cld);
  @override
  Territories get territories => _territories;

  static final _currencies = CurrenciesEnMG(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEnMG(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEnMG(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEnMG extends UnitsEn {
  const UnitsEnMG(super.cld);
...
class DateFieldsEnMG extends DateFieldsEn {
  const DateFieldsEnMG(super.cld);
...
class LanguagesEnMG extends LanguagesEn {
  const LanguagesEnMG(super.cld);
...
class TerritoriesEnMG extends TerritoriesEn {
  const TerritoriesEnMG(super.cld);
...
class CurrenciesEnMG extends CurrenciesEn {
  const CurrenciesEnMG(super.cld);
...
class TimeZonesEnMG extends TimeZonesEn {
  const TimeZonesEnMG(super.cld);
...
class LocaleDisplayNameEnMG extends LocaleDisplayNameEn {
  const LocaleDisplayNameEnMG(super.cld);
