...
const _locale = 'en-MG';
const _cld = CommonLocaleDataEnMG._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEnMG implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataEnMG._();
  ...
  static final _units = UnitsEnMG._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEnMG._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEnMG._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsEnMG._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesEnMG._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsEnMG._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsEnMG._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesEnMG._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEnMG._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEnMG._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEnMG extends Units {
  UnitsEnMG._(super.cld);
...
class DateFieldsEnMG extends DateFields {
  DateFieldsEnMG._(super.cld);
...
class LanguagesEnMG extends Languages {
  const LanguagesEnMG._(super.cld);
...
class ScriptsEnMG extends Scripts {
  const ScriptsEnMG._(super.cld);
...
class TerritoriesEnMG extends Territories {
  const TerritoriesEnMG._(super.cld);
...
class VariantsEnMG extends Variants {
  const VariantsEnMG._(super.cld);
...
class SubdivisionsEnMG extends Subdivisions {
  const SubdivisionsEnMG._(super.cld);
...
class CurrenciesEnMG extends Currencies {
  const CurrenciesEnMG._(super.cld);
...
class TimeZonesEnMG extends TimeZones {
  const TimeZonesEnMG._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
            regionFormat: '{0} Time',
...
class LocaleDisplayNameEnMG extends LocaleDisplayName {
  const LocaleDisplayNameEnMG._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
