...
const _locale = 'sv-FI';
const _cld = CommonLocaleDataSvFI._();
...
class CommonLocaleDataSvFI implements CommonLocaleData {
  ...
  static final _units = UnitsSvFI._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsSvFI._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesSvFI._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsSvFI._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesSvFI._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsSvFI._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsSvFI._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesSvFI._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesSvFI._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameSvFI._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsSvFI extends Units {
  UnitsSvFI._(super.cld);
...
class DateFieldsSvFI extends DateFields {
  DateFieldsSvFI._(super.cld);
...
class LanguagesSvFI extends Languages {
  const LanguagesSvFI._(super.cld);
...
class TerritoriesSvFI extends Territories {
  const TerritoriesSvFI._(super.cld);
...
class VariantsSvFI extends Variants {
  const VariantsSvFI._(super.cld);
...
class SubdivisionsSvFI extends Subdivisions {
  const SubdivisionsSvFI._(super.cld);
...
class CurrenciesSvFI extends Currencies {
  const CurrenciesSvFI._(super.cld);
...
class TimeZonesSvFI extends TimeZones {
  const TimeZonesSvFI._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
            regionFormat: '{0}tid',
...
class LocaleDisplayNameSvFI extends LocaleDisplayName {
  const LocaleDisplayNameSvFI._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
