...
const _locale = 'hr';
const _cld = CommonLocaleDataHr.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataHr extends CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataHr.constant() : super.constant();
  ...
  static final _units = UnitsHr(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsHr(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesHr(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsHr(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesHr(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsHr(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsHr(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesHr(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesHr(_cld);
  @override
...
class DateFieldsHr extends DateFields {
  ...
  DateFieldFullData get year => const DateFieldFullData(
    displayName: MultiLength(long: 'godina', short: 'g.', narrow: 'g.'),
    previous: MultiLength(
      long: 'prošle godine',
      short: 'prošle god.',
      narrow: 'prošle g.',
    ),
    now: MultiLength(long: 'ove godine', short: 'ove god.', narrow: 'ove g.'),
    next: MultiLength(
  ...
  DateFieldFullData get month => const DateFieldFullData(
    displayName: MultiLength(long: 'mjesec', short: 'mj.', narrow: 'm.'),
    previous: MultiLength(
      long: 'prošli mjesec',
      short: 'prošli mj.',
      narrow: 'prošli mj.',
  ...
  DateFieldFullData get week => const DateFieldFullData(
    displayName: MultiLength(long: 'tjedan', short: 'tj.', narrow: 'tj.'),
    previous: MultiLength(
      long: 'prošli tjedan',
      short: 'prošli tj.',
      narrow: 'prošli tj.',
  ...
  DateFieldFullData get day => const DateFieldFullData(
    displayName: MultiLength(long: 'dan', short: 'd.', narrow: 'd.'),
  ...
  DateFieldDataTime get second => const DateFieldDataTime(
    ...
    now: MultiLength(long: 'sad', short: 'sad', narrow: 'sad'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
        one: 'prije {0} sekundu',
...
class SubdivisionsHr extends Subdivisions {
  const SubdivisionsHr(super.cld);
...
class TimeZonesHr extends TimeZones {
  ...
  static const staticMetaZoneNames = <String, MetaZone>{
    ...
    'Gambier': MetaZone(
      'Gambier',
      long: TimeZoneName(standard: 'vrijeme Gambiera'),
    ),
    'Georgia': MetaZone(
      'Georgia',
      long: TimeZoneName(
    ...
    'India': MetaZone(
      'India',
      long: TimeZoneName(standard: 'indijsko vrijeme'),
    ),
    ...
    'Kosrae': MetaZone(
      'Kosrae',
      long: TimeZoneName(standard: 'vrijeme Kosrae'),
    ),
    ...
    'Lanka': MetaZone(
      'Lanka',
      long: TimeZoneName(standard: 'lankansko vrijeme'),
    ),
    ...
    'Mawson': MetaZone(
      'Mawson',
      long: TimeZoneName(standard: 'mawsonsko vrijeme'),
    ),
    ...
    'Myanmar': MetaZone(
      'Myanmar',
      long: TimeZoneName(standard: 'mjanmarsko vrijeme'),
    ),
    ...
    'Ponape': MetaZone(
      'Ponape',
      long: TimeZoneName(standard: 'ponapejsko vrijeme'),
    ),
    'Pyongyang': MetaZone(
      'Pyongyang',
    ...
    'Reunion': MetaZone(
      'Reunion',
      long: TimeZoneName(standard: 'vrijeme Reuniona'),
    ),
    'Rothera': MetaZone(
      'Rothera',
      long: TimeZoneName(standard: 'vrijeme Rothere'),
    ),
    'Sakhalin': MetaZone(
      'Sakhalin',
      long: TimeZoneName(
    ...
    'Tahiti': MetaZone(
      'Tahiti',
      long: TimeZoneName(standard: 'vrijeme Tahitija'),
    ),
    'Taipei': MetaZone(
      'Taipei',
      long: TimeZoneName(
    ...
    'Tokelau': MetaZone(
      'Tokelau',
      long: TimeZoneName(standard: 'vrijeme Tokelaua'),
    ),
    'Tonga': MetaZone(
      'Tonga',
      long: TimeZoneName(
    ...
    'Tuvalu': MetaZone(
      'Tuvalu',
      long: TimeZoneName(standard: 'vrijeme Tuvalua'),
    ),
    'Uruguay': MetaZone(
      'Uruguay',
      long: TimeZoneName(
    ...
    'Vostok': MetaZone(
      'Vostok',
      long: TimeZoneName(standard: 'vostočko vrijeme'),
    ),
    'Wake': MetaZone(
      'Wake',
      long: TimeZoneName(standard: 'vrijeme Otoka Wake'),
    ),
    'Wallis': MetaZone(
      'Wallis',
    ...
    'Yukon': MetaZone(
      'Yukon',
      long: TimeZoneName(standard: 'jukonško vrijeme'),
    ),
  };
}

class LocaleDisplayNameHr extends LocaleDisplayName {
  const LocaleDisplayNameHr(super.cld);
