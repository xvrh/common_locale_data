...
const _locale = 'fr-TG';
const _cld = CommonLocaleDataFrTG._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataFrTG implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataFrTG._();
  ...
  static final _units = UnitsFrTG._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsFrTG._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesFrTG._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsFrTG._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesFrTG._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsFrTG._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsFrTG._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesFrTG._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesFrTG._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameFrTG._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsFrTG extends Units {
  UnitsFrTG._(super.cld);
...
class DateFieldsFrTG extends DateFields {
  DateFieldsFrTG._(super.cld);
...
class LanguagesFrTG extends Languages {
  const LanguagesFrTG._(super.cld);
...
class ScriptsFrTG extends Scripts {
  const ScriptsFrTG._(super.cld);
...
class TerritoriesFrTG extends Territories {
  const TerritoriesFrTG._(super.cld);
...
class VariantsFrTG extends Variants {
  const VariantsFrTG._(super.cld);
...
class SubdivisionsFrTG extends Subdivisions {
  const SubdivisionsFrTG._(super.cld);
...
class CurrenciesFrTG extends Currencies {
  const CurrenciesFrTG._(super.cld);
...
class TimeZonesFrTG extends TimeZones {
  const TimeZonesFrTG._(super.cld)
      : super(
            gmtFormat: 'UTC{0}',
            gmtZeroFormat: 'UTC',
...
class LocaleDisplayNameFrTG extends LocaleDisplayName {
  const LocaleDisplayNameFrTG._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
