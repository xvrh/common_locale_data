...
const _locale = 'es-UY';
const _cld = CommonLocaleDataEsUY.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEsUY extends CommonLocaleDataEs {
  @override
  String get locale => _locale;

  const CommonLocaleDataEsUY.constant() : super.constant();

  factory CommonLocaleDataEsUY() => _cld;
  ...
  static final _units = UnitsEsUY(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEsUY(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEsUY(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsEsUY(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesEsUY(_cld);
  @override
  Territories get territories => _territories;

  static final _currencies = CurrenciesEsUY(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEsUY(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEsUY(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEsUY extends UnitsEs {
  const UnitsEsUY(super.cld);
...
class DateFieldsEsUY extends DateFieldsEs {
  const DateFieldsEsUY(super.cld);
...
class LanguagesEsUY extends LanguagesEs {
  ...
  static const _swCD = Language('sw-CD', 'swahili (Congo)');
...
class ScriptsEsUY extends ScriptsEs {
  const ScriptsEsUY(super.cld);
...
class TerritoriesEsUY extends TerritoriesEs {
  const TerritoriesEsUY(super.cld);
  ...
  static const _gb = Territory('GB', 'Reino Unido', short: 'R. U.');
  ...
  static const _um = Territory('UM', 'Islas Ultramarinas de EE.UU.');
...
class CurrenciesEsUY extends CurrenciesEs {
  const CurrenciesEsUY(super.cld);
...
class TimeZonesEsUY extends TimeZonesEs {
  const TimeZonesEsUY(super.cld);
  ...
  Map<String, MetaZone> get metaZoneNames => Map.unmodifiable({
    ...
    ...const {
      ...
      'Uruguay': MetaZone(
        ...
        short: TimeZoneName(generic: 'UYT', standard: 'UYT', daylight: 'UYST'),
      ),
      'Wake': MetaZone(
        'Wake',
...
class LocaleDisplayNameEsUY extends LocaleDisplayNameEs {
  const LocaleDisplayNameEsUY(super.cld);
