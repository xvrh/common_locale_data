...
const _locale = 'en-SG';
const _cld = CommonLocaleDataEnSG.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEnSG extends CommonLocaleDataEn {
  @override
  String get locale => _locale;

  const CommonLocaleDataEnSG.constant() : super.constant();

  factory CommonLocaleDataEnSG() => _cld;
  ...
  static final _units = UnitsEnSG(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEnSG(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEnSG(_cld);
  @override
  Languages get languages => _languages;

  static final _territories = TerritoriesEnSG(_cld);
  @override
  Territories get territories => _territories;

  static final _currencies = CurrenciesEnSG(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEnSG(_cld);
  @override
...
class DateFieldsEnSG extends DateFieldsEn {
  const DateFieldsEnSG(super.cld);
  ...
  DateFieldFullData get month => const DateFieldFullData(
    displayName: MultiLength(long: 'month', short: 'mth', narrow: 'mo'),
    previous: MultiLength(
      long: 'last month',
      short: 'last mth',
      narrow: 'last mo',
    ),
    now: MultiLength(long: 'this month', short: 'this mth', narrow: 'this mo'),
    next: MultiLength(long: 'next month', short: 'next mth', narrow: 'next mo'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
        one: '{0} month ago',
...
class LanguagesEnSG extends LanguagesEn {
  const LanguagesEnSG(super.cld);
...
class TerritoriesEnSG extends TerritoriesEn {
  const TerritoriesEnSG(super.cld);
...
class CurrenciesEnSG extends CurrenciesEn {
  const CurrenciesEnSG(super.cld);
...
class TimeZonesEnSG extends TimeZonesEn {
  const TimeZonesEnSG(super.cld);
...
class LocaleDisplayNameEnSG extends LocaleDisplayNameEn {
  const LocaleDisplayNameEnSG(super.cld);
