...
const _locale = 'en-CY';
const _cld = CommonLocaleDataEnCY._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEnCY implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataEnCY._();
  ...
  static final _units = UnitsEnCY._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEnCY._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEnCY._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsEnCY._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesEnCY._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsEnCY._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsEnCY._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesEnCY._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEnCY._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEnCY._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEnCY extends Units {
  UnitsEnCY._(super.cld);
...
class DateFieldsEnCY extends DateFields {
  DateFieldsEnCY._(super.cld);
...
class LanguagesEnCY extends Languages {
  const LanguagesEnCY._(super.cld);
...
class ScriptsEnCY extends Scripts {
  const ScriptsEnCY._(super.cld);
...
class TerritoriesEnCY extends Territories {
  const TerritoriesEnCY._(super.cld);
...
class VariantsEnCY extends Variants {
  const VariantsEnCY._(super.cld);
...
class SubdivisionsEnCY extends Subdivisions {
  const SubdivisionsEnCY._(super.cld);
...
class CurrenciesEnCY extends Currencies {
  const CurrenciesEnCY._(super.cld);
...
class TimeZonesEnCY extends TimeZones {
  const TimeZonesEnCY._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
            regionFormat: '{0} Time',
...
class LocaleDisplayNameEnCY extends LocaleDisplayName {
  const LocaleDisplayNameEnCY._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
