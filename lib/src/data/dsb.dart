...
const _locale = 'dsb';
const _cld = CommonLocaleDataDsb.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataDsb extends CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataDsb.constant() : super.constant();
  ...
  static final _units = UnitsDsb(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsDsb(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesDsb(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsDsb(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesDsb(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsDsb(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsDsb(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesDsb(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesDsb(_cld);
  @override
...
class DateFieldsDsb extends DateFields {
  const DateFieldsDsb(super.cld);

  @override
  MultiLength get era =>
      const MultiLength(long: 'epocha', short: 'epocha', narrow: 'epocha');

  @override
  DateFieldFullData get year => const DateFieldFullData(
    displayName: MultiLength(long: 'lěto', short: 'l.', narrow: 'l.'),
    previous: MultiLength(long: 'łoni', short: 'łon.', narrow: 'ło.'),
    now: MultiLength(long: 'lětosa', short: 'lěts.', narrow: 'lět.'),
    next: MultiLength(long: 'znowa', short: 'znow.', narrow: 'zno.'),
  ...
  DateFieldFullData get quarter => const DateFieldFullData(
    displayName: MultiLength(long: 'kwartal', short: 'kwart.', narrow: 'kw.'),
  ...
  DateFieldFullData get month => const DateFieldFullData(
    displayName: MultiLength(long: 'mjasec', short: 'mjas.', narrow: 'mjas.'),
    previous: MultiLength(
      long: 'zajźony mjasec',
      short: 'zajź. mjasec',
      narrow: 'zajź. mjasec',
  ...
  DateFieldFullData get week => const DateFieldFullData(
    displayName: MultiLength(long: 'tyźeń', short: 'tyź.', narrow: 'tyź.'),
    previous: MultiLength(
      long: 'zajźony tyźeń',
      short: 'zajź. tyźeń',
      narrow: 'zajź. tyźeń',
  ...
  DateFieldFullData get day => const DateFieldFullData(
    displayName: MultiLength(long: 'źeń', short: 'źeń', narrow: 'ź'),
    previous: MultiLength(long: 'cora', short: 'cra.', narrow: 'cr.'),
    now: MultiLength(long: 'źinsa', short: 'źins.', narrow: 'źis.'),
    next: MultiLength(long: 'witśe', short: 'witś.', narrow: 'wit.'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
        one: 'pśed {0} dnjom',
  ...
  MultiLength get dayOfYear =>
      const MultiLength(long: 'źeń lěta', short: 'źeń lěta', narrow: 'ź. lě.');
  ...
  DateFieldDataWithRelative get sunday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: 'tu njeźelu', short: 'tu nje.', narrow: 'tu nj.'),
    next: MultiLength(
  ...
  DateFieldDataWithRelative get monday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: 'to pónjeźele', short: 'to pónj.', narrow: 'to pó.'),
    next: MultiLength(
  ...
  DateFieldDataWithRelative get tuesday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: 'tu wałtoru', short: 'tu wałt.', narrow: 'tu wa.'),
    next: MultiLength(
  ...
  DateFieldDataWithRelative get wednesday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: 'tu srjodu', short: 'tu srj.', narrow: 'tu sr.'),
    next: MultiLength(
      long: 'pśiducu srjodu',
      short: 'pśiducu srj.',
      narrow: 'pśiducu sr.',
  ...
  DateFieldDataWithRelative get thursday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: 'ten stwórtk', short: 'ten stw.', narrow: 'ten st.'),
    next: MultiLength(
  ...
  DateFieldDataWithRelative get friday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: 'ten pětk', short: 'ten pět.', narrow: 'ten pě.'),
    next: MultiLength(
      long: 'pśiducy pětk',
      short: 'pśiducy pět.',
      narrow: 'pśiducy pě.',
  ...
  DateFieldDataWithRelative get saturday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: 'tu sobotu', short: 'tu sob.', narrow: 'tu so.'),
    next: MultiLength(
      long: 'pśiducu sobotu',
      short: 'pśiducu sob.',
      narrow: 'pśiducu so.',
  ...
  DateFieldDataTime get hour => const DateFieldDataTime(
    displayName: MultiLength(long: 'góźina', short: 'góź.', narrow: 'g'),
    now: MultiLength(
  ...
  DateFieldDataTime get minute => const DateFieldDataTime(
    displayName: MultiLength(long: 'minuta', short: 'min.', narrow: 'm'),
    now: MultiLength(
  ...
  DateFieldDataTime get second => const DateFieldDataTime(
    displayName: MultiLength(long: 'sekunda', short: 'sek.', narrow: 's'),
    now: MultiLength(long: 'něnto', short: 'něnto', narrow: 'něnto'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
        one: 'pśed {0} sekundu',
...
class TerritoriesDsb extends Territories {
  const TerritoriesDsb(super.cld);
...
class SubdivisionsDsb extends Subdivisions {
  const SubdivisionsDsb(super.cld);
...
class TimeZonesDsb extends TimeZones {
  ...
  @override
  String get regionFormat => 'Casowe pasmo {0}';
  @override
  String get regionFormatDaylight => '{0} lěśojski cas';
  @override
  String get regionFormatStandard => '{0} zymski cas';
  @override
  ...
  static const staticMetaZoneNames = <String, MetaZone>{
    'Afghanistan': MetaZone(
      'Afghanistan',
      long: TimeZoneName(standard: 'Afghaniski cas'),
    ),
    ...
    'Bolivia': MetaZone(
      'Bolivia',
      long: TimeZoneName(standard: 'Boliwiski cas'),
    ),
    'Brasilia': MetaZone(
      'Brasilia',
      long: TimeZoneName(
    ...
    'Chamorro': MetaZone(
      'Chamorro',
      long: TimeZoneName(standard: 'Chamorrski cas'),
    ),
    'Chatham': MetaZone(
      'Chatham',
      long: TimeZoneName(
    ...
    'Cocos': MetaZone(
      'Cocos',
      long: TimeZoneName(standard: 'cas Kokosowych kupow'),
    ),
    'Colombia': MetaZone(
      'Colombia',
      long: TimeZoneName(
    ...
    'Ecuador': MetaZone(
      'Ecuador',
      long: TimeZoneName(standard: 'Ekuadorski cas'),
    ),
    ...
    'Galapagos': MetaZone(
      'Galapagos',
      long: TimeZoneName(standard: 'Galapagoski cas'),
    ),
    'Gambier': MetaZone(
      'Gambier',
      long: TimeZoneName(standard: 'Gambierski cas'),
    ),
    'Georgia': MetaZone(
      'Georgia',
      long: TimeZoneName(
    ...
    'Gulf': MetaZone(
      'Gulf',
      long: TimeZoneName(standard: 'cas Persiskego golfa'),
    ),
    ...
    'Indochina': MetaZone(
      'Indochina',
      long: TimeZoneName(standard: 'Indochinski cas'),
    ),
    ...
    'Kazakhstan': MetaZone(
      'Kazakhstan',
      long: TimeZoneName(standard: 'kazachiski cas'),
    ),
    ...
    'Kyrgystan': MetaZone(
      'Kyrgystan',
      long: TimeZoneName(standard: 'Kirgiski cas'),
    ),
    ...
    'Malaysia': MetaZone(
      'Malaysia',
      long: TimeZoneName(standard: 'Malajziski cas'),
    ),
    'Maldives': MetaZone(
      'Maldives',
      long: TimeZoneName(standard: 'Malediwski cas'),
    ),
    'Marquesas': MetaZone(
      'Marquesas',
      long: TimeZoneName(standard: 'Marqueski cas'),
    ),
    ...
    'Myanmar': MetaZone(
      'Myanmar',
      long: TimeZoneName(standard: 'Myanmarski cas'),
    ),
    ...
    'Pyongyang': MetaZone(
      'Pyongyang',
      long: TimeZoneName(standard: 'Pjöngjangski cas'),
    ),
    'Reunion': MetaZone(
      'Reunion',
      long: TimeZoneName(standard: 'Reunionski cas'),
    ),
    ...
    'Seychelles': MetaZone(
      'Seychelles',
      long: TimeZoneName(standard: 'Seychelski cas'),
    ),
    'Singapore': MetaZone(
      'Singapore',
      long: TimeZoneName(standard: 'Singapurski cas'),
    ),
    'Solomon': MetaZone(
      'Solomon',
      long: TimeZoneName(standard: 'Salomoński cas'),
    ),
    ...
    'Suriname': MetaZone(
      'Suriname',
      long: TimeZoneName(standard: 'Surinamski cas'),
    ),
    ...
    'Tajikistan': MetaZone(
      'Tajikistan',
      long: TimeZoneName(standard: 'Tadźikiski cas'),
    ),
    'Tokelau': MetaZone(
      'Tokelau',
      long: TimeZoneName(standard: 'Tokelauski cas'),
    ),
    'Tonga': MetaZone(
      'Tonga',
      long: TimeZoneName(
    ...
    'Venezuela': MetaZone(
      'Venezuela',
      long: TimeZoneName(standard: 'Venezuelski cas'),
    ),
...
class LocaleDisplayNameDsb extends LocaleDisplayName {
  const LocaleDisplayNameDsb(super.cld);
  ...
  @override
  String get codePatternLanguage => 'Rěc: {0}';
  @override
