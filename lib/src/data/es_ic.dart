...
const _locale = 'es-IC';
const _cld = CommonLocaleDataEsIC._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEsIC implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataEsIC._();
  ...
  static final _units = UnitsEsIC._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEsIC._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEsIC._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsEsIC._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesEsIC._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsEsIC._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsEsIC._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesEsIC._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEsIC._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEsIC._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEsIC extends Units {
  UnitsEsIC._(super.cld);
...
class DateFieldsEsIC extends DateFields {
  DateFieldsEsIC._(super.cld);
...
class LanguagesEsIC extends Languages {
  const LanguagesEsIC._(super.cld);
...
class ScriptsEsIC extends Scripts {
  const ScriptsEsIC._(super.cld);
...
class TerritoriesEsIC extends Territories {
  const TerritoriesEsIC._(super.cld);
  ...
  static const _ci =
      Territory('CI', 'Côte d’Ivoire', variant: 'Costa de Marfil');
...
class VariantsEsIC extends Variants {
  const VariantsEsIC._(super.cld);
...
class SubdivisionsEsIC extends Subdivisions {
  const SubdivisionsEsIC._(super.cld);
...
class CurrenciesEsIC extends Currencies {
  const CurrenciesEsIC._(super.cld);
  ...
  static const _ang = Currency(_cld, 'ANG', 'florín antillano',
      one: 'florín antillano', other: 'florines antillanos');
  ...
  static const _bmd = Currency(_cld, 'BMD', 'dólar bermudeño',
      one: 'dólar bermudeño', other: 'dólares bermudeños', symbolNarrow: r'$');
  ...
  static const _egp = Currency(_cld, 'EGP', 'libra egipcia',
      one: 'libra egipcia', other: 'libras egipcias', symbolNarrow: 'EGP');
  ...
  static const _htg = Currency(_cld, 'HTG', 'gurde haitiano',
      one: 'gurde haitiano', other: 'gurdes haitianos');
  ...
  static const _kyd = Currency(_cld, 'KYD', 'dólar de las Islas Caimán',
      ...
      symbolNarrow: r'$');
  static const _kzt = Currency(_cld, 'KZT', 'tengue kazajo',
      one: 'tengue kazajo', other: 'tengues kazajos', symbolNarrow: '₸');
  ...
  static const _mwk = Currency(_cld, 'MWK', 'kuacha malauí',
      one: 'kuacha malauí', other: 'kuachas malauíes');
  ...
  static const _nio = Currency(_cld, 'NIO', 'córdoba oro',
      one: 'córdoba oro', other: 'córdobas oro', symbolNarrow: r'C$');
  ...
  static const _sle = Currency(_cld, 'SLE', 'leona sierraleonesa',
      one: 'leona sierraleonesa', other: 'leonas sierraleonesas');
  static const _sll = Currency(_cld, 'SLL', 'leona sierraleonesa (1964–2022)',
  ...
  static const _thb = Currency(_cld, 'THB', 'bat tailandés',
      one: 'bat tailandés',
  ...
  static const _uzs = Currency(_cld, 'UZS', 'sum uzbeko',
      one: 'sum uzbeko', other: 'sums uzbekos');
  ...
  static const _xxx = Currency(_cld, 'XXX', 'moneda desconocida',
      one: '(moneda desconocida)', other: '(moneda desconocida)', symbol: '¤');
...
class TimeZonesEsIC extends TimeZones {
  const TimeZonesEsIC._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
            regionFormat: 'hora de {0}',
            regionFormatDaylight: 'horario de verano de {0}',
  ...
  final metaZoneNames = const {
    ...
    'Wake':
        MetaZone('Wake', long: TimeZoneName(standard: 'hora de la isla Wake')),
...
class LocaleDisplayNameEsIC extends LocaleDisplayName {
  const LocaleDisplayNameEsIC._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
            localeKeyTypePattern: '{0}: {1}',
            codePatternLanguage: 'Idioma: {0}',
            codePatternScript: 'Sistema de escritura: {0}',
