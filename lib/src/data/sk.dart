...
class DateFieldsSk extends DateFields {
  ...
  @override
  MultiLength get era =>
      const MultiLength(long: 'letopočet', short: 'letop.', narrow: 'letop.');
  ...
  DateFieldFullData get quarter => const DateFieldFullData(
    displayName: MultiLength(long: 'štvrťrok', short: 'Q', narrow: 'Q'),
    previous: MultiLength(
  ...
  DateFieldFullData get month => const DateFieldFullData(
    displayName: MultiLength(long: 'mesiac', short: 'mes.', narrow: 'mes.'),
    previous: MultiLength(
      long: 'minulý mesiac',
      short: 'minulý mes.',
      narrow: 'minulý mes.',
  ...
  DateFieldFullData get week => const DateFieldFullData(
    displayName: MultiLength(long: 'týždeň', short: 'týž.', narrow: 'týž.'),
    previous: MultiLength(
      long: 'minulý týždeň',
      short: 'minulý týž.',
      narrow: 'minulý týž.',
  ...
  DateFieldFullData get day => const DateFieldFullData(
    displayName: MultiLength(long: 'deň', short: 'd.', narrow: 'd.'),
    previous: MultiLength(long: 'včera', short: 'včera', narrow: 'včera'),
    now: MultiLength(long: 'dnes', short: 'dnes', narrow: 'dnes'),
    next: MultiLength(long: 'zajtra', short: 'zajtra', narrow: 'zajtra'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
        one: 'pred {0} dňom',
  ...
  MultiLength get dayOfYear =>
      const MultiLength(long: 'deň roka', short: 'deň r.', narrow: 'deň r.');
  ...
  DateFieldDataTime get minute => const DateFieldDataTime(
    displayName: MultiLength(long: 'minúta', short: 'min', narrow: 'min'),
    now: MultiLength(
      long: 'v tejto minúte',
  ...
  DateFieldDataTime get second => const DateFieldDataTime(
    ...
    now: MultiLength(long: 'teraz', short: 'teraz', narrow: 'teraz'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
        one: 'pred {0} sekundou',
  ...
  MultiLength get zone =>
      const MultiLength(long: 'časové pásmo', short: 'pásmo', narrow: 'pásmo');
}
...
class VariantsSk extends Variants {
  ...
  static const staticVariants = <String, Variant>{'SCOTLAND': _scotland};
}
...
class TimeZonesSk extends TimeZones {
  ...
  static const staticTimeZoneNames = <String, TimeZoneNames>{
    ...
    'Europe/Dublin': TimeZoneNames(
      long: TimeZoneName(daylight: 'írsky štandardný čas'),
    ),
  ...
  static const staticMetaZoneNames = <String, MetaZone>{
    ...
    'Afghanistan': MetaZone(
      'Afghanistan',
      long: TimeZoneName(standard: 'afganský čas'),
    ),
    ...
    'Bolivia': MetaZone(
      'Bolivia',
      long: TimeZoneName(standard: 'bolívijský čas'),
    ),
    'Brasilia': MetaZone(
      'Brasilia',
      long: TimeZoneName(
    ...
    'Galapagos': MetaZone(
      'Galapagos',
      long: TimeZoneName(standard: 'galapágsky čas'),
    ),
    'Gambier': MetaZone(
      'Gambier',
    ...
    'Indochina': MetaZone(
      'Indochina',
      long: TimeZoneName(standard: 'indočínsky čas'),
    ),
    ...
    'Kyrgystan': MetaZone(
      'Kyrgystan',
      long: TimeZoneName(standard: 'kirgizský čas'),
    ),
    ...
    'Malaysia': MetaZone(
      'Malaysia',
      long: TimeZoneName(standard: 'malajzijský čas'),
    ),
    'Maldives': MetaZone(
      'Maldives',
      long: TimeZoneName(standard: 'maldivský čas'),
    ),
    'Marquesas': MetaZone(
      'Marquesas',
      long: TimeZoneName(standard: 'markézsky čas'),
    ),
    ...
    'Myanmar': MetaZone(
      'Myanmar',
      long: TimeZoneName(standard: 'mjanmarský čas'),
    ),
    ...
    'Tajikistan': MetaZone(
      'Tajikistan',
      long: TimeZoneName(standard: 'tadžický čas'),
    ),
    'Tokelau': MetaZone(
      'Tokelau',
