...
const _locale = 'ar';
const _cld = CommonLocaleDataAr.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataAr extends CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataAr.constant() : super.constant();

  factory CommonLocaleDataAr() => _cld;
  ...
  static final _units = UnitsAr(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsAr(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesAr(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsAr(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesAr(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsAr(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsAr(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesAr(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesAr(_cld);
  @override
...
class DateFieldsAr extends DateFields {
  const DateFieldsAr(super.cld);

  @override
  MultiLength get era =>
      const MultiLength(long: 'العصر', short: 'العصر', narrow: 'العصر');
  ...
  DateFieldFullData get month => const DateFieldFullData(
    displayName: MultiLength(long: 'الشهر', short: 'الشهر', narrow: 'الشهر'),
    previous: MultiLength(
      long: 'الشهر الماضي',
      short: 'الشهر الماضي',
      narrow: 'الشهر الماضي',
  ...
  DateFieldFullData get day => const DateFieldFullData(
    displayName: MultiLength(long: 'يوم', short: 'يوم', narrow: 'يوم'),
    previous: MultiLength(long: 'أمس', short: 'أمس', narrow: 'أمس'),
    now: MultiLength(long: 'اليوم', short: 'اليوم', narrow: 'اليوم'),
    next: MultiLength(long: 'غدًا', short: 'غدًا', narrow: 'غدًا'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
        zero: 'قبل {0} يوم',
  ...
  MultiLength get weekday =>
      const MultiLength(long: 'اليوم', short: 'اليوم', narrow: 'اليوم');
  ...
  MultiLength get dayperiod =>
      const MultiLength(long: 'ص/م', short: 'ص/م', narrow: 'ص/م');
  ...
  DateFieldDataTime get second => const DateFieldDataTime(
    ...
    now: MultiLength(long: 'الآن', short: 'الآن', narrow: 'الآن'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
        zero: 'قبل {0} ثانية',
  ...
  MultiLength get zone =>
      const MultiLength(long: 'التوقيت', short: 'توقيت', narrow: 'توقيت');
}

class LanguagesAr extends Languages {
  const LanguagesAr(super.cld);
...
class ScriptsAr extends Scripts {
  const ScriptsAr(super.cld);
...
class TerritoriesAr extends Territories {
  const TerritoriesAr(super.cld);
...
class VariantsAr extends Variants {
  const VariantsAr(super.cld);
...
class SubdivisionsAr extends Subdivisions {
  const SubdivisionsAr(super.cld);
...
class CurrenciesAr extends Currencies {
  const CurrenciesAr(super.cld);
...
class TimeZonesAr extends TimeZones {
  const TimeZonesAr(super.cld);

  @override
  String get gmtFormat => 'غرينتش{0}';
  @override
  String get gmtZeroFormat => 'غرينتش';
  @override
  String get regionFormat => 'توقيت {0}';
  @override
  String get regionFormatDaylight => 'توقيت {0} الصيفي';
  @override
  String get regionFormatStandard => 'توقيت {0} الرسمي';
  @override
  ...
  static const staticMetaZoneNames = <String, MetaZone>{
    ...
    'Bolivia': MetaZone(
      'Bolivia',
      long: TimeZoneName(standard: 'توقيت بوليفيا'),
    ),
    'Brasilia': MetaZone(
      'Brasilia',
      long: TimeZoneName(
    ...
    'Chamorro': MetaZone(
      'Chamorro',
      long: TimeZoneName(standard: 'توقيت تشامورو'),
    ),
    'Chatham': MetaZone(
      'Chatham',
      long: TimeZoneName(
    ...
    'Ecuador': MetaZone(
      'Ecuador',
      long: TimeZoneName(standard: 'توقيت الإكوادور'),
    ),
    ...
    'Galapagos': MetaZone(
      'Galapagos',
      long: TimeZoneName(standard: 'توقيت غلاباغوس'),
    ),
    'Gambier': MetaZone(
      'Gambier',
      long: TimeZoneName(standard: 'توقيت جامبير'),
    ),
    'Georgia': MetaZone(
      'Georgia',
      long: TimeZoneName(
    ...
    'Kazakhstan': MetaZone(
      'Kazakhstan',
      long: TimeZoneName(standard: 'توقيت كازاخستان'),
    ),
    ...
    'Kyrgystan': MetaZone(
      'Kyrgystan',
      long: TimeZoneName(standard: 'توقيت قيرغيزستان'),
    ),
    ...
    'Malaysia': MetaZone(
      'Malaysia',
      long: TimeZoneName(standard: 'توقيت ماليزيا'),
    ),
    'Maldives': MetaZone(
      'Maldives',
    ...
    'Marquesas': MetaZone(
      'Marquesas',
      long: TimeZoneName(standard: 'توقيت ماركيساس'),
    ),
    ...
    'Myanmar': MetaZone(
      'Myanmar',
      long: TimeZoneName(standard: 'توقيت ميانمار'),
    ),
    ...
    'Pitcairn': MetaZone(
      'Pitcairn',
      long: TimeZoneName(standard: 'توقيت بيتكيرن'),
    ),
    'Ponape': MetaZone('Ponape', long: TimeZoneName(standard: 'توقيت بونابي')),
    'Pyongyang': MetaZone(
      'Pyongyang',
      long: TimeZoneName(standard: 'توقيت بيونغ يانغ'),
    ),
    'Reunion': MetaZone(
      'Reunion',
      long: TimeZoneName(standard: 'توقيت روينيون'),
    ),
    'Rothera': MetaZone(
      'Rothera',
      long: TimeZoneName(standard: 'توقيت روثيرا'),
    ),
    'Sakhalin': MetaZone(
      'Sakhalin',
      long: TimeZoneName(
    ...
    'Seychelles': MetaZone(
      'Seychelles',
      long: TimeZoneName(standard: 'توقيت سيشل'),
    ),
    'Singapore': MetaZone(
      'Singapore',
      long: TimeZoneName(standard: 'توقيت سنغافورة'),
    ),
    'Solomon': MetaZone(
      'Solomon',
      long: TimeZoneName(standard: 'توقيت جزر سليمان'),
    ),
    ...
    'Suriname': MetaZone(
      'Suriname',
      long: TimeZoneName(standard: 'توقيت سورينام'),
    ),
    ...
    'Tajikistan': MetaZone(
      'Tajikistan',
      long: TimeZoneName(standard: 'توقيت طاجكستان'),
    ),
    'Tokelau': MetaZone(
      'Tokelau',
      long: TimeZoneName(standard: 'توقيت توكيلاو'),
    ),
    'Tonga': MetaZone(
      'Tonga',
      long: TimeZoneName(
    ...
    'Venezuela': MetaZone(
      'Venezuela',
      long: TimeZoneName(standard: 'توقيت فنزويلا'),
    ),
...
class LocaleDisplayNameAr extends LocaleDisplayName {
  const LocaleDisplayNameAr(super.cld);
  ...
  @override
  String get codePatternLanguage => 'اللغة: {0}';
  @override
  String get codePatternScript => 'نظام الكتابة: {0}';
  @override
  String get codePatternTerritory => 'المنطقة: {0}';
  ...
  static const staticValueNames = <String, Map<String, String>>{
    ...
    'ka': {'noignore': 'تصنيف الرموز', 'shifted': 'تصنيف تجاهل الرموز'},
    'kb': {'false': 'تصنيف اللكنات بشكل عادي', 'true': 'تصنيف اللكنات معكوسة'},
    'kf': {
    ...
    'kk': {'false': 'التصفية بدون تسوية', 'true': 'تصنيف Unicode طبيعي'},
    'kn': {'false': 'تصنيف الأرقام على حدة', 'true': 'تصنيف الأرقام بالعدد'},
    'ks': {
      'identic': 'تصنيف الكل',
    ...
    'd0': {'fwidth': 'عرض كامل', 'hwidth': 'نصف العرض', 'npinyin': 'رقمي'},
    'hc': {
    ...
    'm0': {'bgn': 'بي جي إن', 'ungegn': 'يو إن جي إي جي إن'},
    'ms': {
