...
class UnitsHiLatn extends Units {
  ...
  Unit get concentrKarat => const Unit(
    ...
    short: UnitCountPattern(_locale, 'karats', one: '{0} ct', other: '{0} ct'),
  ...
  Unit get concentrPercent => const Unit(
    ...
    short: UnitCountPattern(_locale, 'per cent', one: '{0}%', other: '{0}%'),
  ...
  Unit get concentrPermille => const Unit(
    ...
    short: UnitCountPattern(_locale, 'per mille', one: '{0}‰', other: '{0}‰'),
    narrow: UnitCountPattern(_locale, '‰', one: '{0}‰', other: '{0}‰'),
  );
  ...
  Unit get digitalGigabyte => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'GByte', one: '{0}GB', other: '{0}GB'),
  );
  ...
  Unit get digitalMegabyte => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'MByte', one: '{0}MB', other: '{0}MB'),
  );
  ...
  Unit get digitalByte => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'byte', one: '{0}B', other: '{0}B'),
  );
  ...
  Unit get durationDay => const Unit(
    long: UnitCountPattern(_locale, 'days', one: '{0} din', other: '{0} din'),
    short: UnitCountPattern(_locale, 'days', one: '{0} din', other: '{0} din'),
  ...
  Unit get durationHour => const Unit(
    ...
    short: UnitCountPattern(_locale, 'hours', one: '{0} hr', other: '{0} hrs'),
  ...
  Unit get durationMinute => const Unit(
    ...
    short: UnitCountPattern(_locale, 'mins', one: '{0} min', other: '{0} mins'),
  ...
  Unit get durationSecond => const Unit(
    ...
    short: UnitCountPattern(_locale, 'secs', one: '{0} sec', other: '{0} secs'),
  ...
  Unit get graphicsDot => const Unit(
    ...
    short: UnitCountPattern(_locale, 'dots', one: '{0} px', other: '{0} px'),
  ...
  Unit get lengthMicrometer => const Unit(
    ...
    short: UnitCountPattern(_locale, 'μmetres', one: '{0} μm', other: '{0} μm'),
  ...
  Unit get massCarat => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'carat', one: '{0}ct', other: '{0}ct'),
  );
  ...
  Unit get speedKilometerPerHour => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'km/h', one: '{0}kph', other: '{0}kph'),
  );
  ...
  Unit get volumeLiter => const Unit(
    ...
    short: UnitCountPattern(_locale, 'litres', one: '{0} l', other: '{0} l'),
    narrow: UnitCountPattern(_locale, 'litre', one: '{0}l', other: '{0}l'),
  );
  ...
  Unit get volumeQuart => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'USqt', one: '{0}USqt', other: '{0}USqt'),
  );
...
class DateFieldsHiLatn extends DateFields {
  ...
  DateFieldFullData get year => const DateFieldFullData(
    displayName: MultiLength(long: 'saal', short: 'yr', narrow: 'yr'),
    previous: MultiLength(
      long: 'pichhla saal',
      short: 'last yr.',
      narrow: 'last yr.',
    ),
    now: MultiLength(long: 'is saal', short: 'is yr.', narrow: 'is yr.'),
    next: MultiLength(long: 'agla saal', short: 'next yr.', narrow: 'next yr.'),
    past: MultiLengthRelativeTime(
      ...
      narrow: RelativeTime(_locale, one: '{0}y pahle', other: '{0}y pahle'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(_locale, one: '{0} saal mein', other: '{0} saal mein'),
      short: RelativeTime(_locale, one: '{0} yr. mein', other: '{0} yr. mein'),
      narrow: RelativeTime(_locale, one: '{0}y mein', other: '{0}y mein'),
    ),
  );
  ...
  DateFieldFullData get quarter => const DateFieldFullData(
    ...
    past: MultiLengthRelativeTime(
      ...
      narrow: RelativeTime(_locale, one: '{0}q pahle', other: '{0}q pahle'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
      ...
      narrow: RelativeTime(_locale, one: '{0}q mein', other: '{0}q mein'),
    ),
  );

  @override
  DateFieldFullData get month => const DateFieldFullData(
    displayName: MultiLength(long: 'mahina', short: 'mo', narrow: 'mo'),
    previous: MultiLength(
      long: 'pichhla maheena',
      short: 'last mo',
      narrow: 'last mo.',
    ),
    now: MultiLength(long: 'yah maheena', short: 'is mo', narrow: 'is mo.'),
    next: MultiLength(
      long: 'agla maheena',
      short: 'next mo',
      narrow: 'next mo.',
    ...
    past: MultiLengthRelativeTime(
      ...
      narrow: RelativeTime(_locale, one: '{0}mo pahle', other: '{0}mo pahle'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
      ...
      short: RelativeTime(_locale, one: '{0} mo. mein', other: '{0} mo. mein'),
      narrow: RelativeTime(_locale, one: '{0}mo mein', other: '{0}mo mein'),
    ),
  );

  @override
  DateFieldFullData get week => const DateFieldFullData(
    displayName: MultiLength(long: 'hafta', short: 'wk', narrow: 'wk'),
    previous: MultiLength(
      long: 'pichhla hafta',
      short: 'last wk.',
      narrow: 'last wk',
    ),
    now: MultiLength(long: 'is hafte', short: 'is wk.', narrow: 'is wk'),
    next: MultiLength(long: 'agla hafta', short: 'next wk.', narrow: 'next wk'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
        one: '{0} hafte pahle',
      ...
      narrow: RelativeTime(_locale, one: '{0}w pahle', other: '{0}w pahle'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
      ...
      short: RelativeTime(_locale, one: '{0} wk. mein', other: '{0} wk. mein'),
      narrow: RelativeTime(_locale, one: '{0}w mein', other: '{0}w mein'),
    ),
  );
  ...
  DateFieldFullData get day => const DateFieldFullData(
    displayName: MultiLength(long: 'din', short: 'din', narrow: 'din'),
    previous: MultiLength(long: 'kal', short: 'kal', narrow: 'kal'),
    now: MultiLength(long: 'aaj', short: 'aaj', narrow: 'aaj'),
    next: MultiLength(
      long: 'aane wala kal',
      short: 'aane wala kal',
    ...
    past: MultiLengthRelativeTime(
      long: RelativeTime(_locale, one: '{0} din pahle', other: '{0} din pahle'),
      short: RelativeTime(
        _locale,
        one: '{0} din pahle',
        other: '{0} din pahle',
    ...
    future: MultiLengthRelativeTime(
      long: RelativeTime(_locale, one: '{0} din mein', other: '{0} din mein'),
      short: RelativeTime(_locale, one: '{0} din mein', other: '{0} din mein'),
      narrow: RelativeTime(_locale, one: '{0} din mein', other: '{0} din mein'),
    ),
  );
  ...
  DateFieldDataWithRelative get sunday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: 'is Sunday', short: 'yah Sun.', narrow: 'is Su'),
    next: MultiLength(
      long: 'next Sunday',
      short: 'next Sun.',
      narrow: 'next Su',
    ...
    past: MultiLengthRelativeTime(
      ...
      narrow: RelativeTime(_locale, one: '{0} Su pahle', other: '{0} Su pahle'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
      ...
      narrow: RelativeTime(_locale, one: '{0} Su mein', other: '{0} Su mein'),
    ),
  );
  ...
  DateFieldDataWithRelative get monday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: 'Monday', short: 'Mon', narrow: 'M'),
    next: MultiLength(long: 'next Monday', short: 'next Mon', narrow: 'next M'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
        one: '{0} Monday pahle',
      ...
      narrow: RelativeTime(_locale, one: '{0} M pahle', other: '{0} M pahle'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
      ...
      narrow: RelativeTime(_locale, one: '{0} M mein', other: '{0} M mein'),
    ),
  );
  ...
  DateFieldDataWithRelative get tuesday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: 'Tuesday', short: 'is Tue.', narrow: 'is Tu'),
    next: MultiLength(
      long: 'next Tuesday',
      short: 'next Tue.',
      narrow: 'next Tu',
    ...
    past: MultiLengthRelativeTime(
      ...
      narrow: RelativeTime(_locale, one: '{0} Tu pahle', other: '{0} Tu pahle'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
      ...
      narrow: RelativeTime(_locale, one: '{0} Tu mein', other: '{0} Tu mein'),
    ),
  );
  ...
  DateFieldDataWithRelative get wednesday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: 'is Wednesday', short: 'is Wed', narrow: 'is W'),
    next: MultiLength(
      long: 'next Wednesday',
      short: 'next Wed',
      narrow: 'next W',
  ...
  DateFieldDataWithRelative get thursday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: 'yah Thursday', short: 'yah Thu.', narrow: 'is Th'),
    next: MultiLength(
      long: 'next Thursday',
      short: 'next Thu.',
      narrow: 'next Th',
    ...
    past: MultiLengthRelativeTime(
      ...
      narrow: RelativeTime(_locale, one: '{0} Th pahle', other: '{0} Th pahle'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
      ...
      narrow: RelativeTime(_locale, one: '{0} Th mein', other: '{0} Th mein'),
    ),
  );
  ...
  DateFieldDataWithRelative get friday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: 'Friday', short: 'Fri', narrow: 'F'),
    next: MultiLength(long: 'next Friday', short: 'next Fri', narrow: 'next F'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
        one: '{0} Friday pahle',
      ...
      narrow: RelativeTime(_locale, one: '{0} F pahle', other: '{0} F pahle'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
      ...
      narrow: RelativeTime(_locale, one: '{0} F mein', other: '{0} F mein'),
    ),
  );
  ...
  DateFieldDataWithRelative get saturday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: 'is Saturday', short: 'is Sat.', narrow: 'is Sa'),
    next: MultiLength(
      long: 'next Saturday',
      short: 'last Sat.',
      narrow: 'next Sa',
    ...
    past: MultiLengthRelativeTime(
      ...
      narrow: RelativeTime(_locale, one: '{0} Sa pahle', other: '{0} Sa pahle'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
      ...
      narrow: RelativeTime(_locale, one: '{0} Sa mein', other: '{0} Sa mein'),
    ),
  );
  ...
  DateFieldDataTime get hour => const DateFieldDataTime(
    displayName: MultiLength(long: 'ghanta', short: 'hr', narrow: 'hr'),
    now: MultiLength(
      long: 'yah ghanta',
      short: 'yah ghanta',
      narrow: 'yah ghanta',
    ...
    past: MultiLengthRelativeTime(
      ...
      short: RelativeTime(_locale, one: '{0} hr pahle', other: '{0} hr mein'),
      narrow: RelativeTime(_locale, one: '{0}hr pahle', other: '{0}hr pahle'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
      ...
      short: RelativeTime(_locale, one: '{0} hr mein', other: '{0} hr mein'),
      narrow: RelativeTime(_locale, one: '{0}hr mein', other: '{0}hr mein'),
    ),
  );
  ...
  DateFieldDataTime get second => const DateFieldDataTime(
    ...
    now: MultiLength(long: 'abhi', short: 'now', narrow: 'now'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
        one: '{0} second pahle',
      ...
      narrow: RelativeTime(_locale, one: '{0}s pahle', other: '{0}s pahle'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
      ...
      narrow: RelativeTime(_locale, one: '{0}s mein', other: '{0}s mein'),
    ),
  );
...
class TimeZonesHiLatn extends TimeZones {
  ...
  static const staticTimeZoneNames = <String, TimeZoneNames>{
    ...
    'Pacific/Honolulu': TimeZoneNames(
      ...
      short: TimeZoneName(generic: 'HST'),
    ),
  ...
  static const staticMetaZoneNames = <String, MetaZone>{
    ...
    'Reunion': MetaZone(
      'Reunion',
      long: TimeZoneName(standard: 'Reunion Time'),
    ),
    'Rothera': MetaZone(
      'Rothera',
