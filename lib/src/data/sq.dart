...
const _locale = 'sq';
const _cld = CommonLocaleDataSq.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataSq extends CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataSq.constant() : super.constant();
  ...
  static final _units = UnitsSq(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsSq(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesSq(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsSq(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesSq(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsSq(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsSq(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesSq(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesSq(_cld);
  @override
...
class UnitsSq extends Units {
  ...
  Unit get accelerationGForce => const Unit(
    ...
    short: UnitCountPattern(_locale, 'G', one: '{0} g-forcë', other: '{0} G'),
  ...
  Unit get angleDegree => const Unit(
    ...
    short: UnitCountPattern(_locale, '°', one: '{0} gradë', other: '{0}°'),
    narrow: UnitCountPattern(_locale, '°', one: '{0} gradë', other: '{0}°'),
  );
  ...
  Unit get angleArcMinute => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'hark-min.', one: '{0}′', other: '{0}′'),
  );
  ...
  Unit get angleArcSecond => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'hark-sek.', one: '{0}″', other: '{0}″'),
  );
  ...
  Unit get areaHectare => const Unit(
    ...
    short: UnitCountPattern(_locale, 'ha', one: '{0} hektar', other: '{0} ha'),
  ...
  Unit get areaAcre => const Unit(
    long: UnitCountPattern(_locale, 'akra', one: '{0} akër', other: '{0} akra'),
    short: UnitCountPattern(_locale, 'ac', one: '{0} akër', other: '{0} ac'),
    narrow: UnitCountPattern(_locale, 'akër', one: '{0} akër', other: '{0} ac'),
  );
  ...
  Unit get concentrPercent => const Unit(
    ...
    short: UnitCountPattern(_locale, '%', one: '{0} përqind', other: '{0}%'),
    narrow: UnitCountPattern(_locale, '%', one: '{0} përqind', other: '{0}%'),
  );
  ...
  Unit get concentrPermille => const Unit(
    ...
    short: UnitCountPattern(_locale, '‰', one: '{0} përmijë', other: '{0}‰'),
    narrow: UnitCountPattern(_locale, '‰', one: '{0} përmijë', other: '{0}‰'),
  );
  ...
  Unit get concentrMole => const Unit(
    long: UnitCountPattern(_locale, 'molë', one: '{0} mol', other: '{0} molë'),
    short: UnitCountPattern(_locale, 'mol', one: '{0} mol', other: '{0} mol'),
    narrow: UnitCountPattern(_locale, 'mol', one: '{0} mol', other: '{0} molë'),
  );
  ...
  Unit get digitalByte => const Unit(
    long: UnitCountPattern(_locale, 'bajt', one: '{0} bajt', other: '{0} bajt'),
    short: UnitCountPattern(
      _locale,
      'bajt',
      one: '{0} bajt',
  ...
  Unit get durationYear => const Unit(
    long: UnitCountPattern(_locale, 'vjet', one: '{0} vit', other: '{0} vjet'),
    short: UnitCountPattern(_locale, 'vjet', one: '{0} vit', other: '{0} vjet'),
    narrow: UnitCountPattern(
      _locale,
      'vjet',
      one: '{0} vit',
  ...
  Unit get durationMonth => const Unit(
    long: UnitCountPattern(_locale, 'muaj', one: '{0} muaj', other: '{0} muaj'),
    short: UnitCountPattern(
      _locale,
      'muaj',
      one: '{0} muaj',
  ...
  Unit get durationWeek => const Unit(
    long: UnitCountPattern(_locale, 'javë', one: '{0} javë', other: '{0} javë'),
    short: UnitCountPattern(
      _locale,
      'javë',
      one: '{0} javë',
  ...
  Unit get durationDay => const Unit(
    long: UnitCountPattern(_locale, 'ditë', one: '{0} ditë', other: '{0} ditë'),
    short: UnitCountPattern(
      _locale,
      'ditë',
      one: '{0} ditë',
  ...
  Unit get durationHour => const Unit(
    long: UnitCountPattern(_locale, 'orë', one: '{0} orë', other: '{0} orë'),
    short: UnitCountPattern(_locale, 'orë', one: '{0} orë', other: '{0} orë'),
    narrow: UnitCountPattern(_locale, 'orë', one: '{0} orë', other: '{0} orë'),
  );
  ...
  Unit get electricOhm => const Unit(
    ...
    short: UnitCountPattern(_locale, 'Ω', one: '{0} om', other: '{0} Ω'),
    narrow: UnitCountPattern(_locale, 'Ω', one: '{0} om', other: '{0} Ω'),
  );
  ...
  Unit get energyJoule => const Unit(
    long: UnitCountPattern(_locale, 'zhul', one: '{0} zhul', other: '{0} zhul'),
    short: UnitCountPattern(_locale, 'J', one: '{0} zhul', other: '{0} J'),
    narrow: UnitCountPattern(_locale, 'J', one: '{0} zhul', other: '{0} J'),
  );
  ...
  Unit get energyThermUs => const Unit(
    ...
    short: UnitCountPattern(_locale, 'UStu', one: 'UStu', other: '{0} UStu'),
    narrow: UnitCountPattern(
      _locale,
      'UStu',
      one: '{0} UStu',
  ...
  Unit get forceNewton => const Unit(
    ...
    short: UnitCountPattern(_locale, 'N', one: '{0} njuton', other: '{0} N'),
    narrow: UnitCountPattern(_locale, 'N', one: '{0} njuton', other: '{0} N'),
  );
  ...
  Unit get frequencyHertz => const Unit(
    long: UnitCountPattern(_locale, 'herc', one: '{0} herc', other: '{0} herc'),
    short: UnitCountPattern(_locale, 'Hz', one: '{0} herc', other: '{0} Hz'),
    narrow: UnitCountPattern(_locale, 'Hz', one: '{0} herc', other: '{0} Hz'),
  );
  ...
  Unit get graphicsPixel => const Unit(
    ...
    short: UnitCountPattern(_locale, 'px', one: '{0} piksel', other: '{0} px'),
  ...
  Unit get graphicsDot => const Unit(
    long: UnitCountPattern(_locale, 'pika', one: '{0} pikë', other: '{0} pika'),
    short: UnitCountPattern(
      _locale,
      'pika',
      one: '{0} pikë',
  ...
  Unit get lengthMeter => const Unit(
    ...
    short: UnitCountPattern(_locale, 'm', one: '{0} metër', other: '{0} m'),
    narrow: UnitCountPattern(_locale, 'm', one: '{0} metër', other: '{0} m'),
  );
  ...
  Unit get lengthMile => const Unit(
    ...
    short: UnitCountPattern(_locale, 'mi', one: '{0} milje', other: '{0} mi'),
    narrow: UnitCountPattern(_locale, 'mi', one: '{0} milje', other: '{0} mi'),
  );
  ...
  Unit get lengthYard => const Unit(
    ...
    short: UnitCountPattern(_locale, 'yd', one: '{0} jard', other: '{0} yd'),
    narrow: UnitCountPattern(_locale, 'yd', one: '{0} jard', other: '{0} yd'),
  );
  ...
  Unit get lengthFoot => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'ft', one: '{0} këmbë', other: '{0} ft'),
  );

  @override
  Unit get lengthInch => const Unit(
    long: UnitCountPattern(_locale, 'inç', one: '{0} inç', other: '{0} inç'),
    short: UnitCountPattern(_locale, 'inç', one: '{0} inç', other: '{0} in'),
    narrow: UnitCountPattern(_locale, 'in', one: '{0} inç', other: '{0} in'),
  );
  ...
  Unit get lengthParsec => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'pc', one: '{0} parsek', other: '{0} pc'),
  );
  ...
  Unit get lightLux => const Unit(
    long: UnitCountPattern(_locale, 'luks', one: '{0} luks', other: '{0} luks'),
    short: UnitCountPattern(_locale, 'lx', one: '{0} luks', other: '{0} lx'),
    narrow: UnitCountPattern(_locale, 'lx', one: '{0} luks', other: '{0} lx'),
  );
  ...
  Unit get lightCandela => const Unit(
    ...
    short: UnitCountPattern(_locale, 'cd', one: '{0} kandelë', other: '{0} cd'),
    narrow: UnitCountPattern(
      _locale,
      'cd',
      one: '{0} kandelë',
  ...
  Unit get massTon => const Unit(
    long: UnitCountPattern(_locale, 'tonë', one: '{0} ton', other: '{0} tonë'),
  ...
  Unit get massPound => const Unit(
    ...
    short: UnitCountPattern(_locale, 'lb', one: '{0} paund', other: '{0} lb'),
    narrow: UnitCountPattern(_locale, 'lb', one: '{0} paund', other: '{0} lb'),
  );

  @override
  Unit get massOunce => const Unit(
    long: UnitCountPattern(_locale, 'onsë', one: '{0} ons', other: '{0} onsë'),
  ...
  Unit get massCarat => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'CD', one: '{0} karat', other: '{0} CD'),
  );
  ...
  Unit get powerWatt => const Unit(
    ...
    short: UnitCountPattern(_locale, 'W', one: '{0} vat', other: '{0} W'),
    narrow: UnitCountPattern(_locale, 'W', one: '{0} vat', other: '{0} W'),
  );
  ...
  Unit get pressureBar => const Unit(
    long: UnitCountPattern(_locale, 'bare', one: '{0} bar', other: '{0} bare'),
  ...
  Unit get volumeQuart => const Unit(
    ...
    short: UnitCountPattern(_locale, 'qt', one: '{0} çerek', other: '{0} qt'),
    narrow: UnitCountPattern(_locale, 'qt', one: '{0} çerek', other: '{0} qt'),
  );
  ...
  Unit get volumePint => const Unit(
    ...
    short: UnitCountPattern(_locale, 'pt', one: '{0} pintë', other: '{0} pt'),
    narrow: UnitCountPattern(_locale, 'pt', one: '{0} pintë', other: '{0} pt'),
  );

  @override
  Unit get volumeCup => const Unit(
    long: UnitCountPattern(_locale, 'kupa', one: '{0} kupë', other: '{0} kupa'),
    short: UnitCountPattern(_locale, 'c', one: '{0} kupë', other: '{0} c'),
    narrow: UnitCountPattern(_locale, 'c', one: '{0} kupë', other: '{0} c'),
  );
  ...
  Unit get volumeBarrel => const Unit(
    long: UnitCountPattern(_locale, 'fuçi', one: '{0} fuçi', other: '{0} fuçi'),
    short: UnitCountPattern(_locale, 'bbl', one: '{0} fuçi', other: '{0} bbl'),
    narrow: UnitCountPattern(
      _locale,
      'fuçi',
      one: '{0} fuçi',
  ...
  Unit get volumeDrop => const Unit(
    long: UnitCountPattern(_locale, 'çika', one: '{0} çikë', other: '{0} çika'),
    short: UnitCountPattern(
      _locale,
      'drop',
      one: '{0} çikë',
  ...
  Unit get volumeJigger => const Unit(
    long: UnitCountPattern(_locale, 'teke', one: '{0} teke', other: '{0} teke'),
    short: UnitCountPattern(
      _locale,
      'jigger',
      one: '{0} teke',
  ...
  Unit get durationNight => const Unit(
    long: UnitCountPattern(_locale, 'net', one: '{0} natë', other: '{0} net'),
    short: UnitCountPattern(_locale, 'net', one: '{0} natë', other: '{0} net'),
    narrow: UnitCountPattern(_locale, 'net', one: '{0} natë', other: '{0} net'),
  );
}

class DateFieldsSq extends DateFields {
  const DateFieldsSq(super.cld);

  @override
  MultiLength get era =>
      const MultiLength(long: 'erë', short: 'erë', narrow: 'erë');

  @override
  DateFieldFullData get year => const DateFieldFullData(
    displayName: MultiLength(long: 'vit', short: 'vit', narrow: 'vit'),
    previous: MultiLength(
      long: 'vjet',
      short: 'vitin e kaluar',
      narrow: 'vitin e kaluar',
    ),
    now: MultiLength(long: 'sivjet', short: 'këtë vit', narrow: 'këtë vit'),
    next: MultiLength(
      long: 'mot',
  ...
  DateFieldFullData get month => const DateFieldFullData(
    displayName: MultiLength(long: 'muaj', short: 'muaj', narrow: 'muaj'),
    previous: MultiLength(
  ...
  DateFieldFullData get week => const DateFieldFullData(
    displayName: MultiLength(long: 'javë', short: 'javë', narrow: 'javë'),
    previous: MultiLength(
      long: 'javën e kaluar',
    ...
    future: MultiLengthRelativeTime(
      long: RelativeTime(_locale, one: 'pas {0} jave', other: 'pas {0} javësh'),
      short: RelativeTime(
        _locale,
        one: 'pas {0} jave',
        other: 'pas {0} javësh',
  ...
  DateFieldFullData get day => const DateFieldFullData(
    displayName: MultiLength(long: 'ditë', short: 'ditë', narrow: 'ditë'),
    previous: MultiLength(long: 'dje', short: 'dje', narrow: 'dje'),
    now: MultiLength(long: 'sot', short: 'sot', narrow: 'sot'),
    next: MultiLength(long: 'nesër', short: 'nesër', narrow: 'nesër'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
        one: '{0} ditë më parë',
    ...
    future: MultiLengthRelativeTime(
      long: RelativeTime(_locale, one: 'pas {0} dite', other: 'pas {0} ditësh'),
      short: RelativeTime(
        _locale,
        one: 'pas {0} dite',
        other: 'pas {0} ditësh',
  ...
  DateFieldDataTime get hour => const DateFieldDataTime(
    displayName: MultiLength(long: 'orë', short: 'orë', narrow: 'orë'),
    now: MultiLength(long: 'këtë orë', short: 'këtë orë', narrow: 'këtë orë'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
        one: '{0} orë më parë',
    ...
    future: MultiLengthRelativeTime(
      long: RelativeTime(_locale, one: 'pas {0} ore', other: 'pas {0} orësh'),
      short: RelativeTime(_locale, one: 'pas {0} ore', other: 'pas {0} orësh'),
      narrow: RelativeTime(_locale, one: 'pas {0} ore', other: 'pas {0} orësh'),
    ),
  );

  @override
  DateFieldDataTime get minute => const DateFieldDataTime(
    displayName: MultiLength(long: 'minutë', short: 'min', narrow: 'min'),
    now: MultiLength(
      long: 'këtë minutë',
      short: 'këtë minutë',
      narrow: 'këtë minutë',
    ...
    future: MultiLengthRelativeTime(
      ...
      short: RelativeTime(_locale, one: 'pas {0} min', other: 'pas {0} min'),
      narrow: RelativeTime(_locale, one: 'pas {0} min', other: 'pas {0} min'),
    ),
  );

  @override
  DateFieldDataTime get second => const DateFieldDataTime(
    displayName: MultiLength(long: 'sekondë', short: 'sek', narrow: 'sek'),
    now: MultiLength(long: 'tani', short: 'tani', narrow: 'tani'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
    ...
    future: MultiLengthRelativeTime(
      ...
      short: RelativeTime(_locale, one: 'pas {0} sek', other: 'pas {0} sek'),
      narrow: RelativeTime(_locale, one: 'pas {0} sek', other: 'pas {0} sek'),
    ),
  );
...
class SubdivisionsSq extends Subdivisions {
  const SubdivisionsSq(super.cld);
...
class TimeZonesSq extends TimeZones {
  ...
  @override
  String get regionFormatDaylight => 'Ora verore: {0}';
  @override
  String get regionFormatStandard => 'Ora standarde: {0}';
  @override
  ...
  static const staticMetaZoneNames = <String, MetaZone>{
    ...
    'Bolivia': MetaZone(
      'Bolivia',
      long: TimeZoneName(standard: 'Ora e Bolivisë'),
    ),
    'Brasilia': MetaZone(
      'Brasilia',
      long: TimeZoneName(
    ...
    'Chamorro': MetaZone(
      'Chamorro',
      long: TimeZoneName(standard: 'Ora e Kamorros'),
    ),
    'Chatham': MetaZone(
      'Chatham',
      long: TimeZoneName(
    ...
    'Cocos': MetaZone(
      'Cocos',
      long: TimeZoneName(standard: 'Ora e Ishujve Kokos'),
    ),
    'Colombia': MetaZone(
      'Colombia',
      long: TimeZoneName(
    ...
    'Ecuador': MetaZone(
      'Ecuador',
      long: TimeZoneName(standard: 'Ora e Ekuadorit'),
    ),
    ...
    'Gambier': MetaZone(
      'Gambier',
      long: TimeZoneName(standard: 'Ora e Gambierit'),
    ),
    'Georgia': MetaZone(
      'Georgia',
      long: TimeZoneName(
    ...
    'Guyana': MetaZone(
      'Guyana',
      long: TimeZoneName(standard: 'Ora e Guajanës'),
    ),
    ...
    'Indochina': MetaZone(
      'Indochina',
      long: TimeZoneName(standard: 'Ora e Indokinës'),
    ),
    ...
    'Kyrgystan': MetaZone(
      'Kyrgystan',
      long: TimeZoneName(standard: 'Ora e Kirgizisë'),
    ),
    ...
    'Malaysia': MetaZone(
      'Malaysia',
      long: TimeZoneName(standard: 'Ora e Malajzisë'),
    ),
    'Maldives': MetaZone(
      'Maldives',
      long: TimeZoneName(standard: 'Ora e Maldiveve'),
    ),
    'Marquesas': MetaZone(
      'Marquesas',
    ...
    'Mawson': MetaZone(
      'Mawson',
      long: TimeZoneName(standard: 'Ora e Mausonit'),
    ),
    ...
    'Myanmar': MetaZone(
      'Myanmar',
      long: TimeZoneName(standard: 'Ora e Mianmarit'),
    ),
    ...
    'Pitcairn': MetaZone(
      'Pitcairn',
      long: TimeZoneName(standard: 'Ora e Pitkernit'),
    ),
    'Ponape': MetaZone(
      'Ponape',
      long: TimeZoneName(standard: 'Ora e Ponapeit'),
    ),
    'Pyongyang': MetaZone(
      'Pyongyang',
      long: TimeZoneName(standard: 'Ora e Penianit'),
    ),
    'Qyzylorda': MetaZone(
      'Qyzylorda',
      long: TimeZoneName(
    ...
    'Reunion': MetaZone(
      'Reunion',
      long: TimeZoneName(standard: 'Ora e Reunionit'),
    ),
    'Rothera': MetaZone(
      'Rothera',
      long: TimeZoneName(standard: 'Ora e Rodherës'),
    ),
    'Sakhalin': MetaZone(
      'Sakhalin',
      long: TimeZoneName(
    ...
    'Singapore': MetaZone(
      'Singapore',
      long: TimeZoneName(standard: 'Ora e Singaporit'),
    ),
    'Solomon': MetaZone(
      'Solomon',
    ...
    'Suriname': MetaZone(
      'Suriname',
      long: TimeZoneName(standard: 'Ora e Surinamit'),
    ),
    ...
    'Tokelau': MetaZone(
      'Tokelau',
      long: TimeZoneName(standard: 'Ora e Tokelaut'),
    ),
    'Tonga': MetaZone(
      'Tonga',
      long: TimeZoneName(
    ...
    'Tuvalu': MetaZone(
      'Tuvalu',
      long: TimeZoneName(standard: 'Ora e Tuvalusë'),
    ),
    'Uruguay': MetaZone(
      'Uruguay',
      long: TimeZoneName(
    ...
    'Venezuela': MetaZone(
      'Venezuela',
      long: TimeZoneName(standard: 'Ora e Venezuelës'),
    ),
    ...
    'Vostok': MetaZone(
      'Vostok',
      long: TimeZoneName(standard: 'Ora e Vostokut'),
    ),
    'Wake': MetaZone(
      'Wake',
      long: TimeZoneName(standard: 'Ora e Ishullit Uejk'),
    ),
    'Wallis': MetaZone(
      'Wallis',
...
class LocaleDisplayNameSq extends LocaleDisplayName {
  const LocaleDisplayNameSq(super.cld);
  ...
  @override
  String get codePatternLanguage => 'Gjuha: {0}';
  @override
  String get codePatternScript => 'Skripti: {0}';
  @override
  String get codePatternTerritory => 'Rajoni: {0}';
