...
const _locale = 'ar-SA';
const _cld = CommonLocaleDataArSA._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataArSA implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataArSA._();
  ...
  static final _units = UnitsArSA._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsArSA._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesArSA._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsArSA._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesArSA._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsArSA._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsArSA._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesArSA._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesArSA._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameArSA._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsArSA extends Units {
  UnitsArSA._(super.cld);
...
class DateFieldsArSA extends DateFields {
  DateFieldsArSA._(super.cld);
...
class LanguagesArSA extends Languages {
  const LanguagesArSA._(super.cld);
...
class ScriptsArSA extends Scripts {
  const ScriptsArSA._(super.cld);
...
class TerritoriesArSA extends Territories {
  const TerritoriesArSA._(super.cld);
...
class VariantsArSA extends Variants {
  const VariantsArSA._(super.cld);
...
class SubdivisionsArSA extends Subdivisions {
  const SubdivisionsArSA._(super.cld);
...
class CurrenciesArSA extends Currencies {
  const CurrenciesArSA._(super.cld);
...
class TimeZonesArSA extends TimeZones {
  const TimeZonesArSA._(super.cld)
      : super(
            gmtFormat: 'غرينتش{0}',
...
class LocaleDisplayNameArSA extends LocaleDisplayName {
  const LocaleDisplayNameArSA._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}، {1}',
