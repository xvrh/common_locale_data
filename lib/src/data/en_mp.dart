...
const _locale = 'en-MP';
const _cld = CommonLocaleDataEnMP._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEnMP implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataEnMP._();
  ...
  static final _units = UnitsEnMP._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEnMP._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEnMP._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsEnMP._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesEnMP._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsEnMP._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsEnMP._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesEnMP._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEnMP._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEnMP._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEnMP extends Units {
  UnitsEnMP._(super.cld);
...
class DateFieldsEnMP extends DateFields {
  DateFieldsEnMP._(super.cld);
...
class LanguagesEnMP extends Languages {
  const LanguagesEnMP._(super.cld);
...
class ScriptsEnMP extends Scripts {
  const ScriptsEnMP._(super.cld);
...
class TerritoriesEnMP extends Territories {
  const TerritoriesEnMP._(super.cld);
...
class VariantsEnMP extends Variants {
  const VariantsEnMP._(super.cld);
...
class SubdivisionsEnMP extends Subdivisions {
  const SubdivisionsEnMP._(super.cld);
...
class CurrenciesEnMP extends Currencies {
  const CurrenciesEnMP._(super.cld);
...
class TimeZonesEnMP extends TimeZones {
  const TimeZonesEnMP._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
            regionFormat: '{0} Time',
...
class LocaleDisplayNameEnMP extends LocaleDisplayName {
  const LocaleDisplayNameEnMP._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
