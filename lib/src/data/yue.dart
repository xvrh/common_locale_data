...
const _locale = 'yue';
const _cld = CommonLocaleDataYue._();
...
class CommonLocaleDataYue implements CommonLocaleData {
  ...
  static final _units = UnitsYue._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsYue._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesYue._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsYue._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesYue._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsYue._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsYue._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesYue._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesYue._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameYue._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsYue extends Units {
  UnitsYue._(super.cld);
...
class LanguagesYue extends Languages {
  const LanguagesYue._(super.cld);
...
class TerritoriesYue extends Territories {
  const TerritoriesYue._(super.cld);
...
class SubdivisionsYue extends Subdivisions {
  const SubdivisionsYue._(super.cld);
...
class CurrenciesYue extends Currencies {
  const CurrenciesYue._(super.cld);
...
class TimeZonesYue extends TimeZones {
  const TimeZonesYue._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
            regionFormat: '{0}時間',
...
class LocaleDisplayNameYue extends LocaleDisplayName {
  const LocaleDisplayNameYue._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}，{1}',
