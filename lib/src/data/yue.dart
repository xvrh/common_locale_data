...
const _locale = 'yue';
const _cld = CommonLocaleDataYue.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataYue extends CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataYue.constant() : super.constant();

  factory CommonLocaleDataYue() => _cld;
  ...
  static final _units = UnitsYue(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsYue(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesYue(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsYue(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesYue(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsYue(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsYue(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesYue(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesYue(_cld);
  @override
...
class UnitsYue extends Units {
  ...
  Unit get accelerationGForce => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'G 力', one: '{0}G', other: '{0} G 力'),
  );
  ...
  Unit get angleRevolution => const Unit(
    long: UnitCountPattern(_locale, '圈', one: '{0} revolution', other: '{0} 圈'),
    short: UnitCountPattern(_locale, '圈', one: '{0} rev', other: '{0} 圈'),
    narrow: UnitCountPattern(_locale, '圈', one: '{0}rev', other: '{0} 圈'),
  );
  ...
  Unit get angleDegree => const Unit(
    ...
    narrow: UnitCountPattern(_locale, '角度', one: '{0}°', other: '{0} 度'),
  );
  ...
  Unit get areaSquareKilometer => const Unit(
    ...
    narrow: UnitCountPattern(_locale, '平方公里', one: '{0}km²', other: '{0} 平方公里'),
  );
  ...
  Unit get areaSquareMeter => const Unit(
    ...
    short: UnitCountPattern(_locale, '平方米', one: '{0} m²', other: '{0} 平方米'),
    narrow: UnitCountPattern(_locale, '平方米', one: '{0}m²', other: '{0} 平方米'),
  );
  ...
  Unit get areaSquareCentimeter => const Unit(
    ...
    short: UnitCountPattern(_locale, '平方厘米', one: '{0} cm²', other: '{0} 平方厘米'),
    narrow: UnitCountPattern(_locale, '平方厘米', one: '{0}cm²', other: '{0} 平方厘米'),
  );
  ...
  Unit get areaSquareYard => const Unit(
    ...
    narrow: UnitCountPattern(_locale, '平方碼', one: '{0}yd²', other: '{0} 平方碼'),
  );
  ...
  Unit get areaSquareFoot => const Unit(
    ...
    narrow: UnitCountPattern(_locale, '平方英呎', one: '{0}ft²', other: '{0} 平方英呎'),
  );
  ...
  Unit get areaSquareInch => const Unit(
    ...
    short: UnitCountPattern(_locale, '平方英吋', one: '{0} in²', other: '{0} 平方英吋'),
    narrow: UnitCountPattern(_locale, '平方英吋', one: '{0}in²', other: '{0} 平方英吋'),
  );

  @override
  Unit get areaDunam => const Unit(
    long: UnitCountPattern(_locale, '德南', one: '{0} dunam', other: '{0} 德南'),
    short: UnitCountPattern(_locale, '德南', one: '{0} dunam', other: '{0} 德南'),
    narrow: UnitCountPattern(_locale, '德南', one: '{0}dunam', other: '{0} 德南'),
  );
  ...
  Unit get concentrItem => const Unit(
    long: UnitCountPattern(_locale, '項', one: '{0} item', other: '{0} 項'),
    short: UnitCountPattern(_locale, '項', one: '{0} item', other: '{0} 項'),
    narrow: UnitCountPattern(_locale, '項', one: '{0}item', other: '{0} 項'),
  );
  ...
  Unit get concentrPercent => const Unit(
    long: UnitCountPattern(_locale, '%', one: '{0} percent', other: '{0}%'),
  ...
  Unit get concentrPermille => const Unit(
    long: UnitCountPattern(_locale, '‰', one: '{0} permille', other: '{0}‰'),
    short: UnitCountPattern(_locale, '‰', one: '{0}‰', other: '{0}‰'),
    narrow: UnitCountPattern(_locale, '‰', one: '{0}‰', other: '{0}‰'),
  );
  ...
  Unit get concentrPermyriad => const Unit(
    ...
    short: UnitCountPattern(_locale, '點子', one: '{0}‱', other: '{0} 點子'),
    narrow: UnitCountPattern(_locale, '點子', one: '{0}‱', other: '{0} 點子'),
  );

  @override
  Unit get concentrMole => const Unit(
    long: UnitCountPattern(_locale, '摩爾', one: '{0} mole', other: '{0} 摩爾'),
    short: UnitCountPattern(_locale, '摩爾', one: '{0} mol', other: '{0} 摩爾'),
    narrow: UnitCountPattern(_locale, '摩爾', one: '{0}mol', other: '{0} 摩爾'),
  );
  ...
  Unit get durationDecade => const Unit(
    long: UnitCountPattern(_locale, '十年', one: '{0} decade', other: '{0} 個十年'),
    short: UnitCountPattern(_locale, '十年', one: '{0} dec', other: '{0} 個十年'),
    narrow: UnitCountPattern(_locale, '十年', one: '{0}dec', other: '{0} 個十年'),
  );
  ...
  Unit get durationQuarter => const Unit(
    long: UnitCountPattern(_locale, '季', one: '{0} quarter', other: '{0} 季'),
    short: UnitCountPattern(_locale, '季', one: '{0} qtr', other: '{0} 季'),
    narrow: UnitCountPattern(_locale, '季', one: '{0}q', other: '{0} 季'),
  );
  ...
  Unit get durationMicrosecond => const Unit(
    ...
    narrow: UnitCountPattern(_locale, '微秒', one: '{0}μs', other: '{0} 微秒'),
  );
  ...
  Unit get durationNanosecond => const Unit(
    ...
    narrow: UnitCountPattern(_locale, '奈秒', one: '{0}ns', other: '{0} 奈秒'),
  );
  ...
  Unit get electricVolt => const Unit(
    ...
    short: UnitCountPattern(_locale, '伏特', one: '{0} V', other: '{0} 伏'),
    narrow: UnitCountPattern(_locale, '伏特', one: '{0}V', other: '{0} 伏'),
  );
  ...
  Unit get energyCalorie => const Unit(
    ...
    short: UnitCountPattern(_locale, '卡路里', one: '{0} cal', other: '{0} 卡路里'),
    narrow: UnitCountPattern(_locale, '卡路里', one: '{0}cal', other: '{0} 卡路里'),
  );

  @override
  Unit get energyFoodcalorie => const Unit(
    long: UnitCountPattern(_locale, '大卡', one: '{0} Calorie', other: '{0} 大卡'),
  ...
  Unit get energyKilojoule => const Unit(
    ...
    narrow: UnitCountPattern(_locale, '千焦耳', one: '{0}kJ', other: '{0} 千焦'),
  );

  @override
  Unit get energyJoule => const Unit(
    long: UnitCountPattern(_locale, '焦耳', one: '{0} joule', other: '{0} 焦耳'),
    short: UnitCountPattern(_locale, '焦耳', one: '{0} J', other: '{0} 焦耳'),
    narrow: UnitCountPattern(_locale, '焦耳', one: '{0}J', other: '{0} 焦耳'),
  );
  ...
  Unit get forcePoundForce => const Unit(
    ...
    short: UnitCountPattern(_locale, '磅力', one: '{0} lbf', other: '{0} 磅力'),
    narrow: UnitCountPattern(_locale, '磅力', one: '{0}lbf', other: '{0} 磅力'),
  );

  @override
  Unit get forceNewton => const Unit(
    long: UnitCountPattern(_locale, '牛頓', one: '{0} newton', other: '{0} 牛頓'),
    short: UnitCountPattern(_locale, '牛頓', one: '{0} N', other: '{0} 牛頓'),
    narrow: UnitCountPattern(_locale, '牛頓', one: '{0}N', other: '{0} 牛頓'),
  );
  ...
  Unit get graphicsEm => const Unit(
    long: UnitCountPattern(_locale, '字體 em', one: '{0} em', other: '{0} em'),
  ...
  Unit get graphicsPixel => const Unit(
    ...
    short: UnitCountPattern(_locale, '像素', one: '{0} px', other: '{0} 像素'),
    narrow: UnitCountPattern(_locale, '像素', one: '{0}px', other: '{0} 像素'),
  );
  ...
  Unit get graphicsMegapixel => const Unit(
    ...
    short: UnitCountPattern(_locale, '百萬像素', one: '{0} MP', other: '{0} 百萬像素'),
  ...
  Unit get graphicsDot => const Unit(
    long: UnitCountPattern(_locale, '圓點', one: '{0} dot', other: '{0} 個圓點'),
    short: UnitCountPattern(_locale, '圓點', one: '{0} dot', other: '{0} 個圓點'),
    narrow: UnitCountPattern(_locale, '圓點', one: '{0}dot', other: '{0} 個圓點'),
  );
  ...
  Unit get lengthEarthRadius => const Unit(
    ...
    short: UnitCountPattern(_locale, '地球半徑', one: '{0} R⊕', other: '{0} 地球半徑'),
    narrow: UnitCountPattern(_locale, '地球半徑', one: '{0}R⊕', other: '{0} 地球半徑'),
  );
  ...
  Unit get lengthMeter => const Unit(
    long: UnitCountPattern(_locale, '米', one: '{0} meter', other: '{0} 米'),
    short: UnitCountPattern(_locale, '米', one: '{0} m', other: '{0} 米'),
    narrow: UnitCountPattern(_locale, '米', one: '{0}m', other: '{0} 米'),
  );
  ...
  Unit get lengthCentimeter => const Unit(
    ...
    short: UnitCountPattern(_locale, '厘米', one: '{0} cm', other: '{0} 厘米'),
    narrow: UnitCountPattern(_locale, '厘米', one: '{0}cm', other: '{0} 厘米'),
  );
  ...
  Unit get lengthMillimeter => const Unit(
    ...
    short: UnitCountPattern(_locale, '毫米', one: '{0} mm', other: '{0} 毫米'),
    narrow: UnitCountPattern(_locale, '毫米', one: '{0}mm', other: '{0} 毫米'),
  );
  ...
  Unit get lengthMicrometer => const Unit(
    ...
    narrow: UnitCountPattern(_locale, '微米', one: '{0}μm', other: '{0} 微米'),
  );
  ...
  Unit get lengthFoot => const Unit(
    long: UnitCountPattern(_locale, '英呎', one: '{0} foot', other: '{0} 英呎'),
    short: UnitCountPattern(_locale, '英呎', one: '{0} ft', other: '{0} 英呎'),
    narrow: UnitCountPattern(_locale, '英呎', one: '{0}′', other: '{0} 英呎'),
  );

  @override
  Unit get lengthInch => const Unit(
    long: UnitCountPattern(_locale, '英吋', one: '{0} inch', other: '{0} 英吋'),
    short: UnitCountPattern(_locale, '英吋', one: '{0} in', other: '{0} 英吋'),
    narrow: UnitCountPattern(_locale, '英吋', one: '{0}″', other: '{0} 英吋'),
  );
  ...
  Unit get lengthFathom => const Unit(
    ...
    narrow: UnitCountPattern(_locale, '英尋', one: '{0}fth', other: '{0} 英尋'),
  );
  ...
  Unit get lengthNauticalMile => const Unit(
    ...
    narrow: UnitCountPattern(_locale, '海里', one: '{0}nmi', other: '{0} 海里'),
  );
  ...
  Unit get lengthSolarRadius => const Unit(
    ...
    short: UnitCountPattern(_locale, '太陽半徑', one: '{0} R☉', other: '{0} 太陽半徑'),
    narrow: UnitCountPattern(_locale, '太陽半徑', one: '{0}R☉', other: '{0} 太陽半徑'),
  );
  ...
  Unit get lightCandela => const Unit(
    ...
    short: UnitCountPattern(_locale, '坎德拉', one: '{0} cd', other: '{0} 坎德拉'),
    narrow: UnitCountPattern(_locale, '坎德拉', one: '{0}cd', other: '{0} 坎德拉'),
  );
  ...
  Unit get lightSolarLuminosity => const Unit(
    ...
    short: UnitCountPattern(_locale, '太陽光度', one: '{0} L☉', other: '{0} 太陽光度'),
    narrow: UnitCountPattern(_locale, '太陽光度', one: '{0}L☉', other: '{0} 太陽光度'),
  );
  ...
  Unit get massTon => const Unit(
    long: UnitCountPattern(_locale, '英噸', one: '{0} ton', other: '{0} 英噸'),
    short: UnitCountPattern(_locale, '英噸', one: '{0} tn', other: '{0} 英噸'),
    narrow: UnitCountPattern(_locale, '英噸', one: '{0}tn', other: '{0} 英噸'),
  );
  ...
  Unit get massOunce => const Unit(
    long: UnitCountPattern(_locale, '安士', one: '{0} ounce', other: '{0} 安士'),
    short: UnitCountPattern(_locale, '安士', one: '{0} oz', other: '{0} 安士'),
    narrow: UnitCountPattern(_locale, '安士', one: '{0}oz', other: '{0} 安士'),
  );
  ...
  Unit get massDalton => const Unit(
    long: UnitCountPattern(_locale, '道爾頓', one: '{0} dalton', other: '{0} 道爾頓'),
    short: UnitCountPattern(_locale, '道爾頓', one: '{0} Da', other: '{0} 道爾頓'),
    narrow: UnitCountPattern(_locale, '道爾頓', one: '{0}Da', other: '{0} 道爾頓'),
  );
  ...
  Unit get massGrain => const Unit(
    long: UnitCountPattern(_locale, '喱', one: '{0} grain', other: '{0}格令'),
    short: UnitCountPattern(_locale, '喱', one: '{0} gr', other: '{0} 喱'),
    narrow: UnitCountPattern(_locale, '喱', one: '{0}gr', other: '{0} 喱'),
  );
  ...
  Unit get powerMegawatt => const Unit(
    ...
    short: UnitCountPattern(_locale, '百萬瓦特', one: '{0} MW', other: '{0} 百萬瓦特'),
    narrow: UnitCountPattern(_locale, '百萬瓦特', one: '{0}MW', other: '{0} 百萬瓦特'),
  );
  ...
  Unit get powerKilowatt => const Unit(
    ...
    short: UnitCountPattern(_locale, '千瓦特', one: '{0} kW', other: '{0} 千瓦特'),
    narrow: UnitCountPattern(_locale, '千瓦特', one: '{0}kW', other: '{0} 千瓦特'),
  );

  @override
  Unit get powerWatt => const Unit(
    long: UnitCountPattern(_locale, '瓦特', one: '{0} watt', other: '{0} 瓦特'),
    short: UnitCountPattern(_locale, '瓦特', one: '{0} W', other: '{0} 瓦特'),
  ...
  Unit get powerMilliwatt => const Unit(
    ...
    short: UnitCountPattern(_locale, '毫瓦特', one: '{0} mW', other: '{0} 毫瓦特'),
    narrow: UnitCountPattern(_locale, '毫瓦特', one: '{0}mW', other: '{0} 毫瓦特'),
  );

  @override
  Unit get powerHorsepower => const Unit(
    long: UnitCountPattern(_locale, '匹', one: '{0} horsepower', other: '{0} 匹'),
  ...
  Unit get pressurePascal => const Unit(
    ...
    short: UnitCountPattern(_locale, '帕斯卡', one: '{0} Pa', other: '{0} 帕斯卡'),
    narrow: UnitCountPattern(_locale, '帕斯卡', one: '{0}Pa', other: '{0} 帕斯卡'),
  );
  ...
  Unit get speedMeterPerSecond => const Unit(
    ...
    short: UnitCountPattern(_locale, '米/秒', one: '{0} m/s', other: '每秒{0}米'),
    narrow: UnitCountPattern(_locale, '米/秒', one: '{0}m/s', other: '每秒 {0} 米'),
  );
  ...
  Unit get temperatureKelvin => const Unit(
    ...
    narrow: UnitCountPattern(_locale, '克耳文', one: '{0}K', other: '{0} 克耳文'),
  );
  ...
  Unit get torquePoundForceFoot => const Unit(
    ...
    short: UnitCountPattern(_locale, '尺磅', one: '{0} lbf⋅ft', other: '{0} 尺磅'),
    narrow: UnitCountPattern(_locale, '尺磅', one: '{0}lbf⋅ft', other: '{0} 尺磅'),
  );
  ...
  Unit get volumeCubicMeter => const Unit(
    ...
    short: UnitCountPattern(_locale, '立方米', one: '{0} m³', other: '{0} 立方米'),
    narrow: UnitCountPattern(_locale, '立方米', one: '{0}m³', other: '{0} 立方米'),
  );
  ...
  Unit get volumeCubicCentimeter => const Unit(
    ...
    short: UnitCountPattern(_locale, '立方厘米', one: '{0} cm³', other: '{0} 立方厘米'),
    narrow: UnitCountPattern(_locale, '立方厘米', one: '{0}cm³', other: '{0} 立方厘米'),
  );
  ...
  Unit get volumeCubicFoot => const Unit(
    ...
    short: UnitCountPattern(_locale, '立方英呎', one: '{0} ft³', other: '{0} 立方英呎'),
    narrow: UnitCountPattern(_locale, '立方英呎', one: '{0}ft³', other: '{0} 立方英呎'),
  );
  ...
  Unit get volumeCubicInch => const Unit(
    ...
    short: UnitCountPattern(_locale, '立方英吋', one: '{0} in³', other: '{0} 立方英吋'),
    narrow: UnitCountPattern(_locale, '立方英吋', one: '{0}in³', other: '{0} 立方英吋'),
  );
  ...
  Unit get volumeLiter => const Unit(
    ...
    short: UnitCountPattern(_locale, '公升', one: '{0} L', other: '{0} 公升'),
    narrow: UnitCountPattern(_locale, '公升', one: '{0}L', other: '{0} 公升'),
  );
  ...
  Unit get volumeTablespoon => const Unit(
    ...
    narrow: UnitCountPattern(_locale, '湯匙', one: '{0}tbsp', other: '{0} 湯匙'),
  );
  ...
  Unit get volumeJigger => const Unit(
    long: UnitCountPattern(_locale, '量酒杯', one: '{0} jigger', other: '量酒器{0}杯'),
    short: UnitCountPattern(
      _locale,
      '量酒杯',
      one: '{0} jigger',
  ...
  Unit get speedLightSpeed => const Unit(
    long: UnitCountPattern(_locale, '光速', one: '{0} light', other: '{0} 光速'),
    short: UnitCountPattern(_locale, '光速', one: '{0} light', other: '{0} 光速'),
    narrow: UnitCountPattern(_locale, '光速', one: '{0}light', other: '{0}光速'),
  );
  ...
  Unit get durationNight => const Unit(
    long: UnitCountPattern(_locale, '晚', one: '{0} night', other: '{0} 晚'),
    short: UnitCountPattern(_locale, '晚', one: '{0} night', other: '{0} 晚'),
    narrow: UnitCountPattern(_locale, '晚', one: '{0}night', other: '{0}晚'),
  );
}

class DateFieldsYue extends DateFields {
  const DateFieldsYue(super.cld);

  @override
  MultiLength get era =>
      const MultiLength(long: '年代', short: '年代', narrow: '年代');

  @override
  DateFieldFullData get year => const DateFieldFullData(
    displayName: MultiLength(long: '年', short: '年', narrow: '年'),
    previous: MultiLength(long: '舊年', short: '舊年', narrow: '舊年'),
    now: MultiLength(long: '今年', short: '今年', narrow: '今年'),
    next: MultiLength(long: '下年', short: '下年', narrow: '下年'),
  ...
  DateFieldFullData get quarter => const DateFieldFullData(
    displayName: MultiLength(long: '季', short: '季', narrow: '季'),
    previous: MultiLength(long: '上一季', short: '上季', narrow: '上季'),
    now: MultiLength(long: '今季', short: '今季', narrow: '今季'),
    next: MultiLength(long: '下一季', short: '下季', narrow: '下季'),
    past: MultiLengthRelativeTime(
  ...
  DateFieldFullData get month => const DateFieldFullData(
    ...
    now: MultiLength(long: '今個月', short: '今個月', narrow: '今個月'),
  ...
  DateFieldFullData get week => const DateFieldFullData(
    ...
    previous: MultiLength(long: '上星期', short: '上星期', narrow: '上星期'),
    now: MultiLength(long: '今個星期', short: '今個星期', narrow: '今個星期'),
    next: MultiLength(long: '下星期', short: '下星期', narrow: '下星期'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(_locale, other: '{0} 個星期前'),
      short: RelativeTime(_locale, other: '{0} 個星期前'),
      narrow: RelativeTime(_locale, other: '{0} 個星期前'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(_locale, other: '{0} 個星期後'),
      short: RelativeTime(_locale, other: '{0} 個星期後'),
      narrow: RelativeTime(_locale, other: '{0} 個星期後'),
    ),
  );

  @override
  MultiLength get weekOfMonth =>
      const MultiLength(long: '月週', short: '月週', narrow: '月週');

  @override
  DateFieldFullData get day => const DateFieldFullData(
    displayName: MultiLength(long: '日', short: '日', narrow: '日'),
    previous: MultiLength(long: '尋日', short: '尋日', narrow: '尋日'),
    now: MultiLength(long: '今日', short: '今日', narrow: '今日'),
    next: MultiLength(long: '聽日', short: '聽日', narrow: '聽日'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(_locale, other: '{0} 日前'),
      short: RelativeTime(_locale, other: '{0} 日前'),
      narrow: RelativeTime(_locale, other: '{0} 日前'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(_locale, other: '{0} 日後'),
      short: RelativeTime(_locale, other: '{0} 日後'),
      narrow: RelativeTime(_locale, other: '{0} 日後'),
    ),
  );

  @override
  MultiLength get dayOfYear =>
      const MultiLength(long: '年日', short: '年日', narrow: '年日');

  @override
  MultiLength get weekday =>
      const MultiLength(long: '週天', short: '週天', narrow: '週天');

  @override
  MultiLength get weekdayOfMonth =>
      const MultiLength(long: '月平日', short: '月平日', narrow: '月平日');

  @override
  DateFieldDataWithRelative get sunday => const DateFieldDataWithRelative(
    previous: MultiLength(long: '上星期日', short: '上星期日', narrow: '上星期日'),
    now: MultiLength(long: '今個星期日', short: '今個星期日', narrow: '今個星期日'),
    next: MultiLength(long: '下星期日', short: '下星期日', narrow: '下星期日'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(_locale, other: '{0} 個星期日前'),
      short: RelativeTime(_locale, other: '{0} 個星期日前'),
      narrow: RelativeTime(_locale, other: '{0} 個星期日前'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(_locale, other: '{0} 個星期日後'),
      short: RelativeTime(_locale, other: '{0} 個星期日後'),
      narrow: RelativeTime(_locale, other: '{0} 個星期日後'),
    ),
  );

  @override
  DateFieldDataWithRelative get monday => const DateFieldDataWithRelative(
    previous: MultiLength(long: '上星期一', short: '上星期一', narrow: '上星期一'),
    now: MultiLength(long: '今個星期一', short: '今個星期一', narrow: '今個星期一'),
    next: MultiLength(long: '下星期一', short: '下星期一', narrow: '下星期一'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(_locale, other: '{0} 個星期一前'),
      short: RelativeTime(_locale, other: '{0} 個星期一前'),
      narrow: RelativeTime(_locale, other: '{0} 個星期一前'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(_locale, other: '{0} 個星期一後'),
      short: RelativeTime(_locale, other: '{0} 個星期一後'),
      narrow: RelativeTime(_locale, other: '{0} 個星期一後'),
    ),
  );

  @override
  DateFieldDataWithRelative get tuesday => const DateFieldDataWithRelative(
    previous: MultiLength(long: '上星期二', short: '上星期二', narrow: '上星期二'),
    now: MultiLength(long: '今個星期二', short: '今個星期二', narrow: '今個星期二'),
    next: MultiLength(long: '下星期二', short: '下星期二', narrow: '下星期二'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(_locale, other: '{0} 個星期二前'),
      short: RelativeTime(_locale, other: '{0} 個星期二前'),
      narrow: RelativeTime(_locale, other: '{0} 個星期二前'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(_locale, other: '{0} 個星期二後'),
      short: RelativeTime(_locale, other: '{0} 個星期二後'),
      narrow: RelativeTime(_locale, other: '{0} 個星期二後'),
    ),
  );

  @override
  DateFieldDataWithRelative get wednesday => const DateFieldDataWithRelative(
    previous: MultiLength(long: '上星期三', short: '上星期三', narrow: '上星期三'),
    now: MultiLength(long: '今個星期三', short: '今個星期三', narrow: '今個星期三'),
    next: MultiLength(long: '下星期三', short: '下星期三', narrow: '下星期三'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(_locale, other: '{0} 個星期三前'),
      short: RelativeTime(_locale, other: '{0} 個星期三前'),
      narrow: RelativeTime(_locale, other: '{0} 個星期三前'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(_locale, other: '{0} 個星期三後'),
      short: RelativeTime(_locale, other: '{0} 個星期三後'),
      narrow: RelativeTime(_locale, other: '{0} 個星期三後'),
    ),
  );

  @override
  DateFieldDataWithRelative get thursday => const DateFieldDataWithRelative(
    previous: MultiLength(long: '上星期四', short: '上星期四', narrow: '上星期四'),
    now: MultiLength(long: '今個星期四', short: '今個星期四', narrow: '今個星期四'),
    next: MultiLength(long: '下星期四', short: '下星期四', narrow: '下星期四'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(_locale, other: '{0} 個星期四前'),
      short: RelativeTime(_locale, other: '{0} 個星期四前'),
      narrow: RelativeTime(_locale, other: '{0} 個星期四前'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(_locale, other: '{0} 個星期四後'),
      short: RelativeTime(_locale, other: '{0} 個星期四後'),
      narrow: RelativeTime(_locale, other: '{0} 個星期四後'),
    ),
  );

  @override
  DateFieldDataWithRelative get friday => const DateFieldDataWithRelative(
    previous: MultiLength(long: '上星期五', short: '上星期五', narrow: '上星期五'),
    now: MultiLength(long: '今個星期五', short: '今個星期五', narrow: '今個星期五'),
    next: MultiLength(long: '下星期五', short: '下星期五', narrow: '下星期五'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(_locale, other: '{0} 個星期五前'),
      short: RelativeTime(_locale, other: '{0} 個星期五前'),
      narrow: RelativeTime(_locale, other: '{0} 個星期五前'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(_locale, other: '{0} 個星期五後'),
      short: RelativeTime(_locale, other: '{0} 個星期五後'),
      narrow: RelativeTime(_locale, other: '{0} 個星期五後'),
    ),
  );

  @override
  DateFieldDataWithRelative get saturday => const DateFieldDataWithRelative(
    previous: MultiLength(long: '上星期六', short: '上星期六', narrow: '上星期六'),
    now: MultiLength(long: '今個星期六', short: '今個星期六', narrow: '今個星期六'),
    next: MultiLength(long: '下星期六', short: '下星期六', narrow: '下星期六'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(_locale, other: '{0} 個星期六前'),
      short: RelativeTime(_locale, other: '{0} 個星期六前'),
      narrow: RelativeTime(_locale, other: '{0} 個星期六前'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(_locale, other: '{0} 個星期六後'),
      short: RelativeTime(_locale, other: '{0} 個星期六後'),
      narrow: RelativeTime(_locale, other: '{0} 個星期六後'),
    ),
  );

  @override
  MultiLength get dayperiod =>
      const MultiLength(long: '上午/下午', short: '上午/下午', narrow: '上午/下午');

  @override
  DateFieldDataTime get hour => const DateFieldDataTime(
    displayName: MultiLength(long: '小時', short: '小時', narrow: '小時'),
    now: MultiLength(long: '呢個小時', short: '呢個小時', narrow: '呢個小時'),
    past: MultiLengthRelativeTime(
  ...
  DateFieldDataTime get minute => const DateFieldDataTime(
    displayName: MultiLength(long: '分鐘', short: '分鐘', narrow: '分鐘'),
    now: MultiLength(long: '呢分鐘', short: '呢分鐘', narrow: '呢分鐘'),
    past: MultiLengthRelativeTime(
  ...
  DateFieldDataTime get second => const DateFieldDataTime(
    ...
    now: MultiLength(long: '宜家', short: '宜家', narrow: '宜家'),
    past: MultiLengthRelativeTime(
...
class TerritoriesYue extends Territories {
  const TerritoriesYue(super.cld);
...
class SubdivisionsYue extends Subdivisions {
  const SubdivisionsYue(super.cld);
...
class CurrenciesYue extends Currencies {
  const CurrenciesYue(super.cld);
...
class LocaleDisplayNameYue extends LocaleDisplayName {
  const LocaleDisplayNameYue(super.cld);
  ...
  static const staticValueNames = <String, Map<String, String>>{
    ...
    'd0': {'fwidth': '全形', 'hwidth': '半形', 'npinyin': '數值'},
    'hc': {
      'h11': '12 小時制 (0–11)',
      'h12': '12 小時制 (1–12)',
      'h23': '24 小時制 (0–23)',
