...
const _cld = CommonLocaleDataAzLatn._();
...
class CommonLocaleDataAzLatn implements CommonLocaleData {
  ...
  const CommonLocaleDataAzLatn._();
  ...
  static final _units = UnitsAzLatn._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsAzLatn._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesAzLatn._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsAzLatn._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesAzLatn._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsAzLatn._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsAzLatn._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesAzLatn._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesAzLatn._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameAzLatn._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsAzLatn extends Units {
  UnitsAzLatn._(super.cld);
...
class LanguagesAzLatn extends Languages {
  const LanguagesAzLatn._(super.cld);
...
class ScriptsAzLatn extends Scripts {
  const ScriptsAzLatn._(super.cld);
...
class TerritoriesAzLatn extends Territories {
  const TerritoriesAzLatn._(super.cld);
...
class VariantsAzLatn extends Variants {
  const VariantsAzLatn._(super.cld);
...
class SubdivisionsAzLatn extends Subdivisions {
  const SubdivisionsAzLatn._(super.cld);
...
class CurrenciesAzLatn extends Currencies {
  const CurrenciesAzLatn._(super.cld);
...
class TimeZonesAzLatn extends TimeZones {
  const TimeZonesAzLatn._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
...
class LocaleDisplayNameAzLatn extends LocaleDisplayName {
  const LocaleDisplayNameAzLatn._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
