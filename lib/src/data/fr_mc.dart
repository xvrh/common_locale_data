...
const _locale = 'fr-MC';
const _cld = CommonLocaleDataFrMC._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataFrMC implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataFrMC._();
  ...
  static final _units = UnitsFrMC._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsFrMC._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesFrMC._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsFrMC._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesFrMC._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsFrMC._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsFrMC._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesFrMC._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesFrMC._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameFrMC._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsFrMC extends Units {
  UnitsFrMC._(super.cld);
...
class DateFieldsFrMC extends DateFields {
  DateFieldsFrMC._(super.cld);
...
class LanguagesFrMC extends Languages {
  const LanguagesFrMC._(super.cld);
...
class ScriptsFrMC extends Scripts {
  const ScriptsFrMC._(super.cld);
...
class TerritoriesFrMC extends Territories {
  const TerritoriesFrMC._(super.cld);
...
class VariantsFrMC extends Variants {
  const VariantsFrMC._(super.cld);
...
class SubdivisionsFrMC extends Subdivisions {
  const SubdivisionsFrMC._(super.cld);
...
class CurrenciesFrMC extends Currencies {
  const CurrenciesFrMC._(super.cld);
...
class TimeZonesFrMC extends TimeZones {
  const TimeZonesFrMC._(super.cld)
      : super(
            gmtFormat: 'UTC{0}',
            gmtZeroFormat: 'UTC',
...
class LocaleDisplayNameFrMC extends LocaleDisplayName {
  const LocaleDisplayNameFrMC._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
