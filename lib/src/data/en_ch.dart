...
const _locale = 'en-CH';
const _cld = CommonLocaleDataEnCH._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEnCH implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataEnCH._();
  ...
  static final _units = UnitsEnCH._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEnCH._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEnCH._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsEnCH._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesEnCH._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsEnCH._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsEnCH._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesEnCH._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEnCH._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEnCH._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEnCH extends Units {
  UnitsEnCH._(super.cld);
...
class DateFieldsEnCH extends DateFields {
  DateFieldsEnCH._(super.cld);
...
class LanguagesEnCH extends Languages {
  const LanguagesEnCH._(super.cld);
...
class ScriptsEnCH extends Scripts {
  const ScriptsEnCH._(super.cld);
...
class TerritoriesEnCH extends Territories {
  const TerritoriesEnCH._(super.cld);
...
class VariantsEnCH extends Variants {
  const VariantsEnCH._(super.cld);
...
class SubdivisionsEnCH extends Subdivisions {
  const SubdivisionsEnCH._(super.cld);
...
class CurrenciesEnCH extends Currencies {
  const CurrenciesEnCH._(super.cld);
...
class TimeZonesEnCH extends TimeZones {
  const TimeZonesEnCH._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
            regionFormat: '{0} Time',
...
class LocaleDisplayNameEnCH extends LocaleDisplayName {
  const LocaleDisplayNameEnCH._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
