...
const _locale = 'fr-LU';
const _cld = CommonLocaleDataFrLU._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataFrLU implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataFrLU._();
  ...
  static final _units = UnitsFrLU._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsFrLU._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesFrLU._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsFrLU._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesFrLU._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsFrLU._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsFrLU._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesFrLU._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesFrLU._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameFrLU._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsFrLU extends Units {
  UnitsFrLU._(super.cld);
...
class DateFieldsFrLU extends DateFields {
  DateFieldsFrLU._(super.cld);
...
class LanguagesFrLU extends Languages {
  const LanguagesFrLU._(super.cld);
...
class ScriptsFrLU extends Scripts {
  const ScriptsFrLU._(super.cld);
...
class TerritoriesFrLU extends Territories {
  const TerritoriesFrLU._(super.cld);
...
class VariantsFrLU extends Variants {
  const VariantsFrLU._(super.cld);
...
class SubdivisionsFrLU extends Subdivisions {
  const SubdivisionsFrLU._(super.cld);
...
class CurrenciesFrLU extends Currencies {
  const CurrenciesFrLU._(super.cld);
...
class TimeZonesFrLU extends TimeZones {
  const TimeZonesFrLU._(super.cld)
      : super(
            gmtFormat: 'UTC{0}',
            gmtZeroFormat: 'UTC',
...
class LocaleDisplayNameFrLU extends LocaleDisplayName {
  const LocaleDisplayNameFrLU._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
