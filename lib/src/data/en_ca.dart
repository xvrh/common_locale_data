...
const _locale = 'en-CA';
const _cld = CommonLocaleDataEnCA._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEnCA implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataEnCA._();
  ...
  static final _units = UnitsEnCA._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEnCA._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEnCA._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsEnCA._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesEnCA._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsEnCA._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsEnCA._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesEnCA._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEnCA._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEnCA._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEnCA extends Units {
  UnitsEnCA._(super.cld);
...
class DateFieldsEnCA extends DateFields {
  DateFieldsEnCA._(super.cld);
...
class LanguagesEnCA extends Languages {
  const LanguagesEnCA._(super.cld);
...
class ScriptsEnCA extends Scripts {
  const ScriptsEnCA._(super.cld);
...
class TerritoriesEnCA extends Territories {
  const TerritoriesEnCA._(super.cld);
...
class VariantsEnCA extends Variants {
  const VariantsEnCA._(super.cld);
...
class SubdivisionsEnCA extends Subdivisions {
  const SubdivisionsEnCA._(super.cld);
...
class CurrenciesEnCA extends Currencies {
  const CurrenciesEnCA._(super.cld);
...
class TimeZonesEnCA extends TimeZones {
  const TimeZonesEnCA._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
            regionFormat: '{0} Time',
...
class LocaleDisplayNameEnCA extends LocaleDisplayName {
  const LocaleDisplayNameEnCA._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
