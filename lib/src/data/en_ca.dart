...
class UnitsEnCA extends UnitsEn {
  ...
  Unit get angleRevolution => const Unit(
    ...
    short: UnitCountPattern(_locale, 'rev', one: '{0} rev', other: '{0} revs'),
    narrow: UnitCountPattern(_locale, 'rev', one: '{0}rev', other: '{0}revs'),
  );
  ...
  Unit get areaSquareMeter => const Unit(
    ...
    short: UnitCountPattern(_locale, 'metres²', one: '{0} m²', other: '{0} m²'),
    narrow: UnitCountPattern(_locale, 'metres²', one: '{0}m²', other: '{0}m²'),
  );
  ...
  Unit get concentrPermyriad => const Unit(
    ...
    short: UnitCountPattern(_locale, 'per myriad', one: '{0}‱', other: '{0}‱'),
    narrow: UnitCountPattern(_locale, '‱', one: '{0}‱', other: '{0}‱'),
  );
  ...
  Unit get concentrMole => const Unit(
    ...
    short: UnitCountPattern(_locale, 'moles', one: '{0} mol', other: '{0} mol'),
  ...
  Unit get durationMonth => const Unit(
    ...
    short: UnitCountPattern(_locale, 'months', one: '{0} mo', other: '{0} mos'),
  ...
  Unit get lengthMeter => const Unit(
    ...
    short: UnitCountPattern(_locale, 'metres', one: '{0} m', other: '{0} m'),
    narrow: UnitCountPattern(_locale, 'metre', one: '{0}m', other: '{0}m'),
  );
  ...
  Unit get massCarat => const Unit(
    ...
    short: UnitCountPattern(_locale, 'carats', one: '{0} ct', other: '{0} ct'),
  ...
  Unit get pressureBar => const Unit(
    ...
    short: UnitCountPattern(_locale, 'bars', one: '{0} bar', other: '{0} bar'),
  ...
  Unit get temperatureGeneric => const Unit(
    ...
    short: UnitCountPattern(_locale, 'deg', one: '{0}°', other: '{0}°'),
  ...
  Unit get volumeCup => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'cups', one: '{0}c', other: '{0}c'),
  );
...
class DateFieldsEnCA extends DateFieldsEn {
  ...
  DateFieldFullData get year => const DateFieldFullData(
    ...
    past: MultiLengthRelativeTime(
      ...
      short: RelativeTime(_locale, one: '{0} yr ago', other: '{0} yrs ago'),
      narrow: RelativeTime(_locale, one: '{0} yr ago', other: '{0} yrs ago'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(_locale, one: 'in {0} year', other: 'in {0} years'),
      short: RelativeTime(_locale, one: 'in {0} yr', other: 'in {0} yrs'),
      narrow: RelativeTime(_locale, one: 'in {0} yr', other: 'in {0} yrs'),
    ),
  );
  ...
  DateFieldFullData get quarter => const DateFieldFullData(
    ...
    past: MultiLengthRelativeTime(
      ...
      narrow: RelativeTime(_locale, one: '{0} qtr ago', other: '{0} qtrs ago'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
      ...
      narrow: RelativeTime(_locale, one: 'in {0} qtr', other: 'in {0} qtrs'),
    ),
  );
  ...
  DateFieldFullData get month => const DateFieldFullData(
    ...
    next: MultiLength(long: 'next month', short: 'next mo', narrow: 'next mo'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
        one: '{0} month ago',
      ...
      short: RelativeTime(_locale, one: '{0} mo ago', other: '{0} mos ago'),
      narrow: RelativeTime(_locale, one: '{0} mo ago', other: '{0} mos ago'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(_locale, one: 'in {0} month', other: 'in {0} months'),
      short: RelativeTime(_locale, one: 'in {0} mo', other: 'in {0} mos'),
      narrow: RelativeTime(_locale, one: 'in {0} mo', other: 'in {0} mos'),
    ),
  );
  ...
  DateFieldFullData get week => const DateFieldFullData(
    ...
    past: MultiLengthRelativeTime(
      ...
      short: RelativeTime(_locale, one: '{0} wk ago', other: '{0} wks ago'),
      narrow: RelativeTime(_locale, one: '{0} wk ago', other: '{0} wks ago'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(_locale, one: 'in {0} week', other: 'in {0} weeks'),
      short: RelativeTime(_locale, one: 'in {0} wk', other: 'in {0} wks'),
      narrow: RelativeTime(_locale, one: 'in {0} wk', other: 'in {0} wks'),
    ),
  );
  ...
  DateFieldDataWithRelative get sunday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: 'this Sunday', short: 'this Sun', narrow: 'this Su'),
    next: MultiLength(
      long: 'next Sunday',
      short: 'next Sun',
      narrow: 'next Su',
    ...
    past: MultiLengthRelativeTime(
      ...
      short: RelativeTime(_locale, one: '{0} Sun ago', other: '{0} Sun’s ago'),
      narrow: RelativeTime(_locale, one: '{0} Su ago', other: '{0} Su’s ago'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
      ...
      short: RelativeTime(_locale, one: 'in {0} Sun', other: 'in {0} Sun’s'),
      narrow: RelativeTime(_locale, one: 'in {0} Su', other: 'in {0} Su’s'),
    ),
  );
  ...
  DateFieldDataWithRelative get monday => const DateFieldDataWithRelative(
    ...
    past: MultiLengthRelativeTime(
      ...
      short: RelativeTime(_locale, one: '{0} Mon ago', other: '{0} Mon’s ago'),
      narrow: RelativeTime(_locale, one: '{0} M ago', other: '{0} M’s ago'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
      ...
      short: RelativeTime(_locale, one: 'in {0} Mon', other: 'in {0} Mon’s'),
      narrow: RelativeTime(_locale, one: 'in {0} M', other: 'in {0} M’s'),
    ),
  );
  ...
  DateFieldDataWithRelative get tuesday => const DateFieldDataWithRelative(
    ...
    past: MultiLengthRelativeTime(
      ...
      short: RelativeTime(_locale, one: '{0} Tue ago', other: '{0} Tue’s ago'),
      narrow: RelativeTime(_locale, one: '{0} Tu ago', other: '{0} Tu’s ago'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
      ...
      short: RelativeTime(_locale, one: 'in {0} Tue', other: 'in {0} Tue’s'),
      narrow: RelativeTime(_locale, one: 'in {0} Tu', other: 'in {0} Tu’s'),
    ),
  );
  ...
  DateFieldDataWithRelative get wednesday => const DateFieldDataWithRelative(
    ...
    past: MultiLengthRelativeTime(
      ...
      short: RelativeTime(_locale, one: '{0} Wed ago', other: '{0} Wed’s ago'),
      narrow: RelativeTime(_locale, one: '{0} W ago', other: '{0} W’s ago'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
      ...
      short: RelativeTime(_locale, one: 'in {0} Wed', other: 'in {0} Wed’s'),
      narrow: RelativeTime(_locale, one: 'in {0} W', other: 'in {0} W’s'),
    ),
  );
  ...
  DateFieldDataWithRelative get thursday => const DateFieldDataWithRelative(
    ...
    past: MultiLengthRelativeTime(
      ...
      short: RelativeTime(_locale, one: '{0} Thu ago', other: '{0} Thu’s ago'),
      narrow: RelativeTime(_locale, one: '{0} Th ago', other: '{0} Th’s ago'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
      ...
      short: RelativeTime(_locale, one: 'in {0} Thu', other: 'in {0} Thu’s'),
      narrow: RelativeTime(_locale, one: 'in {0} Th', other: 'in {0} Th’s'),
    ),
  );
  ...
  DateFieldDataWithRelative get friday => const DateFieldDataWithRelative(
    ...
    past: MultiLengthRelativeTime(
      ...
      short: RelativeTime(_locale, one: '{0} Fri ago', other: '{0} Fri’s ago'),
      narrow: RelativeTime(_locale, one: '{0} F ago', other: '{0} F’s ago'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
      ...
      short: RelativeTime(_locale, one: 'in {0} Fri', other: 'in {0} Fri’s'),
      narrow: RelativeTime(_locale, one: 'in {0} F', other: 'in {0} F’s'),
    ),
  );
  ...
  DateFieldDataWithRelative get saturday => const DateFieldDataWithRelative(
    ...
    past: MultiLengthRelativeTime(
      ...
      short: RelativeTime(_locale, one: '{0} Sat ago', other: '{0} Sat’s ago'),
      narrow: RelativeTime(_locale, one: '{0} Sa ago', other: '{0} Sa’s ago'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
      ...
      short: RelativeTime(_locale, one: 'in {0} Sat', other: 'in {0} Sat’s'),
      narrow: RelativeTime(_locale, one: 'in {0} Sa', other: 'in {0} Sa’s'),
    ),
  );
  ...
  DateFieldDataTime get hour => const DateFieldDataTime(
    ...
    past: MultiLengthRelativeTime(
      ...
      short: RelativeTime(_locale, one: '{0} hr ago', other: '{0} hrs ago'),
      narrow: RelativeTime(_locale, one: '{0} hr ago', other: '{0} hrs ago'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(_locale, one: 'in {0} hour', other: 'in {0} hours'),
      short: RelativeTime(_locale, one: 'in {0} hr', other: 'in {0} hrs'),
      narrow: RelativeTime(_locale, one: 'in {0} hr', other: 'in {0} hrs'),
    ),
  );
  ...
  DateFieldDataTime get minute => const DateFieldDataTime(
    ...
    past: MultiLengthRelativeTime(
      ...
      short: RelativeTime(_locale, one: '{0} min ago', other: '{0} mins ago'),
      narrow: RelativeTime(_locale, one: '{0} min ago', other: '{0} mins ago'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
      ...
      short: RelativeTime(_locale, one: 'in {0} min', other: 'in {0} mins'),
      narrow: RelativeTime(_locale, one: 'in {0} min', other: 'in {0} mins'),
    ),
  );
  ...
  DateFieldDataTime get second => const DateFieldDataTime(
    ...
    past: MultiLengthRelativeTime(
      ...
      short: RelativeTime(_locale, one: '{0} sec ago', other: '{0} secs ago'),
      narrow: RelativeTime(_locale, one: '{0} sec ago', other: '{0} secs ago'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
      ...
      short: RelativeTime(_locale, one: 'in {0} sec', other: 'in {0} secs'),
      narrow: RelativeTime(_locale, one: 'in {0} sec', other: 'in {0} secs'),
    ),
  );
}
  ...
  Map<String, MetaZone> get metaZoneNames => Map.unmodifiable({
    ...
    ...const {
      ...
      'Australia_Eastern': MetaZone(
        ...
        short: TimeZoneName(generic: 'AET', standard: 'AEST', daylight: 'AEDT'),
      ),
      ...
      'French_Southern': MetaZone(
        'French_Southern',
        long: TimeZoneName(standard: 'French Southern and Antarctic Time'),
      ),
      'Galapagos': MetaZone(
        'Galapagos',
