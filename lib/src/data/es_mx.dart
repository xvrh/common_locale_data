...
class UnitsEsMX extends UnitsEs {
  ...
  Unit get accelerationGForce => const Unit(
    ...
    short: UnitCountPattern(_locale, 'fuerza G', one: '{0} G', other: '{0} G'),
    narrow: UnitCountPattern(_locale, 'fuerza G', one: '{0}Fg', other: '{0}Fg'),
  );
  ...
  Unit get areaSquareMeter => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'metros²', one: '{0}m²', other: '{0}m²'),
  );
  ...
  Unit get concentrKarat => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'kt', one: '{0}kt', other: '{0}ct'),
  );
  ...
  Unit get digitalByte => const Unit(
    ...
    short: UnitCountPattern(_locale, 'B', one: '{0} B', other: '{0} byte'),
  ...
  Unit get durationMonth => const Unit(
    ...
    short: UnitCountPattern(_locale, 'meses', one: '{0} m.', other: '{0} m'),
  ...
  Unit get durationWeek => const Unit(
    ...
    short: UnitCountPattern(_locale, 'sem', one: '{0} sem.', other: '{0} sem'),
  ...
  Unit get durationDay => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'días', one: '{0}d', other: '{0}d'),
  );
  ...
  Unit get lengthMile => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'millas', one: '{0}mi', other: '{0}mi'),
  );
  ...
  Unit get lengthParsec => const Unit(
    ...
    short: UnitCountPattern(_locale, 'pc', one: '{0} pársec', other: '{0} pc'),
  ...
  Unit get lengthAstronomicalUnit => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'au', one: '{0}ua', other: '{0}ua'),
  );
  ...
  Unit get lengthNauticalMile => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'M', one: '{0}nmi', other: '{0}nmi'),
  );
  ...
  Unit get lightLux => const Unit(
    long: UnitCountPattern(_locale, 'lux', one: '{0} lux', other: '{0} luxes'),
  ...
  Unit get massStone => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'stones', one: '{0}st', other: '{0}st'),
  );
  ...
  Unit get massCarat => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'c', one: '{0}ct', other: '{0}ct'),
  );
  ...
  Unit get powerHorsepower => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'CV', one: '{0}hp', other: '{0}hp'),
  );
  ...
  Unit get speedBeaufort => const Unit(
    long: UnitCountPattern(_locale, 'Bft', one: 'B {0}', other: 'B {0}'),
  ...
  Unit get temperatureGeneric => const Unit(
    long: UnitCountPattern(_locale, 'grados', one: '{0}°', other: '{0}°'),
    short: UnitCountPattern(_locale, '°', one: '{0}°', other: '{0}°'),
    narrow: UnitCountPattern(_locale, '°', one: '{0}°', other: '{0}°'),
  );
  ...
  Unit get temperatureKelvin => const Unit(
    ...
    short: UnitCountPattern(_locale, 'K', one: 'kelvin', other: '{0} K'),
  ...
  Unit get torqueNewtonMeter => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'N⋅m', one: '{0}Nm', other: '{0}Nm'),
  );
  ...
  Unit get volumeTablespoon => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'cdas.', one: '{0}cda', other: '{0}cda'),
  );
...
class DateFieldsEsMX extends DateFieldsEs {
  ...
  DateFieldFullData get year => const DateFieldFullData(
    ...
    future: MultiLengthRelativeTime(
      ...
      short: RelativeTime(_locale, one: 'en {0} a', other: 'en {0} a'),
      narrow: RelativeTime(_locale, one: 'en {0} a', other: 'en {0} a'),
    ),
  );
  ...
  DateFieldFullData get month => const DateFieldFullData(
    ...
    future: MultiLengthRelativeTime(
      ...
      short: RelativeTime(_locale, one: 'en {0} m', other: 'en {0} m'),
      narrow: RelativeTime(_locale, one: 'en {0} m', other: 'en {0} m'),
    ),
  );
  ...
  DateFieldFullData get day => const DateFieldFullData(
    ...
    past: MultiLengthRelativeTime(
      ...
      short: RelativeTime(_locale, one: 'hace {0} día', other: 'hace {0} días'),
      narrow: RelativeTime(
        _locale,
        one: 'hace {0} día',
        other: 'hace {0} días',
  ...
  DateFieldDataTime get hour => const DateFieldDataTime(
    ...
    future: MultiLengthRelativeTime(
      ...
      short: RelativeTime(_locale, one: 'en {0} h', other: 'en {0} n'),
      narrow: RelativeTime(_locale, one: 'en {0} h', other: 'en {0} n'),
    ),
  );
...
class CurrenciesEsMX extends CurrenciesEs {
  ...
  static const _mvr = Currency(
    ...
    'MVR',
    'rupia de Maldivas',
    one: 'rupia de Maldivas',
    other: 'rupias de Maldivas',
  );
