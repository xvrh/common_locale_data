...
class UnitsPsPK extends UnitsPs {
  ...
  Unit get angleDegree => const Unit(
    long: UnitCountPattern(_locale, 'درجے', one: '{0} درجے', other: '{0} درجے'),
    short: UnitCountPattern(_locale, 'درجے', one: '{0} درجے', other: '{0}°'),
    narrow: UnitCountPattern(_locale, 'درجے', one: '{0} درجے', other: '{0}°'),
  );
  ...
  Unit get durationMonth => const Unit(
    ...
    short: UnitCountPattern(_locale, 'مياشتے', one: '{0} m', other: '{0} mths'),
    narrow: UnitCountPattern(_locale, 'مياشت', one: '{0} m', other: '{0} m'),
  );

  @override
  Unit get durationDay => const Unit(
    long: UnitCountPattern(_locale, 'ورځے', one: '{0} ورځ', other: '{0} ورځے'),
    short: UnitCountPattern(_locale, 'ورځے', one: '{0} ورځ', other: '{0} ورځے'),
    narrow: UnitCountPattern(_locale, 'ورځ', one: '{0} ورځ', other: '{0}d'),
  );

  @override
  Unit get lengthInch => const Unit(
    long: UnitCountPattern(_locale, 'انچے', one: '{0} انچ', other: '{0} انچے'),
    short: UnitCountPattern(_locale, 'انچے', one: '{0} انچ', other: '{0} in'),
    narrow: UnitCountPattern(_locale, 'انچے', one: '{0}″', other: '{0}″'),
  );
  ...
  Unit get volumeCup => const Unit(
    ...
    short: UnitCountPattern(_locale, 'پيالے', one: '{0} پياله', other: '{0} c'),
    narrow: UnitCountPattern(
      _locale,
      'پيالے',
      one: '{0} پياله',
...
class DateFieldsPsPK extends DateFieldsPs {
  ...
  DateFieldFullData get year => const DateFieldFullData(
    ...
    past: MultiLengthRelativeTime(
      long: RelativeTime(_locale, one: '{0} کال مخکے', other: '{0} کاله مخکے'),
      short: RelativeTime(_locale, one: '{0} کال مخکے', other: '{0} کاله مخکے'),
      narrow: RelativeTime(
        _locale,
        one: '{0} کال مخکے',
        other: '{0} کاله مخکے',
...
class LanguagesPsPK extends LanguagesPs {
  ...
  Map<String, Language> get languages => Map.unmodifiable({
    ...
    ...const {'ar-001': _ar001, 'dsb': _dsb, 'fo': _fo, 'kha': _kha, 'nb': _nb},
  });
}
...
class TerritoriesPsPK extends TerritoriesPs {
  ...
  Map<String, Territory> get territories => Map.unmodifiable({
    ...
    ...const {'019': _$019, 'PS': _ps, 'TC': _tc, 'TF': _tf},
  });
}
