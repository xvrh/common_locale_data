...
const _locale = 'es-BO';
const _cld = CommonLocaleDataEsBO.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEsBO extends CommonLocaleDataEs {
  @override
  String get locale => _locale;

  const CommonLocaleDataEsBO.constant() : super.constant();

  factory CommonLocaleDataEsBO() => _cld;
  ...
  static final _units = UnitsEsBO(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEsBO(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEsBO(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsEsBO(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesEsBO(_cld);
  @override
  Territories get territories => _territories;

  static final _currencies = CurrenciesEsBO(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEsBO(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEsBO(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEsBO extends UnitsEs {
  const UnitsEsBO(super.cld);
...
class DateFieldsEsBO extends DateFieldsEs {
  const DateFieldsEsBO(super.cld);
...
class LanguagesEsBO extends LanguagesEs {
  const LanguagesEsBO(super.cld);
...
class ScriptsEsBO extends ScriptsEs {
  const ScriptsEsBO(super.cld);
...
class TerritoriesEsBO extends TerritoriesEs {
  const TerritoriesEsBO(super.cld);
...
class CurrenciesEsBO extends CurrenciesEs {
  const CurrenciesEsBO(super.cld);
...
class TimeZonesEsBO extends TimeZonesEs {
  const TimeZonesEsBO(super.cld);
  ...
  Map<String, MetaZone> get metaZoneNames => Map.unmodifiable({
    ...
    ...const {
      ...
      'Bolivia': MetaZone(
        ...
        short: TimeZoneName(standard: 'BOT'),
      ),
      'Cocos': MetaZone(
        'Cocos',
...
class LocaleDisplayNameEsBO extends LocaleDisplayNameEs {
  const LocaleDisplayNameEsBO(super.cld);
