...
const _locale = 'fr-YT';
const _cld = CommonLocaleDataFrYT._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataFrYT implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataFrYT._();
  ...
  static final _units = UnitsFrYT._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsFrYT._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesFrYT._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsFrYT._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesFrYT._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsFrYT._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsFrYT._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesFrYT._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesFrYT._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameFrYT._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsFrYT extends Units {
  UnitsFrYT._(super.cld);
...
class DateFieldsFrYT extends DateFields {
  DateFieldsFrYT._(super.cld);
...
class LanguagesFrYT extends Languages {
  const LanguagesFrYT._(super.cld);
...
class ScriptsFrYT extends Scripts {
  const ScriptsFrYT._(super.cld);
...
class TerritoriesFrYT extends Territories {
  const TerritoriesFrYT._(super.cld);
...
class VariantsFrYT extends Variants {
  const VariantsFrYT._(super.cld);
...
class SubdivisionsFrYT extends Subdivisions {
  const SubdivisionsFrYT._(super.cld);
...
class CurrenciesFrYT extends Currencies {
  const CurrenciesFrYT._(super.cld);
...
class TimeZonesFrYT extends TimeZones {
  const TimeZonesFrYT._(super.cld)
      : super(
            gmtFormat: 'UTC{0}',
            gmtZeroFormat: 'UTC',
...
class LocaleDisplayNameFrYT extends LocaleDisplayName {
  const LocaleDisplayNameFrYT._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
