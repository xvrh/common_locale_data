...
const _locale = 'it-VA';
const _cld = CommonLocaleDataItVA._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataItVA implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataItVA._();
  ...
  static final _units = UnitsItVA._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsItVA._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesItVA._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsItVA._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesItVA._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsItVA._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsItVA._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesItVA._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesItVA._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameItVA._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsItVA extends Units {
  UnitsItVA._(super.cld);
...
class DateFieldsItVA extends DateFields {
  DateFieldsItVA._(super.cld);
...
class LanguagesItVA extends Languages {
  const LanguagesItVA._(super.cld);
...
class ScriptsItVA extends Scripts {
  const ScriptsItVA._(super.cld);
...
class TerritoriesItVA extends Territories {
  const TerritoriesItVA._(super.cld);
...
class VariantsItVA extends Variants {
  const VariantsItVA._(super.cld);
...
class SubdivisionsItVA extends Subdivisions {
  const SubdivisionsItVA._(super.cld);
...
class CurrenciesItVA extends Currencies {
  const CurrenciesItVA._(super.cld);
...
class TimeZonesItVA extends TimeZones {
  const TimeZonesItVA._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
            regionFormat: 'Ora {0}',
...
class LocaleDisplayNameItVA extends LocaleDisplayName {
  const LocaleDisplayNameItVA._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
