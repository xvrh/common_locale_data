...
const _locale = 'so-KE';
const _cld = CommonLocaleDataSoKE._();
...
class CommonLocaleDataSoKE implements CommonLocaleData {
  ...
  static final _units = UnitsSoKE._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsSoKE._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesSoKE._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsSoKE._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesSoKE._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsSoKE._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsSoKE._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesSoKE._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesSoKE._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameSoKE._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsSoKE extends Units {
  UnitsSoKE._(super.cld);
...
class DateFieldsSoKE extends DateFields {
  DateFieldsSoKE._(super.cld);
...
class LanguagesSoKE extends Languages {
  const LanguagesSoKE._(super.cld);
...
class TerritoriesSoKE extends Territories {
  const TerritoriesSoKE._(super.cld);
...
class VariantsSoKE extends Variants {
  const VariantsSoKE._(super.cld);
...
class SubdivisionsSoKE extends Subdivisions {
  const SubdivisionsSoKE._(super.cld);
...
class CurrenciesSoKE extends Currencies {
  const CurrenciesSoKE._(super.cld);
...
class TimeZonesSoKE extends TimeZones {
  const TimeZonesSoKE._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
...
class LocaleDisplayNameSoKE extends LocaleDisplayName {
  const LocaleDisplayNameSoKE._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
