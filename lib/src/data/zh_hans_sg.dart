...
class UnitsZhHansSG extends UnitsZhHans {
  ...
  Unit get concentrKarat => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'kt', one: '{0}kt', other: '{0}开'),
  );

  @override
  Unit get durationSecond => const Unit(
    long: UnitCountPattern(_locale, '秒钟', one: '{0} second', other: '{0}秒'),
  ...
  Unit get temperatureKelvin => const Unit(
    long: UnitCountPattern(_locale, '开氏度', one: '{0} kelvin', other: '{0}开氏度'),
...
class CurrenciesZhHansSG extends CurrenciesZhHans {
  ...
  Map<String, Currency> get currencies => Map.unmodifiable({
    ...
    ...const {'ANG': _ang, 'CNY': _cny, 'NIO': _nio, 'SGD': _sgd, 'XAG': _xag},
  });
}
...
class TimeZonesZhHansSG extends TimeZonesZhHans {
  ...
  Map<String, TimeZoneNames> get timeZoneNames => Map.unmodifiable({
    ...
    ...const {'America/Scoresbysund': TimeZoneNames(exemplarCity: '斯考斯伯松德')},
  });
