...
const _locale = 'es-419';
const _cld = CommonLocaleDataEs419.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEs419 extends CommonLocaleDataEs {
  @override
  String get locale => _locale;

  const CommonLocaleDataEs419.constant() : super.constant();

  factory CommonLocaleDataEs419() => _cld;
  ...
  static final _units = UnitsEs419(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEs419(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEs419(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsEs419(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesEs419(_cld);
  @override
  Territories get territories => _territories;

  static final _currencies = CurrenciesEs419(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEs419(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEs419(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEs419 extends UnitsEs {
  const UnitsEs419(super.cld);
...
class DateFieldsEs419 extends DateFieldsEs {
  const DateFieldsEs419(super.cld);
...
class LanguagesEs419 extends LanguagesEs {
  const LanguagesEs419(super.cld);
...
class ScriptsEs419 extends ScriptsEs {
  const ScriptsEs419(super.cld);
...
class TerritoriesEs419 extends TerritoriesEs {
  const TerritoriesEs419(super.cld);
...
class CurrenciesEs419 extends CurrenciesEs {
  const CurrenciesEs419(super.cld);
...
class TimeZonesEs419 extends TimeZonesEs {
  const TimeZonesEs419(super.cld);
...
class LocaleDisplayNameEs419 extends LocaleDisplayNameEs {
  const LocaleDisplayNameEs419(super.cld);
