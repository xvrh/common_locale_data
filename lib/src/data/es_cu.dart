...
const _locale = 'es-CU';
const _cld = CommonLocaleDataEsCU.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEsCU extends CommonLocaleDataEs {
  @override
  String get locale => _locale;

  const CommonLocaleDataEsCU.constant() : super.constant();

  factory CommonLocaleDataEsCU() => _cld;
  ...
  static final _units = UnitsEsCU(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEsCU(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEsCU(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsEsCU(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesEsCU(_cld);
  @override
  Territories get territories => _territories;

  static final _currencies = CurrenciesEsCU(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEsCU(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEsCU(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEsCU extends UnitsEs {
  const UnitsEsCU(super.cld);
...
class DateFieldsEsCU extends DateFieldsEs {
  const DateFieldsEsCU(super.cld);
...
class LanguagesEsCU extends LanguagesEs {
  const LanguagesEsCU(super.cld);
...
class ScriptsEsCU extends ScriptsEs {
  const ScriptsEsCU(super.cld);
...
class TerritoriesEsCU extends TerritoriesEs {
  const TerritoriesEsCU(super.cld);
...
class CurrenciesEsCU extends CurrenciesEs {
  const CurrenciesEsCU(super.cld);
...
class TimeZonesEsCU extends TimeZonesEs {
  const TimeZonesEsCU(super.cld);
...
class LocaleDisplayNameEsCU extends LocaleDisplayNameEs {
  const LocaleDisplayNameEsCU(super.cld);
