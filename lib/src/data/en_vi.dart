...
const _locale = 'en-VI';
const _cld = CommonLocaleDataEnVI._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEnVI implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataEnVI._();
  ...
  static final _units = UnitsEnVI._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEnVI._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEnVI._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsEnVI._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesEnVI._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsEnVI._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsEnVI._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesEnVI._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEnVI._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEnVI._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEnVI extends Units {
  UnitsEnVI._(super.cld);
...
class DateFieldsEnVI extends DateFields {
  DateFieldsEnVI._(super.cld);
...
class LanguagesEnVI extends Languages {
  const LanguagesEnVI._(super.cld);
...
class ScriptsEnVI extends Scripts {
  const ScriptsEnVI._(super.cld);
...
class TerritoriesEnVI extends Territories {
  const TerritoriesEnVI._(super.cld);
...
class VariantsEnVI extends Variants {
  const VariantsEnVI._(super.cld);
...
class SubdivisionsEnVI extends Subdivisions {
  const SubdivisionsEnVI._(super.cld);
...
class CurrenciesEnVI extends Currencies {
  const CurrenciesEnVI._(super.cld);
...
class TimeZonesEnVI extends TimeZones {
  const TimeZonesEnVI._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
            regionFormat: '{0} Time',
...
class LocaleDisplayNameEnVI extends LocaleDisplayName {
  const LocaleDisplayNameEnVI._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
