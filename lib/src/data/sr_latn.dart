...
const _cld = CommonLocaleDataSrLatn._();
...
class CommonLocaleDataSrLatn implements CommonLocaleData {
  ...
  const CommonLocaleDataSrLatn._();
  ...
  static final _units = UnitsSrLatn._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsSrLatn._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesSrLatn._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsSrLatn._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesSrLatn._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsSrLatn._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsSrLatn._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesSrLatn._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesSrLatn._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameSrLatn._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsSrLatn extends Units {
  UnitsSrLatn._(super.cld);
...
class LanguagesSrLatn extends Languages {
  const LanguagesSrLatn._(super.cld);
...
class ScriptsSrLatn extends Scripts {
  const ScriptsSrLatn._(super.cld);
...
class TerritoriesSrLatn extends Territories {
  const TerritoriesSrLatn._(super.cld);
...
class VariantsSrLatn extends Variants {
  const VariantsSrLatn._(super.cld);
...
class SubdivisionsSrLatn extends Subdivisions {
  const SubdivisionsSrLatn._(super.cld);
...
class CurrenciesSrLatn extends Currencies {
  const CurrenciesSrLatn._(super.cld);
...
class TimeZonesSrLatn extends TimeZones {
  const TimeZonesSrLatn._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
            regionFormat: '{0}',
...
class LocaleDisplayNameSrLatn extends LocaleDisplayName {
  const LocaleDisplayNameSrLatn._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
