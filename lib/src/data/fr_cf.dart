...
const _locale = 'fr-CF';
const _cld = CommonLocaleDataFrCF._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataFrCF implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataFrCF._();
  ...
  static final _units = UnitsFrCF._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsFrCF._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesFrCF._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsFrCF._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesFrCF._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsFrCF._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsFrCF._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesFrCF._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesFrCF._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameFrCF._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsFrCF extends Units {
  UnitsFrCF._(super.cld);
...
class DateFieldsFrCF extends DateFields {
  DateFieldsFrCF._(super.cld);
...
class LanguagesFrCF extends Languages {
  const LanguagesFrCF._(super.cld);
...
class ScriptsFrCF extends Scripts {
  const ScriptsFrCF._(super.cld);
...
class TerritoriesFrCF extends Territories {
  const TerritoriesFrCF._(super.cld);
...
class VariantsFrCF extends Variants {
  const VariantsFrCF._(super.cld);
...
class SubdivisionsFrCF extends Subdivisions {
  const SubdivisionsFrCF._(super.cld);
...
class CurrenciesFrCF extends Currencies {
  const CurrenciesFrCF._(super.cld);
...
class TimeZonesFrCF extends TimeZones {
  const TimeZonesFrCF._(super.cld)
      : super(
            gmtFormat: 'UTC{0}',
            gmtZeroFormat: 'UTC',
...
class LocaleDisplayNameFrCF extends LocaleDisplayName {
  const LocaleDisplayNameFrCF._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
