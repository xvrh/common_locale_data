...
const _locale = 'sv';
const _cld = CommonLocaleDataSv.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataSv extends CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataSv.constant() : super.constant();
  ...
  static final _units = UnitsSv(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsSv(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesSv(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsSv(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesSv(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsSv(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsSv(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesSv(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesSv(_cld);
  @override
...
class UnitsSv extends Units {
  ...
  Unit get angleRevolution => const Unit(
    long: UnitCountPattern(_locale, 'varv', one: '{0} varv', other: '{0} varv'),
    short: UnitCountPattern(
      _locale,
      'varv',
      one: '{0} varv',
    ...
    narrow: UnitCountPattern(_locale, 'varv', one: '{0}varv', other: '{0}varv'),
  );
  ...
  Unit get angleDegree => const Unit(
    ...
    short: UnitCountPattern(_locale, 'grader', one: '{0} grad', other: '{0}°'),
    narrow: UnitCountPattern(_locale, '°', one: '{0} grad', other: '{0}°'),
  );
  ...
  Unit get areaSquareFoot => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'fot²', one: '{0}fot²', other: '{0}fot²'),
  );
  ...
  Unit get areaSquareInch => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'tum²', one: '{0}tum²', other: '{0}tum²'),
  );
  ...
  Unit get concentrKarat => const Unit(
    ...
    short: UnitCountPattern(_locale, 'karat', one: '{0} K', other: '{0} K'),
    narrow: UnitCountPattern(_locale, 'karat', one: '{0}K', other: '{0}K'),
  );
  ...
  Unit get digitalByte => const Unit(
    ...
    short: UnitCountPattern(_locale, 'byte', one: '{0} B', other: '{0} B'),
  ...
  Unit get durationCentury => const Unit(
    ...
    short: UnitCountPattern(_locale, 'årh', one: '{0} årh', other: '{0} årh'),
    narrow: UnitCountPattern(_locale, 'årh', one: '{0}årh', other: '{0}årh'),
  );
  ...
  Unit get durationDecade => const Unit(
    ...
    short: UnitCountPattern(_locale, 'årt', one: '{0} årt', other: '{0} årt'),
    narrow: UnitCountPattern(_locale, 'årt', one: '{0}årt', other: '{0}årt'),
  );

  @override
  Unit get durationYear => const Unit(
    long: UnitCountPattern(_locale, 'år', one: '{0} år', other: '{0} år'),
    short: UnitCountPattern(_locale, 'år', one: '{0} år', other: '{0} år'),
    narrow: UnitCountPattern(_locale, 'år', one: '{0}å', other: '{0}å'),
  );
  ...
  Unit get durationMonth => const Unit(
    ...
    short: UnitCountPattern(_locale, 'mån', one: '{0} mån', other: '{0} mån'),
    narrow: UnitCountPattern(_locale, 'm', one: '{0}m', other: '{0}m'),
  );
  ...
  Unit get durationWeek => const Unit(
    ...
    short: UnitCountPattern(_locale, 'vkr', one: '{0} v', other: '{0} v'),
    narrow: UnitCountPattern(_locale, 'v', one: '{0}v', other: '{0}v'),
  );

  @override
  Unit get durationDay => const Unit(
    long: UnitCountPattern(_locale, 'dygn', one: '{0} dygn', other: '{0} dygn'),
    short: UnitCountPattern(_locale, 'dygn', one: '{0} dygn', other: '{0} d'),
  ...
  Unit get durationHour => const Unit(
    ...
    short: UnitCountPattern(_locale, 'tim', one: '{0} tim', other: '{0} tim'),
  ...
  Unit get durationSecond => const Unit(
    ...
    short: UnitCountPattern(_locale, 'sek', one: '{0} sekund', other: '{0} s'),
    narrow: UnitCountPattern(_locale, 'sek', one: '{0}s', other: '{0}s'),
  );
  ...
  Unit get electricAmpere => const Unit(
    ...
    short: UnitCountPattern(_locale, 'A', one: '{0} ampere', other: '{0} A'),
  ...
  Unit get electricOhm => const Unit(
    ...
    short: UnitCountPattern(_locale, 'ohm', one: '{0} ohm', other: '{0} Ω'),
  ...
  Unit get energyJoule => const Unit(
    ...
    short: UnitCountPattern(_locale, 'J', one: '{0} joule', other: '{0} J'),
  ...
  Unit get graphicsPixel => const Unit(
    ...
    short: UnitCountPattern(_locale, 'px', one: '{0} pixel', other: '{0} px'),
  ...
  Unit get graphicsDot => const Unit(
    ...
    short: UnitCountPattern(_locale, 'punkt', one: '{0} p', other: '{0} p'),
    narrow: UnitCountPattern(_locale, 'pkt', one: '{0}pkt', other: '{0}pkt'),
  );
  ...
  Unit get lengthMeter => const Unit(
    ...
    short: UnitCountPattern(_locale, 'm', one: '{0} meter', other: '{0} m'),
    narrow: UnitCountPattern(_locale, 'm', one: '{0}m', other: '{0}m'),
  );
  ...
  Unit get lengthMile => const Unit(
    long: UnitCountPattern(_locale, 'mile', one: '{0} mile', other: '{0} mile'),
    short: UnitCountPattern(_locale, 'mile', one: '{0} mile', other: '{0} mi'),
    narrow: UnitCountPattern(_locale, 'mi', one: '{0}mi', other: '{0}mi'),
  );
  ...
  Unit get lengthFoot => const Unit(
    long: UnitCountPattern(_locale, 'fot', one: '{0} fot', other: '{0} fot'),
    short: UnitCountPattern(_locale, 'fot', one: '{0} fot', other: '{0} fot'),
    narrow: UnitCountPattern(_locale, 'fot', one: '{0}fot', other: '{0}fot'),
  );

  @override
  Unit get lengthInch => const Unit(
    long: UnitCountPattern(_locale, 'tum', one: '{0} tum', other: '{0} tum'),
    short: UnitCountPattern(_locale, 'tum', one: '{0} tum', other: '{0} tum'),
    narrow: UnitCountPattern(_locale, 'tum', one: '{0} tum', other: '{0}"'),
  );
  ...
  Unit get lengthAstronomicalUnit => const Unit(
    ...
    short: UnitCountPattern(_locale, 'AE', one: '{0} AE', other: '{0} AE'),
    narrow: UnitCountPattern(_locale, 'AE', one: '{0}AE', other: '{0}AE'),
  );
  ...
  Unit get lightLux => const Unit(
    ...
    short: UnitCountPattern(_locale, 'lux', one: '{0} lux', other: '{0} lux'),
    narrow: UnitCountPattern(_locale, 'lux', one: '{0}lux', other: '{0}lux'),
  );
  ...
  Unit get massTonne => const Unit(
    ...
    short: UnitCountPattern(_locale, 't', one: '{0} ton', other: '{0} t'),
  ...
  Unit get massGram => const Unit(
    ...
    short: UnitCountPattern(_locale, 'g', one: '{0} gram', other: '{0} g'),
    narrow: UnitCountPattern(_locale, 'g', one: '{0}g', other: '{0}g'),
  );
  ...
  Unit get massPound => const Unit(
    long: UnitCountPattern(_locale, 'pund', one: '{0} pund', other: '{0} pund'),
    short: UnitCountPattern(
      _locale,
      'pund',
      one: '{0} pund',
    ...
    narrow: UnitCountPattern(_locale, 'pund', one: '{0}lb', other: '{0}lb'),
  );

  @override
  Unit get massOunce => const Unit(
    long: UnitCountPattern(_locale, 'uns', one: '{0} uns', other: '{0} uns'),
    short: UnitCountPattern(_locale, 'uns', one: '{0} uns', other: '{0} uns'),
    narrow: UnitCountPattern(_locale, 'uns', one: '{0}uns', other: '{0}uns'),
  );
  ...
  Unit get massOunceTroy => const Unit(
    ...
    short: UnitCountPattern(_locale, 'ozt', one: '{0} ozt', other: '{0} ozt'),
    narrow: UnitCountPattern(_locale, 'ozt', one: '{0}ozt', other: '{0}ozt'),
  );
  ...
  Unit get massCarat => const Unit(
    ...
    short: UnitCountPattern(_locale, 'karat', one: '{0} ct', other: '{0} ct'),
    narrow: UnitCountPattern(_locale, 'karat', one: '{0}ct', other: '{0}ct'),
  );
  ...
  Unit get massGrain => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'grain', one: '{0}gr', other: '{0}gr'),
  );
  ...
  Unit get powerWatt => const Unit(
    ...
    short: UnitCountPattern(_locale, 'W', one: '{0} watt', other: '{0} W'),
  ...
  Unit get powerHorsepower => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'hk', one: '{0}hk', other: '{0}hk'),
  );
  ...
  Unit get speedKnot => const Unit(
    long: UnitCountPattern(_locale, 'knop', one: '{0} knop', other: '{0} knop'),
    short: UnitCountPattern(
      _locale,
      'knop',
      one: '{0} knop',
    ...
    narrow: UnitCountPattern(_locale, 'knop', one: '{0}knop', other: '{0}knop'),
  );
  ...
  Unit get temperatureGeneric => const Unit(
    ...
    short: UnitCountPattern(_locale, '°', one: '{0} grad', other: '{0}°'),
    narrow: UnitCountPattern(_locale, '°', one: '{0} grad', other: '{0}°'),
  );
  ...
  Unit get volumeLiter => const Unit(
    ...
    short: UnitCountPattern(_locale, 'liter', one: '{0} liter', other: '{0} l'),
  ...
  Unit get volumeCupMetric => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'mcup', one: '{0}mcup', other: '{0}mcup'),
  );
  ...
  Unit get volumeQuart => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'quart', one: '{0}qt', other: '{0}qt'),
  );

  @override
  Unit get volumePint => const Unit(
    long: UnitCountPattern(_locale, 'pint', one: '{0} pint', other: '{0} pint'),
    short: UnitCountPattern(_locale, 'pint', one: '{0} pint', other: '{0} pt'),
  ...
  Unit get volumeTablespoon => const Unit(
    ...
    short: UnitCountPattern(_locale, 'msk', one: '{0} msk', other: '{0} msk'),
    narrow: UnitCountPattern(_locale, 'msk', one: '{0}msk', other: '{0}msk'),
  );
  ...
  Unit get volumeTeaspoon => const Unit(
    ...
    short: UnitCountPattern(_locale, 'tsk', one: '{0} tsk', other: '{0} tsk'),
    narrow: UnitCountPattern(_locale, 'tsk', one: '{0}tsk', other: '{0}tsk'),
  );

  @override
  Unit get volumeBarrel => const Unit(
    long: UnitCountPattern(_locale, 'fat', one: '{0} fat', other: '{0} fat'),
    short: UnitCountPattern(_locale, 'fat', one: '{0} fat', other: '{0} fat'),
    narrow: UnitCountPattern(_locale, 'fat', one: '{0}fat', other: '{0}fat'),
  );
  ...
  Unit get volumeDessertSpoon => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'dsk', one: '{0}dsk', other: '{0}dsk'),
  );
  ...
  Unit get volumeDrop => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'drp', one: '{0}drp', other: '{0}drp'),
  );
  ...
  Unit get volumePinch => const Unit(
    long: UnitCountPattern(_locale, 'nypa', one: '{0} nypa', other: '{0} nypa'),
    short: UnitCountPattern(
      _locale,
      'nypa',
      one: '{0} nypa',
  ...
  Unit get speedLightSpeed => const Unit(
    long: UnitCountPattern(_locale, 'ljus', one: '{0} ljus', other: '{0} ljus'),
    short: UnitCountPattern(
      _locale,
      'ljus',
      one: '{0} ljus',
    ...
    narrow: UnitCountPattern(_locale, 'ljs', one: '{0}ljs', other: '{0}ljs'),
  );
  ...
  Unit get durationNight => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'nttr', one: '{0}ntt', other: '{0}nttr'),
  );
}

class DateFieldsSv extends DateFields {
  const DateFieldsSv(super.cld);
  ...
  DateFieldFullData get year => const DateFieldFullData(
    displayName: MultiLength(long: 'år', short: 'år', narrow: 'år'),
    previous: MultiLength(long: 'i fjol', short: 'i fjol', narrow: 'i fjol'),
    now: MultiLength(long: 'i år', short: 'i år', narrow: 'i år'),
    next: MultiLength(long: 'nästa år', short: 'nästa år', narrow: 'nästa år'),
    past: MultiLengthRelativeTime(
      ...
      narrow: RelativeTime(_locale, one: '−{0} år', other: '−{0} år'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(_locale, one: 'om {0} år', other: 'om {0} år'),
      short: RelativeTime(_locale, one: 'om {0} år', other: 'om {0} år'),
      narrow: RelativeTime(_locale, one: '+{0} år', other: '+{0} år'),
    ),
  );
  ...
  DateFieldFullData get quarter => const DateFieldFullData(
    displayName: MultiLength(long: 'kvartal', short: 'kv.', narrow: 'kv.'),
    ...
    past: MultiLengthRelativeTime(
      ...
      narrow: RelativeTime(_locale, one: '−{0} kv', other: '−{0} kv'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
      ...
      short: RelativeTime(_locale, one: 'om {0} kv.', other: 'om {0} kv.'),
      narrow: RelativeTime(_locale, one: '+{0} kv.', other: '+{0} kv.'),
    ),
  );
  ...
  DateFieldFullData get month => const DateFieldFullData(
    displayName: MultiLength(long: 'månad', short: 'mån', narrow: 'mån'),
    previous: MultiLength(
      long: 'förra månaden',
      short: 'förra mån.',
      narrow: 'förra mån.',
    ...
    past: MultiLengthRelativeTime(
      ...
      narrow: RelativeTime(_locale, one: '−{0} mån', other: '−{0} mån'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(_locale, one: 'om {0} månad', other: 'om {0} månader'),
      short: RelativeTime(_locale, one: 'om {0} mån.', other: 'om {0} mån.'),
      narrow: RelativeTime(_locale, one: '+{0} mån.', other: '+{0} mån.'),
    ),
  );
  ...
  DateFieldFullData get week => const DateFieldFullData(
    displayName: MultiLength(long: 'vecka', short: 'v.', narrow: 'v.'),
    previous: MultiLength(
      long: 'förra veckan',
      short: 'förra v.',
      narrow: 'förra v.',
    ...
    past: MultiLengthRelativeTime(
      ...
      narrow: RelativeTime(_locale, one: '−{0} v', other: '−{0} v'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(_locale, one: 'om {0} vecka', other: 'om {0} veckor'),
      short: RelativeTime(_locale, one: 'om {0} v.', other: 'om {0} v.'),
      narrow: RelativeTime(_locale, one: '+{0} v.', other: '+{0} v.'),
    ),
  );
  ...
  DateFieldFullData get day => const DateFieldFullData(
    displayName: MultiLength(long: 'dag', short: 'd.', narrow: 'd'),
    previous: MultiLength(long: 'i går', short: 'i går', narrow: 'igår'),
    now: MultiLength(long: 'i dag', short: 'i dag', narrow: 'idag'),
    next: MultiLength(long: 'i morgon', short: 'i morgon', narrow: 'imorgon'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
        one: 'för {0} dag sedan',
      ...
      narrow: RelativeTime(_locale, one: '−{0} d', other: '−{0} d'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(_locale, one: 'om {0} dag', other: 'om {0} dagar'),
      short: RelativeTime(_locale, one: 'om {0} d', other: 'om {0} d'),
      narrow: RelativeTime(_locale, one: '+{0} d', other: '+{0} d'),
    ),
  );
  ...
  MultiLength get weekday =>
      const MultiLength(long: 'veckodag', short: 'veckod.', narrow: 'vd');
  ...
  DateFieldDataWithRelative get sunday => const DateFieldDataWithRelative(
    ...
    past: MultiLengthRelativeTime(
      ...
      narrow: RelativeTime(_locale, one: '−{0} sön', other: '−{0} sön'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
      ...
      short: RelativeTime(_locale, one: 'om {0} sön.', other: 'om {0} sön.'),
      narrow: RelativeTime(_locale, one: '+{0} sön', other: '+{0} sön'),
    ),
  );
  ...
  DateFieldDataWithRelative get monday => const DateFieldDataWithRelative(
    ...
    past: MultiLengthRelativeTime(
      ...
      narrow: RelativeTime(_locale, one: '–{0} månd', other: '–{0} månd'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
      ...
      short: RelativeTime(_locale, one: 'om {0} månd.', other: 'om {0} månd.'),
      narrow: RelativeTime(_locale, one: '+{0} må.', other: '+{0} må.'),
    ),
  );
  ...
  DateFieldDataWithRelative get tuesday => const DateFieldDataWithRelative(
    ...
    past: MultiLengthRelativeTime(
      ...
      narrow: RelativeTime(_locale, one: '−{0} tis', other: '−{0} tis'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
      ...
      short: RelativeTime(_locale, one: 'om {0} tis.', other: 'om {0} tis.'),
      narrow: RelativeTime(_locale, one: '+{0} tis', other: '+{0} tis'),
    ),
  );
  ...
  DateFieldDataWithRelative get wednesday => const DateFieldDataWithRelative(
    ...
    past: MultiLengthRelativeTime(
      ...
      narrow: RelativeTime(_locale, one: '−{0} ons', other: '−{0} ons'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
      ...
      short: RelativeTime(_locale, one: 'om {0} ons.', other: 'om {0} ons.'),
      narrow: RelativeTime(_locale, one: '+{0} ons', other: '+{0} ons'),
    ),
  );
  ...
  DateFieldDataWithRelative get thursday => const DateFieldDataWithRelative(
    ...
    past: MultiLengthRelativeTime(
      ...
      narrow: RelativeTime(_locale, one: '−{0} tors', other: '−{0} tors'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
      ...
      short: RelativeTime(_locale, one: 'om {0} tors.', other: 'om {0} tors.'),
      narrow: RelativeTime(_locale, one: '+{0} tors', other: '+{0} tors'),
    ),
  );
  ...
  DateFieldDataWithRelative get friday => const DateFieldDataWithRelative(
    ...
    past: MultiLengthRelativeTime(
      ...
      narrow: RelativeTime(_locale, one: '−{0} fre', other: '−{0} fre'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
      ...
      short: RelativeTime(_locale, one: 'om {0} fre.', other: 'om {0} fre.'),
      narrow: RelativeTime(_locale, one: '+{0} fre', other: '+{0} fre'),
    ),
  );
  ...
  DateFieldDataWithRelative get saturday => const DateFieldDataWithRelative(
    ...
    past: MultiLengthRelativeTime(
      ...
      narrow: RelativeTime(_locale, one: '−{0} lör', other: '−{0} lör'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
      ...
      short: RelativeTime(_locale, one: 'om {0} lör.', other: 'om {0} lör.'),
      narrow: RelativeTime(_locale, one: '+{0} lör', other: '+{0} lör'),
    ),
  );
  ...
  MultiLength get dayperiod =>
      const MultiLength(long: 'fm/em', short: 'fm/em', narrow: 'fm/em');

  @override
  DateFieldDataTime get hour => const DateFieldDataTime(
    displayName: MultiLength(long: 'timme', short: 'tim', narrow: 'h'),
    now: MultiLength(
      long: 'denna timme',
      short: 'denna timme',
      narrow: 'denna timme',
    ...
    past: MultiLengthRelativeTime(
      ...
      narrow: RelativeTime(_locale, one: '−{0} h', other: '−{0} h'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(_locale, one: 'om {0} timme', other: 'om {0} timmar'),
      short: RelativeTime(_locale, one: 'om {0} tim', other: 'om {0} tim'),
      narrow: RelativeTime(_locale, one: '+{0} h', other: '+{0} h'),
    ),
  );
  ...
  DateFieldDataTime get minute => const DateFieldDataTime(
    displayName: MultiLength(long: 'minut', short: 'min', narrow: 'm'),
    now: MultiLength(
      long: 'denna minut',
      short: 'denna minut',
      narrow: 'denna minut',
    ...
    past: MultiLengthRelativeTime(
      ...
      narrow: RelativeTime(_locale, one: '−{0} min', other: '−{0} min'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(_locale, one: 'om {0} minut', other: 'om {0} minuter'),
      short: RelativeTime(_locale, one: 'om {0} min', other: 'om {0} min'),
      narrow: RelativeTime(_locale, one: '+{0} min', other: '+{0} min'),
    ),
  );
  ...
  DateFieldDataTime get second => const DateFieldDataTime(
    displayName: MultiLength(long: 'sekund', short: 'sek', narrow: 's'),
    now: MultiLength(long: 'nu', short: 'nu', narrow: 'nu'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
      ...
      narrow: RelativeTime(_locale, one: '−{0} s', other: '−{0} s'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
      ...
      short: RelativeTime(_locale, one: 'om {0} sek', other: 'om {0} sek'),
      narrow: RelativeTime(_locale, one: '+{0} s', other: '+{0} s'),
    ),
  );
  ...
  MultiLength get zone =>
      const MultiLength(long: 'tidszon', short: 'tidszon', narrow: 'tidszon');
}

class LanguagesSv extends Languages {
  const LanguagesSv(super.cld);
...
class VariantsSv extends Variants {
  ...
  static const _fonkirsh = Variant(
    'FONKIRSH',
    'Kirshenbaums fonetiska alfabet',
  );
  static const _fonnapa = Variant(
    'FONNAPA',
  ...
  static const _ivanchov = Variant(
    'IVANCHOV',
...
class SubdivisionsSv extends Subdivisions {
  const SubdivisionsSv(super.cld);
...
class CurrenciesSv extends Currencies {
  ...
  static const _byn = Currency(
    ...
    'BYN',
    'belarusisk rubel',
    one: 'belarusisk rubel',
    other: 'belarusiska rubel',
    symbolNarrow: 'р.',
  );
  ...
  static const _srg = Currency(
    ...
    'SRG',
    'surinamesisk gulden',
    one: 'surinamesisk gulden',
    other: 'surinamesiska gulden',
  );
...
class TimeZonesSv extends TimeZones {
  ...
  @override
  String get regionFormat => '{0}tid';
  @override
  String get regionFormatDaylight => '{0} (sommartid)';
  @override
  String get regionFormatStandard => '{0} (normaltid)';
  @override
  ...
  static const staticTimeZoneNames = <String, TimeZoneNames>{
    ...
    'Europe/Dublin': TimeZoneNames(
      long: TimeZoneName(daylight: 'irländsk sommartid'),
    ),
    ...
    'Europe/London': TimeZoneNames(
      long: TimeZoneName(daylight: 'brittisk sommartid'),
    ),
  ...
  static const staticMetaZoneNames = <String, MetaZone>{
    ...
    'Afghanistan': MetaZone(
      'Afghanistan',
      long: TimeZoneName(standard: 'afghansk tid'),
    ),
    ...
    'Bolivia': MetaZone(
      'Bolivia',
      long: TimeZoneName(standard: 'boliviansk tid'),
    ),
    'Brasilia': MetaZone(
      'Brasilia',
      long: TimeZoneName(
    ...
    'Chamorro': MetaZone(
      'Chamorro',
      long: TimeZoneName(standard: 'Chamorrotid'),
    ),
    'Chatham': MetaZone(
      'Chatham',
      long: TimeZoneName(
    ...
    'Christmas': MetaZone(
      'Christmas',
      long: TimeZoneName(standard: 'Julöns tid'),
    ),
    'Cocos': MetaZone(
      'Cocos',
      long: TimeZoneName(standard: 'Keelingöarnas tid'),
    ),
    'Colombia': MetaZone(
      'Colombia',
      long: TimeZoneName(
    ...
    'East_Timor': MetaZone(
      'East_Timor',
      long: TimeZoneName(standard: 'östtimorisk tid'),
    ),
    'Easter': MetaZone(
      'Easter',
      long: TimeZoneName(
    ...
    'Ecuador': MetaZone(
      'Ecuador',
      long: TimeZoneName(standard: 'ecuadoriansk tid'),
    ),
    ...
    'Galapagos': MetaZone(
      'Galapagos',
      long: TimeZoneName(standard: 'Galápagostid'),
    ),
    ...
    'Indochina': MetaZone(
      'Indochina',
      long: TimeZoneName(standard: 'indokinesisk tid'),
    ),
    ...
    'Kazakhstan': MetaZone(
      'Kazakhstan',
      long: TimeZoneName(standard: 'kazakstansk tid'),
    ),
    ...
    'Kyrgystan': MetaZone(
      'Kyrgystan',
      long: TimeZoneName(standard: 'kirgizisk tid'),
    ),
    ...
    'Malaysia': MetaZone(
      'Malaysia',
      long: TimeZoneName(standard: 'malaysisk tid'),
    ),
    'Maldives': MetaZone(
      'Maldives',
      long: TimeZoneName(standard: 'Maldivernatid'),
    ),
    'Marquesas': MetaZone(
      'Marquesas',
      long: TimeZoneName(standard: 'Marquesastid'),
    ),
    ...
    'Myanmar': MetaZone(
      'Myanmar',
      long: TimeZoneName(standard: 'burmesisk tid'),
    ),
    ...
    'Pitcairn': MetaZone(
      'Pitcairn',
      long: TimeZoneName(standard: 'Pitcairntid'),
    ),
    'Ponape': MetaZone('Ponape', long: TimeZoneName(standard: 'Ponapetid')),
    'Pyongyang': MetaZone(
      'Pyongyang',
      long: TimeZoneName(standard: 'Pyongyangtid'),
    ),
    'Qyzylorda': MetaZone(
      'Qyzylorda',
      long: TimeZoneName(
    ...
    'Seychelles': MetaZone(
      'Seychelles',
      long: TimeZoneName(standard: 'Seychellernatid'),
    ),
    'Singapore': MetaZone(
      'Singapore',
      long: TimeZoneName(standard: 'Singaporetid'),
    ),
    'Solomon': MetaZone(
      'Solomon',
      long: TimeZoneName(standard: 'Salomonöarnas tid'),
    ),
    ...
    'Suriname': MetaZone(
      'Suriname',
      long: TimeZoneName(standard: 'Surinamtid'),
    ),
    ...
    'Tajikistan': MetaZone(
      'Tajikistan',
      long: TimeZoneName(standard: 'Tadzjikistantid'),
    ),
    ...
    'Venezuela': MetaZone(
      'Venezuela',
      long: TimeZoneName(standard: 'venezuelansk tid'),
    ),
...
class LocaleDisplayNameSv extends LocaleDisplayName {
  const LocaleDisplayNameSv(super.cld);
  ...
  static const staticValueNames = <String, Map<String, String>>{
    ...
    'cf': {'account': 'redovisningsformat', 'standard': 'normalt format'},
    'ka': {
