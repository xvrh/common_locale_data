...
const _locale = 'fr-BE';
const _cld = CommonLocaleDataFrBE._();
...
class CommonLocaleDataFrBE implements CommonLocaleData {
  ...
  static final _units = UnitsFrBE._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsFrBE._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesFrBE._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsFrBE._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesFrBE._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsFrBE._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsFrBE._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesFrBE._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesFrBE._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameFrBE._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsFrBE extends Units {
  UnitsFrBE._(super.cld);
...
class DateFieldsFrBE extends DateFields {
  DateFieldsFrBE._(super.cld);
...
class LanguagesFrBE extends Languages {
  const LanguagesFrBE._(super.cld);
...
class ScriptsFrBE extends Scripts {
  const ScriptsFrBE._(super.cld);
...
class TerritoriesFrBE extends Territories {
  const TerritoriesFrBE._(super.cld);
...
class VariantsFrBE extends Variants {
  const VariantsFrBE._(super.cld);
...
class SubdivisionsFrBE extends Subdivisions {
  const SubdivisionsFrBE._(super.cld);
...
class CurrenciesFrBE extends Currencies {
  const CurrenciesFrBE._(super.cld);
...
class TimeZonesFrBE extends TimeZones {
  const TimeZonesFrBE._(super.cld)
      : super(
            gmtFormat: 'UTC{0}',
            gmtZeroFormat: 'UTC',
...
class LocaleDisplayNameFrBE extends LocaleDisplayName {
  const LocaleDisplayNameFrBE._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
