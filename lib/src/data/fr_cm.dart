...
const _locale = 'fr-CM';
const _cld = CommonLocaleDataFrCM._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataFrCM implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataFrCM._();
  ...
  static final _units = UnitsFrCM._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsFrCM._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesFrCM._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsFrCM._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesFrCM._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsFrCM._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsFrCM._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesFrCM._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesFrCM._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameFrCM._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsFrCM extends Units {
  UnitsFrCM._(super.cld);
...
class DateFieldsFrCM extends DateFields {
  DateFieldsFrCM._(super.cld);
...
class LanguagesFrCM extends Languages {
  const LanguagesFrCM._(super.cld);
...
class ScriptsFrCM extends Scripts {
  const ScriptsFrCM._(super.cld);
...
class TerritoriesFrCM extends Territories {
  const TerritoriesFrCM._(super.cld);
...
class VariantsFrCM extends Variants {
  const VariantsFrCM._(super.cld);
...
class SubdivisionsFrCM extends Subdivisions {
  const SubdivisionsFrCM._(super.cld);
...
class CurrenciesFrCM extends Currencies {
  const CurrenciesFrCM._(super.cld);
...
class TimeZonesFrCM extends TimeZones {
  const TimeZonesFrCM._(super.cld)
      : super(
            gmtFormat: 'UTC{0}',
            gmtZeroFormat: 'UTC',
...
class LocaleDisplayNameFrCM extends LocaleDisplayName {
  const LocaleDisplayNameFrCM._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
