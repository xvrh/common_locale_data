...
const _locale = 'en-AT';
const _cld = CommonLocaleDataEnAT._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEnAT implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataEnAT._();
  ...
  static final _units = UnitsEnAT._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEnAT._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEnAT._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsEnAT._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesEnAT._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsEnAT._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsEnAT._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesEnAT._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEnAT._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEnAT._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEnAT extends Units {
  UnitsEnAT._(super.cld);
...
class DateFieldsEnAT extends DateFields {
  DateFieldsEnAT._(super.cld);
...
class LanguagesEnAT extends Languages {
  const LanguagesEnAT._(super.cld);
...
class ScriptsEnAT extends Scripts {
  const ScriptsEnAT._(super.cld);
...
class TerritoriesEnAT extends Territories {
  const TerritoriesEnAT._(super.cld);
...
class VariantsEnAT extends Variants {
  const VariantsEnAT._(super.cld);
...
class SubdivisionsEnAT extends Subdivisions {
  const SubdivisionsEnAT._(super.cld);
...
class CurrenciesEnAT extends Currencies {
  const CurrenciesEnAT._(super.cld);
...
class TimeZonesEnAT extends TimeZones {
  const TimeZonesEnAT._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
            regionFormat: '{0} Time',
...
class LocaleDisplayNameEnAT extends LocaleDisplayName {
  const LocaleDisplayNameEnAT._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
