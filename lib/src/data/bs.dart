...
const _locale = 'bs';
const _cld = CommonLocaleDataBs.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataBs extends CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataBs.constant() : super.constant();

  factory CommonLocaleDataBs() => _cld;
  ...
  static final _units = UnitsBs(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsBs(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesBs(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsBs(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesBs(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsBs(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsBs(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesBs(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesBs(_cld);
  @override
...
class DateFieldsBs extends DateFields {
  const DateFieldsBs(super.cld);
  ...
  DateFieldFullData get year => const DateFieldFullData(
    displayName: MultiLength(long: 'godina', short: 'god.', narrow: 'g.'),
  ...
  DateFieldFullData get month => const DateFieldFullData(
    displayName: MultiLength(long: 'mjesec', short: 'mj.', narrow: 'mj.'),
    previous: MultiLength(
      long: 'prošli mjesec',
      short: 'prošli mjesec',
  ...
  DateFieldFullData get week => const DateFieldFullData(
    displayName: MultiLength(long: 'sedmica', short: 'sed.', narrow: 'sed.'),
    previous: MultiLength(
      long: 'prošle sedmice',
  ...
  DateFieldFullData get day => const DateFieldFullData(
    displayName: MultiLength(long: 'dan', short: 'dan', narrow: 'dan'),
    previous: MultiLength(long: 'jučer', short: 'jučer', narrow: 'jučer'),
    now: MultiLength(long: 'danas', short: 'danas', narrow: 'danas'),
    next: MultiLength(long: 'sutra', short: 'sutra', narrow: 'sutra'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
        one: 'prije {0} dan',
  ...
  DateFieldDataWithRelative get wednesday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: 'ova srijeda', short: 'ova sri.', narrow: 'ova sri'),
    next: MultiLength(
  ...
  DateFieldDataWithRelative get saturday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: 'ova subota', short: 'ova sub.', narrow: 'ova sub.'),
    next: MultiLength(
  ...
  DateFieldDataTime get hour => const DateFieldDataTime(
    displayName: MultiLength(long: 'sat', short: 'h', narrow: 'h'),
    now: MultiLength(long: 'ovaj sat', short: 'ovaj sat', narrow: 'ovaj sat'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
        one: 'prije {0} sat',
  ...
  DateFieldDataTime get minute => const DateFieldDataTime(
    displayName: MultiLength(long: 'minuta', short: 'min', narrow: 'min'),
    now: MultiLength(
      long: 'ova minuta',
      short: 'ova minuta',
      narrow: 'ova minuta',
  ...
  DateFieldDataTime get second => const DateFieldDataTime(
    displayName: MultiLength(long: 'sekunda', short: 's', narrow: 's'),
    now: MultiLength(long: 'sada', short: 'sada', narrow: 'sada'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
        one: 'prije {0} sekundu',
  ...
  MultiLength get zone =>
      const MultiLength(long: 'vremenska zona', short: 'zona', narrow: 'zona');
}

class LanguagesBs extends Languages {
  const LanguagesBs(super.cld);
...
class ScriptsBs extends Scripts {
  const ScriptsBs(super.cld);
...
class TerritoriesBs extends Territories {
  const TerritoriesBs(super.cld);
...
class VariantsBs extends Variants {
  const VariantsBs(super.cld);
...
class SubdivisionsBs extends Subdivisions {
  const SubdivisionsBs(super.cld);
...
class CurrenciesBs extends Currencies {
  const CurrenciesBs(super.cld);
...
class TimeZonesBs extends TimeZones {
  const TimeZonesBs(super.cld);
  ...
  static const staticTimeZoneNames = <String, TimeZoneNames>{
    ...
    'Europe/London': TimeZoneNames(
      long: TimeZoneName(daylight: 'Britansko ljetno vrijeme'),
    ),
  ...
  static const staticMetaZoneNames = <String, MetaZone>{
    ...
    'Bhutan': MetaZone(
      'Bhutan',
      long: TimeZoneName(standard: 'Butansko vrijeme'),
    ),
    'Bolivia': MetaZone(
      'Bolivia',
      long: TimeZoneName(standard: 'Bolivijsko vrijeme'),
    ),
    'Brasilia': MetaZone(
      'Brasilia',
      long: TimeZoneName(
    ...
    'Brunei': MetaZone(
      'Brunei',
      long: TimeZoneName(standard: 'Brunejsko vrijeme'),
    ),
    'Cape_Verde': MetaZone(
      'Cape_Verde',
      long: TimeZoneName(
    ...
    'Ecuador': MetaZone(
      'Ecuador',
      long: TimeZoneName(standard: 'Ekvadorsko vrijeme'),
    ),
    ...
    'Guam': MetaZone(
      'Guam',
      long: TimeZoneName(standard: 'Guam standardno vreme'),
    ),
    'Gulf': MetaZone(
      'Gulf',
    ...
    'Guyana': MetaZone(
      'Guyana',
      long: TimeZoneName(standard: 'Gvajansko vrijeme'),
    ),
    ...
    'Maldives': MetaZone(
      'Maldives',
      long: TimeZoneName(standard: 'Maldivsko vrijeme'),
    ),
    'Marquesas': MetaZone(
      'Marquesas',
    ...
    'Nepal': MetaZone(
      'Nepal',
      long: TimeZoneName(standard: 'Nepalsko vrijeme'),
    ),
    ...
    'Reunion': MetaZone(
      'Reunion',
      long: TimeZoneName(standard: 'Reunionsko vrijeme'),
    ),
    'Rothera': MetaZone(
      'Rothera',
    ...
    'Tahiti': MetaZone(
      'Tahiti',
      long: TimeZoneName(standard: 'Tahićansko vrijeme'),
    ),
    'Taipei': MetaZone(
      'Taipei',
      long: TimeZoneName(
    ...
    'Tuvalu': MetaZone(
      'Tuvalu',
      long: TimeZoneName(standard: 'Tuvaluansko vrijeme'),
    ),
    'Uruguay': MetaZone(
      'Uruguay',
      long: TimeZoneName(
    ...
    'Yukon': MetaZone(
      'Yukon',
      long: TimeZoneName(standard: 'Jukonsko vrijeme'),
    ),
  };
}

class LocaleDisplayNameBs extends LocaleDisplayName {
  const LocaleDisplayNameBs(super.cld);
  ...
  static const staticValueNames = <String, Map<String, String>>{
    ...
    'd0': {'fwidth': 'Široki', 'hwidth': 'Uski', 'npinyin': 'Numerički'},
    'hc': {
