...
const _locale = 'en-MT';
const _cld = CommonLocaleDataEnMT._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEnMT implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataEnMT._();
  ...
  static final _units = UnitsEnMT._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEnMT._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEnMT._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsEnMT._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesEnMT._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsEnMT._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsEnMT._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesEnMT._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEnMT._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEnMT._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEnMT extends Units {
  UnitsEnMT._(super.cld);
...
class DateFieldsEnMT extends DateFields {
  DateFieldsEnMT._(super.cld);
...
class LanguagesEnMT extends Languages {
  const LanguagesEnMT._(super.cld);
...
class ScriptsEnMT extends Scripts {
  const ScriptsEnMT._(super.cld);
...
class TerritoriesEnMT extends Territories {
  const TerritoriesEnMT._(super.cld);
...
class VariantsEnMT extends Variants {
  const VariantsEnMT._(super.cld);
...
class SubdivisionsEnMT extends Subdivisions {
  const SubdivisionsEnMT._(super.cld);
...
class CurrenciesEnMT extends Currencies {
  const CurrenciesEnMT._(super.cld);
...
class TimeZonesEnMT extends TimeZones {
  const TimeZonesEnMT._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
            regionFormat: '{0} Time',
...
class LocaleDisplayNameEnMT extends LocaleDisplayName {
  const LocaleDisplayNameEnMT._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
