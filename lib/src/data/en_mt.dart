...
const _locale = 'en-MT';
const _cld = CommonLocaleDataEnMT.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEnMT extends CommonLocaleDataEn {
  @override
  String get locale => _locale;

  const CommonLocaleDataEnMT.constant() : super.constant();

  factory CommonLocaleDataEnMT() => _cld;
  ...
  static final _units = UnitsEnMT(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEnMT(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEnMT(_cld);
  @override
  Languages get languages => _languages;

  static final _territories = TerritoriesEnMT(_cld);
  @override
  Territories get territories => _territories;

  static final _currencies = CurrenciesEnMT(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEnMT(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEnMT(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEnMT extends UnitsEn {
  const UnitsEnMT(super.cld);
...
class DateFieldsEnMT extends DateFieldsEn {
  const DateFieldsEnMT(super.cld);
...
class LanguagesEnMT extends LanguagesEn {
  const LanguagesEnMT(super.cld);
...
class TerritoriesEnMT extends TerritoriesEn {
  const TerritoriesEnMT(super.cld);
...
class CurrenciesEnMT extends CurrenciesEn {
  const CurrenciesEnMT(super.cld);
...
class TimeZonesEnMT extends TimeZonesEn {
  const TimeZonesEnMT(super.cld);
...
class LocaleDisplayNameEnMT extends LocaleDisplayNameEn {
  const LocaleDisplayNameEnMT(super.cld);
