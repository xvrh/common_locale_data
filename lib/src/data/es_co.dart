...
const _locale = 'es-CO';
const _cld = CommonLocaleDataEsCO.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEsCO extends CommonLocaleDataEs {
  @override
  String get locale => _locale;

  const CommonLocaleDataEsCO.constant() : super.constant();

  factory CommonLocaleDataEsCO() => _cld;
  ...
  static final _units = UnitsEsCO(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEsCO(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEsCO(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsEsCO(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesEsCO(_cld);
  @override
  Territories get territories => _territories;

  static final _currencies = CurrenciesEsCO(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEsCO(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEsCO(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEsCO extends UnitsEs {
  const UnitsEsCO(super.cld);
  ...
  Unit get durationMonth => const Unit(
    ...
    short: UnitCountPattern(_locale, 'mes', one: '{0} mes', other: '{0} meses'),
    narrow: UnitCountPattern(
      _locale,
      'mes',
      one: '{0} mes',
  ...
  Unit get durationDay => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'día', one: '{0} día', other: '{0} días'),
  );
...
class DateFieldsEsCO extends DateFieldsEs {
  const DateFieldsEsCO(super.cld);
...
class LanguagesEsCO extends LanguagesEs {
  const LanguagesEsCO(super.cld);
...
class ScriptsEsCO extends ScriptsEs {
  const ScriptsEsCO(super.cld);
...
class TerritoriesEsCO extends TerritoriesEs {
  const TerritoriesEsCO(super.cld);
...
class CurrenciesEsCO extends CurrenciesEs {
  const CurrenciesEsCO(super.cld);
...
class TimeZonesEsCO extends TimeZonesEs {
  const TimeZonesEsCO(super.cld);
  ...
  Map<String, MetaZone> get metaZoneNames => Map.unmodifiable({
    ...
    ...const {
      ...
      'Colombia': MetaZone(
        ...
        short: TimeZoneName(generic: 'COT', standard: 'COT', daylight: 'COST'),
      ),
      'Cook': MetaZone(
        'Cook',
        long: TimeZoneName(
...
class LocaleDisplayNameEsCO extends LocaleDisplayNameEs {
  const LocaleDisplayNameEsCO(super.cld);
