...
class UnitsZu extends Units {
  ...
  Unit get angleDegree => const Unit(
    long: UnitCountPattern(_locale, '°', one: '{0} degree', other: '{0}°'),
  ...
  Unit get areaSquareCentimeter => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'cm²', one: '{0}m²', other: '{0}m²'),
  );
  ...
  Unit get areaAcre => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'acre', one: '{0}m²', other: '{0}m²'),
  );
  ...
  Unit get digitalKilobyte => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'kB', one: '{0}Mb', other: '{0} kB'),
  );
  ...
  Unit get digitalKilobit => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'kbit', one: '{0}Mb', other: '{0}Mb'),
  );
  ...
  Unit get digitalBit => const Unit(
    ...
    short: UnitCountPattern(_locale, 'bit', one: '{0} i-bit', other: '{0} bit'),
    narrow: UnitCountPattern(_locale, 'bit', one: '{0}bit', other: '{0}bit'),
  );

  @override
  Unit get durationCentury => const Unit(
    long: UnitCountPattern(_locale, 'c', one: '{0} century', other: '{0} c'),
  ...
  Unit get durationYear => const Unit(
    long: UnitCountPattern(_locale, 'yr', one: '{0} year', other: '{0} y'),
  ...
  Unit get durationQuarter => const Unit(
    long: UnitCountPattern(_locale, 'qtr', one: '{0} quarter', other: '{0} q'),
  ...
  Unit get durationWeek => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'amaviki', one: '{0} w', other: '{0} w'),
  );
  ...
  Unit get energyCalorie => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'cal', one: '{0}kcal', other: '{0}kcal'),
  );
  ...
  Unit get energyJoule => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'joules', one: '{0}J', other: '{0}J'),
  );
  ...
  Unit get lengthMeter => const Unit(
    long: UnitCountPattern(_locale, 'm', one: '{0} meter', other: '{0} m'),
    short: UnitCountPattern(_locale, 'm', one: '{0} m', other: '{0} m'),
    narrow: UnitCountPattern(_locale, 'm', one: '{0}m', other: '{0} m'),
  );
  ...
  Unit get lightLux => const Unit(
    ...
    short: UnitCountPattern(_locale, 'lux', one: '{0} i-lux', other: '{0} lx'),
    narrow: UnitCountPattern(_locale, 'lux', one: '{0} i-lux', other: '{0} lx'),
  );

  @override
  Unit get lightCandela => const Unit(
    long: UnitCountPattern(_locale, 'cd', one: '{0} cd', other: '{0} candela'),
  ...
  Unit get lightLumen => const Unit(
    long: UnitCountPattern(_locale, 'lm', one: '{0} i-lumen', other: '{0} lm'),
    short: UnitCountPattern(_locale, 'lm', one: '{0} i-lumen', other: '{0} lm'),
  ...
  Unit get massGram => const Unit(
    long: UnitCountPattern(_locale, 'g', one: '{0} gram', other: '{0} g'),
  ...
  Unit get powerKilowatt => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'kW', one: '{0}MW', other: '{0}MW'),
  );
  ...
  Unit get pressureMegapascal => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'MPa', one: '{0}kPa', other: '{0}kPa'),
  );
  ...
  Unit get speedKilometerPerHour => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'km/h', one: '{0}kph', other: '{0} km/h'),
  );
  ...
  Unit get volumeCubicInch => const Unit(
    ...
    short: UnitCountPattern(_locale, 'in³', one: '{0} in³', other: '{0} in³'),
    narrow: UnitCountPattern(_locale, 'in³', one: '{0}ft³', other: '{0}ft³'),
  );
  ...
  Unit get volumeLiter => const Unit(
    long: UnitCountPattern(_locale, 'l', one: '{0} liter', other: '{0} l'),
    short: UnitCountPattern(_locale, 'l', one: '{0} L', other: '{0} l'),
    narrow: UnitCountPattern(_locale, 'l', one: '{0}L', other: '{0} l'),
  );
  ...
  Unit get volumeDeciliter => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'dL', one: '{0}hL', other: '{0}hL'),
  );
  ...
  Unit get volumeMilliliter => const Unit(
    ...
    short: UnitCountPattern(_locale, 'mL', one: '{0} mL', other: '{0} mL'),
    narrow: UnitCountPattern(_locale, 'mL', one: '{0}cL', other: '{0}cL'),
  );
  ...
  Unit get volumeGallon => const Unit(
    long: UnitCountPattern(_locale, 'gal', one: '{0} gal', other: '{0} gal'),
  ...
  Unit get volumeDessertSpoon => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'dstspn', one: '{0}bbl', other: '{0}bbl'),
  );
...
class DateFieldsZu extends DateFields {
  ...
  DateFieldFullData get year => const DateFieldFullData(
    displayName: MultiLength(long: 'Unyaka', short: 'Unyaka', narrow: 'Unyaka'),
  ...
  DateFieldFullData get quarter => const DateFieldFullData(
    displayName: MultiLength(long: 'Ikota', short: 'Ikota', narrow: 'Ikota'),
    previous: MultiLength(
      long: 'ikota edlule',
      short: 'ikota edlule',
      narrow: 'ikota edlule',
    ),
    now: MultiLength(long: 'le kota', short: 'le kota', narrow: 'le kota'),
    next: MultiLength(
      long: 'ikota ezayo',
      short: 'ikota ezayo',
      narrow: 'ikota ezayo',
  ...
  DateFieldFullData get week => const DateFieldFullData(
    displayName: MultiLength(long: 'Iviki', short: 'Iviki', narrow: 'Iviki'),
    previous: MultiLength(
      long: 'iviki eledlule',
  ...
  DateFieldFullData get day => const DateFieldFullData(
    displayName: MultiLength(long: 'Usuku', short: 'Usuku', narrow: 'Usuku'),
    previous: MultiLength(long: 'izolo', short: 'izolo', narrow: 'izolo'),
    now: MultiLength(
      long: 'namhlanje',
      short: 'namhlanje',
      narrow: 'namhlanje',
    ),
    next: MultiLength(long: 'kusasa', short: 'kusasa', narrow: 'kusasa'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
  ...
  DateFieldDataTime get hour => const DateFieldDataTime(
    displayName: MultiLength(long: 'Ihora', short: 'Ihora', narrow: 'Ihora'),
    now: MultiLength(
      long: 'leli hora',
      short: 'leli hora',
      narrow: 'leli hora',
  ...
  DateFieldDataTime get second => const DateFieldDataTime(
    ...
    now: MultiLength(long: 'manje', short: 'manje', narrow: 'manje'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
...
class CurrenciesZu extends Currencies {
  ...
  static const _cve = Currency(
    ...
    one: 'i-Cape Verdean Escudo',
    other: 'i-Cape Verdean escudos',
  );
  ...
  static const _gmd = Currency(
    ...
    'GMD',
    'i-Gambian Dalasi',
    one: 'i-Gambian Dalasi',
    other: 'i-Gambian dalasis',
  );
  ...
  static const _xaf = Currency(
    ...
    one: 'i-CFA Franc BCEA',
    other: 'i-CFA Franc BCEA',
    symbol: 'FCFA',
  );
...
class TimeZonesZu extends TimeZones {
  ...
  static const staticMetaZoneNames = <String, MetaZone>{
    ...
    'Africa_Southern': MetaZone(
      'Africa_Southern',
      long: TimeZoneName(standard: 'Isikhathi esivamile saseNingizimu Afrika'),
    ),
    ...
    'Davis': MetaZone(
      'Davis',
      long: TimeZoneName(standard: 'Isikhathi sase-Davis'),
    ),
    ...
    'Kazakhstan_Eastern': MetaZone(
      'Kazakhstan_Eastern',
      long: TimeZoneName(standard: 'Isikhathi sase-Mpumalanga ne-Kazakhstan'),
    ),
    'Kazakhstan_Western': MetaZone(
      'Kazakhstan_Western',
      long: TimeZoneName(standard: 'Isikhathi saseNtshonalanga ne-Kazakhstan'),
    ),
    'Korea': MetaZone(
      'Korea',
      long: TimeZoneName(
    ...
    'Nauru': MetaZone(
      'Nauru',
      long: TimeZoneName(standard: 'Isikhathi sase-Nauru'),
    ),
    'Nepal': MetaZone(
      'Nepal',
      long: TimeZoneName(standard: 'Isikhathi sase-Nepal'),
    ),
    ...
    'Niue': MetaZone(
      'Niue',
      long: TimeZoneName(standard: 'Isikhathi sase-Niue'),
    ),
    'Norfolk': MetaZone(
      'Norfolk',
      long: TimeZoneName(
    ...
    'Palau': MetaZone(
      'Palau',
      long: TimeZoneName(standard: 'Isikhathi sase-Palau'),
    ),
    ...
    'Syowa': MetaZone(
      'Syowa',
      long: TimeZoneName(standard: 'Isikhathi sase-Syowa'),
    ),
    'Tahiti': MetaZone(
      'Tahiti',
    ...
    'Truk': MetaZone(
      'Truk',
      long: TimeZoneName(standard: 'Isikhathi sase-Chuuk'),
    ),
...
class LocaleDisplayNameZu extends LocaleDisplayName {
  ...
  static const staticValueNames = <String, Map<String, String>>{
    ...
    'ka': {'noignore': 'Hlela Izimpawu', 'shifted': 'Hlela Ukuziba Izimpawu'},
    'kb': {
