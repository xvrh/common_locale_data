...
const _locale = 'pt-AO';
const _cld = CommonLocaleDataPtAO.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataPtAO extends CommonLocaleDataPt {
  @override
  String get locale => _locale;

  const CommonLocaleDataPtAO.constant() : super.constant();

  factory CommonLocaleDataPtAO() => _cld;
  ...
  static final _units = UnitsPtAO(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsPtAO(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesPtAO(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsPtAO(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesPtAO(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsPtAO(_cld);
  @override
  Variants get variants => _variants;

  static final _currencies = CurrenciesPtAO(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesPtAO(_cld);
  @override
...
class DateFieldsPtAO extends DateFieldsPt {
  const DateFieldsPtAO(super.cld);
...
class LanguagesPtAO extends LanguagesPt {
  const LanguagesPtAO(super.cld);
...
class ScriptsPtAO extends ScriptsPt {
  const ScriptsPtAO(super.cld);
...
class TerritoriesPtAO extends TerritoriesPt {
  const TerritoriesPtAO(super.cld);
...
class VariantsPtAO extends VariantsPt {
  const VariantsPtAO(super.cld);
...
class CurrenciesPtAO extends CurrenciesPt {
  const CurrenciesPtAO(super.cld);
...
class TimeZonesPtAO extends TimeZonesPt {
  const TimeZonesPtAO(super.cld);
...
class LocaleDisplayNamePtAO extends LocaleDisplayNamePt {
  const LocaleDisplayNamePtAO(super.cld);
