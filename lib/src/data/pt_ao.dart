...
const _locale = 'pt-AO';
const _cld = CommonLocaleDataPtAO._();
...
class CommonLocaleDataPtAO implements CommonLocaleData {
  ...
  static final _units = UnitsPtAO._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsPtAO._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesPtAO._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsPtAO._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesPtAO._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsPtAO._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsPtAO._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesPtAO._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesPtAO._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNamePtAO._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsPtAO extends Units {
  UnitsPtAO._(super.cld);
...
class DateFieldsPtAO extends DateFields {
  DateFieldsPtAO._(super.cld);
...
class LanguagesPtAO extends Languages {
  const LanguagesPtAO._(super.cld);
...
class TerritoriesPtAO extends Territories {
  const TerritoriesPtAO._(super.cld);
...
class VariantsPtAO extends Variants {
  const VariantsPtAO._(super.cld);
...
class SubdivisionsPtAO extends Subdivisions {
  const SubdivisionsPtAO._(super.cld);
...
class CurrenciesPtAO extends Currencies {
  const CurrenciesPtAO._(super.cld);
...
class TimeZonesPtAO extends TimeZones {
  const TimeZonesPtAO._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
...
class LocaleDisplayNamePtAO extends LocaleDisplayName {
  const LocaleDisplayNamePtAO._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
