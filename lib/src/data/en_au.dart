...
class UnitsEnAU extends UnitsEn {
  ...
  Unit get concentrPermille => const Unit(
    ...
    short: UnitCountPattern(_locale, 'per mill', one: '{0}‰', other: '{0}‰'),
    narrow: UnitCountPattern(_locale, '‰', one: '{0}‰', other: '{0}‰'),
  );
  ...
  Unit get massCarat => const Unit(
    ...
    short: UnitCountPattern(_locale, 'carats', one: '{0} CM', other: '{0} CM'),
    narrow: UnitCountPattern(_locale, 'carat', one: '{0}ct', other: '{0}ct'),
  );
...
class TerritoriesEnAU extends TerritoriesEn {
  ...
  Map<String, Territory> get territories => Map.unmodifiable({
    ...
    ...const {'001': _$001, 'PM': _pm, 'SH': _sh, 'UM': _um, 'VI': _vi},
  });
}
