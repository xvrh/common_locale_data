...
const _locale = 'en-AU';
const _cld = CommonLocaleDataEnAU._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEnAU implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataEnAU._();
  ...
  static final _units = UnitsEnAU._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEnAU._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEnAU._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsEnAU._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesEnAU._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsEnAU._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsEnAU._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesEnAU._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEnAU._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEnAU._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEnAU extends Units {
  UnitsEnAU._(super.cld);
...
class DateFieldsEnAU extends DateFields {
  DateFieldsEnAU._(super.cld);
...
class LanguagesEnAU extends Languages {
  const LanguagesEnAU._(super.cld);
...
class ScriptsEnAU extends Scripts {
  const ScriptsEnAU._(super.cld);
...
class TerritoriesEnAU extends Territories {
  const TerritoriesEnAU._(super.cld);
...
class VariantsEnAU extends Variants {
  const VariantsEnAU._(super.cld);
...
class SubdivisionsEnAU extends Subdivisions {
  const SubdivisionsEnAU._(super.cld);
...
class CurrenciesEnAU extends Currencies {
  const CurrenciesEnAU._(super.cld);
...
class TimeZonesEnAU extends TimeZones {
  const TimeZonesEnAU._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
            regionFormat: '{0} Time',
...
class LocaleDisplayNameEnAU extends LocaleDisplayName {
  const LocaleDisplayNameEnAU._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
