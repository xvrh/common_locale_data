...
const _locale = 'fr-TD';
const _cld = CommonLocaleDataFrTD._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataFrTD implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataFrTD._();
  ...
  static final _units = UnitsFrTD._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsFrTD._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesFrTD._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsFrTD._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesFrTD._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsFrTD._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsFrTD._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesFrTD._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesFrTD._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameFrTD._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsFrTD extends Units {
  UnitsFrTD._(super.cld);
...
class DateFieldsFrTD extends DateFields {
  DateFieldsFrTD._(super.cld);
...
class LanguagesFrTD extends Languages {
  const LanguagesFrTD._(super.cld);
...
class ScriptsFrTD extends Scripts {
  const ScriptsFrTD._(super.cld);
...
class TerritoriesFrTD extends Territories {
  const TerritoriesFrTD._(super.cld);
...
class VariantsFrTD extends Variants {
  const VariantsFrTD._(super.cld);
...
class SubdivisionsFrTD extends Subdivisions {
  const SubdivisionsFrTD._(super.cld);
...
class CurrenciesFrTD extends Currencies {
  const CurrenciesFrTD._(super.cld);
...
class TimeZonesFrTD extends TimeZones {
  const TimeZonesFrTD._(super.cld)
      : super(
            gmtFormat: 'UTC{0}',
            gmtZeroFormat: 'UTC',
...
class LocaleDisplayNameFrTD extends LocaleDisplayName {
  const LocaleDisplayNameFrTD._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
