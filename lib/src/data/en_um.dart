...
const _locale = 'en-UM';
const _cld = CommonLocaleDataEnUM._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEnUM implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataEnUM._();
  ...
  static final _units = UnitsEnUM._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEnUM._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEnUM._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsEnUM._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesEnUM._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsEnUM._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsEnUM._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesEnUM._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEnUM._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEnUM._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEnUM extends Units {
  UnitsEnUM._(super.cld);
...
class DateFieldsEnUM extends DateFields {
  DateFieldsEnUM._(super.cld);
...
class LanguagesEnUM extends Languages {
  const LanguagesEnUM._(super.cld);
...
class ScriptsEnUM extends Scripts {
  const ScriptsEnUM._(super.cld);
...
class TerritoriesEnUM extends Territories {
  const TerritoriesEnUM._(super.cld);
...
class VariantsEnUM extends Variants {
  const VariantsEnUM._(super.cld);
...
class SubdivisionsEnUM extends Subdivisions {
  const SubdivisionsEnUM._(super.cld);
...
class CurrenciesEnUM extends Currencies {
  const CurrenciesEnUM._(super.cld);
...
class TimeZonesEnUM extends TimeZones {
  const TimeZonesEnUM._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
            regionFormat: '{0} Time',
...
class LocaleDisplayNameEnUM extends LocaleDisplayName {
  const LocaleDisplayNameEnUM._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
