...
const _locale = 'en-ID';
const _cld = CommonLocaleDataEnID.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEnID extends CommonLocaleDataEn {
  @override
  String get locale => _locale;

  const CommonLocaleDataEnID.constant() : super.constant();

  factory CommonLocaleDataEnID() => _cld;
  ...
  static final _units = UnitsEnID(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEnID(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEnID(_cld);
  @override
  Languages get languages => _languages;

  static final _territories = TerritoriesEnID(_cld);
  @override
  Territories get territories => _territories;

  static final _currencies = CurrenciesEnID(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEnID(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEnID(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEnID extends UnitsEn {
  const UnitsEnID(super.cld);
...
class DateFieldsEnID extends DateFieldsEn {
  const DateFieldsEnID(super.cld);
...
class LanguagesEnID extends LanguagesEn {
  const LanguagesEnID(super.cld);
...
class TerritoriesEnID extends TerritoriesEn {
  const TerritoriesEnID(super.cld);
...
class CurrenciesEnID extends CurrenciesEn {
  const CurrenciesEnID(super.cld);
...
class TimeZonesEnID extends TimeZonesEn {
  const TimeZonesEnID(super.cld);
...
class LocaleDisplayNameEnID extends LocaleDisplayNameEn {
  const LocaleDisplayNameEnID(super.cld);
