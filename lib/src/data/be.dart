...
class CommonLocaleDataBe implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataBe();

  static final _dateFields = DateFieldsBe._();
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesBe._();
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsBe._();
  @override
  Scripts get scripts => _scripts;

  static final _variants = VariantsBe._();
  @override
  Variants get variants => _variants;

  static final _units = UnitsBe._();
  @override
  Units get units => _units;

  static final _territories = TerritoriesBe._();
  @override
  Territories get territories => _territories;

  static final _timeZones = TimeZonesBe._(_territories);
  @override
...
class UnitsBe implements Units {
  UnitsBe._();
...
class TerritoriesBe implements Territories {
  TerritoriesBe._();
...
class TimeZonesBe extends TimeZones {
  TimeZonesBe._(Territories territories)
  ...
  final timeZoneNames = CanonicalizedMap<String, String, TimeZoneNames>.from({
    ...
    'America/Indiana/Vincennes': TimeZoneNames(
      city: 'Вінсенс, Індыяна',
    ),
    'America/Indiana/Petersburg': TimeZoneNames(
      city: 'Пітэрсберг, Індыяна',
    ),
    'America/Indiana/Tell_City': TimeZoneNames(
      city: 'Тэл Сіці, Індыяна',
    ),
    'America/Indiana/Knox': TimeZoneNames(
      city: 'Нокс, Індыяна',
    ),
    'America/Indiana/Winamac': TimeZoneNames(
      city: 'Уінамак, Індыяна',
    ),
    'America/Indiana/Marengo': TimeZoneNames(
      city: 'Марэнга, Індыяна',
    ),
    ...
    'America/North_Dakota/Beulah': TimeZoneNames(
      city: 'Б’юла, Паўночная Дакота',
    ),
    'America/North_Dakota/New_Salem': TimeZoneNames(
      city: 'Нью-Сейлем, Паўночная Дакота',
    ),
    'America/North_Dakota/Center': TimeZoneNames(
      city: 'Сентэр, Паўночная Дакота',
    ),
    ...
    'Atlantic/Azores': TimeZoneNames(
      city: 'Азорскія астравы',
    ),
    'Atlantic/Bermuda': TimeZoneNames(
      city: 'Бермудскія астравы',
    ),
    'Atlantic/Canary': TimeZoneNames(
      city: 'Канарскія астравы',
    ),
    'Atlantic/Cape_Verde': TimeZoneNames(
      city: 'Каба-Вердэ',
    ),
    'Atlantic/Faeroe': TimeZoneNames(
      city: 'Фарэрскія астравы',
    ),
    ...
    'Atlantic/South_Georgia': TimeZoneNames(
      city: 'Паўднёвая Георгія',
    ),
    'Atlantic/St_Helena': TimeZoneNames(
      city: 'Востраў Святой Алены',
    ),
    ...
    'Indian/Cocos': TimeZoneNames(
      city: 'Какосавыя астравы',
    ),
    'Indian/Comoro': TimeZoneNames(
      city: 'Каморскія астравы',
    ),
