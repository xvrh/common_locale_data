...
const _locale = 'en-AI';
const _cld = CommonLocaleDataEnAI.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEnAI extends CommonLocaleDataEn {
  @override
  String get locale => _locale;

  const CommonLocaleDataEnAI.constant() : super.constant();

  factory CommonLocaleDataEnAI() => _cld;
  ...
  static final _units = UnitsEnAI(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEnAI(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEnAI(_cld);
  @override
  Languages get languages => _languages;

  static final _territories = TerritoriesEnAI(_cld);
  @override
  Territories get territories => _territories;

  static final _currencies = CurrenciesEnAI(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEnAI(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEnAI(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEnAI extends UnitsEn {
  const UnitsEnAI(super.cld);
...
class DateFieldsEnAI extends DateFieldsEn {
  const DateFieldsEnAI(super.cld);
...
class LanguagesEnAI extends LanguagesEn {
  const LanguagesEnAI(super.cld);
...
class TerritoriesEnAI extends TerritoriesEn {
  const TerritoriesEnAI(super.cld);
...
class CurrenciesEnAI extends CurrenciesEn {
  const CurrenciesEnAI(super.cld);
...
class TimeZonesEnAI extends TimeZonesEn {
  const TimeZonesEnAI(super.cld);
...
class LocaleDisplayNameEnAI extends LocaleDisplayNameEn {
  const LocaleDisplayNameEnAI(super.cld);
