...
const _locale = 'fr-CG';
const _cld = CommonLocaleDataFrCG._();
...
class CommonLocaleDataFrCG implements CommonLocaleData {
  ...
  static final _units = UnitsFrCG._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsFrCG._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesFrCG._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsFrCG._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesFrCG._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsFrCG._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsFrCG._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesFrCG._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesFrCG._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameFrCG._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsFrCG extends Units {
  UnitsFrCG._(super.cld);
...
class DateFieldsFrCG extends DateFields {
  DateFieldsFrCG._(super.cld);
...
class LanguagesFrCG extends Languages {
  const LanguagesFrCG._(super.cld);
...
class ScriptsFrCG extends Scripts {
  const ScriptsFrCG._(super.cld);
...
class TerritoriesFrCG extends Territories {
  const TerritoriesFrCG._(super.cld);
...
class VariantsFrCG extends Variants {
  const VariantsFrCG._(super.cld);
...
class SubdivisionsFrCG extends Subdivisions {
  const SubdivisionsFrCG._(super.cld);
...
class CurrenciesFrCG extends Currencies {
  const CurrenciesFrCG._(super.cld);
...
class TimeZonesFrCG extends TimeZones {
  const TimeZonesFrCG._(super.cld)
      : super(
            gmtFormat: 'UTC{0}',
            gmtZeroFormat: 'UTC',
...
class LocaleDisplayNameFrCG extends LocaleDisplayName {
  const LocaleDisplayNameFrCG._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
