...
const _locale = 'en-NG';
const _cld = CommonLocaleDataEnNG.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEnNG extends CommonLocaleDataEn {
  @override
  String get locale => _locale;

  const CommonLocaleDataEnNG.constant() : super.constant();

  factory CommonLocaleDataEnNG() => _cld;
  ...
  static final _units = UnitsEnNG(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEnNG(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEnNG(_cld);
  @override
  Languages get languages => _languages;

  static final _territories = TerritoriesEnNG(_cld);
  @override
  Territories get territories => _territories;

  static final _currencies = CurrenciesEnNG(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEnNG(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEnNG(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEnNG extends UnitsEn {
  const UnitsEnNG(super.cld);
...
class DateFieldsEnNG extends DateFieldsEn {
  const DateFieldsEnNG(super.cld);
...
class LanguagesEnNG extends LanguagesEn {
  const LanguagesEnNG(super.cld);
...
class TerritoriesEnNG extends TerritoriesEn {
  const TerritoriesEnNG(super.cld);
...
class CurrenciesEnNG extends CurrenciesEn {
  const CurrenciesEnNG(super.cld);
...
class TimeZonesEnNG extends TimeZonesEn {
  const TimeZonesEnNG(super.cld);
...
class LocaleDisplayNameEnNG extends LocaleDisplayNameEn {
  const LocaleDisplayNameEnNG(super.cld);
