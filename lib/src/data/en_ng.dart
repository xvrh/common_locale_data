...
const _locale = 'en-NG';
const _cld = CommonLocaleDataEnNG._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEnNG implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataEnNG._();
  ...
  static final _units = UnitsEnNG._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEnNG._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEnNG._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsEnNG._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesEnNG._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsEnNG._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsEnNG._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesEnNG._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEnNG._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEnNG._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEnNG extends Units {
  UnitsEnNG._(super.cld);
...
class DateFieldsEnNG extends DateFields {
  DateFieldsEnNG._(super.cld);
...
class LanguagesEnNG extends Languages {
  const LanguagesEnNG._(super.cld);
...
class ScriptsEnNG extends Scripts {
  const ScriptsEnNG._(super.cld);
...
class TerritoriesEnNG extends Territories {
  const TerritoriesEnNG._(super.cld);
...
class VariantsEnNG extends Variants {
  const VariantsEnNG._(super.cld);
...
class SubdivisionsEnNG extends Subdivisions {
  const SubdivisionsEnNG._(super.cld);
...
class CurrenciesEnNG extends Currencies {
  const CurrenciesEnNG._(super.cld);
...
class TimeZonesEnNG extends TimeZones {
  const TimeZonesEnNG._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
            regionFormat: '{0} Time',
...
class LocaleDisplayNameEnNG extends LocaleDisplayName {
  const LocaleDisplayNameEnNG._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
