...
const _locale = 'ga';
const _cld = CommonLocaleDataGa.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataGa extends CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataGa.constant() : super.constant();

  factory CommonLocaleDataGa() => _cld;
  ...
  static final _units = UnitsGa(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsGa(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesGa(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsGa(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesGa(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsGa(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsGa(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesGa(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesGa(_cld);
  @override
...
class UnitsGa extends Units {
  ...
  Unit get lengthPoint => const Unit(
    ...
    short: UnitCountPattern(_locale, 'pointí', one: '{0} pt', other: '{0} pt'),
    narrow: UnitCountPattern(_locale, 'pointí', one: '{0}pt', other: '{0} pt'),
  );
...
class DateFieldsGa extends DateFields {
  const DateFieldsGa(super.cld);

  @override
  MultiLength get era =>
      const MultiLength(long: 'ré', short: 'ré', narrow: 'ré');

  @override
  DateFieldFullData get year => const DateFieldFullData(
    displayName: MultiLength(long: 'bliain', short: 'bl.', narrow: 'bl.'),
    previous: MultiLength(
      long: 'anuraidh',
      short: 'anuraidh',
      narrow: 'anuraidh',
    ),
    now: MultiLength(long: 'i mbliana', short: 'i mbl.', narrow: 'i mbl.'),
    next: MultiLength(
  ...
  DateFieldFullData get quarter => const DateFieldFullData(
    displayName: MultiLength(long: 'ráithe', short: 'ráithe', narrow: 'ráithe'),
    previous: MultiLength(
  ...
  DateFieldFullData get month => const DateFieldFullData(
    displayName: MultiLength(long: 'mí', short: 'mí', narrow: 'mí'),
    previous: MultiLength(
  ...
  DateFieldFullData get day => const DateFieldFullData(
    displayName: MultiLength(long: 'lá', short: 'lá', narrow: 'lá'),
    previous: MultiLength(long: 'inné', short: 'inné', narrow: 'inné'),
    now: MultiLength(long: 'inniu', short: 'inniu', narrow: 'inniu'),
    next: MultiLength(long: 'amárach', short: 'amárach', narrow: 'amárach'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
        one: '{0} lá ó shin',
  ...
  DateFieldDataTime get hour => const DateFieldDataTime(
    displayName: MultiLength(long: 'uair', short: 'uair', narrow: 'u'),
    now: MultiLength(
      long: 'an uair seo',
      short: 'an uair seo',
      narrow: 'an uair seo',
  ...
  DateFieldDataTime get minute => const DateFieldDataTime(
    displayName: MultiLength(long: 'nóiméad', short: 'nóim.', narrow: 'n'),
    now: MultiLength(
      long: 'an nóiméad seo',
  ...
  DateFieldDataTime get second => const DateFieldDataTime(
    displayName: MultiLength(long: 'soicind', short: 'soic.', narrow: 's'),
    now: MultiLength(long: 'anois', short: 'anois', narrow: 'anois'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
  ...
  MultiLength get zone =>
      const MultiLength(long: 'crios ama', short: 'crios', narrow: 'crios');
}

class LanguagesGa extends Languages {
  const LanguagesGa(super.cld);
...
class TerritoriesGa extends Territories {
  const TerritoriesGa(super.cld);
...
class SubdivisionsGa extends Subdivisions {
  const SubdivisionsGa(super.cld);
...
class TimeZonesGa extends TimeZones {
  const TimeZonesGa(super.cld);

  @override
  String get gmtFormat => 'MAG{0}';
  @override
  String get gmtZeroFormat => 'MAG';
  @override
  ...
  static const staticMetaZoneNames = <String, MetaZone>{
    ...
    'America_Pacific': MetaZone(
      ...
      short: TimeZoneName(generic: 'AAC', standard: 'ACAC', daylight: 'ASAC'),
    ),
    'Anadyr': MetaZone(
      'Anadyr',
      long: TimeZoneName(
    ...
    'Bolivia': MetaZone(
      'Bolivia',
      long: TimeZoneName(standard: 'Am na Bolaive'),
    ),
    'Brasilia': MetaZone(
      'Brasilia',
      long: TimeZoneName(
    ...
    'Casey': MetaZone(
      'Casey',
      long: TimeZoneName(standard: 'Am Stáisiún Casey'),
    ),
    'Chamorro': MetaZone(
      'Chamorro',
    ...
    'Cocos': MetaZone(
      'Cocos',
      long: TimeZoneName(standard: 'Am Oileáin Cocos'),
    ),
    'Colombia': MetaZone(
      'Colombia',
      long: TimeZoneName(
    ...
    'Guam': MetaZone(
      'Guam',
      long: TimeZoneName(standard: 'Am Caighdeánach Ghuam'),
    ),
    'Gulf': MetaZone(
      'Gulf',
    ...
    'Indochina': MetaZone(
      'Indochina',
      long: TimeZoneName(standard: 'Am na hInd-Síne'),
    ),
    ...
    'Malaysia': MetaZone(
      'Malaysia',
      long: TimeZoneName(standard: 'Am na Malaeisia'),
    ),
    'Maldives': MetaZone(
      'Maldives',
    ...
    'Palau': MetaZone(
      'Palau',
      long: TimeZoneName(standard: 'Am Oileáin Palau'),
    ),
    ...
    'Pitcairn': MetaZone(
      'Pitcairn',
      long: TimeZoneName(standard: 'Am Pitcairn'),
    ),
    'Ponape': MetaZone('Ponape', long: TimeZoneName(standard: 'Am Phohnpei')),
    'Pyongyang': MetaZone(
      'Pyongyang',
      long: TimeZoneName(standard: 'Am Pyongyang'),
    ),
    'Qyzylorda': MetaZone(
      'Qyzylorda',
      long: TimeZoneName(
    ...
    'Seychelles': MetaZone(
      'Seychelles',
      long: TimeZoneName(standard: 'Am na Séiséal'),
    ),
    'Singapore': MetaZone(
      'Singapore',
    ...
    'Suriname': MetaZone(
      'Suriname',
      long: TimeZoneName(standard: 'Am Shuranam'),
    ),
    ...
    'Tokelau': MetaZone(
      'Tokelau',
      long: TimeZoneName(standard: 'Am Oileáin Tócalá'),
    ),
    'Tonga': MetaZone(
      'Tonga',
      long: TimeZoneName(
    ...
    'Venezuela': MetaZone(
      'Venezuela',
      long: TimeZoneName(standard: 'Am Veiniséala'),
    ),
...
class LocaleDisplayNameGa extends LocaleDisplayName {
  const LocaleDisplayNameGa(super.cld);
  ...
  @override
  String get codePatternLanguage => 'Teanga: {0}';
  @override
  String get codePatternScript => 'Script: {0}';
  @override
  String get codePatternTerritory => 'Réigiún: {0}';
