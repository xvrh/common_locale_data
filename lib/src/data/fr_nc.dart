...
const _locale = 'fr-NC';
const _cld = CommonLocaleDataFrNC._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataFrNC implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataFrNC._();
  ...
  static final _units = UnitsFrNC._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsFrNC._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesFrNC._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsFrNC._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesFrNC._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsFrNC._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsFrNC._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesFrNC._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesFrNC._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameFrNC._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsFrNC extends Units {
  UnitsFrNC._(super.cld);
...
class DateFieldsFrNC extends DateFields {
  DateFieldsFrNC._(super.cld);
...
class LanguagesFrNC extends Languages {
  const LanguagesFrNC._(super.cld);
...
class ScriptsFrNC extends Scripts {
  const ScriptsFrNC._(super.cld);
...
class TerritoriesFrNC extends Territories {
  const TerritoriesFrNC._(super.cld);
...
class VariantsFrNC extends Variants {
  const VariantsFrNC._(super.cld);
...
class SubdivisionsFrNC extends Subdivisions {
  const SubdivisionsFrNC._(super.cld);
...
class CurrenciesFrNC extends Currencies {
  const CurrenciesFrNC._(super.cld);
...
class TimeZonesFrNC extends TimeZones {
  const TimeZonesFrNC._(super.cld)
      : super(
            gmtFormat: 'UTC{0}',
            gmtZeroFormat: 'UTC',
...
class LocaleDisplayNameFrNC extends LocaleDisplayName {
  const LocaleDisplayNameFrNC._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
