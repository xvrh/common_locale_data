...
const _locale = 'ar-PS';
const _cld = CommonLocaleDataArPS._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataArPS implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataArPS._();
  ...
  static final _units = UnitsArPS._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsArPS._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesArPS._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsArPS._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesArPS._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsArPS._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsArPS._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesArPS._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesArPS._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameArPS._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsArPS extends Units {
  UnitsArPS._(super.cld);
...
class DateFieldsArPS extends DateFields {
  DateFieldsArPS._(super.cld);
...
class LanguagesArPS extends Languages {
  const LanguagesArPS._(super.cld);
...
class ScriptsArPS extends Scripts {
  const ScriptsArPS._(super.cld);
...
class TerritoriesArPS extends Territories {
  const TerritoriesArPS._(super.cld);
...
class VariantsArPS extends Variants {
  const VariantsArPS._(super.cld);
...
class SubdivisionsArPS extends Subdivisions {
  const SubdivisionsArPS._(super.cld);
...
class CurrenciesArPS extends Currencies {
  const CurrenciesArPS._(super.cld);
...
class TimeZonesArPS extends TimeZones {
  const TimeZonesArPS._(super.cld)
      : super(
            gmtFormat: 'غرينتش{0}',
...
class LocaleDisplayNameArPS extends LocaleDisplayName {
  const LocaleDisplayNameArPS._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}، {1}',
