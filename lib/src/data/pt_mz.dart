...
const _locale = 'pt-MZ';
const _cld = CommonLocaleDataPtMZ.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataPtMZ extends CommonLocaleDataPt {
  @override
  String get locale => _locale;

  const CommonLocaleDataPtMZ.constant() : super.constant();

  factory CommonLocaleDataPtMZ() => _cld;
  ...
  static final _units = UnitsPtMZ(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsPtMZ(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesPtMZ(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsPtMZ(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesPtMZ(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsPtMZ(_cld);
  @override
  Variants get variants => _variants;

  static final _currencies = CurrenciesPtMZ(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesPtMZ(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNamePtMZ(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsPtMZ extends UnitsPt {
  const UnitsPtMZ(super.cld);
...
class DateFieldsPtMZ extends DateFieldsPt {
  const DateFieldsPtMZ(super.cld);
...
class LanguagesPtMZ extends LanguagesPt {
  const LanguagesPtMZ(super.cld);
...
class ScriptsPtMZ extends ScriptsPt {
  const ScriptsPtMZ(super.cld);
...
class TerritoriesPtMZ extends TerritoriesPt {
  const TerritoriesPtMZ(super.cld);
...
class VariantsPtMZ extends VariantsPt {
  const VariantsPtMZ(super.cld);
...
class CurrenciesPtMZ extends CurrenciesPt {
  const CurrenciesPtMZ(super.cld);
...
class TimeZonesPtMZ extends TimeZonesPt {
  const TimeZonesPtMZ(super.cld);
...
class LocaleDisplayNamePtMZ extends LocaleDisplayNamePt {
  const LocaleDisplayNamePtMZ(super.cld);
