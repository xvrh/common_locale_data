...
const _locale = 'es-NI';
const _cld = CommonLocaleDataEsNI.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEsNI extends CommonLocaleDataEs {
  @override
  String get locale => _locale;

  const CommonLocaleDataEsNI.constant() : super.constant();

  factory CommonLocaleDataEsNI() => _cld;
  ...
  static final _units = UnitsEsNI(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEsNI(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEsNI(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsEsNI(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesEsNI(_cld);
  @override
  Territories get territories => _territories;

  static final _currencies = CurrenciesEsNI(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEsNI(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEsNI(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEsNI extends UnitsEs {
  const UnitsEsNI(super.cld);
...
class DateFieldsEsNI extends DateFieldsEs {
  const DateFieldsEsNI(super.cld);
...
class LanguagesEsNI extends LanguagesEs {
  const LanguagesEsNI(super.cld);
...
class ScriptsEsNI extends ScriptsEs {
  const ScriptsEsNI(super.cld);
...
class TerritoriesEsNI extends TerritoriesEs {
  const TerritoriesEsNI(super.cld);
...
class CurrenciesEsNI extends CurrenciesEs {
  const CurrenciesEsNI(super.cld);
...
class TimeZonesEsNI extends TimeZonesEs {
  const TimeZonesEsNI(super.cld);
...
class LocaleDisplayNameEsNI extends LocaleDisplayNameEs {
  const LocaleDisplayNameEsNI(super.cld);
