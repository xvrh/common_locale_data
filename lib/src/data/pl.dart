...
class DateFieldsPl extends DateFields {
  ...
  DateFieldFullData get quarter => const DateFieldFullData(
    displayName: MultiLength(long: 'kwartał', short: 'kw.', narrow: 'kw.'),
    previous: MultiLength(
  ...
  DateFieldFullData get month => const DateFieldFullData(
    displayName: MultiLength(long: 'miesiąc', short: 'mies.', narrow: 'mc'),
    previous: MultiLength(
  ...
  DateFieldFullData get week => const DateFieldFullData(
    displayName: MultiLength(long: 'tydzień', short: 'tydz.', narrow: 'tydz.'),
    previous: MultiLength(
  ...
  DateFieldFullData get day => const DateFieldFullData(
    displayName: MultiLength(long: 'dzień', short: 'dz.', narrow: 'd.'),
    previous: MultiLength(long: 'wczoraj', short: 'wczoraj', narrow: 'wcz.'),
    now: MultiLength(long: 'dzisiaj', short: 'dzisiaj', narrow: 'dziś'),
    next: MultiLength(long: 'jutro', short: 'jutro', narrow: 'jutro'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
        one: '{0} dzień temu',
  ...
  DateFieldDataTime get hour => const DateFieldDataTime(
    displayName: MultiLength(long: 'godzina', short: 'godz.', narrow: 'g.'),
    now: MultiLength(
      long: 'ta godzina',
      short: 'ta godzina',
      narrow: 'ta godzina',
...
class TimeZonesPl extends TimeZones {
  ...
  static const staticTimeZoneNames = <String, TimeZoneNames>{
    ...
    'Europe/Dublin': TimeZoneNames(
      long: TimeZoneName(daylight: 'Irlandia (czas letni)'),
    ),
  ...
  static const staticMetaZoneNames = <String, MetaZone>{
    ...
    'Bolivia': MetaZone(
      'Bolivia',
      long: TimeZoneName(standard: 'czas Boliwia'),
    ),
    'Brasilia': MetaZone(
      'Brasilia',
      long: TimeZoneName(
    ...
    'Chamorro': MetaZone(
      'Chamorro',
      long: TimeZoneName(standard: 'czas Czamorro'),
    ),
    'Chatham': MetaZone(
      'Chatham',
      long: TimeZoneName(
    ...
    'Cocos': MetaZone(
      'Cocos',
      long: TimeZoneName(standard: 'czas Wyspy Kokosowe'),
    ),
    'Colombia': MetaZone(
      'Colombia',
      long: TimeZoneName(
    ...
    'Ecuador': MetaZone(
      'Ecuador',
      long: TimeZoneName(standard: 'czas Ekwador'),
    ),
    ...
    'Galapagos': MetaZone(
      'Galapagos',
      long: TimeZoneName(standard: 'czas Galapagos'),
    ),
    'Gambier': MetaZone(
      'Gambier',
    ...
    'Gulf': MetaZone(
      'Gulf',
      long: TimeZoneName(standard: 'czas Zatoka Perska'),
    ),
    ...
    'Indochina': MetaZone(
      'Indochina',
      long: TimeZoneName(standard: 'czas indochiński'),
    ),
    ...
    'Kazakhstan': MetaZone(
      'Kazakhstan',
      long: TimeZoneName(standard: 'czas Kazachstan'),
    ),
    ...
    'Kyrgystan': MetaZone(
      'Kyrgystan',
      long: TimeZoneName(standard: 'czas Kirgistan'),
    ),
    ...
    'Malaysia': MetaZone(
      'Malaysia',
      long: TimeZoneName(standard: 'czas Malezja'),
    ),
    'Maldives': MetaZone(
      'Maldives',
      long: TimeZoneName(standard: 'czas Malediwy'),
    ),
    'Marquesas': MetaZone(
      'Marquesas',
      long: TimeZoneName(standard: 'czas Markizy'),
    ),
    ...
    'Pitcairn': MetaZone(
      'Pitcairn',
      long: TimeZoneName(standard: 'czas Pitcairn'),
    ),
    'Ponape': MetaZone('Ponape', long: TimeZoneName(standard: 'czas Pohnpei')),
    'Pyongyang': MetaZone(
      'Pyongyang',
      long: TimeZoneName(standard: 'czas Pjongjang'),
    ),
    'Reunion': MetaZone(
      'Reunion',
      long: TimeZoneName(standard: 'czas Reunion'),
    ),
    'Rothera': MetaZone(
      'Rothera',
      long: TimeZoneName(standard: 'czas Rothera'),
    ),
    'Sakhalin': MetaZone(
      'Sakhalin',
      long: TimeZoneName(
    ...
    'Seychelles': MetaZone(
      'Seychelles',
      long: TimeZoneName(standard: 'czas Seszele'),
    ),
    'Singapore': MetaZone(
      'Singapore',
      long: TimeZoneName(standard: 'czas Singapur'),
    ),
    'Solomon': MetaZone(
      'Solomon',
    ...
    'Suriname': MetaZone(
      'Suriname',
      long: TimeZoneName(standard: 'czas Surinam'),
    ),
    ...
    'Tokelau': MetaZone(
      'Tokelau',
      long: TimeZoneName(standard: 'czas Tokelau'),
    ),
    'Tonga': MetaZone(
      'Tonga',
      long: TimeZoneName(
    ...
    'Venezuela': MetaZone(
      'Venezuela',
      long: TimeZoneName(standard: 'czas Wenezuela'),
    ),
...
class LocaleDisplayNamePl extends LocaleDisplayName {
  ...
  static const staticValueNames = <String, Map<String, String>>{
    ...
    'm0': {'bgn': 'transliteracja BGN', 'ungegn': 'transliteracja UNGEGN'},
    'ms': {
