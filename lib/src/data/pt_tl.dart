...
const _locale = 'pt-TL';
const _cld = CommonLocaleDataPtTL.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataPtTL extends CommonLocaleDataPt {
  @override
  String get locale => _locale;

  const CommonLocaleDataPtTL.constant() : super.constant();

  factory CommonLocaleDataPtTL() => _cld;
  ...
  static final _units = UnitsPtTL(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsPtTL(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesPtTL(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsPtTL(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesPtTL(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsPtTL(_cld);
  @override
  Variants get variants => _variants;

  static final _currencies = CurrenciesPtTL(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesPtTL(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNamePtTL(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsPtTL extends UnitsPt {
  const UnitsPtTL(super.cld);
...
class DateFieldsPtTL extends DateFieldsPt {
  const DateFieldsPtTL(super.cld);
...
class LanguagesPtTL extends LanguagesPt {
  const LanguagesPtTL(super.cld);
...
class ScriptsPtTL extends ScriptsPt {
  const ScriptsPtTL(super.cld);
...
class TerritoriesPtTL extends TerritoriesPt {
  const TerritoriesPtTL(super.cld);
...
class VariantsPtTL extends VariantsPt {
  const VariantsPtTL(super.cld);
...
class CurrenciesPtTL extends CurrenciesPt {
  const CurrenciesPtTL(super.cld);
...
class TimeZonesPtTL extends TimeZonesPt {
  const TimeZonesPtTL(super.cld);
...
class LocaleDisplayNamePtTL extends LocaleDisplayNamePt {
  const LocaleDisplayNamePtTL(super.cld);
