...
const _locale = 'pt-TL';
const _cld = CommonLocaleDataPtTL._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataPtTL implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataPtTL._();
  ...
  static final _units = UnitsPtTL._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsPtTL._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesPtTL._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsPtTL._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesPtTL._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsPtTL._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsPtTL._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesPtTL._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesPtTL._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNamePtTL._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsPtTL extends Units {
  UnitsPtTL._(super.cld);
...
class DateFieldsPtTL extends DateFields {
  DateFieldsPtTL._(super.cld);
...
class LanguagesPtTL extends Languages {
  const LanguagesPtTL._(super.cld);
...
class ScriptsPtTL extends Scripts {
  const ScriptsPtTL._(super.cld);
...
class TerritoriesPtTL extends Territories {
  const TerritoriesPtTL._(super.cld);
...
class VariantsPtTL extends Variants {
  const VariantsPtTL._(super.cld);
...
class SubdivisionsPtTL extends Subdivisions {
  const SubdivisionsPtTL._(super.cld);
...
class CurrenciesPtTL extends Currencies {
  const CurrenciesPtTL._(super.cld);
...
class TimeZonesPtTL extends TimeZones {
  const TimeZonesPtTL._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
...
class LocaleDisplayNamePtTL extends LocaleDisplayName {
  const LocaleDisplayNamePtTL._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
