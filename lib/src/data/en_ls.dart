...
const _locale = 'en-LS';
const _cld = CommonLocaleDataEnLS._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEnLS implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataEnLS._();
  ...
  static final _units = UnitsEnLS._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEnLS._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEnLS._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsEnLS._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesEnLS._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsEnLS._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsEnLS._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesEnLS._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEnLS._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEnLS._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEnLS extends Units {
  UnitsEnLS._(super.cld);
...
class DateFieldsEnLS extends DateFields {
  DateFieldsEnLS._(super.cld);
...
class LanguagesEnLS extends Languages {
  const LanguagesEnLS._(super.cld);
...
class ScriptsEnLS extends Scripts {
  const ScriptsEnLS._(super.cld);
...
class TerritoriesEnLS extends Territories {
  const TerritoriesEnLS._(super.cld);
...
class VariantsEnLS extends Variants {
  const VariantsEnLS._(super.cld);
...
class SubdivisionsEnLS extends Subdivisions {
  const SubdivisionsEnLS._(super.cld);
...
class CurrenciesEnLS extends Currencies {
  const CurrenciesEnLS._(super.cld);
...
class TimeZonesEnLS extends TimeZones {
  const TimeZonesEnLS._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
            regionFormat: '{0} Time',
...
class LocaleDisplayNameEnLS extends LocaleDisplayName {
  const LocaleDisplayNameEnLS._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
