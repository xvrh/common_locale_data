...
const _locale = 'en-LS';
const _cld = CommonLocaleDataEnLS.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEnLS extends CommonLocaleDataEn {
  @override
  String get locale => _locale;

  const CommonLocaleDataEnLS.constant() : super.constant();

  factory CommonLocaleDataEnLS() => _cld;
  ...
  static final _units = UnitsEnLS(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEnLS(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEnLS(_cld);
  @override
  Languages get languages => _languages;

  static final _territories = TerritoriesEnLS(_cld);
  @override
  Territories get territories => _territories;

  static final _currencies = CurrenciesEnLS(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEnLS(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEnLS(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEnLS extends UnitsEn {
  const UnitsEnLS(super.cld);
...
class DateFieldsEnLS extends DateFieldsEn {
  const DateFieldsEnLS(super.cld);
...
class LanguagesEnLS extends LanguagesEn {
  const LanguagesEnLS(super.cld);
...
class TerritoriesEnLS extends TerritoriesEn {
  const TerritoriesEnLS(super.cld);
...
class CurrenciesEnLS extends CurrenciesEn {
  const CurrenciesEnLS(super.cld);
...
class TimeZonesEnLS extends TimeZonesEn {
  const TimeZonesEnLS(super.cld);
...
class LocaleDisplayNameEnLS extends LocaleDisplayNameEn {
  const LocaleDisplayNameEnLS(super.cld);
