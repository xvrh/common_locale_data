...
const _locale = 'es-HN';
const _cld = CommonLocaleDataEsHN.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEsHN extends CommonLocaleDataEs {
  @override
  String get locale => _locale;

  const CommonLocaleDataEsHN.constant() : super.constant();
  ...
  static final _units = UnitsEsHN(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEsHN(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEsHN(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsEsHN(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesEsHN(_cld);
  @override
  Territories get territories => _territories;

  static final _currencies = CurrenciesEsHN(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEsHN(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEsHN(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEsHN extends UnitsEs {
  const UnitsEsHN(super.cld);
...
class DateFieldsEsHN extends DateFieldsEs {
  const DateFieldsEsHN(super.cld);
...
class LanguagesEsHN extends LanguagesEs {
  const LanguagesEsHN(super.cld);
...
class ScriptsEsHN extends ScriptsEs {
  const ScriptsEsHN(super.cld);
...
class TerritoriesEsHN extends TerritoriesEs {
  const TerritoriesEsHN(super.cld);
...
class CurrenciesEsHN extends CurrenciesEs {
  const CurrenciesEsHN(super.cld);
...
class TimeZonesEsHN extends TimeZonesEs {
  const TimeZonesEsHN(super.cld);
...
class LocaleDisplayNameEsHN extends LocaleDisplayNameEs {
  const LocaleDisplayNameEsHN(super.cld);
