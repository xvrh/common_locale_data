...
const _locale = 'es-BR';
const _cld = CommonLocaleDataEsBR.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEsBR extends CommonLocaleDataEs {
  @override
  String get locale => _locale;

  const CommonLocaleDataEsBR.constant() : super.constant();

  factory CommonLocaleDataEsBR() => _cld;
  ...
  static final _units = UnitsEsBR(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEsBR(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEsBR(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsEsBR(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesEsBR(_cld);
  @override
  Territories get territories => _territories;

  static final _currencies = CurrenciesEsBR(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEsBR(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEsBR(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEsBR extends UnitsEs {
  const UnitsEsBR(super.cld);
...
class DateFieldsEsBR extends DateFieldsEs {
  const DateFieldsEsBR(super.cld);
...
class LanguagesEsBR extends LanguagesEs {
  const LanguagesEsBR(super.cld);
...
class ScriptsEsBR extends ScriptsEs {
  const ScriptsEsBR(super.cld);
...
class TerritoriesEsBR extends TerritoriesEs {
  const TerritoriesEsBR(super.cld);
...
class CurrenciesEsBR extends CurrenciesEs {
  const CurrenciesEsBR(super.cld);
...
class TimeZonesEsBR extends TimeZonesEs {
  const TimeZonesEsBR(super.cld);
...
class LocaleDisplayNameEsBR extends LocaleDisplayNameEs {
  const LocaleDisplayNameEsBR(super.cld);
