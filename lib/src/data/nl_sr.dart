...
const _locale = 'nl-SR';
const _cld = CommonLocaleDataNlSR._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataNlSR implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataNlSR._();
  ...
  static final _units = UnitsNlSR._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsNlSR._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesNlSR._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsNlSR._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesNlSR._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsNlSR._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsNlSR._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesNlSR._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesNlSR._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameNlSR._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsNlSR extends Units {
  UnitsNlSR._(super.cld);
...
class DateFieldsNlSR extends DateFields {
  DateFieldsNlSR._(super.cld);
...
class LanguagesNlSR extends Languages {
  const LanguagesNlSR._(super.cld);
...
class ScriptsNlSR extends Scripts {
  const ScriptsNlSR._(super.cld);
...
class TerritoriesNlSR extends Territories {
  const TerritoriesNlSR._(super.cld);
...
class VariantsNlSR extends Variants {
  const VariantsNlSR._(super.cld);
...
class SubdivisionsNlSR extends Subdivisions {
  const SubdivisionsNlSR._(super.cld);
...
class CurrenciesNlSR extends Currencies {
  const CurrenciesNlSR._(super.cld);
...
class TimeZonesNlSR extends TimeZones {
  const TimeZonesNlSR._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
...
class LocaleDisplayNameNlSR extends LocaleDisplayName {
  const LocaleDisplayNameNlSR._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
