...
const _locale = 'fr-BL';
const _cld = CommonLocaleDataFrBL._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataFrBL implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataFrBL._();
  ...
  static final _units = UnitsFrBL._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsFrBL._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesFrBL._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsFrBL._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesFrBL._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsFrBL._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsFrBL._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesFrBL._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesFrBL._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameFrBL._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsFrBL extends Units {
  UnitsFrBL._(super.cld);
...
class DateFieldsFrBL extends DateFields {
  DateFieldsFrBL._(super.cld);
...
class LanguagesFrBL extends Languages {
  const LanguagesFrBL._(super.cld);
...
class ScriptsFrBL extends Scripts {
  const ScriptsFrBL._(super.cld);
...
class TerritoriesFrBL extends Territories {
  const TerritoriesFrBL._(super.cld);
...
class VariantsFrBL extends Variants {
  const VariantsFrBL._(super.cld);
...
class SubdivisionsFrBL extends Subdivisions {
  const SubdivisionsFrBL._(super.cld);
...
class CurrenciesFrBL extends Currencies {
  const CurrenciesFrBL._(super.cld);
...
class TimeZonesFrBL extends TimeZones {
  const TimeZonesFrBL._(super.cld)
      : super(
            gmtFormat: 'UTC{0}',
            gmtZeroFormat: 'UTC',
...
class LocaleDisplayNameFrBL extends LocaleDisplayName {
  const LocaleDisplayNameFrBL._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
