...
const _locale = 'en-NZ';
const _cld = CommonLocaleDataEnNZ.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEnNZ extends CommonLocaleDataEn {
  @override
  String get locale => _locale;

  const CommonLocaleDataEnNZ.constant() : super.constant();

  factory CommonLocaleDataEnNZ() => _cld;
  ...
  static final _units = UnitsEnNZ(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEnNZ(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEnNZ(_cld);
  @override
  Languages get languages => _languages;

  static final _territories = TerritoriesEnNZ(_cld);
  @override
  Territories get territories => _territories;

  static final _currencies = CurrenciesEnNZ(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEnNZ(_cld);
  @override
...
class DateFieldsEnNZ extends DateFieldsEn {
  const DateFieldsEnNZ(super.cld);
  ...
  DateFieldFullData get quarter => const DateFieldFullData(
    ...
    past: MultiLengthRelativeTime(
      ...
      short: RelativeTime(_locale, one: '{0} qtr ago', other: '{0} qtr ago'),
      narrow: RelativeTime(_locale, one: '{0} qtr ago', other: '{0} qtr ago'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
      ...
      short: RelativeTime(_locale, one: 'in {0} qtr', other: 'in {0} qtr'),
      narrow: RelativeTime(_locale, one: 'in {0} qtr', other: 'in {0} qtr'),
    ),
  );
  ...
  DateFieldFullData get week => const DateFieldFullData(
    ...
    past: MultiLengthRelativeTime(
      ...
      narrow: RelativeTime(_locale, one: '{0} wk ago', other: '{0} wk ago'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(_locale, one: 'in {0} week', other: 'in {0} weeks'),
      short: RelativeTime(_locale, one: 'in {0} wk', other: 'in {0} wk'),
      narrow: RelativeTime(_locale, one: 'in {0} wk', other: 'in {0} wk'),
    ),
  );
  ...
  DateFieldFullData get day => const DateFieldFullData(
    ...
    past: MultiLengthRelativeTime(
      ...
      narrow: RelativeTime(_locale, one: '{0} day ago', other: '{0} days ago'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(_locale, one: 'in {0} day', other: 'in {0} days'),
      short: RelativeTime(_locale, one: 'in {0} day', other: 'in {0} days'),
      narrow: RelativeTime(_locale, one: 'in {0} day', other: 'in {0} days'),
    ),
  );
  ...
  DateFieldDataTime get hour => const DateFieldDataTime(
    ...
    past: MultiLengthRelativeTime(
      ...
      narrow: RelativeTime(_locale, one: '{0} hr ago', other: '{0} hr ago'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(_locale, one: 'in {0} hour', other: 'in {0} hours'),
      short: RelativeTime(_locale, one: 'in {0} hr', other: 'in {0} hr'),
      narrow: RelativeTime(_locale, one: 'in {0} hr', other: 'in {0} hr'),
    ),
  );
  ...
  DateFieldDataTime get minute => const DateFieldDataTime(
    ...
    past: MultiLengthRelativeTime(
      ...
      narrow: RelativeTime(_locale, one: '{0} min ago', other: '{0} min ago'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
      ...
      narrow: RelativeTime(_locale, one: 'in {0} min', other: 'in {0} min'),
    ),
  );
  ...
  DateFieldDataTime get second => const DateFieldDataTime(
    ...
    past: MultiLengthRelativeTime(
      ...
      narrow: RelativeTime(_locale, one: '{0} sec ago', other: '{0} sec ago'),
    ),
    future: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
      ...
      narrow: RelativeTime(_locale, one: 'in {0} sec', other: 'in {0} sec'),
    ),
  );
}

class LanguagesEnNZ extends LanguagesEn {
  const LanguagesEnNZ(super.cld);
  ...
  Map<String, Language> get languages => Map.unmodifiable({
    ...
    ...const {'bla': _bla, 'mus': _mus, 'nds-NL': _ndsNL},
  });
}

class TerritoriesEnNZ extends TerritoriesEn {
  const TerritoriesEnNZ(super.cld);
...
class CurrenciesEnNZ extends CurrenciesEn {
  const CurrenciesEnNZ(super.cld);
...
class TimeZonesEnNZ extends TimeZonesEn {
  const TimeZonesEnNZ(super.cld);
  ...
  Map<String, MetaZone> get metaZoneNames => Map.unmodifiable({
    ...
    ...const {
      ...
      'Australia_Central': MetaZone(
        ...
        short: TimeZoneName(generic: 'ACT', standard: 'ACST', daylight: 'ACDT'),
      ),
      ...
      'Australia_Western': MetaZone(
        ...
        short: TimeZoneName(generic: 'AWT', standard: 'AWST', daylight: 'AWDT'),
      ),
      'Chatham': MetaZone(
        'Chatham',
        long: TimeZoneName(
      ...
      'Lord_Howe': MetaZone(
        ...
        short: TimeZoneName(generic: 'LHT', standard: 'LHST', daylight: 'LHDT'),
      ),
      'New_Zealand': MetaZone(
        ...
        short: TimeZoneName(generic: 'NZT', standard: 'NZST', daylight: 'NZDT'),
      ),
...
class LocaleDisplayNameEnNZ extends LocaleDisplayNameEn {
  const LocaleDisplayNameEnNZ(super.cld);

  @override
  Map<String, String> get keyNames => Map.unmodifiable({
    ...LocaleDisplayNameEn.staticKeyNames,
    ...const {'kc': 'Case-Sensitive Sorting', 'kk': 'Normalised Sorting'},
  });
