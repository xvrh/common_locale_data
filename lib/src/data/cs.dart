...
const _locale = 'cs';
const _cld = CommonLocaleDataCs.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataCs extends CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataCs.constant() : super.constant();
  ...
  static final _units = UnitsCs(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsCs(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesCs(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsCs(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesCs(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsCs(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsCs(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesCs(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesCs(_cld);
  @override
...
class DateFieldsCs extends DateFields {
  const DateFieldsCs(super.cld);

  @override
  MultiLength get era =>
      const MultiLength(long: 'letopočet', short: 'letop.', narrow: 'let.');

  @override
  DateFieldFullData get year => const DateFieldFullData(
    displayName: MultiLength(long: 'rok', short: 'r.', narrow: 'r.'),
  ...
  DateFieldFullData get quarter => const DateFieldFullData(
    displayName: MultiLength(long: 'čtvrtletí', short: 'Q', narrow: 'Q'),
    previous: MultiLength(
  ...
  DateFieldFullData get month => const DateFieldFullData(
    displayName: MultiLength(long: 'měsíc', short: 'měs.', narrow: 'měs.'),
    previous: MultiLength(
      long: 'minulý měsíc',
      short: 'minulý měs.',
      narrow: 'minulý měs.',
  ...
  DateFieldFullData get week => const DateFieldFullData(
    displayName: MultiLength(long: 'týden', short: 'týd.', narrow: 'týd.'),
    previous: MultiLength(
      long: 'minulý týden',
      short: 'minulý týd.',
      narrow: 'minulý týd.',
  ...
  DateFieldFullData get day => const DateFieldFullData(
    displayName: MultiLength(long: 'den', short: 'den', narrow: 'den'),
    previous: MultiLength(long: 'včera', short: 'včera', narrow: 'včera'),
    now: MultiLength(long: 'dnes', short: 'dnes', narrow: 'dnes'),
    next: MultiLength(long: 'zítra', short: 'zítra', narrow: 'zítra'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
        one: 'před {0} dnem',
  ...
  MultiLength get dayperiod =>
      const MultiLength(long: 'část dne', short: 'část dne', narrow: 'část d.');

  @override
  DateFieldDataTime get hour => const DateFieldDataTime(
    displayName: MultiLength(long: 'hodina', short: 'h', narrow: 'h'),
    now: MultiLength(
      long: 'tuto hodinu',
      short: 'tuto hodinu',
      narrow: 'tuto hodinu',
  ...
  DateFieldDataTime get second => const DateFieldDataTime(
    ...
    now: MultiLength(long: 'nyní', short: 'nyní', narrow: 'nyní'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
        one: 'před {0} sekundou',
...
class SubdivisionsCs extends Subdivisions {
  const SubdivisionsCs(super.cld);
...
class TimeZonesCs extends TimeZones {
  ...
  static const staticTimeZoneNames = <String, TimeZoneNames>{
    ...
    'Europe/Dublin': TimeZoneNames(
      long: TimeZoneName(daylight: 'irský letní čas'),
    ),
  ...
  static const staticMetaZoneNames = <String, MetaZone>{
    ...
    'Afghanistan': MetaZone(
      'Afghanistan',
      long: TimeZoneName(standard: 'afghánský čas'),
    ),
    ...
    'Bolivia': MetaZone(
      'Bolivia',
      long: TimeZoneName(standard: 'bolivijský čas'),
    ),
    'Brasilia': MetaZone(
      'Brasilia',
      long: TimeZoneName(
    ...
    'Casey': MetaZone(
      'Casey',
      long: TimeZoneName(standard: 'čas Caseyho stanice'),
    ),
    'Chamorro': MetaZone(
      'Chamorro',
      long: TimeZoneName(standard: 'chamorrský čas'),
    ),
    'Chatham': MetaZone(
      'Chatham',
      long: TimeZoneName(
    ...
    'Davis': MetaZone(
      'Davis',
      long: TimeZoneName(standard: 'čas Davisovy stanice'),
    ),
    ...
    'Ecuador': MetaZone(
      'Ecuador',
      long: TimeZoneName(standard: 'ekvádorský čas'),
    ),
    ...
    'Galapagos': MetaZone(
      'Galapagos',
      long: TimeZoneName(standard: 'galapážský čas'),
    ),
    'Gambier': MetaZone(
      'Gambier',
      long: TimeZoneName(standard: 'gambierský čas'),
    ),
    'Georgia': MetaZone(
      'Georgia',
      long: TimeZoneName(
    ...
    'Indochina': MetaZone(
      'Indochina',
      long: TimeZoneName(standard: 'indočínský čas'),
    ),
    ...
    'Kyrgystan': MetaZone(
      'Kyrgystan',
      long: TimeZoneName(standard: 'kyrgyzský čas'),
    ),
    ...
    'Malaysia': MetaZone(
      'Malaysia',
      long: TimeZoneName(standard: 'malajský čas'),
    ),
    'Maldives': MetaZone(
      'Maldives',
      long: TimeZoneName(standard: 'maledivský čas'),
    ),
    'Marquesas': MetaZone(
      'Marquesas',
      long: TimeZoneName(standard: 'markézský čas'),
    ),
    ...
    'Myanmar': MetaZone(
      'Myanmar',
      long: TimeZoneName(standard: 'myanmarský čas'),
    ),
    ...
    'Reunion': MetaZone(
      'Reunion',
      long: TimeZoneName(standard: 'réunionský čas'),
    ),
    'Rothera': MetaZone(
      'Rothera',
    ...
    'Seychelles': MetaZone(
      'Seychelles',
      long: TimeZoneName(standard: 'seychelský čas'),
    ),
    'Singapore': MetaZone(
      'Singapore',
      long: TimeZoneName(standard: 'singapurský čas'),
    ),
    'Solomon': MetaZone(
      'Solomon',
    ...
    'Suriname': MetaZone(
      'Suriname',
      long: TimeZoneName(standard: 'surinamský čas'),
    ),
    'Syowa': MetaZone(
      'Syowa',
      long: TimeZoneName(standard: 'čas stanice Šówa'),
    ),
    ...
    'Tajikistan': MetaZone(
      'Tajikistan',
      long: TimeZoneName(standard: 'tádžický čas'),
    ),
    'Tokelau': MetaZone(
      'Tokelau',
      long: TimeZoneName(standard: 'tokelauský čas'),
    ),
    'Tonga': MetaZone(
      'Tonga',
      long: TimeZoneName(
    ...
    'Venezuela': MetaZone(
      'Venezuela',
      long: TimeZoneName(standard: 'venezuelský čas'),
    ),
    ...
    'Vostok': MetaZone(
      'Vostok',
      long: TimeZoneName(standard: 'čas stanice Vostok'),
    ),
...
class LocaleDisplayNameCs extends LocaleDisplayName {
  const LocaleDisplayNameCs(super.cld);
  ...
  static const staticValueNames = <String, Map<String, String>>{
    ...
    'kb': {'false': 'Normální řazení akcentů', 'true': 'Řadit akcenty opačně'},
    'kf': {
