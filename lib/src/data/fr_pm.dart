...
const _locale = 'fr-PM';
const _cld = CommonLocaleDataFrPM._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataFrPM implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataFrPM._();
  ...
  static final _units = UnitsFrPM._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsFrPM._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesFrPM._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsFrPM._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesFrPM._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsFrPM._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsFrPM._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesFrPM._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesFrPM._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameFrPM._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsFrPM extends Units {
  UnitsFrPM._(super.cld);
...
class DateFieldsFrPM extends DateFields {
  DateFieldsFrPM._(super.cld);
...
class LanguagesFrPM extends Languages {
  const LanguagesFrPM._(super.cld);
...
class ScriptsFrPM extends Scripts {
  const ScriptsFrPM._(super.cld);
...
class TerritoriesFrPM extends Territories {
  const TerritoriesFrPM._(super.cld);
...
class VariantsFrPM extends Variants {
  const VariantsFrPM._(super.cld);
...
class SubdivisionsFrPM extends Subdivisions {
  const SubdivisionsFrPM._(super.cld);
...
class CurrenciesFrPM extends Currencies {
  const CurrenciesFrPM._(super.cld);
...
class TimeZonesFrPM extends TimeZones {
  const TimeZonesFrPM._(super.cld)
      : super(
            gmtFormat: 'UTC{0}',
            gmtZeroFormat: 'UTC',
...
class LocaleDisplayNameFrPM extends LocaleDisplayName {
  const LocaleDisplayNameFrPM._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
