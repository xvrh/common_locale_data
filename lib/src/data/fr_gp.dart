...
const _locale = 'fr-GP';
const _cld = CommonLocaleDataFrGP._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataFrGP implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataFrGP._();
  ...
  static final _units = UnitsFrGP._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsFrGP._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesFrGP._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsFrGP._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesFrGP._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsFrGP._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsFrGP._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesFrGP._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesFrGP._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameFrGP._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsFrGP extends Units {
  UnitsFrGP._(super.cld);
...
class DateFieldsFrGP extends DateFields {
  DateFieldsFrGP._(super.cld);
...
class LanguagesFrGP extends Languages {
  const LanguagesFrGP._(super.cld);
...
class ScriptsFrGP extends Scripts {
  const ScriptsFrGP._(super.cld);
...
class TerritoriesFrGP extends Territories {
  const TerritoriesFrGP._(super.cld);
...
class VariantsFrGP extends Variants {
  const VariantsFrGP._(super.cld);
...
class SubdivisionsFrGP extends Subdivisions {
  const SubdivisionsFrGP._(super.cld);
...
class CurrenciesFrGP extends Currencies {
  const CurrenciesFrGP._(super.cld);
...
class TimeZonesFrGP extends TimeZones {
  const TimeZonesFrGP._(super.cld)
      : super(
            gmtFormat: 'UTC{0}',
            gmtZeroFormat: 'UTC',
...
class LocaleDisplayNameFrGP extends LocaleDisplayName {
  const LocaleDisplayNameFrGP._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
