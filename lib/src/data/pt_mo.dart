...
const _locale = 'pt-MO';
const _cld = CommonLocaleDataPtMO._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataPtMO implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataPtMO._();
  ...
  static final _units = UnitsPtMO._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsPtMO._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesPtMO._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsPtMO._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesPtMO._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsPtMO._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsPtMO._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesPtMO._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesPtMO._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNamePtMO._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsPtMO extends Units {
  UnitsPtMO._(super.cld);
...
class DateFieldsPtMO extends DateFields {
  DateFieldsPtMO._(super.cld);
...
class LanguagesPtMO extends Languages {
  const LanguagesPtMO._(super.cld);
...
class ScriptsPtMO extends Scripts {
  const ScriptsPtMO._(super.cld);
...
class TerritoriesPtMO extends Territories {
  const TerritoriesPtMO._(super.cld);
...
class VariantsPtMO extends Variants {
  const VariantsPtMO._(super.cld);
...
class SubdivisionsPtMO extends Subdivisions {
  const SubdivisionsPtMO._(super.cld);
...
class CurrenciesPtMO extends Currencies {
  const CurrenciesPtMO._(super.cld);
  ...
  static const _mop = Currency(_cld, 'MOP', 'pataca macaense',
      one: 'pataca macaense', other: 'patacas macaenses', symbol: r'MOP$');
...
class TimeZonesPtMO extends TimeZones {
  const TimeZonesPtMO._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
...
class LocaleDisplayNamePtMO extends LocaleDisplayName {
  const LocaleDisplayNamePtMO._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
