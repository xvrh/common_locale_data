...
const _locale = 'pt-MO';
const _cld = CommonLocaleDataPtMO.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataPtMO extends CommonLocaleDataPt {
  @override
  String get locale => _locale;

  const CommonLocaleDataPtMO.constant() : super.constant();

  factory CommonLocaleDataPtMO() => _cld;
  ...
  static final _units = UnitsPtMO(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsPtMO(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesPtMO(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsPtMO(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesPtMO(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsPtMO(_cld);
  @override
  Variants get variants => _variants;

  static final _currencies = CurrenciesPtMO(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesPtMO(_cld);
  @override
...
class DateFieldsPtMO extends DateFieldsPt {
  const DateFieldsPtMO(super.cld);
...
class LanguagesPtMO extends LanguagesPt {
  const LanguagesPtMO(super.cld);
...
class ScriptsPtMO extends ScriptsPt {
  const ScriptsPtMO(super.cld);
...
class TerritoriesPtMO extends TerritoriesPt {
  const TerritoriesPtMO(super.cld);
...
class VariantsPtMO extends VariantsPt {
  const VariantsPtMO(super.cld);
...
class CurrenciesPtMO extends CurrenciesPt {
  const CurrenciesPtMO(super.cld);
...
class TimeZonesPtMO extends TimeZonesPt {
  const TimeZonesPtMO(super.cld);
...
class LocaleDisplayNamePtMO extends LocaleDisplayNamePt {
  const LocaleDisplayNamePtMO(super.cld);
