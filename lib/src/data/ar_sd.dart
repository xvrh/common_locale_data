...
const _locale = 'ar-SD';
const _cld = CommonLocaleDataArSD._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataArSD implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataArSD._();
  ...
  static final _units = UnitsArSD._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsArSD._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesArSD._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsArSD._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesArSD._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsArSD._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsArSD._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesArSD._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesArSD._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameArSD._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsArSD extends Units {
  UnitsArSD._(super.cld);
...
class DateFieldsArSD extends DateFields {
  DateFieldsArSD._(super.cld);
...
class LanguagesArSD extends Languages {
  const LanguagesArSD._(super.cld);
...
class ScriptsArSD extends Scripts {
  const ScriptsArSD._(super.cld);
...
class TerritoriesArSD extends Territories {
  const TerritoriesArSD._(super.cld);
...
class VariantsArSD extends Variants {
  const VariantsArSD._(super.cld);
...
class SubdivisionsArSD extends Subdivisions {
  const SubdivisionsArSD._(super.cld);
...
class CurrenciesArSD extends Currencies {
  const CurrenciesArSD._(super.cld);
...
class TimeZonesArSD extends TimeZones {
  const TimeZonesArSD._(super.cld)
      : super(
            gmtFormat: 'غرينتش{0}',
...
class LocaleDisplayNameArSD extends LocaleDisplayName {
  const LocaleDisplayNameArSD._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}، {1}',
