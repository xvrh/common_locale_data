...
const _locale = 'es-BZ';
const _cld = CommonLocaleDataEsBZ.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEsBZ extends CommonLocaleDataEs {
  @override
  String get locale => _locale;

  const CommonLocaleDataEsBZ.constant() : super.constant();

  factory CommonLocaleDataEsBZ() => _cld;
  ...
  static final _units = UnitsEsBZ(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEsBZ(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEsBZ(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsEsBZ(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesEsBZ(_cld);
  @override
  Territories get territories => _territories;

  static final _currencies = CurrenciesEsBZ(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEsBZ(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEsBZ(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEsBZ extends UnitsEs {
  const UnitsEsBZ(super.cld);
...
class DateFieldsEsBZ extends DateFieldsEs {
  const DateFieldsEsBZ(super.cld);
...
class LanguagesEsBZ extends LanguagesEs {
  const LanguagesEsBZ(super.cld);
...
class ScriptsEsBZ extends ScriptsEs {
  const ScriptsEsBZ(super.cld);
...
class TerritoriesEsBZ extends TerritoriesEs {
  const TerritoriesEsBZ(super.cld);
...
class CurrenciesEsBZ extends CurrenciesEs {
  const CurrenciesEsBZ(super.cld);
...
class TimeZonesEsBZ extends TimeZonesEs {
  const TimeZonesEsBZ(super.cld);
...
class LocaleDisplayNameEsBZ extends LocaleDisplayNameEs {
  const LocaleDisplayNameEsBZ(super.cld);
