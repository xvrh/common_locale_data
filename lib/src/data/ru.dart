...
const _locale = 'ru';
const _cld = CommonLocaleDataRu.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataRu extends CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataRu.constant() : super.constant();

  factory CommonLocaleDataRu() => _cld;
  ...
  static final _units = UnitsRu(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsRu(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesRu(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsRu(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesRu(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsRu(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsRu(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesRu(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesRu(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameRu(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsRu extends Units {
  const UnitsRu(super.cld);
...
class DateFieldsRu extends DateFields {
  const DateFieldsRu(super.cld);
  ...
  DateFieldFullData get week => const DateFieldFullData(
    displayName: MultiLength(long: 'неделя', short: 'нед.', narrow: 'нед.'),
    previous: MultiLength(
  ...
  DateFieldFullData get day => const DateFieldFullData(
    displayName: MultiLength(long: 'день', short: 'дн.', narrow: 'дн.'),
    previous: MultiLength(long: 'вчера', short: 'вчера', narrow: 'вчера'),
    now: MultiLength(long: 'сегодня', short: 'сегодня', narrow: 'сегодня'),
    next: MultiLength(long: 'завтра', short: 'завтра', narrow: 'завтра'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
        one: '{0} день назад',
  ...
  DateFieldDataTime get second => const DateFieldDataTime(
    displayName: MultiLength(long: 'секунда', short: 'сек.', narrow: 'с'),
    now: MultiLength(long: 'сейчас', short: 'сейчас', narrow: 'сейчас'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
        one: '{0} секунду назад',
...
class ScriptsRu extends Scripts {
  const ScriptsRu(super.cld);
...
class TerritoriesRu extends Territories {
  const TerritoriesRu(super.cld);
...
class VariantsRu extends Variants {
  const VariantsRu(super.cld);
...
class SubdivisionsRu extends Subdivisions {
  const SubdivisionsRu(super.cld);
...
class CurrenciesRu extends Currencies {
  const CurrenciesRu(super.cld);
...
class TimeZonesRu extends TimeZones {
  const TimeZonesRu(super.cld);
  ...
  @override
  String get regionFormatDaylight => '{0}, летнее время';
  @override
  String get regionFormatStandard => '{0}, стандартное время';
  @override
  ...
  static const staticMetaZoneNames = <String, MetaZone>{
    ...
    'Afghanistan': MetaZone(
      'Afghanistan',
      long: TimeZoneName(standard: 'Афганистан'),
    ),
    ...
    'Christmas': MetaZone(
      'Christmas',
      long: TimeZoneName(standard: 'о-в Рождества'),
    ),
    ...
    'East_Timor': MetaZone(
      'East_Timor',
      long: TimeZoneName(standard: 'Восточный Тимор'),
    ),
    'Easter': MetaZone(
      'Easter',
      long: TimeZoneName(
    ...
    'Indochina': MetaZone(
      'Indochina',
      long: TimeZoneName(standard: 'Индокитай'),
    ),
    ...
    'Kazakhstan': MetaZone(
      'Kazakhstan',
      long: TimeZoneName(standard: 'Казахстан'),
    ),
    ...
    'Kyrgystan': MetaZone(
      'Kyrgystan',
      long: TimeZoneName(standard: 'Киргизия'),
    ),
    'Lanka': MetaZone('Lanka', long: TimeZoneName(standard: 'Шри-Ланка')),
    'Line_Islands': MetaZone(
      'Line_Islands',
      long: TimeZoneName(standard: 'о-ва Лайн'),
    ),
    'Lord_Howe': MetaZone(
      'Lord_Howe',
      long: TimeZoneName(
    ...
    'Marquesas': MetaZone(
      'Marquesas',
      long: TimeZoneName(standard: 'Маркизские о-ва'),
    ),
    ...
    'Singapore': MetaZone(
      'Singapore',
      long: TimeZoneName(standard: 'Сингапур'),
    ),
    'Solomon': MetaZone(
      'Solomon',
      long: TimeZoneName(standard: 'Соломоновы Острова'),
    ),
    ...
    'Tajikistan': MetaZone(
      'Tajikistan',
      long: TimeZoneName(standard: 'Таджикистан'),
    ),
    ...
    'Venezuela': MetaZone(
      'Venezuela',
      long: TimeZoneName(standard: 'Венесуэла'),
    ),
    ...
    'Wallis': MetaZone(
      'Wallis',
      long: TimeZoneName(standard: 'Уоллис и Футуна'),
    ),
    'Yakutsk': MetaZone(
      'Yakutsk',
      long: TimeZoneName(
...
class LocaleDisplayNameRu extends LocaleDisplayName {
  const LocaleDisplayNameRu(super.cld);
  ...
  @override
  String get codePatternLanguage => 'Язык: {0}';
  @override
  String get codePatternScript => 'Письменность: {0}';
  @override
  ...
  static const staticValueNames = <String, Map<String, String>>{
    ...
    'cf': {'account': 'финансовый формат', 'standard': 'стандартный формат'},
    'ka': {
