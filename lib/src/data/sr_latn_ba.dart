...
const _cld = CommonLocaleDataSrLatnBA._();
...
class CommonLocaleDataSrLatnBA implements CommonLocaleData {
  ...
  const CommonLocaleDataSrLatnBA._();
  ...
  static final _units = UnitsSrLatnBA._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsSrLatnBA._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesSrLatnBA._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsSrLatnBA._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesSrLatnBA._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsSrLatnBA._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsSrLatnBA._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesSrLatnBA._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesSrLatnBA._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameSrLatnBA._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsSrLatnBA extends Units {
  UnitsSrLatnBA._(super.cld);
...
class DateFieldsSrLatnBA extends DateFields {
  DateFieldsSrLatnBA._(super.cld);
...
class LanguagesSrLatnBA extends Languages {
  const LanguagesSrLatnBA._(super.cld);
...
class ScriptsSrLatnBA extends Scripts {
  const ScriptsSrLatnBA._(super.cld);
...
class TerritoriesSrLatnBA extends Territories {
  const TerritoriesSrLatnBA._(super.cld);
...
class VariantsSrLatnBA extends Variants {
  const VariantsSrLatnBA._(super.cld);
...
class SubdivisionsSrLatnBA extends Subdivisions {
  const SubdivisionsSrLatnBA._(super.cld);
...
class CurrenciesSrLatnBA extends Currencies {
  const CurrenciesSrLatnBA._(super.cld);
...
class TimeZonesSrLatnBA extends TimeZones {
  const TimeZonesSrLatnBA._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
            regionFormat: '{0}',
  ...
  final timeZoneNames = const {
    ...
    'America/Indiana/Vevay': TimeZoneNames(exemplarCity: 'Vivi, Indijana'),
    ...
    'Antarctica/DumontDUrville': TimeZoneNames(exemplarCity: 'Dimon d’Irvil'),
  ...
  final metaZoneNames = const {
    ...
    'Bhutan': MetaZone('Bhutan', long: TimeZoneName(standard: 'Butan vrijeme')),
    'Bolivia':
        MetaZone('Bolivia', long: TimeZoneName(standard: 'Bolivija vrijeme')),
    ...
    'Chamorro':
        MetaZone('Chamorro', long: TimeZoneName(standard: 'Čamoro vrijeme')),
    ...
    'Davis': MetaZone('Davis', long: TimeZoneName(standard: 'Dejvis vrijeme')),
    ...
    'Ecuador':
        MetaZone('Ecuador', long: TimeZoneName(standard: 'Ekvador vrijeme')),
    ...
    'French_Southern': MetaZone('French_Southern',
        long: TimeZoneName(standard: 'Francusko južno i antarktičko vrijeme')),
    'Galapagos': MetaZone('Galapagos',
        long: TimeZoneName(standard: 'Galapagos vrijeme')),
    'Gambier':
        MetaZone('Gambier', long: TimeZoneName(standard: 'Gambije vrijeme')),
    ...
    'Gulf': MetaZone('Gulf', long: TimeZoneName(standard: 'Zalivsko vrijeme')),
    'Guyana':
        MetaZone('Guyana', long: TimeZoneName(standard: 'Gvajana vrijeme')),
    ...
    'Indochina':
        MetaZone('Indochina', long: TimeZoneName(standard: 'Indokina vrijeme')),
    ...
    'Kosrae': MetaZone('Kosrae', long: TimeZoneName(standard: 'Košre vrijeme')),
    ...
    'Malaysia':
        MetaZone('Malaysia', long: TimeZoneName(standard: 'Malezija vrijeme')),
    'Maldives':
        MetaZone('Maldives', long: TimeZoneName(standard: 'Maldivi vrijeme')),
    'Marquesas':
        MetaZone('Marquesas', long: TimeZoneName(standard: 'Markiz vrijeme')),
    ...
    'Mawson': MetaZone('Mawson', long: TimeZoneName(standard: 'Moson vrijeme')),
    ...
    'Myanmar':
        MetaZone('Myanmar', long: TimeZoneName(standard: 'Mjanmar vrijeme')),
    'Nauru': MetaZone('Nauru', long: TimeZoneName(standard: 'Nauru vrijeme')),
    'Nepal': MetaZone('Nepal', long: TimeZoneName(standard: 'Nepal vrijeme')),
    ...
    'Niue': MetaZone('Niue', long: TimeZoneName(standard: 'Nijue vrijeme')),
    ...
    'Palau': MetaZone('Palau', long: TimeZoneName(standard: 'Palau vrijeme')),
    ...
    'Pitcairn':
        MetaZone('Pitcairn', long: TimeZoneName(standard: 'Pitkern vrijeme')),
    'Ponape':
        MetaZone('Ponape', long: TimeZoneName(standard: 'Ponpej vrijeme')),
    ...
    'Reunion':
        MetaZone('Reunion', long: TimeZoneName(standard: 'Reunion vrijeme')),
    'Rothera':
        MetaZone('Rothera', long: TimeZoneName(standard: 'Rotera vrijeme')),
    ...
    'Seychelles':
        MetaZone('Seychelles', long: TimeZoneName(standard: 'Sejšeli vrijeme')),
    ...
    'Suriname':
        MetaZone('Suriname', long: TimeZoneName(standard: 'Surinam vrijeme')),
    'Syowa': MetaZone('Syowa', long: TimeZoneName(standard: 'Šova vrijeme')),
    'Tahiti':
        MetaZone('Tahiti', long: TimeZoneName(standard: 'Tahiti vrijeme')),
    ...
    'Tokelau':
        MetaZone('Tokelau', long: TimeZoneName(standard: 'Tokelau vrijeme')),
    ...
    'Tuvalu':
        MetaZone('Tuvalu', long: TimeZoneName(standard: 'Tuvalu vrijeme')),
    ...
    'Vostok':
        MetaZone('Vostok', long: TimeZoneName(standard: 'Vostok vrijeme')),
    'Wake':
        MetaZone('Wake', long: TimeZoneName(standard: 'ostrvo Vejk vrijeme')),
...
class LocaleDisplayNameSrLatnBA extends LocaleDisplayName {
  const LocaleDisplayNameSrLatnBA._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
