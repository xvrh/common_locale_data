...
class DateFieldsSrLatnBA extends DateFieldsSrLatn {
  ...
  DateFieldFullData get month => const DateFieldFullData(
    displayName: MultiLength(long: 'mjesec', short: 'mjes.', narrow: 'mjes.'),
    previous: MultiLength(
  ...
  DateFieldFullData get week => const DateFieldFullData(
    displayName: MultiLength(long: 'sedmica', short: 'sedm.', narrow: 'sedm.'),
    previous: MultiLength(
      long: 'prošle sedmice',
      short: 'prošle sedm.',
      narrow: 'prošle s.',
    ),
    now: MultiLength(long: 'ove sedmice', short: 'ove sedm.', narrow: 'ove s.'),
    next: MultiLength(
  ...
  DateFieldDataWithRelative get sunday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: 'u nedjelju', short: 'u ned', narrow: 'u ned'),
    next: MultiLength(
  ...
  DateFieldDataWithRelative get monday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: 'u ponedjeljak', short: 'u pon', narrow: 'u pon'),
    next: MultiLength(
  ...
  DateFieldDataWithRelative get wednesday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: 'u srijedu', short: 'u sri', narrow: 'u sri'),
    next: MultiLength(
...
class CurrenciesSrLatnBA extends CurrenciesSrLatn {
  ...
  Map<String, Currency> get currencies => Map.unmodifiable({
    ...
    ...const {'BAM': _bam, 'BYN': _byn, 'KPW': _kpw, 'NIO': _nio},
  });
}
...
class TimeZonesSrLatnBA extends TimeZonesSrLatn {
  ...
  Map<String, TimeZoneNames> get timeZoneNames => Map.unmodifiable({
    ...
    ...const {
      ...
      'America/North_Dakota/Beulah': TimeZoneNames(
        exemplarCity: 'Bjula, Sjeverna Dakota',
      ),
      'America/North_Dakota/New_Salem': TimeZoneNames(
        exemplarCity: 'Novi Salem, Sjeverna Dakota',
      ),
      'America/North_Dakota/Center': TimeZoneNames(
        exemplarCity: 'Centar, Sjeverna Dakota',
      ),
  ...
  Map<String, MetaZone> get metaZoneNames => Map.unmodifiable({
    ...
    ...const {
      ...
      'Bhutan': MetaZone(
        'Bhutan',
        long: TimeZoneName(standard: 'Butan vrijeme'),
      ),
      'Bolivia': MetaZone(
        'Bolivia',
      ...
      'Davis': MetaZone(
        'Davis',
        long: TimeZoneName(standard: 'Dejvis vrijeme'),
      ),
      ...
      'Kosrae': MetaZone(
        'Kosrae',
        long: TimeZoneName(standard: 'Košre vrijeme'),
      ),
      ...
      'Mawson': MetaZone(
        'Mawson',
        long: TimeZoneName(standard: 'Moson vrijeme'),
      ),
...
class LocaleDisplayNameSrLatnBA extends LocaleDisplayNameSrLatn {
  ...
  Map<String, String> get keyNames => Map.unmodifiable({
    ...
    ...const {'co': 'redoslijed sortiranja', 'ms': 'sistem mjernih jedinica'},
  });
