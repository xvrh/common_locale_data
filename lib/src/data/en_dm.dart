...
const _locale = 'en-DM';
const _cld = CommonLocaleDataEnDM._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEnDM implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataEnDM._();
  ...
  static final _units = UnitsEnDM._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEnDM._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEnDM._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsEnDM._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesEnDM._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsEnDM._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsEnDM._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesEnDM._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEnDM._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEnDM._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEnDM extends Units {
  UnitsEnDM._(super.cld);
...
class DateFieldsEnDM extends DateFields {
  DateFieldsEnDM._(super.cld);
...
class LanguagesEnDM extends Languages {
  const LanguagesEnDM._(super.cld);
...
class ScriptsEnDM extends Scripts {
  const ScriptsEnDM._(super.cld);
...
class TerritoriesEnDM extends Territories {
  const TerritoriesEnDM._(super.cld);
...
class VariantsEnDM extends Variants {
  const VariantsEnDM._(super.cld);
...
class SubdivisionsEnDM extends Subdivisions {
  const SubdivisionsEnDM._(super.cld);
...
class CurrenciesEnDM extends Currencies {
  const CurrenciesEnDM._(super.cld);
...
class TimeZonesEnDM extends TimeZones {
  const TimeZonesEnDM._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
            regionFormat: '{0} Time',
...
class LocaleDisplayNameEnDM extends LocaleDisplayName {
  const LocaleDisplayNameEnDM._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
