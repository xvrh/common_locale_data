...
const _locale = 'es-CL';
const _cld = CommonLocaleDataEsCL.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEsCL extends CommonLocaleDataEs {
  @override
  String get locale => _locale;

  const CommonLocaleDataEsCL.constant() : super.constant();

  factory CommonLocaleDataEsCL() => _cld;
  ...
  static final _units = UnitsEsCL(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEsCL(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEsCL(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsEsCL(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesEsCL(_cld);
  @override
  Territories get territories => _territories;

  static final _currencies = CurrenciesEsCL(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEsCL(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEsCL(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEsCL extends UnitsEs {
  const UnitsEsCL(super.cld);
...
class DateFieldsEsCL extends DateFieldsEs {
  const DateFieldsEsCL(super.cld);
...
class LanguagesEsCL extends LanguagesEs {
  const LanguagesEsCL(super.cld);
...
class ScriptsEsCL extends ScriptsEs {
  const ScriptsEsCL(super.cld);
...
class TerritoriesEsCL extends TerritoriesEs {
  const TerritoriesEsCL(super.cld);
...
class CurrenciesEsCL extends CurrenciesEs {
  const CurrenciesEsCL(super.cld);
...
class TimeZonesEsCL extends TimeZonesEs {
  const TimeZonesEsCL(super.cld);
  ...
  Map<String, MetaZone> get metaZoneNames => Map.unmodifiable({
    ...
    ...const {
      ...
      'Chile': MetaZone(
        ...
        short: TimeZoneName(generic: 'CLT', standard: 'CLT', daylight: 'CLST'),
      ),
      'Cocos': MetaZone(
        'Cocos',
...
class LocaleDisplayNameEsCL extends LocaleDisplayNameEs {
  const LocaleDisplayNameEsCL(super.cld);
  ...
  Map<String, Map<String, String>> get valueNames => Map.unmodifiable({
    ...
    ...const {
      ...
      'co': {
        ...
        'phonebk': 'orden de directorio telefónico',
