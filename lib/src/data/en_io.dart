...
const _locale = 'en-IO';
const _cld = CommonLocaleDataEnIO.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEnIO extends CommonLocaleDataEn {
  @override
  String get locale => _locale;

  const CommonLocaleDataEnIO.constant() : super.constant();

  factory CommonLocaleDataEnIO() => _cld;
  ...
  static final _units = UnitsEnIO(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEnIO(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEnIO(_cld);
  @override
  Languages get languages => _languages;

  static final _territories = TerritoriesEnIO(_cld);
  @override
  Territories get territories => _territories;

  static final _currencies = CurrenciesEnIO(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEnIO(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEnIO(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEnIO extends UnitsEn {
  const UnitsEnIO(super.cld);
...
class DateFieldsEnIO extends DateFieldsEn {
  const DateFieldsEnIO(super.cld);
...
class LanguagesEnIO extends LanguagesEn {
  const LanguagesEnIO(super.cld);
...
class TerritoriesEnIO extends TerritoriesEn {
  const TerritoriesEnIO(super.cld);
...
class CurrenciesEnIO extends CurrenciesEn {
  const CurrenciesEnIO(super.cld);
...
class TimeZonesEnIO extends TimeZonesEn {
  const TimeZonesEnIO(super.cld);
...
class LocaleDisplayNameEnIO extends LocaleDisplayNameEn {
  const LocaleDisplayNameEnIO(super.cld);
