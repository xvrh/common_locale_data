...
const _locale = 'en-CM';
const _cld = CommonLocaleDataEnCM._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEnCM implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataEnCM._();
  ...
  static final _units = UnitsEnCM._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEnCM._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEnCM._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsEnCM._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesEnCM._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsEnCM._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsEnCM._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesEnCM._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEnCM._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEnCM._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEnCM extends Units {
  UnitsEnCM._(super.cld);
...
class DateFieldsEnCM extends DateFields {
  DateFieldsEnCM._(super.cld);
...
class LanguagesEnCM extends Languages {
  const LanguagesEnCM._(super.cld);
...
class ScriptsEnCM extends Scripts {
  const ScriptsEnCM._(super.cld);
...
class TerritoriesEnCM extends Territories {
  const TerritoriesEnCM._(super.cld);
...
class VariantsEnCM extends Variants {
  const VariantsEnCM._(super.cld);
...
class SubdivisionsEnCM extends Subdivisions {
  const SubdivisionsEnCM._(super.cld);
...
class CurrenciesEnCM extends Currencies {
  const CurrenciesEnCM._(super.cld);
...
class TimeZonesEnCM extends TimeZones {
  const TimeZonesEnCM._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
            regionFormat: '{0} Time',
...
class LocaleDisplayNameEnCM extends LocaleDisplayName {
  const LocaleDisplayNameEnCM._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
