...
const _locale = 'es-PY';
const _cld = CommonLocaleDataEsPY.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEsPY extends CommonLocaleDataEs {
  @override
  String get locale => _locale;

  const CommonLocaleDataEsPY.constant() : super.constant();

  factory CommonLocaleDataEsPY() => _cld;
  ...
  static final _units = UnitsEsPY(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEsPY(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEsPY(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsEsPY(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesEsPY(_cld);
  @override
  Territories get territories => _territories;

  static final _currencies = CurrenciesEsPY(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEsPY(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEsPY(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEsPY extends UnitsEs {
  const UnitsEsPY(super.cld);
  ...
  Unit get durationYear => const Unit(
    ...
    short: UnitCountPattern(_locale, 'años', one: '{0} año', other: '{0} años'),
    narrow: UnitCountPattern(_locale, 'año', one: '{0}a.', other: '{0}aa.'),
  );
  ...
  Unit get durationMonth => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'mes', one: '{0}m.', other: '{0}mm.'),
  );
  ...
  Unit get durationDay => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'día', one: '{0}d.', other: '{0}dd.'),
  );
...
class DateFieldsEsPY extends DateFieldsEs {
  const DateFieldsEsPY(super.cld);
...
class LanguagesEsPY extends LanguagesEs {
  const LanguagesEsPY(super.cld);
...
class ScriptsEsPY extends ScriptsEs {
  const ScriptsEsPY(super.cld);
...
class TerritoriesEsPY extends TerritoriesEs {
  const TerritoriesEsPY(super.cld);
...
class CurrenciesEsPY extends CurrenciesEs {
  const CurrenciesEsPY(super.cld);
...
class TimeZonesEsPY extends TimeZonesEs {
  const TimeZonesEsPY(super.cld);
...
class LocaleDisplayNameEsPY extends LocaleDisplayNameEs {
  const LocaleDisplayNameEsPY(super.cld);
