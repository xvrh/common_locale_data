...
const _locale = 'fr-MA';
const _cld = CommonLocaleDataFrMA._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataFrMA implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataFrMA._();
  ...
  static final _units = UnitsFrMA._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsFrMA._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesFrMA._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsFrMA._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesFrMA._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsFrMA._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsFrMA._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesFrMA._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesFrMA._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameFrMA._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsFrMA extends Units {
  UnitsFrMA._(super.cld);
...
class DateFieldsFrMA extends DateFields {
  DateFieldsFrMA._(super.cld);
...
class LanguagesFrMA extends Languages {
  const LanguagesFrMA._(super.cld);
...
class ScriptsFrMA extends Scripts {
  const ScriptsFrMA._(super.cld);
...
class TerritoriesFrMA extends Territories {
  const TerritoriesFrMA._(super.cld);
...
class VariantsFrMA extends Variants {
  const VariantsFrMA._(super.cld);
...
class SubdivisionsFrMA extends Subdivisions {
  const SubdivisionsFrMA._(super.cld);
...
class CurrenciesFrMA extends Currencies {
  const CurrenciesFrMA._(super.cld);
...
class TimeZonesFrMA extends TimeZones {
  const TimeZonesFrMA._(super.cld)
      : super(
            gmtFormat: 'UTC{0}',
            gmtZeroFormat: 'UTC',
...
class LocaleDisplayNameFrMA extends LocaleDisplayName {
  const LocaleDisplayNameFrMA._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
