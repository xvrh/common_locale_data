...
const _locale = 'ar-SO';
const _cld = CommonLocaleDataArSO._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataArSO implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataArSO._();
  ...
  static final _units = UnitsArSO._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsArSO._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesArSO._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsArSO._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesArSO._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsArSO._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsArSO._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesArSO._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesArSO._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameArSO._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsArSO extends Units {
  UnitsArSO._(super.cld);
...
class DateFieldsArSO extends DateFields {
  DateFieldsArSO._(super.cld);
...
class LanguagesArSO extends Languages {
  const LanguagesArSO._(super.cld);
...
class ScriptsArSO extends Scripts {
  const ScriptsArSO._(super.cld);
...
class TerritoriesArSO extends Territories {
  const TerritoriesArSO._(super.cld);
...
class VariantsArSO extends Variants {
  const VariantsArSO._(super.cld);
...
class SubdivisionsArSO extends Subdivisions {
  const SubdivisionsArSO._(super.cld);
...
class CurrenciesArSO extends Currencies {
  const CurrenciesArSO._(super.cld);
...
class TimeZonesArSO extends TimeZones {
  const TimeZonesArSO._(super.cld)
      : super(
            gmtFormat: 'غرينتش{0}',
...
class LocaleDisplayNameArSO extends LocaleDisplayName {
  const LocaleDisplayNameArSO._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}، {1}',
