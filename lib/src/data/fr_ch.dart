...
const _locale = 'fr-CH';
const _cld = CommonLocaleDataFrCH._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataFrCH implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataFrCH._();
  ...
  static final _units = UnitsFrCH._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsFrCH._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesFrCH._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsFrCH._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesFrCH._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsFrCH._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsFrCH._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesFrCH._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesFrCH._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameFrCH._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsFrCH extends Units {
  UnitsFrCH._(super.cld);
...
class DateFieldsFrCH extends DateFields {
  DateFieldsFrCH._(super.cld);
...
class LanguagesFrCH extends Languages {
  const LanguagesFrCH._(super.cld);
...
class ScriptsFrCH extends Scripts {
  const ScriptsFrCH._(super.cld);
...
class TerritoriesFrCH extends Territories {
  const TerritoriesFrCH._(super.cld);
...
class VariantsFrCH extends Variants {
  const VariantsFrCH._(super.cld);
...
class SubdivisionsFrCH extends Subdivisions {
  const SubdivisionsFrCH._(super.cld);
...
class CurrenciesFrCH extends Currencies {
  const CurrenciesFrCH._(super.cld);
...
class TimeZonesFrCH extends TimeZones {
  const TimeZonesFrCH._(super.cld)
      : super(
            gmtFormat: 'UTC{0}',
            gmtZeroFormat: 'UTC',
...
class LocaleDisplayNameFrCH extends LocaleDisplayName {
  const LocaleDisplayNameFrCH._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
