...
const _locale = 'ca-IT';
const _cld = CommonLocaleDataCaIT._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataCaIT implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataCaIT._();
  ...
  static final _units = UnitsCaIT._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsCaIT._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesCaIT._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsCaIT._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesCaIT._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsCaIT._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsCaIT._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesCaIT._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesCaIT._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameCaIT._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsCaIT extends Units {
  UnitsCaIT._(super.cld);
...
class DateFieldsCaIT extends DateFields {
  DateFieldsCaIT._(super.cld);
...
class LanguagesCaIT extends Languages {
  const LanguagesCaIT._(super.cld);
...
class ScriptsCaIT extends Scripts {
  const ScriptsCaIT._(super.cld);
...
class TerritoriesCaIT extends Territories {
  const TerritoriesCaIT._(super.cld);
...
class VariantsCaIT extends Variants {
  const VariantsCaIT._(super.cld);
...
class SubdivisionsCaIT extends Subdivisions {
  const SubdivisionsCaIT._(super.cld);
...
class CurrenciesCaIT extends Currencies {
  const CurrenciesCaIT._(super.cld);
...
class TimeZonesCaIT extends TimeZones {
  const TimeZonesCaIT._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
...
class LocaleDisplayNameCaIT extends LocaleDisplayName {
  const LocaleDisplayNameCaIT._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
