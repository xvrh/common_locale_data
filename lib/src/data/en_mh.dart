...
const _locale = 'en-MH';
const _cld = CommonLocaleDataEnMH._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEnMH implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataEnMH._();

  factory CommonLocaleDataEnMH() => _cld;
  ...
  static final _units = UnitsEnMH._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEnMH._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEnMH._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsEnMH._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesEnMH._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsEnMH._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsEnMH._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesEnMH._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEnMH._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEnMH._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEnMH extends Units {
  UnitsEnMH._(super.cld);
...
class DateFieldsEnMH extends DateFields {
  DateFieldsEnMH._(super.cld);
...
class LanguagesEnMH extends Languages {
  const LanguagesEnMH._(super.cld);
...
class ScriptsEnMH extends Scripts {
  const ScriptsEnMH._(super.cld);
...
class TerritoriesEnMH extends Territories {
  const TerritoriesEnMH._(super.cld);
...
class VariantsEnMH extends Variants {
  const VariantsEnMH._(super.cld);
...
class SubdivisionsEnMH extends Subdivisions {
  const SubdivisionsEnMH._(super.cld);
...
class CurrenciesEnMH extends Currencies {
  const CurrenciesEnMH._(super.cld);
  ...
  static const _bmd = Currency(_cld, 'BMD', 'Bermudan Dollar',
      one: 'Bermudan dollar', other: 'Bermudan dollars', symbolNarrow: r'$');
  ...
  static const _byb = Currency(_cld, 'BYB', 'Belarusian Ruble (1994–1999)',
      one: 'Belarusian ruble (1994–1999)',
      other: 'Belarusian rubles (1994–1999)');
  static const _byn = Currency(_cld, 'BYN', 'Belarusian Ruble',
      one: 'Belarusian ruble', other: 'Belarusian rubles');
  ...
  static const _lvr = Currency(_cld, 'LVR', 'Latvian Ruble',
      one: 'Latvian ruble', other: 'Latvian rubles');
  ...
  static const _rur = Currency(_cld, 'RUR', 'Russian Ruble (1991–1998)',
      one: 'Russian ruble (1991–1998)', other: 'Russian rubles (1991–1998)');
  ...
  static const _tjr = Currency(_cld, 'TJR', 'Tajikistani Ruble',
      one: 'Tajikistani ruble', other: 'Tajikistani rubles');
...
class TimeZonesEnMH extends TimeZones {
  const TimeZonesEnMH._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
            regionFormat: '{0} Time',
...
class LocaleDisplayNameEnMH extends LocaleDisplayName {
  const LocaleDisplayNameEnMH._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
