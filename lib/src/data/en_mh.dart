...
const _locale = 'en-MH';
const _cld = CommonLocaleDataEnMH.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEnMH extends CommonLocaleDataEn {
  @override
  String get locale => _locale;

  const CommonLocaleDataEnMH.constant() : super.constant();
  ...
  static final _timeZones = TimeZonesEnMH(_cld);
  @override
  TimeZones get timeZones => _timeZones;
}

class TimeZonesEnMH extends TimeZonesEn {
  const TimeZonesEnMH(super.cld);
