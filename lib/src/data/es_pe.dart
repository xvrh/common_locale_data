...
const _locale = 'es-PE';
const _cld = CommonLocaleDataEsPE.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEsPE extends CommonLocaleDataEs {
  @override
  String get locale => _locale;

  const CommonLocaleDataEsPE.constant() : super.constant();

  factory CommonLocaleDataEsPE() => _cld;
  ...
  static final _units = UnitsEsPE(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEsPE(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEsPE(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsEsPE(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesEsPE(_cld);
  @override
  Territories get territories => _territories;

  static final _currencies = CurrenciesEsPE(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEsPE(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEsPE(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEsPE extends UnitsEs {
  const UnitsEsPE(super.cld);
...
class DateFieldsEsPE extends DateFieldsEs {
  const DateFieldsEsPE(super.cld);
...
class LanguagesEsPE extends LanguagesEs {
  const LanguagesEsPE(super.cld);
...
class ScriptsEsPE extends ScriptsEs {
  const ScriptsEsPE(super.cld);
...
class TerritoriesEsPE extends TerritoriesEs {
  const TerritoriesEsPE(super.cld);
...
class CurrenciesEsPE extends CurrenciesEs {
  const CurrenciesEsPE(super.cld);
...
class TimeZonesEsPE extends TimeZonesEs {
  const TimeZonesEsPE(super.cld);
  ...
  Map<String, MetaZone> get metaZoneNames => Map.unmodifiable({
    ...
    ...const {
      ...
      'Peru': MetaZone(
        ...
        short: TimeZoneName(generic: 'PET', standard: 'PET', daylight: 'PEST'),
      ),
      'Pyongyang': MetaZone(
        'Pyongyang',
...
class LocaleDisplayNameEsPE extends LocaleDisplayNameEs {
  const LocaleDisplayNameEsPE(super.cld);
