...
const _locale = 'fr-BI';
const _cld = CommonLocaleDataFrBI._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataFrBI implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataFrBI._();
  ...
  static final _units = UnitsFrBI._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsFrBI._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesFrBI._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsFrBI._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesFrBI._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsFrBI._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsFrBI._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesFrBI._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesFrBI._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameFrBI._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsFrBI extends Units {
  UnitsFrBI._(super.cld);
...
class DateFieldsFrBI extends DateFields {
  DateFieldsFrBI._(super.cld);
...
class LanguagesFrBI extends Languages {
  const LanguagesFrBI._(super.cld);
...
class ScriptsFrBI extends Scripts {
  const ScriptsFrBI._(super.cld);
...
class TerritoriesFrBI extends Territories {
  const TerritoriesFrBI._(super.cld);
...
class VariantsFrBI extends Variants {
  const VariantsFrBI._(super.cld);
...
class SubdivisionsFrBI extends Subdivisions {
  const SubdivisionsFrBI._(super.cld);
...
class CurrenciesFrBI extends Currencies {
  const CurrenciesFrBI._(super.cld);
...
class TimeZonesFrBI extends TimeZones {
  const TimeZonesFrBI._(super.cld)
      : super(
            gmtFormat: 'UTC{0}',
            gmtZeroFormat: 'UTC',
...
class LocaleDisplayNameFrBI extends LocaleDisplayName {
  const LocaleDisplayNameFrBI._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
