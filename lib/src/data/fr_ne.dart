...
const _locale = 'fr-NE';
const _cld = CommonLocaleDataFrNE._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataFrNE implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataFrNE._();
  ...
  static final _units = UnitsFrNE._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsFrNE._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesFrNE._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsFrNE._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesFrNE._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsFrNE._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsFrNE._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesFrNE._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesFrNE._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameFrNE._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsFrNE extends Units {
  UnitsFrNE._(super.cld);
...
class DateFieldsFrNE extends DateFields {
  DateFieldsFrNE._(super.cld);
...
class LanguagesFrNE extends Languages {
  const LanguagesFrNE._(super.cld);
...
class ScriptsFrNE extends Scripts {
  const ScriptsFrNE._(super.cld);
...
class TerritoriesFrNE extends Territories {
  const TerritoriesFrNE._(super.cld);
...
class VariantsFrNE extends Variants {
  const VariantsFrNE._(super.cld);
...
class SubdivisionsFrNE extends Subdivisions {
  const SubdivisionsFrNE._(super.cld);
...
class CurrenciesFrNE extends Currencies {
  const CurrenciesFrNE._(super.cld);
...
class TimeZonesFrNE extends TimeZones {
  const TimeZonesFrNE._(super.cld)
      : super(
            gmtFormat: 'UTC{0}',
            gmtZeroFormat: 'UTC',
...
class LocaleDisplayNameFrNE extends LocaleDisplayName {
  const LocaleDisplayNameFrNE._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
