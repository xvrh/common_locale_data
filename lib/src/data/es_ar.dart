...
const _locale = 'es-AR';
const _cld = CommonLocaleDataEsAR.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEsAR extends CommonLocaleDataEs {
  @override
  String get locale => _locale;

  const CommonLocaleDataEsAR.constant() : super.constant();

  factory CommonLocaleDataEsAR() => _cld;
  ...
  static final _units = UnitsEsAR(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEsAR(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEsAR(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsEsAR(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesEsAR(_cld);
  @override
  Territories get territories => _territories;

  static final _currencies = CurrenciesEsAR(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEsAR(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEsAR(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEsAR extends UnitsEs {
  const UnitsEsAR(super.cld);
  ...
  Unit get durationHour => const Unit(
    long: UnitCountPattern(_locale, 'hs.', one: '{0} hora', other: '{0} horas'),
    short: UnitCountPattern(_locale, 'hs.', one: '{0} hora', other: '{0} h'),
  ...
  Unit get durationSecond => const Unit(
    ...
    narrow: UnitCountPattern(_locale, 'seg.', one: '{0}seg.', other: '{0}seg.'),
  );
...
class DateFieldsEsAR extends DateFieldsEs {
  const DateFieldsEsAR(super.cld);
...
class LanguagesEsAR extends LanguagesEs {
  const LanguagesEsAR(super.cld);
...
class ScriptsEsAR extends ScriptsEs {
  const ScriptsEsAR(super.cld);
...
class TerritoriesEsAR extends TerritoriesEs {
  const TerritoriesEsAR(super.cld);
...
class CurrenciesEsAR extends CurrenciesEs {
  const CurrenciesEsAR(super.cld);
...
class TimeZonesEsAR extends TimeZonesEs {
  const TimeZonesEsAR(super.cld);
  ...
  Map<String, MetaZone> get metaZoneNames => Map.unmodifiable({
    ...
    ...const {
      ...
      'Argentina': MetaZone(
        ...
        short: TimeZoneName(generic: 'ART', standard: 'ART', daylight: 'ARST'),
      ),
...
class LocaleDisplayNameEsAR extends LocaleDisplayNameEs {
  const LocaleDisplayNameEsAR(super.cld);
