...
const _locale = 'es-CR';
const _cld = CommonLocaleDataEsCR.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEsCR extends CommonLocaleDataEs {
  @override
  String get locale => _locale;

  const CommonLocaleDataEsCR.constant() : super.constant();

  factory CommonLocaleDataEsCR() => _cld;
  ...
  static final _units = UnitsEsCR(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEsCR(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEsCR(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsEsCR(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesEsCR(_cld);
  @override
  Territories get territories => _territories;

  static final _currencies = CurrenciesEsCR(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEsCR(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEsCR(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEsCR extends UnitsEs {
  const UnitsEsCR(super.cld);
...
class DateFieldsEsCR extends DateFieldsEs {
  const DateFieldsEsCR(super.cld);
...
class LanguagesEsCR extends LanguagesEs {
  const LanguagesEsCR(super.cld);
...
class ScriptsEsCR extends ScriptsEs {
  const ScriptsEsCR(super.cld);
...
class TerritoriesEsCR extends TerritoriesEs {
  const TerritoriesEsCR(super.cld);
...
class CurrenciesEsCR extends CurrenciesEs {
  const CurrenciesEsCR(super.cld);
...
class TimeZonesEsCR extends TimeZonesEs {
  const TimeZonesEsCR(super.cld);
...
class LocaleDisplayNameEsCR extends LocaleDisplayNameEs {
  const LocaleDisplayNameEsCR(super.cld);
