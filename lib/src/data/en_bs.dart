...
const _locale = 'en-BS';
const _cld = CommonLocaleDataEnBS._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataEnBS implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataEnBS._();
  ...
  static final _units = UnitsEnBS._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsEnBS._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesEnBS._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsEnBS._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesEnBS._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsEnBS._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsEnBS._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesEnBS._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesEnBS._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameEnBS._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsEnBS extends Units {
  UnitsEnBS._(super.cld);
...
class DateFieldsEnBS extends DateFields {
  DateFieldsEnBS._(super.cld);
...
class LanguagesEnBS extends Languages {
  const LanguagesEnBS._(super.cld);
...
class ScriptsEnBS extends Scripts {
  const ScriptsEnBS._(super.cld);
...
class TerritoriesEnBS extends Territories {
  const TerritoriesEnBS._(super.cld);
...
class VariantsEnBS extends Variants {
  const VariantsEnBS._(super.cld);
...
class SubdivisionsEnBS extends Subdivisions {
  const SubdivisionsEnBS._(super.cld);
...
class CurrenciesEnBS extends Currencies {
  const CurrenciesEnBS._(super.cld);
...
class TimeZonesEnBS extends TimeZones {
  const TimeZonesEnBS._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
            regionFormat: '{0} Time',
...
class LocaleDisplayNameEnBS extends LocaleDisplayName {
  const LocaleDisplayNameEnBS._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
