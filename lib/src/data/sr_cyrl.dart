...
const _cld = CommonLocaleDataSrCyrl.constant();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataSrCyrl extends CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataSrCyrl.constant() : super.constant();

  factory CommonLocaleDataSrCyrl() => _cld;
  ...
  static final _units = UnitsSrCyrl(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsSrCyrl(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesSrCyrl(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsSrCyrl(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesSrCyrl(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsSrCyrl(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsSrCyrl(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesSrCyrl(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesSrCyrl(_cld);
  @override
...
class DateFieldsSrCyrl extends DateFields {
  const DateFieldsSrCyrl(super.cld);
  ...
  DateFieldFullData get year => const DateFieldFullData(
    ...
    now: MultiLength(long: 'ове године', short: 'ове год.', narrow: 'ове г.'),
    next: MultiLength(
      long: 'следеће године',
      short: 'следеће год.',
      narrow: 'следеће г.',
  ...
  DateFieldFullData get week => const DateFieldFullData(
    displayName: MultiLength(long: 'недеља', short: 'нед.', narrow: 'нед.'),
    previous: MultiLength(
      long: 'прошле недеље',
      short: 'прошле нед.',
      narrow: 'прошле н.',
    ),
    now: MultiLength(long: 'ове недеље', short: 'ове нед.', narrow: 'ове н.'),
    next: MultiLength(
      long: 'следеће недеље',
      short: 'следеће нед.',
      narrow: 'следеће н.',
  ...
  DateFieldFullData get day => const DateFieldFullData(
    displayName: MultiLength(long: 'дан', short: 'д.', narrow: 'д.'),
    previous: MultiLength(long: 'јуче', short: 'јуче', narrow: 'јуче'),
    now: MultiLength(long: 'данас', short: 'данас', narrow: 'данас'),
    next: MultiLength(long: 'сутра', short: 'сутра', narrow: 'сутра'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
        one: 'пре {0} дана',
  ...
  DateFieldDataWithRelative get sunday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: 'у недељу', short: 'у нед', narrow: 'у нед'),
    next: MultiLength(
      long: 'следеће недеље',
      short: 'сл. нед.',
      narrow: 'сл. нед.',
  ...
  DateFieldDataWithRelative get monday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: 'у понедељак', short: 'у пон', narrow: 'у пон'),
    next: MultiLength(
  ...
  DateFieldDataWithRelative get tuesday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: 'у уторак', short: 'у уто', narrow: 'у уто'),
    next: MultiLength(
  ...
  DateFieldDataWithRelative get wednesday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: 'у среду', short: 'у сре', narrow: 'у сре'),
    next: MultiLength(
      long: 'следеће среде',
      short: 'следеће сре',
      narrow: 'следеће сре',
  ...
  DateFieldDataWithRelative get thursday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: 'у четвртак', short: 'у чет', narrow: 'у чет'),
    next: MultiLength(
  ...
  DateFieldDataWithRelative get friday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: 'у петак', short: 'у пет', narrow: 'у пет'),
    next: MultiLength(
      long: 'следећег петка',
      short: 'следећег пет',
      narrow: 'следећег пет',
  ...
  DateFieldDataWithRelative get saturday => const DateFieldDataWithRelative(
    ...
    now: MultiLength(long: 'у суботу', short: 'у суб', narrow: 'у суб'),
    next: MultiLength(
      long: 'следеће суботе',
      short: 'следеће суб',
      narrow: 'следеће суб',
  ...
  DateFieldDataTime get hour => const DateFieldDataTime(
    displayName: MultiLength(long: 'сат', short: 'ч.', narrow: 'ч.'),
    now: MultiLength(
      long: 'овог сата',
      short: 'овог сата',
      narrow: 'овог сата',
  ...
  DateFieldDataTime get second => const DateFieldDataTime(
    displayName: MultiLength(long: 'секунд', short: 'сек.', narrow: 'с'),
    now: MultiLength(long: 'сада', short: 'сада', narrow: 'сада'),
    past: MultiLengthRelativeTime(
      long: RelativeTime(
        _locale,
        one: 'пре {0} секунде',
...
class LanguagesSrCyrl extends Languages {
  const LanguagesSrCyrl(super.cld);
...
class ScriptsSrCyrl extends Scripts {
  const ScriptsSrCyrl(super.cld);
...
class TerritoriesSrCyrl extends Territories {
  const TerritoriesSrCyrl(super.cld);
...
class VariantsSrCyrl extends Variants {
  const VariantsSrCyrl(super.cld);
...
class SubdivisionsSrCyrl extends Subdivisions {
  const SubdivisionsSrCyrl(super.cld);
...
class CurrenciesSrCyrl extends Currencies {
  const CurrenciesSrCyrl(super.cld);
...
class TimeZonesSrCyrl extends TimeZones {
  const TimeZonesSrCyrl(super.cld);
  ...
  @override
  String get regionFormatDaylight => '{0}, летње време';
  @override
  String get regionFormatStandard => '{0}, стандардно време';
  @override
  ...
  static const staticMetaZoneNames = <String, MetaZone>{
    ...
    'Bolivia': MetaZone(
      'Bolivia',
      long: TimeZoneName(standard: 'Боливија време'),
    ),
    'Brasilia': MetaZone(
      'Brasilia',
      long: TimeZoneName(
    ...
    'Chamorro': MetaZone(
      'Chamorro',
      long: TimeZoneName(standard: 'Чаморо време'),
    ),
    'Chatham': MetaZone(
      'Chatham',
      long: TimeZoneName(
    ...
    'Ecuador': MetaZone(
      'Ecuador',
      long: TimeZoneName(standard: 'Еквадор време'),
    ),
    ...
    'Galapagos': MetaZone(
      'Galapagos',
      long: TimeZoneName(standard: 'Галапагос време'),
    ),
    'Gambier': MetaZone(
      'Gambier',
      long: TimeZoneName(standard: 'Гамбије време'),
    ),
    'Georgia': MetaZone(
      'Georgia',
      long: TimeZoneName(
    ...
    'Guam': MetaZone(
      'Guam',
      long: TimeZoneName(standard: 'Гуам стандардно време'),
    ),
    ...
    'Indochina': MetaZone(
      'Indochina',
      long: TimeZoneName(standard: 'Индокина време'),
    ),
    ...
    'Kyrgystan': MetaZone(
      'Kyrgystan',
      long: TimeZoneName(standard: 'Киргистан време'),
    ),
    ...
    'Malaysia': MetaZone(
      'Malaysia',
      long: TimeZoneName(standard: 'Малезија време'),
    ),
    'Maldives': MetaZone(
      'Maldives',
      long: TimeZoneName(standard: 'Малдиви време'),
    ),
    'Marquesas': MetaZone(
      'Marquesas',
      long: TimeZoneName(standard: 'Маркиз време'),
    ),
    ...
    'Myanmar': MetaZone(
      'Myanmar',
      long: TimeZoneName(standard: 'Мијанмар време'),
    ),
    ...
    'Pitcairn': MetaZone(
      'Pitcairn',
      long: TimeZoneName(standard: 'Питкерн време'),
    ),
    ...
    'Reunion': MetaZone(
      'Reunion',
      long: TimeZoneName(standard: 'Реинион време'),
    ),
    'Rothera': MetaZone(
      'Rothera',
      long: TimeZoneName(standard: 'Ротера време'),
    ),
    'Sakhalin': MetaZone(
      'Sakhalin',
      long: TimeZoneName(
    ...
    'Seychelles': MetaZone(
      'Seychelles',
      long: TimeZoneName(standard: 'Сејшели време'),
    ),
    'Singapore': MetaZone(
      'Singapore',
    ...
    'Suriname': MetaZone(
      'Suriname',
      long: TimeZoneName(standard: 'Суринам време'),
    ),
    ...
    'Tokelau': MetaZone(
      'Tokelau',
      long: TimeZoneName(standard: 'Токелау време'),
    ),
    'Tonga': MetaZone(
      'Tonga',
      long: TimeZoneName(
    ...
    'Venezuela': MetaZone(
      'Venezuela',
      long: TimeZoneName(standard: 'Венецуела време'),
    ),
...
class LocaleDisplayNameSrCyrl extends LocaleDisplayName {
  const LocaleDisplayNameSrCyrl(super.cld);
  ...
  @override
  String get codePatternLanguage => 'Језик: {0}';
  @override
  ...
  static const staticValueNames = <String, Map<String, String>>{
    ...
    'm0': {'bgn': 'БГН (BGN)', 'ungegn': 'УНГЕГН (BGN)'},
    'ms': {
      'metric': 'метрички',
