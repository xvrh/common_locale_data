...
const _locale = 'fr-BF';
const _cld = CommonLocaleDataFrBF._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataFrBF implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataFrBF._();
  ...
  static final _units = UnitsFrBF._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsFrBF._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesFrBF._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsFrBF._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesFrBF._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsFrBF._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsFrBF._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesFrBF._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesFrBF._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameFrBF._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsFrBF extends Units {
  UnitsFrBF._(super.cld);
...
class DateFieldsFrBF extends DateFields {
  DateFieldsFrBF._(super.cld);
...
class LanguagesFrBF extends Languages {
  const LanguagesFrBF._(super.cld);
...
class ScriptsFrBF extends Scripts {
  const ScriptsFrBF._(super.cld);
...
class TerritoriesFrBF extends Territories {
  const TerritoriesFrBF._(super.cld);
...
class VariantsFrBF extends Variants {
  const VariantsFrBF._(super.cld);
...
class SubdivisionsFrBF extends Subdivisions {
  const SubdivisionsFrBF._(super.cld);
...
class CurrenciesFrBF extends Currencies {
  const CurrenciesFrBF._(super.cld);
...
class TimeZonesFrBF extends TimeZones {
  const TimeZonesFrBF._(super.cld)
      : super(
            gmtFormat: 'UTC{0}',
            gmtZeroFormat: 'UTC',
...
class LocaleDisplayNameFrBF extends LocaleDisplayName {
  const LocaleDisplayNameFrBF._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
