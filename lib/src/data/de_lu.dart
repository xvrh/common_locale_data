...
const _locale = 'de-LU';
const _cld = CommonLocaleDataDeLU._();

/// Translations of [CommonLocaleData]
///
/// @nodoc
class CommonLocaleDataDeLU implements CommonLocaleData {
  @override
  String get locale => _locale;

  const CommonLocaleDataDeLU._();
  ...
  static final _units = UnitsDeLU._(_cld);
  @override
  Units get units => _units;

  static final _dateFields = DateFieldsDeLU._(_cld);
  @override
  DateFields get date => _dateFields;

  static final _languages = LanguagesDeLU._(_cld);
  @override
  Languages get languages => _languages;

  static final _scripts = ScriptsDeLU._(_cld);
  @override
  Scripts get scripts => _scripts;

  static final _territories = TerritoriesDeLU._(_cld);
  @override
  Territories get territories => _territories;

  static final _variants = VariantsDeLU._(_cld);
  @override
  Variants get variants => _variants;

  static final _subdivisions = SubdivisionsDeLU._(_cld);
  @override
  Subdivisions get subdivisions => _subdivisions;

  static final _currencies = CurrenciesDeLU._(_cld);
  @override
  Currencies get currencies => _currencies;

  static final _timeZones = TimeZonesDeLU._(_cld);
  @override
  TimeZones get timeZones => _timeZones;

  static final _localeDisplayName = LocaleDisplayNameDeLU._(_cld);
  @override
  LocaleDisplayName get localeDisplayName => _localeDisplayName;
}

class UnitsDeLU extends Units {
  UnitsDeLU._(super.cld);
...
class DateFieldsDeLU extends DateFields {
  DateFieldsDeLU._(super.cld);
...
class LanguagesDeLU extends Languages {
  const LanguagesDeLU._(super.cld);
...
class ScriptsDeLU extends Scripts {
  const ScriptsDeLU._(super.cld);
...
class TerritoriesDeLU extends Territories {
  const TerritoriesDeLU._(super.cld);
...
class VariantsDeLU extends Variants {
  const VariantsDeLU._(super.cld);
...
class SubdivisionsDeLU extends Subdivisions {
  const SubdivisionsDeLU._(super.cld);
...
class CurrenciesDeLU extends Currencies {
  const CurrenciesDeLU._(super.cld);
...
class TimeZonesDeLU extends TimeZones {
  const TimeZonesDeLU._(super.cld)
      : super(
            gmtFormat: 'GMT{0}',
            gmtZeroFormat: 'GMT',
...
class LocaleDisplayNameDeLU extends LocaleDisplayName {
  const LocaleDisplayNameDeLU._(super.cld)
      : super(
            localePattern: '{0} ({1})',
            localeSeparator: '{0}, {1}',
